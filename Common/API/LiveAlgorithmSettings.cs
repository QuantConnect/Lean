...
namespace QuantConnect.API
{
    ...
    public class LiveAlgorithmApiSettingsWrapper
    {
        ...
        public LiveAlgorithmApiSettingsWrapper(int projectId, string compileId, string serverType, BaseLiveAlgorithmSettings settings)
        {
            VersionId = "-1";
            ProjectId = projectId;
            CompileId = compileId;
    ...
    {
        /// <summary>
        /// All common parameters must be specified in the constructor
        /// </summary>
