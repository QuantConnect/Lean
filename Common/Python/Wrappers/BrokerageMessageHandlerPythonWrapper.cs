...
{
    /// <summary>
    /// Wrapper for an <see cref = "IBrokerageMessageHandler"/> instance created in Python.
    ...
    public class BrokerageMessageHandlerPythonWrapper : IBrokerageMessageHandler
    {
        ...
        /// <summary>
        /// <see cref="BrokerageMessageHandlerPythonWrapper"/> constructor.
        /// Wraps the <see cref="IBrokerageMessageHandler"/> object.  
        /// </summary>
        /// <param name="brokerageMessageHandler"><see cref="IBrokerageMessageHandler"/> object to be wrapped</param>
        ...
        /// <summary>
        /// Wrapper for <see cref="IBrokerageMessageHandler.Handle" /> in Python
        /// </summary>
