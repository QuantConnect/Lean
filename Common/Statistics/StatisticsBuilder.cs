...
namespace QuantConnect.Statistics
{
    ...
    public static class StatisticsBuilder
    {
            ...
            int tradingDaysPerYear)
        {
            ...
            var periodWinningTransactions = new SortedDictionary<DateTime, decimal>(transactions.WinningTransactions
            ...
            return new AlgorithmPerformance(periodTrades, periodProfitLoss, periodEquity, portfolioTurnover, listPerformance, listBenchmark,
                runningCapital, periodWinningTransactions, riskFreeInterestRateModel, tradingDaysPerYear);
        }
