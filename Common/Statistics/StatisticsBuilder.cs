    ...
    public static class StatisticsBuilder
    {
            ...
            decimal totalFees, int totalTransactions, string accountCurrencySymbol)
        {
            ...
            return new Dictionary<string, string>
            {
                ...
                { PerformanceMetrics.StartingEquity, Math.Round(totalPerformance.PortfolioStatistics.StartingEquity, 2).ToStringInvariant() },
                { PerformanceMetrics.EndingEquity, Math.Round(totalPerformance.PortfolioStatistics.EndingEquity, 2).ToStringInvariant() },
