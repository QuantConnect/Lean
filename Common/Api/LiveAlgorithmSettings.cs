...
#pragma warning disable CA1056, CA1054 // URI-like properties should not be strings
    ...
    public class TDAmeritradeLiveAlgorithmSettings : BaseLiveAlgorithmSettings
    {
        ...
        /// </summary>
        /// <param name="clientID">Consumer Key made in My Apps(https://developer.tdameritrade.com/user/me/apps)</param>
        /// <param name="redirectUri">Callback URL specified in My Apps(https://developer.tdameritrade.com/user/me/apps)</param>
        /// <param name="authorizationCode">Multi-factor authorization code</param>
