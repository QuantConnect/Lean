...
namespace QuantConnect.Scheduling
{
    ...
    public class DateRules
    {
        ...
        public IDateRule EveryDay(Symbol symbol)
        {
            ...
            return new FuncDateRule(SymbolCache.GetTicker(symbol) + ": EveryDay", (start, end) => Time.EachTradeableDay(security, start, end));
        }
        ...
        {
            return new FuncDateRule(SymbolCache.GetTicker(symbol) + ": MonthStart", (start, end) => MonthStartIterator(GetSecurity(symbol), start, end));
        }
