...
{
    /// <summary>
    /// Specifies that an event should fire every day
    /// </summary>
    public class EveryDayDateRule : IDateRule
    {
        /// <summary>
        /// Gets an instance of <see cref="EveryDayDateRule"/>
        /// </summary>
        public static readonly IDateRule Instance = new EveryDayDateRule();
