...
namespace QuantConnect.Securities.Future
{
    ...
    public class FuturesExpiryFunctions
    {
        ...
        public static Dictionary<DateTime, DateTime> DairyReportDates = new Dictionary<
            DateTime,
            DateTime
        >()
        {
        ...
        public static Dictionary<DateTime, DateTime> EnbridgeNoticeOfShipmentDates = new Dictionary<
            DateTime,
            DateTime
        >()
        {
        ...
        > FuturesExpiryDictionary = new Dictionary<Symbol, Func<DateTime, DateTime>>()
        {
            // Metals
            ...
            {
                Symbol.Create(Futures.Metals.Silver, SecurityType.Future, Market.COMEX),
                (
                    time =>
                    {
                        // Monthly contracts
            ...
            // Aluminum MW U.S. Transaction Premium Platts (25MT) (AUP): https://www.cmegroup.com/trading/metals/base/aluminum-mw-us-transaction-premium-platts-swap-futures_contract_specifications.html
            {
                ...
                (
                    time =>
                    {
                        ...
                        var lastBusinessDay = FuturesExpiryUtilityFunctions.NthLastBusinessDay(
                            time,
                            1,
                            holidays
                        );

                        lastBusinessDay = FuturesExpiryUtilityFunctions.AddBusinessDaysIfHoliday(
                            lastBusinessDay,
                            -1,
                            holidays
                        );
            ...
            {
                Symbol.Create(Futures.Metals.Copper, SecurityType.Future, Market.COMEX),
                (
                    time =>
                    {
                        var market = Market.COMEX;
                        ...
                        return FuturesExpiryUtilityFunctions
                            .NthLastBusinessDay(time, 3, holidays)
                            .Add(new TimeSpan(17, 0, 0));
                    }
                )
            },
            // U.S. Midwest Domestic Hot-Rolled Coil Steel (CRU) Index (HRC): https://www.cmegroup.com/trading/metals/ferrous/hrc-steel_contract_specifications.html
            {
                ...
                (
                    time =>
                    {
                        ...
                        var lastWednesday = (
                            from dateRange in Enumerable.Range(
                                1,
                                DateTime.DaysInMonth(time.Year, time.Month)
                            )
                            where
                                new DateTime(time.Year, time.Month, dateRange).DayOfWeek
                                == DayOfWeek.Wednesday
            ...
            {
                Symbol.Create(Futures.Indices.Dow30EMini, SecurityType.Future, Market.CBOT),
                (
                    time =>
                    {
            ...
            {
                Symbol.Create(Futures.Indices.Russell2000EMini, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        // Quarterly contracts (Mar, Jun, Sep, Dec) listed for 5 consecutive quarters
            ...
            {
                Symbol.Create(Futures.Indices.Nikkei225Dollar, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        ...
                        while (
                            !FuturesExpiryUtilityFunctions.NotHoliday(priorBusinessDay, holidays)
                        )
                        {
            ...
            {
                Symbol.Create(Futures.Indices.Nikkei225YenCME, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Indices.Nikkei225YenEMini, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Indices.FTSEChina50EMini, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
                        ...
                        var secondLastBusinessDay =
                            FuturesExpiryUtilityFunctions.NthLastBusinessDay(time, 2, holidays);

                        while (
                            !FuturesExpiryUtilityFunctions.NotHoliday(
                                secondLastBusinessDay,
                                holidays
                            )
                        )
                        {
            ...
            {
                Symbol.Create(Futures.Indices.FTSE100EMini, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Indices.SPEurop350ESGEMini, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Indices.FTSE100USDEMini, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Indices.TOPIXUSD, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Indices.TOPIXYEN, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Indices.DowJonesRealEstate, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Indices.SP500EMiniESG, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Indices.Russell1000EMini, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            // CBOE Volatility Index Futures (VIX): https://www.cboe.com/tradable_products/vix/vix_futures/specifications/
            {
                ...
                (
                    time =>
                    {
                        ...
                        var nextThirdFriday = FuturesExpiryUtilityFunctions.ThirdFriday(
                            time.AddMonths(1)
                        );
            ...
            // Bloomberg Commodity Index (AW): https://www.cmegroup.com/trading/agricultural/commodity-index/bloomberg-commodity-index_contract_specifications.html
            {
                ...
                (
                    time =>
                    {
                        ...
                        thirdWednesday = FuturesExpiryUtilityFunctions.AddBusinessDaysIfHoliday(
                            thirdWednesday,
                            -1,
                            holidays
                        );
            ...
            // E-mini Nasdaq-100 Biotechnology Index (BIO): https://www.cmegroup.com/trading/equity-index/us-index/e-mini-nasdaq-biotechnology_contract_specifications.html
            {
                ...
                (
                    time =>
                    {
                        ...
                        // Trading can occur up to 9:30 a.m. ET on the 3rd Friday of the contract month
                        var thirdFriday = FuturesExpiryUtilityFunctions.ThirdFriday(time);
                        thirdFriday = FuturesExpiryUtilityFunctions.AddBusinessDaysIfHoliday(
                            thirdFriday,
                            -1,
                            holidays
                        );
            ...
            {
                Symbol.Create(Futures.Indices.FTSEEmergingEmini, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
            ...
            {
                Symbol.Create(Futures.Indices.SP400MidCapEmini, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        // Quarterly contracts (Mar, Jun, Sep, Dec) listed for 5 consecutive quarters
            ...
            {
                Symbol.Create(Futures.Indices.SPGSCICommodity, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
                        ...
                        return FuturesExpiryUtilityFunctions
                            .NthBusinessDay(time, 11, holidays)
                            .Add(new TimeSpan(18, 40, 0));
                    }
                )
            },
            // USD-Denominated Ibovespa Index (IBV): https://www.cmegroup.com/trading/equity-index/international-index/usd-denominated-ibovespa_contract_specifications.html
            {
                ...
                (
                    time =>
                    {
                        ...
                        var distanceFromFifteenthDay = wednesdays
                            .Select(x => Math.Abs(15 - x.Day))
                            .ToList();
                        var wednesdayIndex = distanceFromFifteenthDay.IndexOf(
                            distanceFromFifteenthDay.Min()
                        );
                        var closestWednesday = wednesdays.ElementAt(wednesdayIndex);
                        if (
                            holidays.Contains(closestWednesday)
                            || !FuturesExpiryUtilityFunctions.NotHoliday(closestWednesday, holidays)
                        )
                        {
                            closestWednesday = FuturesExpiryUtilityFunctions.AddBusinessDays(
                                closestWednesday,
                                1,
                                holidays
                            );
            ...
            {
                Symbol.Create(Futures.Indices.Nikkei225Yen, SecurityType.Future, Market.SGX),
                (
                    time =>
                    {
                        ...
                        while (
                            holidays.Contains(priorBusinessDay)
            ...
            {
                Symbol.Create(Futures.Indices.MSCITaiwanIndex, SecurityType.Future, Market.SGX),
                (
                    time =>
                    {
            ...
            {
                Symbol.Create(Futures.Indices.Nifty50, SecurityType.Future, Market.India),
                (
                    time =>
                    {
            ...
            {
                Symbol.Create(Futures.Indices.BseSensex, SecurityType.Future, Market.India),
                (
                    time =>
                    {
            ...
            {
                Symbol.Create(Futures.Indices.MSCIEuropeNTR, SecurityType.Future, Market.NYSELIFFE),
                (
                    time =>
                    {
                        ...
                        lastTradingDay = FuturesExpiryUtilityFunctions.AddBusinessDaysIfHoliday(
                            lastTradingDay,
                            -1,
                            holidays
                        );
            ...
            {
                Symbol.Create(Futures.Indices.MSCIJapanNTR, SecurityType.Future, Market.NYSELIFFE),
                (
                    time =>
                    {
                        var market = Market.NYSELIFFE;
            ...
            {
                Symbol.Create(
                    Futures.Indices.MSCIEmergingMarketsAsiaNTR,
                    SecurityType.Future,
                    Market.NYSELIFFE
                ),
                (
            ...
            {
                Symbol.Create(Futures.Indices.MSCIEafeIndex, SecurityType.Future, Market.NYSELIFFE),
                (
                    time =>
                    {
                        var market = Market.NYSELIFFE;
            ...
            {
                Symbol.Create(
                    Futures.Indices.MSCIEmergingMarketsIndex,
                    SecurityType.Future,
                    Market.NYSELIFFE
                ),
                (
            ...
            {
                Symbol.Create(Futures.Indices.MSCIUsaIndex, SecurityType.Future, Market.NYSELIFFE),
                (
                    time =>
                    {
                        var market = Market.NYSELIFFE;
            ...
            {
                Symbol.Create(Futures.Forestry.RandomLengthLumber, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
                        ...
                        return FuturesExpiryUtilityFunctions
                            .AddBusinessDays(sixteenth, -1, holidays)
                            .Add(new TimeSpan(17, 5, 0));
                    }
                )
            },
            // Lumber and Softs
            ...
            {
                Symbol.Create(Futures.Forestry.Lumber, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Grains.SRWWheat, SecurityType.Future, Market.CBOT),
                (
                    time =>
                    {
                        var market = Market.CBOT;
            ...
            {
                Symbol.Create(Futures.Grains.HRWWheat, SecurityType.Future, Market.CBOT),
                (
                    time =>
                    {
                        var market = Market.CBOT;
            ...
            {
                Symbol.Create(Futures.Grains.SoybeanMeal, SecurityType.Future, Market.CBOT),
                (
                    time =>
                    {
                        var market = Market.CBOT;
            ...
            {
                Symbol.Create(Futures.Grains.SoybeanOil, SecurityType.Future, Market.CBOT),
                (
                    time =>
                    {
                        var market = Market.CBOT;
            ...
            {
                Symbol.Create(Futures.Currencies.USD, SecurityType.Future, Market.ICE),
                (
                    time =>
                    {
                ...
                (
                    time =>
                    {
                        ...
                        var secondBusinessDayPrecedingThirdWednesday =
                            FuturesExpiryUtilityFunctions.AddBusinessDays(
                                thirdWednesday,
                                -2,
                                holidays
                            );
                        return secondBusinessDayPrecedingThirdWednesday.Add(
            ...
            // CAD (6C): http://www.cmegroup.com/trading/fx/g10/canadian-dollar_contract_specifications.html
            {
                ...
                (
                    time =>
                    {
                        ...
                        var thirdWednesday = FuturesExpiryUtilityFunctions.ThirdWednesday(time);
                        var businessDayPrecedingThridWednesday =
                            FuturesExpiryUtilityFunctions.AddBusinessDays(
                                thirdWednesday,
                                -1,
                                holidays
            ...
            {
                Symbol.Create(Futures.Currencies.RUB, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
                        ...
                        {
                            fifteenth = FuturesExpiryUtilityFunctions.AddBusinessDays(
                                fifteenth,
                                1,
                                holidays
                            );
            ...
            // BRL (6L): https://www.cmegroup.com/trading/fx/emerging-market/brazilian-real_contract_specifications.html
            {
                ...
                (
                    time =>
                    {
                        ...
                        var lastPrecedingBusinessDay =
                            FuturesExpiryUtilityFunctions.AddBusinessDays(time, -1, holidays);
                        lastPrecedingBusinessDay =
                            FuturesExpiryUtilityFunctions.AddBusinessDaysIfHoliday(
                                lastPrecedingBusinessDay,
                                -1,
                                holidays
                            );
            ...
            // MXN (6M): https://www.cmegroup.com/trading/fx/emerging-market/mexican-peso_contract_specifications.html
            {
                ...
                (
                    time =>
                    {
                        ...
                        secondBusinessDayPrecedingThirdWednesday =
                            FuturesExpiryUtilityFunctions.AddBusinessDaysIfHoliday(
                                secondBusinessDayPrecedingThirdWednesday,
                                -1,
                                holidays
            ...
            {
                Symbol.Create(Futures.Currencies.ZAR, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Currencies.AUDCAD, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Currencies.AUDJPY, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Currencies.AUDNZD, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            // Bitcoin (BTC): https://www.cmegroup.com/trading/equity-index/us-index/bitcoin_contract_specifications.html
            {
                ...
                (
                    time =>
                    {
                        ...
                        lastFriday = FuturesExpiryUtilityFunctions.AddBusinessDaysIfHoliday(
                            lastFriday,
                            -1,
                            holidays
                        );
            ...
            {
                Symbol.Create(Futures.Currencies.CADJPY, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            // Standard-Size USD/Offshore RMB (CNH): https://www.cmegroup.com/trading/fx/emerging-market/usd-cnh_contract_specifications.html
            {
                ...
                (
                    time =>
                    {
                        ...
                        while (
                            holidays.Contains(secondBusinessDayPrecedingThirdWednesday)
                            || !secondBusinessDayPrecedingThirdWednesday.IsCommonBusinessDay()
                        )
                        {
                            secondBusinessDayPrecedingThirdWednesday =
                                secondBusinessDayPrecedingThirdWednesday.AddDays(-1);
                        }
            ...
            {
                Symbol.Create(Futures.Currencies.EuroFXEmini, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Currencies.EURAUD, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Currencies.EURCAD, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Currencies.EURSEK, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Currencies.JapaneseYenEmini, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Financials.Y30TreasuryBond, SecurityType.Future, Market.CBOT),
                (
                    time =>
                    {
                        var market = Market.CBOT;
                        ...
                        var seventhBusinessDayPrecedingLastBusinessDay =
                            FuturesExpiryUtilityFunctions.AddBusinessDays(
                                lastBusinessDay,
                                -7,
                                holidays
                            );
                        return seventhBusinessDayPrecedingLastBusinessDay.Add(
            ...
            {
                Symbol.Create(Futures.Financials.Y10TreasuryNote, SecurityType.Future, Market.CBOT),
                (
                    time =>
                    {
                        var market = Market.CBOT;
            ...
            {
                Symbol.Create(Futures.Financials.Y5TreasuryNote, SecurityType.Future, Market.CBOT),
                (
                    time =>
                    {
                        var market = Market.CBOT;
            ...
            {
                Symbol.Create(Futures.Financials.Y2TreasuryNote, SecurityType.Future, Market.CBOT),
                (
                    time =>
                    {
                        var market = Market.CBOT;
            ...
            {
                Symbol.Create(Futures.Financials.EuroDollar, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
                        ...
                        return FuturesExpiryUtilityFunctions
                            .AddBusinessDays(
                                FuturesExpiryUtilityFunctions.ThirdWednesday(time),
                                -2,
                                holidays
                            )
            ...
            // 5-Year USD MAC Swap (F1U): https://www.cmegroup.com/trading/interest-rates/swap-futures/5-year-usd-mac-swap_contract_specifications.html
            {
                ...
                (
                    time =>
                    {
                        ...
                        var secondBusinessDayBeforeThirdWednesday = FuturesExpiryUtilityFunctions
                            .ThirdWednesday(time)
                            .AddDays(-2);
                        var holidays = FuturesExpiryUtilityFunctions.GetHolidays(market, symbol);
                        ...
                        while (
                            holidays.Contains(secondBusinessDayBeforeThirdWednesday)
                            || !secondBusinessDayBeforeThirdWednesday.IsCommonBusinessDay()
                        )
                        {
                            secondBusinessDayBeforeThirdWednesday =
                                secondBusinessDayBeforeThirdWednesday.AddDays(-1);
                        }
            ...
            // Ultra U.S. Treasury Bond (UB): https://www.cmegroup.com/trading/interest-rates/us-treasury/ultra-t-bond_contract_specifications.html
            {
                ...
                (
                    time =>
                    {
                        ...
                        // Seventh business day preceding the last business day of the delivery month. Trading in expiring contracts closes at 12:01 p.m. on the last trading day.
                        var sevenBusinessDaysBeforeLastBusinessDay =
                            FuturesExpiryUtilityFunctions.NthLastBusinessDay(time, 8, holidays);
            ...
            {
                Symbol.Create(
                    Futures.Energy.PropaneNonLDHMontBelvieu,
                    SecurityType.Future,
                    Market.NYMEX
                ),
                (
            ...
            {
                Symbol.Create(
                    Futures.Energy.ArgusPropaneFarEastIndexBALMO,
                    SecurityType.Future,
                    Market.NYMEX
                ),
                (
            ...
            {
                Symbol.Create(
                    Futures.Energy.GulfCoastULSDPlattsUpDownBALMO,
                    SecurityType.Future,
                    Market.NYMEX
                ),
                (
            ...
            {
                Symbol.Create(
                    Futures.Energy.GulfCoastJetPlattsUpDownBALMO,
                    SecurityType.Future,
                    Market.NYMEX
                ),
                (
            ...
            {
                Symbol.Create(
                    Futures.Energy.EuropeanPropaneCIFARAArgusBALMO,
                    SecurityType.Future,
                    Market.NYMEX
                ),
                (
            ...
            {
                Symbol.Create(
                    Futures.Energy.GasolineEurobobOxyNWEBargesArgusCrackSpreadBALMO,
                    SecurityType.Future,
                    Market.NYMEX
                ),
                (
                    time =>
                    {
                        ...
                        var symbol = Futures
                            .Energy
                            .GasolineEurobobOxyNWEBargesArgusCrackSpreadBALMO;
                        var holidays = FuturesExpiryUtilityFunctions.GetHolidays(market, symbol);
            ...
            {
                Symbol.Create(
                    Futures.Energy.MontBelvieuNormalButaneOPISBALMO,
                    SecurityType.Future,
                    Market.NYMEX
                ),
                (
            ...
            {
                Symbol.Create(Futures.Energy.ConwayPropaneOPIS, SecurityType.Future, Market.NYMEX),
                (
                    time =>
                    {
                        var market = Market.NYMEX;
            ...
            {
                Symbol.Create(
                    Futures.Energy.MontBelvieuLDHPropaneOPISBALMO,
                    SecurityType.Future,
                    Market.NYMEX
                ),
                (
            ...
            {
                Symbol.Create(
                    Futures.Energy.ArgusPropaneFarEastIndexVsEuropeanPropaneCIFARAArgus,
                    SecurityType.Future,
                    Market.NYMEX
                ),
                (
                    time =>
                    {
                        ...
                        var symbol = Futures
                            .Energy
                            .ArgusPropaneFarEastIndexVsEuropeanPropaneCIFARAArgus;
                        var holidays = FuturesExpiryUtilityFunctions.GetHolidays(market, symbol);
            ...
            {
                Symbol.Create(
                    Futures.Energy.SingaporeFuelOil180cstPlattsBALMO,
                    SecurityType.Future,
                    Market.NYMEX
                ),
                (
            ...
            {
                Symbol.Create(
                    Futures.Energy.SingaporeFuelOil380cstPlattsBALMO,
                    SecurityType.Future,
                    Market.NYMEX
                ),
                (
            ...
            // Argus LLS vs. WTI (Argus) Trade Month Futures (AE5): https://www.cmegroup.com/trading/energy/crude-oil/argus-lls-vs-wti-argus-trade-month-swap-futures_contract_specifications.html
            {
                ...
                (
                    time =>
                    {
                        ...
                        var previousMonth = time.AddMonths(-1);
                        var twentyFifthDay = new DateTime(
                            previousMonth.Year,
                            previousMonth.Month,
                            25
                        );
                        while (
                            !twentyFifthDay.IsCommonBusinessDay()
                            || holidays.Contains(twentyFifthDay)
                        )
                        {
                            twentyFifthDay = FuturesExpiryUtilityFunctions.AddBusinessDays(
                                twentyFifthDay,
                                -1,
                                holidays
                            );
            ...
            {
                Symbol.Create(
                    Futures.Energy.EuropeanNaphthaPlattsBALMO,
                    SecurityType.Future,
                    Market.NYMEX
                ),
                (
            ...
            {
                Symbol.Create(
                    Futures.Energy.MontBelvieuNaturalGasolineOPISBALMO,
                    SecurityType.Future,
                    Market.NYMEX
                ),
                (
            ...
            {
                Symbol.Create(
                    Futures.Energy.GulfCoastHSFOPlattsBALMO,
                    SecurityType.Future,
                    Market.NYMEX
                ),
                (
            ...
            // Mars (Argus) vs. WTI Trade Month (AYV): https://www.cmegroup.com/trading/energy/crude-oil/mars-crude-oil-argus-vs-wti-trade-month-spread-swap-futures_contract_specifications.html
            {
                ...
                (
                    time =>
                    {
                        ...
                        var twentyFifthDayPriorMonth = new DateTime(
                            time.Year,
                            time.Month,
                            25
                        ).AddMonths(-1);
                        while (
                            !FuturesExpiryUtilityFunctions.NotHoliday(
                                twentyFifthDayPriorMonth,
                                holidays
                            ) || holidays.Contains(twentyFifthDayPriorMonth)
                        )
                        {
                            twentyFifthDayPriorMonth =
                                FuturesExpiryUtilityFunctions.AddBusinessDays(
            ...
            {
                Symbol.Create(Futures.Energy.WTIBrentFinancial, SecurityType.Future, Market.NYMEX),
                (
                    time =>
                    {
                        var market = Market.NYMEX;
            ...
            // 3.5% Fuel Oil Barges FOB Rdam (Platts) Crack Spread (1000mt) (BOO): https://www.cmegroup.com/trading/energy/refined-products/35pct-fuel-oil-platts-barges-fob-rdam-crack-spread-1000mt-swap-futures_contract_specifications.html
            {
                ...
                (
                    time =>
                    {
                        ...
                        var symbol = Futures
                            .Energy
                            .ThreePointFivePercentFuelOilBargesFOBRdamPlattsCrackSpread1000mt;
                        var holidays = FuturesExpiryUtilityFunctions.GetHolidays(market, symbol);
                        // Monthly contracts listed for the current year and the next 4 calendar years.
                        // Trading shall cease on the last business day of the contract month
                        var lastBusinessDay = FuturesExpiryUtilityFunctions.NthLastBusinessDay(
            ...
            {
                Symbol.Create(
                    Futures.Energy.GasolineEurobobOxyNWEBargesArgusBALMO,
                    SecurityType.Future,
                    Market.NYMEX
                ),
                (
            ...
            // Brent Last Day Financial (BZ): https://www.cmegroup.com/trading/energy/crude-oil/brent-crude-oil-last-day_contract_specifications.html
            {
                ...
                (
                    time =>
                    {
                        ...
                        {
                            lastBusinessDay = FuturesExpiryUtilityFunctions.NthLastBusinessDay(
                                twoMonthsPriorToContractMonth,
                                1,
                                holidays
                            );
                        }
            ...
            {
                Symbol.Create(Futures.Energy.CrudeOilWTI, SecurityType.Future, Market.NYMEX),
                (
                    time =>
                    {
                        var market = Market.NYMEX;
            ...
            {
                Symbol.Create(
                    Futures.Energy.ClearbrookBakkenSweetCrudeOilMonthlyIndexNetEnergy,
                    SecurityType.Future,
                    Market.NYMEX
                ),
                (
            ...
            {
                Symbol.Create(Futures.Energy.WTIFinancial, SecurityType.Future, Market.NYMEX),
                (
                    time =>
                    {
                        var market = Market.NYMEX;
            ...
            {
                Symbol.Create(
                    Futures.Energy.JapanCnFNaphthaPlattsBALMO,
                    SecurityType.Future,
                    Market.NYMEX
                ),
                (
            ...
            {
                Symbol.Create(Futures.Energy.Ethanol, SecurityType.Future, Market.CBOT),
                (
                    time =>
                    {
                        var market = Market.CBOT;
            ...
            // European Naphtha (Platts) Crack Spread (EN): https://www.cmegroup.com/trading/energy/refined-products/european-naphtha-crack-spread-swap_contract_specifications.html
            {
                ...
                (
                    time =>
                    {
                        ...
                        while (
                            holidays.Contains(lastBusinessDay)
                            || !lastBusinessDay.IsCommonBusinessDay()
                        )
                        {
            ...
            // 3.5% Fuel Oil Barges FOB Rdam (Platts) Crack Spread Futures (FO): https://www.cmegroup.com/trading/energy/refined-products/northwest-europe-nwe-35pct-fuel-oil-rottderdam-crack-spread-swap_contract_specifications.html
            {
                ...
                (
                    time =>
                    {
                        ...
                        var symbol = Futures
                            .Energy
                            .ThreePointFivePercentFuelOilBargesFOBRdamPlattsCrackSpread;
                        var holidays = FuturesExpiryUtilityFunctions.GetHolidays(market, symbol);
                        // Monthly contracts listed for the current year and the next 4 calendar years.
                        // Trading ceases on the last business day of the contract month.
                        var lastBusinessDay = FuturesExpiryUtilityFunctions.NthLastBusinessDay(
            ...
            // Gulf Coast HSFO (Platts) vs. European 3.5% Fuel Oil Barges FOB Rdam (Platts) (GCU): https://www.cmegroup.com/trading/energy/refined-products/gulf-coast-no6-fuel-oil-3pct-vs-european-3point5pct-fuel-oil-barges-fob-rdam-platts-swap-futures_contract_specifications.html
            {
                Symbol.Create(
                    Futures
                        .Energy
                        .GulfCoastHSFOPlattsVsEuropeanThreePointFivePercentFuelOilBargesFOBRdamPlatts,
                    SecurityType.Future,
                    Market.NYMEX
                ),
                (
            ...
            {
                Symbol.Create(Futures.Energy.WTIHoustonCrudeOil, SecurityType.Future, Market.NYMEX),
                (
                    time =>
                    {
                        var market = Market.NYMEX;
                        ...
                        var twentyFifthDayInPriorMonth = new DateTime(
                            time.Year,
                            time.Month,
                            25
                        ).AddMonths(-1);
                        ...
                        while (
                            i < 3
                            || !twentyFifthDayInPriorMonth.IsCommonBusinessDay()
            ...
            // Natural Gas (Henry Hub) Last-day Financial (HH): https://www.cmegroup.com/trading/energy/natural-gas/natural-gas-last-day_contract_specifications.html
            {
                ...
                (
                    time =>
                    {
                        ...
                        return FuturesExpiryUtilityFunctions.NthLastBusinessDay(
                            previousMonth,
                            3,
                            holidays
                        );
            ...
            {
                Symbol.Create(Futures.Energy.HeatingOil, SecurityType.Future, Market.NYMEX),
                (
                    time =>
                    {
                        var market = Market.NYMEX;
            ...
            // WTI Houston (Argus) vs. WTI Trade Month (HTT): https://www.cmegroup.com/trading/energy/crude-oil/wti-houston-argus-vs-wti-trade-month_contract_specifications.html
            {
                ...
                (
                    time =>
                    {
                        ...
                        var twentyFifthPreviousMonth = new DateTime(
                            time.Year,
                            time.Month,
                            25
                        ).AddMonths(-1);
                        while (
                            holidays.Contains(twentyFifthPreviousMonth)
                            || !FuturesExpiryUtilityFunctions.NotHoliday(
                                twentyFifthPreviousMonth,
                                holidays
                            )
                        )
                        {
            ...
            {
                Symbol.Create(Futures.Energy.NaturalGas, SecurityType.Future, Market.NYMEX),
                (
                    time =>
                    {
                        var market = Market.NYMEX;
            ...
            {
                Symbol.Create(Futures.Energy.BrentCrude, SecurityType.Future, Market.ICE),
                (
                    time =>
                    {
            ...
            {
                Symbol.Create(Futures.Energy.LowSulfurGasoil, SecurityType.Future, Market.ICE),
                (
                    time =>
                    {
                        var market = Market.ICE;
                        ...
                        var twelfthDay = FuturesExpiryUtilityFunctions.AddBusinessDays(
                            fourteenthDay,
                            -2,
                            holidays
                        );
            ...
            {
                Symbol.Create(Futures.Meats.LiveCattle, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Meats.LeanHogs, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
                        ...
                        lastday = lastday.AddDays(-1);
                        var tenthday = FuturesExpiryUtilityFunctions.AddBusinessDays(
                            lastday,
                            10,
                            holidays
                        );
            ...
            {
                Symbol.Create(Futures.Meats.FeederCattle, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
                        ...
                        if (time.Month == 11)
                        {
                            var priorThursday = (
                                ...
                                where
                                    new DateTime(time.Year, time.Month, day).DayOfWeek
                                    == DayOfWeek.Thursday
                                ...
                                .ElementAt(1);
                            while (
                                !FuturesExpiryUtilityFunctions.NotHoliday(priorThursday, holidays)
                                || !FuturesExpiryUtilityFunctions.NotPrecededByHoliday(
                                    priorThursday,
                                    holidays
                                )
                            )
                        ...
                        var lastThursday = (
                            ...
                            .ElementAt(0);
                        while (
                            !FuturesExpiryUtilityFunctions.NotHoliday(lastThursday, holidays)
                            || !FuturesExpiryUtilityFunctions.NotPrecededByHoliday(
                                lastThursday,
                                holidays
                            )
            ...
            {
                Symbol.Create(Futures.Softs.Cotton2, SecurityType.Future, Market.ICE),
                (
                    time =>
                    {
                        var market = Market.ICE;
            ...
            {
                Symbol.Create(Futures.Softs.OrangeJuice, SecurityType.Future, Market.ICE),
                (
                    time =>
                    {
                        var market = Market.ICE;
            ...
            {
                Symbol.Create(Futures.Softs.Sugar11, SecurityType.Future, Market.ICE),
                (
                    time =>
                    {
                        var market = Market.ICE;
            ...
            {
                Symbol.Create(Futures.Softs.Sugar11CME, SecurityType.Future, Market.NYMEX),
                (
                    time =>
                    {
                        var market = Market.NYMEX;
            ...
            {
                Symbol.Create(Futures.Softs.Cocoa, SecurityType.Future, Market.ICE),
                (
                    time =>
                    {
                        var market = Market.ICE;
            ...
            {
                Symbol.Create(Futures.Dairy.CashSettledButter, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Dairy.CashSettledCheese, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Dairy.ClassIIIMilk, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Dairy.DryWhey, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Dairy.ClassIVMilk, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Dairy.NonfatDryMilk, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Metals.MicroGold, SecurityType.Future, Market.COMEX),
                (
                    time =>
                    {
                        var market = Market.COMEX;
            ...
            {
                Symbol.Create(Futures.Metals.MicroSilver, SecurityType.Future, Market.COMEX),
                (
                    time =>
                    {
                        var market = Market.COMEX;
            ...
            {
                Symbol.Create(Futures.Metals.MicroGoldTAS, SecurityType.Future, Market.COMEX),
                (
                    time =>
                    {
                        var market = Market.COMEX;
            ...
            {
                Symbol.Create(Futures.Metals.MicroPalladium, SecurityType.Future, Market.NYMEX),
                (
                    time =>
                    {
                        var market = Market.NYMEX;
            ...
            {
                Symbol.Create(Futures.Metals.MiniNYGold, SecurityType.Future, Market.NYSELIFFE),
                (
                    time =>
                    {
                        var market = Market.NYSELIFFE;
            ...
            {
                Symbol.Create(Futures.Metals.MiniNYSilver, SecurityType.Future, Market.NYSELIFFE),
                (
                    time =>
                    {
                        var market = Market.NYSELIFFE;
            ...
            {
                Symbol.Create(Futures.Metals.Gold100Oz, SecurityType.Future, Market.NYSELIFFE),
                (
                    time =>
                    {
                        var market = Market.NYSELIFFE;
            ...
            {
                Symbol.Create(Futures.Metals.Silver5000Oz, SecurityType.Future, Market.NYSELIFFE),
                (
                    time =>
                    {
                        var market = Market.NYSELIFFE;
            ...
            {
                Symbol.Create(Futures.Currencies.MicroEUR, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Currencies.MicroAUD, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Currencies.MicroGBP, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Currencies.MicroCADUSD, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
                        ...
                        var thirdWednesday = FuturesExpiryUtilityFunctions.ThirdWednesday(time);
                        var firstBusinessDayPrecedingThirdWednesday =
                            FuturesExpiryUtilityFunctions.AddBusinessDays(
                                thirdWednesday,
                                -1,
                                holidays
                            );
                        firstBusinessDayPrecedingThirdWednesday =
                            FuturesExpiryUtilityFunctions.AddBusinessDaysIfHoliday(
                                firstBusinessDayPrecedingThirdWednesday,
                                -1,
                                holidays
            ...
            {
                Symbol.Create(Futures.Currencies.MicroJPY, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Currencies.MicroCHF, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Currencies.MicroUSDJPY, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Currencies.MicroINRUSD, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
                        ...
                        var secondBusinessDayPrecedingLastBusinessDay =
                            FuturesExpiryUtilityFunctions.AddBusinessDays(
                                lastBusinessDay,
                                -2,
                                holidays
                            );
                        return secondBusinessDayPrecedingLastBusinessDay.Add(
                            new TimeSpan(6, 30, 0)
                        );
                    }
                )
            ...
            {
                Symbol.Create(Futures.Currencies.MicroCAD, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Currencies.MicroUSDCHF, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Currencies.MicroUSDCNH, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Indices.MicroSP500EMini, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        // Quarterly contracts (Mar, Jun, Sep, Dec) listed for 5 consecutive quarters
            ...
            {
                Symbol.Create(Futures.Indices.MicroNASDAQ100EMini, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        // Quarterly contracts (Mar, Jun, Sep, Dec) listed for 5 consecutive quarters
            ...
            {
                Symbol.Create(Futures.Indices.MicroDow30EMini, SecurityType.Future, Market.CBOT),
                (
                    time =>
                    {
                        // Quarterly contracts (Mar, Jun, Sep, Dec) listed for 4 consecutive quarters
            ...
            {
                Symbol.Create(Futures.Energy.MicroCrudeOilWTI, SecurityType.Future, Market.NYMEX),
                (
                    time =>
                    {
                        var market = Market.NYMEX;
            ...
            {
                Symbol.Create(
                    Futures.Energy.MicroCoalAPIFivefobNewcastleArgusMcCloskey,
                    SecurityType.Future,
                    Market.NYMEX
                ),
                (
                    time =>
                    {
                        ...
                        {
                            lastFriday = FuturesExpiryUtilityFunctions.AddBusinessDays(
                                lastFriday,
                                -1,
                                holidays
                            );
            ...
            {
                Symbol.Create(
                    Futures.Energy.MicroEuropeanThreePointFivePercentFuelOilCargoesFOBMedPlatts,
                    SecurityType.Future,
                    Market.NYMEX
                ),
                (
            ...
            {
                Symbol.Create(Futures.Currencies.MicroEther, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
            ...
            {
                Symbol.Create(Futures.Currencies.MicroBTC, SecurityType.Future, Market.CME),
                (
                    time =>
                    {
                        var market = Market.CME;
