...
namespace QuantConnect.Securities
{
    ...
    public class SecurityService : ISecurityService
    {
        ...
        private void InitializeSecurity(bool initializeSecurity, Security existingSecurity)
        {
            if (initializeSecurity && !existingSecurity.IsInitialized)
            {
                _securityInitializerProvider.SecurityInitializer.Initialize(existingSecurity);
                existingSecurity.IsInitialized = true;
            }
        }
    }
}
