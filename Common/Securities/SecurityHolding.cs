...
namespace QuantConnect.Securities 
{
    ...
    public class SecurityHolding
    {
        ...
        public virtual decimal TotalCloseProfit() 
        {
            ...
            var marketOrder = new MarketOrder(_security.Symbol, -Quantity, _security.LocalTime.ConvertToUtc(_security.Exchange.TimeZone), type: _security.Type) {Price = Price};
