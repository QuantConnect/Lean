...
namespace QuantConnect.Data.Consolidators
{
    ...
    /// </summary>
    public class TickCalendarConsolidator : CalendarConsolidatorBase<Tick, TradeBar>
    {
        /// <summary>
        /// Creates a consolidator to produce a new 'TradeBar' representing the period
        /// </summary>
        /// <param name="calendarType">The minimum span of time before emitting a consolidated bar</param>
        public TickCalendarConsolidator(CalendarType calendarType = CalendarType.Weekly)
        {
        ...
        /// </summary>
        public static TickCalendarConsolidator Monthly()
        {
            return new TickCalendarConsolidator(CalendarType.Monthly);
        }

        /// <summary>
        /// Creates a consolidator to produce a new 'TradeBar' representing one-week period
        /// </summary>
        public static TickCalendarConsolidator Weekly()
        {
            return new TickCalendarConsolidator(CalendarType.Weekly);
        }
        ...
        protected override bool ShouldProcess(Tick data) => data.TickType == TickType.Trade;
