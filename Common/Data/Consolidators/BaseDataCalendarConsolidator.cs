...
namespace QuantConnect.Data.Consolidators
{
    ...
    /// </summary>
    public class BaseDataCalendarConsolidator : CalendarConsolidatorBase<BaseData, TradeBar>
    {
        /// <summary>
        /// Creates a consolidator to produce a new 'TradeBar' representing the period
        /// </summary>
        /// <param name="calendarType">The minimum span of time before emitting a consolidated bar</param>
        public BaseDataCalendarConsolidator(CalendarType calendarType = CalendarType.Weekly)
        {
        ...
        /// </summary>
        public static BaseDataCalendarConsolidator Monthly()
        {
            return new BaseDataCalendarConsolidator(CalendarType.Monthly);
        }

        /// <summary>
        /// Creates a consolidator to produce a new 'TradeBar' representing one-week period
        /// </summary>
        public static BaseDataCalendarConsolidator Weekly()
        {
            return new BaseDataCalendarConsolidator(CalendarType.Weekly);
        }
