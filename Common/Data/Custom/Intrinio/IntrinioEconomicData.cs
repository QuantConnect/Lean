...
namespace QuantConnect.Data.Custom.Intrinio
{
    ...
    public class IntrinioEconomicData : BaseData
    {
        ...
        /// </summary>
        public IntrinioEconomicData()
            : this(IntrinioDataTransformation.Level) { }
        ...
        private static string GetStringForDataTransformation(
            IntrinioDataTransformation dataTransformation
        )
        {
            var item = "level";
        ...
        private SubscriptionDataSource GetIntrinioSubscription(
            SubscriptionDataConfig config,
            bool isLiveMode
        )
        {
            ...
            var byteKey = Encoding.ASCII.GetBytes(
