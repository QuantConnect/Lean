...
namespace QuantConnect.Data.Custom.Fred
{
    public partial class Fred
    {
        ...
        public static class ICEBofAML
        {
            ...
            /// The ICE BofAML Option-Adjusted Spreads (OASs) are the calculated spreads between a computed OAS index of all bonds in a given rating category and a spot Treasury curve. An OAS index is constructed using each constituent bond’s OAS, weighted by market capitalization. The ICE BofAML High Yield Master II OAS uses an indSex of bonds that are below investment grade (those rated BB or below).
