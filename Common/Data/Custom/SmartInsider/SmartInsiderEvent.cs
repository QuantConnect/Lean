...
namespace QuantConnect.Data.Custom.SmartInsider
{
    ...
    /// </summary>
    public abstract class SmartInsiderEvent : BaseData, IEquatable<SmartInsiderEvent>
    {
        /// <summary>
        ...
        /// </summary>
        public string BuybackType { get; protected set; }
        ...
        /// </summary>
        public DateTime? LastIDsUpdate { get; protected set; }
        ...
        /// </summary>
        public decimal? USDMarketCap { get; protected set; }
        ...
        /// </summary>
        public string ICBIndustry { get; protected set; }

        /// <summary>
        /// FTSE Russell Sector Classification
        /// </summary>
        public string ICBSuperSector { get; protected set; }

        /// <summary>
        /// FTSE Russell Sector Classification
        /// </summary>
        public string ICBSector { get; protected set; }

        /// <summary>
        /// FTSE Russell Sector Classification
        /// </summary>
        public string ICBSubSector { get; protected set; }

        /// <summary>
        /// Numeric code that is the most granular level in ICB classification
        /// </summary>
        public int? ICBCode { get; protected set; }
        ...
        /// </summary>
        public DateTime? PreviousResultsAnnouncementDate { get; protected set; }

        /// <summary>
        /// Announcement date of next results, this will be the end date of the next "Close Period"
        /// </summary>
        public DateTime? NextResultsAnnouncementsDate { get; protected set; }

        /// <summary>
        /// ???
        /// </summary>
        public DateTime? NextCloseBegin { get; protected set; }

        /// <summary>
        /// ???
        /// </summary>
        public DateTime? LastCloseEnded { get; protected set; }

        /// <summary>
        /// Type of security. Does not contain nominal value
        /// </summary>
        public string SecurityDescription { get; protected set; }

        /// <summary>
        /// Country of local identifier, denoting where the trade took place
        /// </summary>
        public string TickerCountry { get; protected set; }
        ...
        /// </summary>
        public DateTime? TimeReleased { get; protected set; }
        ...
        /// </summary>
        public DateTime? TimeProcessed { get; protected set; }
        ...
        /// </summary>
        public DateTime? TimeReleasedUtc { get; protected set; }

        /// <summary>
        /// Time the transaction was entered onto our systems and appeared on our website. Time stated is GMT standard
        /// </summary>
        public DateTime? TimeProcessedUtc { get; protected set; }

        /// <summary>
        /// Market in which the transaction was announced, this can reference more than one country
        /// </summary>
        public string AnnouncedIn { get; protected set; }

        #region Reserved Fields
        /*
         * These fields are provided for future proofing of the data provided by Smart Insider
         * public string UserField61 { get; protected set; }
         * public string UserField62 { get; protected set; }
         * public string UserField63 { get; protected set; }
         * public string UserField64 { get; protected set; }
         * public string UserField65 { get; protected set; }
         * public string SystemField66 { get; protected set; }
         * public string SystemField67 { get; protected set; }
         * public string SystemField68 { get; protected set; }
         * public string SystemField69 { get; protected set; }
         * public string SystemField70 { get; protected set; }
         * public decimal? UserField71 { get; protected set; }
         * public decimal? UserField72 { get; protected set; }
         * public decimal? UserField73 { get; protected set; }
         * public decimal? UserField74 { get; protected set; }
         * public decimal? UserField75 { get; protected set; }
         * public decimal? SystemField76 { get; protected set; }
         * public decimal? SystemField77 { get; protected set; }
         * public decimal? SystemField78 { get; protected set; }
         * public decimal? SystemField79 { get; protected set; }
         * public decimal? SystemField80 { get; protected set; }
         * public int? Field81 { get; protected set; }
         * public int? Field82 { get; protected set; }
         * public int? Field83 { get; protected set; }
         * public int? Field84 { get; protected set; }
         * public int? Field85 { get; protected set; }
         * public int? Field86 { get; protected set; }
         * public int? Field87 { get; protected set; }
         * public int? Field88 { get; protected set; }
         * public int? Field89 { get; protected set; }
         * public int? Field90 { get; protected set; }
         * public DateTime? Field91 { get; protected set; }
         * public DateTime? Field92 { get; protected set; }
         * public DateTime? Field93 { get; protected set; }
         * public DateTime? Field94 { get; protected set; }
         * public DateTime? Field95 { get; protected set; }
         * public DateTime? Field96 { get; protected set; }
         * public DateTime? Field97 { get; protected set; }
         * public DateTime? Field98 { get; protected set; }
         * public DateTime? Field99 { get; protected set; }
         * public DateTime? Field100 { get; protected set; }
         */
        ...
        public abstract void FromRawCsv(string line);

        /// <summary>
        /// IEquatable abstract method. This is left to derived classes to implement
        /// </summary>
        /// <param name="other">Other SmartInsiderEvent instance</param>
        /// <returns>True if equal and false if not</returns>
        public abstract bool Equals(SmartInsiderEvent other);
    }
}
