    ...
    public class UserDefinedUniverse : Universe, INotifyCollectionChanged, ITimeTriggeredUniverse
    {
            ...
            : base(configuration)
        {
            ...
            _selector = time =>
            {
                ...
                // if we received an unchanged then short circuit the symbol creation and return it directly
        ...
        /// <param name="selector">Universe selection function invoked for each time returned via GetTriggerTimes.
        /// The function parameter is a DateTime in the time zone of configuration.ExchangeTimeZone</param>
        public UserDefinedUniverse(SubscriptionDataConfig configuration, UniverseSettings universeSettings, TimeSpan interval, Func<DateTime, IEnumerable<Symbol>> selector)
            : base(configuration)
        {
            _interval = interval;
            UniverseSettings = universeSettings;
