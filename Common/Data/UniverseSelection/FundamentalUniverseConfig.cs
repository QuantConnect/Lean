...
namespace QuantConnect.Data.UniverseSelection
{
    ...
    /// </summary>
    public class FundamentalUniverseConfig : Universe
    {
        internal static readonly Fundamental.FundamentalUniverse SymbolFactory = new();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FundamentalUniverseConfig"/> class
        /// </summary>
        ...
        public FundamentalUniverseConfig(UniverseSettings universeSettings, Func<IEnumerable<Fundamental.Fundamental>, IEnumerable<Symbol>> selector)
            : base(CreateConfiguration(Fundamental.FundamentalUniverse.UniverseSymbol()))
        {
        ...
        /// <param name="universeSettings">The settings used for new subscriptions generated by this universe</param>
        /// <param name="selector">Returns the symbols that should be included in the universe</param>
        public FundamentalUniverseConfig(UniverseSettings universeSettings, PyObject selector)
            : this(universeSettings, selector.ConvertToDelegate<Func<IEnumerable<Fundamental.Fundamental>, object>>())
        {
        }
        ...
        /// <param name="universeSettings">The settings used for new subscriptions generated by this universe</param>
        /// <param name="selector">Returns the symbols that should be included in the universe</param>
        public FundamentalUniverseConfig(UniverseSettings universeSettings, Func<IEnumerable<Fundamental.Fundamental>, object> selector)
            : this(universeSettings, selector.ConvertToUniverseSelectionSymbolDelegate())
        {
        }
        ...
        /// <param name="universeSettings">The settings used for new subscriptions generated by this universe</param>
        /// <param name="selector">Returns the symbols that should be included in the universe</param>
        public FundamentalUniverseConfig(Symbol symbol, UniverseSettings universeSettings, Func<IEnumerable<Fundamental.Fundamental>, IEnumerable<Symbol>> selector)
