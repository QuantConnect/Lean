...
namespace QuantConnect.Data.Market
{
    ...
    /// </summary>
    public class WickoBar : BaseData
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the end time of this wicko bar or the most recent update time if it <see cref="IsClosed"/>
        /// </summary>
        ...
        /// Gets the end time of this wicko bar or the most recent update time if it <see cref="IsClosed"/>
        /// </summary>
        [Obsolete("WickoBar.End is obsolete. Please use WickoBar.EndTime property instead.")]
        public DateTime End
        {
            get { return EndTime; }
            set { EndTime = value; }
        ...
        /// <summary>
        /// Initializes a new default instance of the <see cref="WickoBar"/> class.
        /// </summary>
        public WickoBar()
        {
        }
        ...
        {
            // can't update a closed wicko bar
            if (IsClosed) return true;
            if (Start == DateTime.MinValue) Start = time;
            EndTime = time;

            // compute the min/max closes this wicko bar can have
        ...
        {
            throw new NotSupportedException("WickoBar does not support the Reader function. This function should never be called on this type.");
        }
        ...
        {
            throw new NotSupportedException("WickoBar does not support the GetSource function. This function should never be called on this type.");
        }
