...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class InvestmentContractLiabilitiesIncurredIncomeStatement : MultiPeriodField
    {
        ...
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("InvestmentContractLiabilitiesIncurred was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("InvestmentContractLiabilitiesIncurred was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double SixMonths => throw new NotSupportedException("InvestmentContractLiabilitiesIncurred was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("InvestmentContractLiabilitiesIncurred was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("InvestmentContractLiabilitiesIncurred was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("InvestmentContractLiabilitiesIncurred was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("InvestmentContractLiabilitiesIncurred was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("InvestmentContractLiabilitiesIncurred was retired by Morningstar in 2026 for all periods; no replacement is available.");
