...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CurrentDeferredRevenueBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("CurrentDeferredRevenue.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use CurrentDeferredRevenue.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("CurrentDeferredRevenue.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use CurrentDeferredRevenue.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("CurrentDeferredRevenue.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentDeferredRevenue.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("CurrentDeferredRevenue.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentDeferredRevenue.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("CurrentDeferredRevenue.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentDeferredRevenue.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("CurrentDeferredRevenue.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentDeferredRevenue.ThreeMonths (also available: SixMonths, TwelveMonths).");
