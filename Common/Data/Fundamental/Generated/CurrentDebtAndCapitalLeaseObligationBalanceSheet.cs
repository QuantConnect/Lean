...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CurrentDebtAndCapitalLeaseObligationBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("CurrentDebtAndCapitalLeaseObligation.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use CurrentDebtAndCapitalLeaseObligation.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("CurrentDebtAndCapitalLeaseObligation.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use CurrentDebtAndCapitalLeaseObligation.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("CurrentDebtAndCapitalLeaseObligation.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentDebtAndCapitalLeaseObligation.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("CurrentDebtAndCapitalLeaseObligation.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentDebtAndCapitalLeaseObligation.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("CurrentDebtAndCapitalLeaseObligation.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentDebtAndCapitalLeaseObligation.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("CurrentDebtAndCapitalLeaseObligation.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentDebtAndCapitalLeaseObligation.ThreeMonths (also available: SixMonths, TwelveMonths).");
