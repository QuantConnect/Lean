    ...
    public class FCFNetIncomeRatio : MultiPeriodField
    {
        ...
        public double OneYear =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_FCFNetIncomeRatio_OneYear
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"OperationRatios_FCFNetIncomeRatio_{ConvertPeriod(period)}"
                )
            );
        ...
        /// </summary>
        public FCFNetIncomeRatio(ITimeProvider timeProvider, SecurityIdentifier securityIdentifier)
