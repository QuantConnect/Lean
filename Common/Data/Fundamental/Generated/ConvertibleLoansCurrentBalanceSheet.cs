...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class ConvertibleLoansCurrentBalanceSheet : MultiPeriodField
    {
        ...
        public double TwelveMonths => throw new NotSupportedException("ConvertibleLoansCurrent is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("ConvertibleLoansCurrent is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
