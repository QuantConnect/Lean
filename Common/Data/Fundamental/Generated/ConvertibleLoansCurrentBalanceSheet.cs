    ...
    public class ConvertibleLoansCurrentBalanceSheet : MultiPeriodField
    {
        ...
        public double TwelveMonths =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_BalanceSheet_ConvertibleLoansCurrent_TwelveMonths
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"FinancialStatements_BalanceSheet_ConvertibleLoansCurrent_{ConvertPeriod(period)}"
                )
            );
