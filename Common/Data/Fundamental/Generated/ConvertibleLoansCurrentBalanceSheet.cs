...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class ConvertibleLoansCurrentBalanceSheet : MultiPeriodField
    {
        ...
        public double TwelveMonths => throw new NotSupportedException("ConvertibleLoansCurrent was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("ConvertibleLoansCurrent was retired by Morningstar in 2026 for all periods; no replacement is available.");
