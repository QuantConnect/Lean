    ...
    public class ProfitMargin5YrAvg : MultiPeriodField
    {
        ...
        public double FiveYears =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_ProfitMargin5YrAvg_FiveYears
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"OperationRatios_ProfitMargin5YrAvg_{ConvertPeriod(period)}"
                )
            );
        ...
        /// </summary>
        public ProfitMargin5YrAvg(ITimeProvider timeProvider, SecurityIdentifier securityIdentifier)
