...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class OtherCurrentBorrowingsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("OtherCurrentBorrowings.NineMonths was retired by Morningstar in 2026; use OtherCurrentBorrowings.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("OtherCurrentBorrowings.NineMonths was retired by Morningstar in 2026; use OtherCurrentBorrowings.ThreeMonths (also available: SixMonths, TwelveMonths).");
