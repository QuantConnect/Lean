...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NonCurrentPrepaidAssetsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("NonCurrentPrepaidAssets.OneMonth was retired by Morningstar in 2026; use NonCurrentPrepaidAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("NonCurrentPrepaidAssets.OneMonth was retired by Morningstar in 2026; use NonCurrentPrepaidAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");
