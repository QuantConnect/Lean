...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class RegressionGrowthofDividends5Years : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("5Y")]
        [Obsolete("RegressionGrowthofDividends5Years is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double FiveYears => throw new NotSupportedException("RegressionGrowthofDividends5Years is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("RegressionGrowthofDividends5Years is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
