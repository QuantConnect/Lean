...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NetLoanBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("NetLoan.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use NetLoan.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("NetLoan.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use NetLoan.ThreeMonths (also available: SixMonths, TwelveMonths).");
