...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class DepositsbyBankBalanceSheet : MultiPeriodField
    {
        ...
        public double ThreeMonths => throw new NotSupportedException("DepositsbyBank was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("12M")]
        [Obsolete("DepositsbyBank was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double TwelveMonths => throw new NotSupportedException("DepositsbyBank was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("DepositsbyBank was retired by Morningstar in 2026 for all periods; no replacement is available.");
