...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class PayablesAndAccruedExpensesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("PayablesAndAccruedExpenses.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use PayablesAndAccruedExpenses.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("PayablesAndAccruedExpenses.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use PayablesAndAccruedExpenses.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("PayablesAndAccruedExpenses.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use PayablesAndAccruedExpenses.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("PayablesAndAccruedExpenses.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use PayablesAndAccruedExpenses.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("PayablesAndAccruedExpenses.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use PayablesAndAccruedExpenses.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("PayablesAndAccruedExpenses.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use PayablesAndAccruedExpenses.ThreeMonths (also available: SixMonths, TwelveMonths).");
