...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class FuturePolicyBenefitsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("3M")]
        [Obsolete("FuturePolicyBenefits is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double ThreeMonths => throw new NotSupportedException("FuturePolicyBenefits is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("12M")]
        [Obsolete("FuturePolicyBenefits is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double TwelveMonths => throw new NotSupportedException("FuturePolicyBenefits is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("FuturePolicyBenefits is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
