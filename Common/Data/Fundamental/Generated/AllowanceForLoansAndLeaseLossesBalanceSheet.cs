...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class AllowanceForLoansAndLeaseLossesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("AllowanceForLoansAndLeaseLosses.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use AllowanceForLoansAndLeaseLosses.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("AllowanceForLoansAndLeaseLosses.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use AllowanceForLoansAndLeaseLosses.ThreeMonths (also available: SixMonths, TwelveMonths).");
