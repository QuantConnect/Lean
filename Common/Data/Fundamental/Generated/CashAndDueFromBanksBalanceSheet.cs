...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CashAndDueFromBanksBalanceSheet : MultiPeriodField
    {
        ...
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("CashAndDueFromBanks was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("CashAndDueFromBanks was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double SixMonths => throw new NotSupportedException("CashAndDueFromBanks was retired by Morningstar in 2026 for all periods; no replacement is available.");

        /// <summary>
        /// Gets/sets the NineMonths period value for the field
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("CashAndDueFromBanks.NineMonths was retired by Morningstar in 2026; use CashAndDueFromBanks.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("CashAndDueFromBanks.NineMonths was retired by Morningstar in 2026; use CashAndDueFromBanks.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        [Obsolete("CashAndDueFromBanks was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("CashAndDueFromBanks was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("CashAndDueFromBanks was retired by Morningstar in 2026 for all periods; no replacement is available.");
