...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class LongTermDebtEquityRatio : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("LongTermDebtEquityRatio.OneMonth was retired by Morningstar in 2026; use LongTermDebtEquityRatio.ThreeMonths (also available: SixMonths, OneYear).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("LongTermDebtEquityRatio.OneMonth was retired by Morningstar in 2026; use LongTermDebtEquityRatio.ThreeMonths (also available: SixMonths, OneYear).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("LongTermDebtEquityRatio.TwoMonths was retired by Morningstar in 2026; use LongTermDebtEquityRatio.ThreeMonths (also available: SixMonths, OneYear).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("LongTermDebtEquityRatio.TwoMonths was retired by Morningstar in 2026; use LongTermDebtEquityRatio.ThreeMonths (also available: SixMonths, OneYear).");
