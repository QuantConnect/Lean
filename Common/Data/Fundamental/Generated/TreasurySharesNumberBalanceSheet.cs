...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class TreasurySharesNumberBalanceSheet : MultiPeriodField
    {
        ...
        public double ThreeMonths => throw new NotSupportedException("TreasurySharesNumber was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("12M")]
        [Obsolete("TreasurySharesNumber was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double TwelveMonths => throw new NotSupportedException("TreasurySharesNumber was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("TreasurySharesNumber was retired by Morningstar in 2026 for all periods; no replacement is available.");
