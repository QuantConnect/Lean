...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class BasicAccountingChange : MultiPeriodField
    {
        ...
        public double ThreeMonths => throw new NotSupportedException("BasicAccountingChange was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("6M")]
        [Obsolete("BasicAccountingChange was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double SixMonths => throw new NotSupportedException("BasicAccountingChange was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("9M")]
        [Obsolete("BasicAccountingChange was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double NineMonths => throw new NotSupportedException("BasicAccountingChange was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("12M")]
        [Obsolete("BasicAccountingChange was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double TwelveMonths => throw new NotSupportedException("BasicAccountingChange was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("BasicAccountingChange was retired by Morningstar in 2026 for all periods; no replacement is available.");
