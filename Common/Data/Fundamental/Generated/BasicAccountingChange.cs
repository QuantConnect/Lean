...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class BasicAccountingChange : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("3M")]
        [Obsolete("BasicAccountingChange is no longer provided by Morningstar in any period since the 2026 feed migration; no direct replacement is provided.")]
        public double ThreeMonths => throw new NotSupportedException("BasicAccountingChange is no longer provided by Morningstar in any period since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("6M")]
        [Obsolete("BasicAccountingChange is no longer provided by Morningstar in any period since the 2026 feed migration; no direct replacement is provided.")]
        public double SixMonths => throw new NotSupportedException("BasicAccountingChange is no longer provided by Morningstar in any period since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("9M")]
        [Obsolete("BasicAccountingChange is no longer provided by Morningstar in any period since the 2026 feed migration; no direct replacement is provided.")]
        public double NineMonths => throw new NotSupportedException("BasicAccountingChange is no longer provided by Morningstar in any period since the 2026 feed migration; no direct replacement is provided.");
        ...
        public double TwelveMonths => throw new NotSupportedException("BasicAccountingChange is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("BasicAccountingChange is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
