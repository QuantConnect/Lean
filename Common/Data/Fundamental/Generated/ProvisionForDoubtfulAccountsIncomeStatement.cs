...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class ProvisionForDoubtfulAccountsIncomeStatement : MultiPeriodField
    {
        ...
        public double TwoMonths => throw new NotSupportedException("ProvisionForDoubtfulAccounts was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("3M")]
        [Obsolete("ProvisionForDoubtfulAccounts was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double ThreeMonths => throw new NotSupportedException("ProvisionForDoubtfulAccounts was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("6M")]
        [Obsolete("ProvisionForDoubtfulAccounts was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double SixMonths => throw new NotSupportedException("ProvisionForDoubtfulAccounts was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("9M")]
        [Obsolete("ProvisionForDoubtfulAccounts was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double NineMonths => throw new NotSupportedException("ProvisionForDoubtfulAccounts was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("12M")]
        [Obsolete("ProvisionForDoubtfulAccounts was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double TwelveMonths => throw new NotSupportedException("ProvisionForDoubtfulAccounts was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("ProvisionForDoubtfulAccounts was retired by Morningstar in 2026 for all periods; no replacement is available.");
