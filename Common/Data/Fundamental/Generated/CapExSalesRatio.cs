    ...
    public class CapExSalesRatio : MultiPeriodField
    {
        ...
        public double OneYear =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_CapExSalesRatio_OneYear
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"OperationRatios_CapExSalesRatio_{ConvertPeriod(period)}"
                )
            );
        ...
        /// </summary>
        public CapExSalesRatio(ITimeProvider timeProvider, SecurityIdentifier securityIdentifier)
