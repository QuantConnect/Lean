...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class AmortizationCashFlowStatement : MultiPeriodField
    {
        ...
        public double OneMonth => throw new NotSupportedException("Amortization was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("2M")]
        [Obsolete("Amortization was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double TwoMonths => throw new NotSupportedException("Amortization was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("3M")]
        [Obsolete("Amortization was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double ThreeMonths => throw new NotSupportedException("Amortization was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("6M")]
        [Obsolete("Amortization was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double SixMonths => throw new NotSupportedException("Amortization was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("9M")]
        [Obsolete("Amortization was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double NineMonths => throw new NotSupportedException("Amortization was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("12M")]
        [Obsolete("Amortization was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double TwelveMonths => throw new NotSupportedException("Amortization was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("Amortization was retired by Morningstar in 2026 for all periods; no replacement is available.");
