...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class IncomeTaxPayableBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("IncomeTaxPayable.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use IncomeTaxPayable.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("IncomeTaxPayable.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use IncomeTaxPayable.ThreeMonths (also available: SixMonths, TwelveMonths).");
