...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NonCurrentPensionAndOtherPostretirementBenefitPlansBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("NonCurrentPensionAndOtherPostretirementBenefitPlans.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use NonCurrentPensionAndOtherPostretirementBenefitPlans.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("NonCurrentPensionAndOtherPostretirementBenefitPlans.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use NonCurrentPensionAndOtherPostretirementBenefitPlans.ThreeMonths (also available: SixMonths, TwelveMonths).");
