...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NormalizedNetProfitMargin : MultiPeriodField
    {
        ...
        /// </summary>
        public override bool HasValue => FundamentalService.Get<double>(TimeProvider.GetUtcNow(), SecurityIdentifier, FundamentalProperty.OperationRatios_NormalizedNetProfitMargin_OneYear) != NoValue;
