    ...
    public class CashtoTotalAssets : MultiPeriodField
    {
        ...
        public double OneYear =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_CashtoTotalAssets_OneYear
            );
        ...
        public double ThreeMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_CashtoTotalAssets_ThreeMonths
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"OperationRatios_CashtoTotalAssets_{ConvertPeriod(period)}"
                )
            );
        ...
        /// </summary>
        public CashtoTotalAssets(ITimeProvider timeProvider, SecurityIdentifier securityIdentifier)
