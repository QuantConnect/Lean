...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class BuildingsAndImprovementsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("BuildingsAndImprovements.OneMonth was retired by Morningstar in 2026; use BuildingsAndImprovements.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("BuildingsAndImprovements.OneMonth was retired by Morningstar in 2026; use BuildingsAndImprovements.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("BuildingsAndImprovements.TwoMonths was retired by Morningstar in 2026; use BuildingsAndImprovements.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("BuildingsAndImprovements.TwoMonths was retired by Morningstar in 2026; use BuildingsAndImprovements.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("BuildingsAndImprovements.NineMonths was retired by Morningstar in 2026; use BuildingsAndImprovements.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("BuildingsAndImprovements.NineMonths was retired by Morningstar in 2026; use BuildingsAndImprovements.ThreeMonths (also available: SixMonths, TwelveMonths).");
