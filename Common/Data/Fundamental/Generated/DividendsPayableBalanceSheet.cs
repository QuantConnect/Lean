...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class DividendsPayableBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("DividendsPayable.OneMonth was retired by Morningstar in 2026; use DividendsPayable.ThreeMonths (also available: TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("DividendsPayable.OneMonth was retired by Morningstar in 2026; use DividendsPayable.ThreeMonths (also available: TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("DividendsPayable.TwoMonths was retired by Morningstar in 2026; use DividendsPayable.ThreeMonths (also available: TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("DividendsPayable.TwoMonths was retired by Morningstar in 2026; use DividendsPayable.ThreeMonths (also available: TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("DividendsPayable.NineMonths was retired by Morningstar in 2026; use DividendsPayable.ThreeMonths (also available: TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("DividendsPayable.NineMonths was retired by Morningstar in 2026; use DividendsPayable.ThreeMonths (also available: TwelveMonths).");
