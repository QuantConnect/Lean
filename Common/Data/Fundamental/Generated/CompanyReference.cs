    ...
    public class CompanyReference : FundamentalTimeDependentProperty
    {
        ...
        public string ShortName =>
            FundamentalService.Get<string>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_ShortName
            );
        ...
        public string StandardName =>
            FundamentalService.Get<string>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_StandardName
            );
        ...
        public string LegalName =>
            FundamentalService.Get<string>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_LegalName
            );
        ...
        public string CountryId =>
            FundamentalService.Get<string>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_CountryId
            );
        ...
        public string CIK =>
            FundamentalService.Get<string>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_CIK
            );
        ...
        public string CompanyStatus =>
            FundamentalService.Get<string>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_CompanyStatus
            );
        ...
        public int FiscalYearEnd =>
            FundamentalService.Get<int>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_FiscalYearEnd
            );
        ...
        /// </remarks>
        [JsonProperty("11")]
        public string IndustryTemplateCode =>
            FundamentalService.Get<string>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_IndustryTemplateCode
            );
        ...
        /// </remarks>
        [JsonProperty("12")]
        public string PrimaryShareClassID =>
            FundamentalService.Get<string>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_PrimaryShareClassID
            );
        ...
        public string PrimarySymbol =>
            FundamentalService.Get<string>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_PrimarySymbol
            );
        ...
        /// </remarks>
        [JsonProperty("14")]
        public string PrimaryExchangeID =>
            FundamentalService.Get<string>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_PrimaryExchangeID
            );
        ...
        public string BusinessCountryID =>
            FundamentalService.Get<string>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_BusinessCountryID
            );
        ...
        /// </remarks>
        [JsonProperty("16")]
        public string LegalNameLanguageCode =>
            FundamentalService.Get<string>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_LegalNameLanguageCode
            );
        ...
        public string Auditor =>
            FundamentalService.Get<string>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_Auditor
            );
        ...
        /// </remarks>
        [JsonProperty("18")]
        public string AuditorLanguageCode =>
            FundamentalService.Get<string>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_AuditorLanguageCode
            );
        ...
        public string Advisor =>
            FundamentalService.Get<string>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_Advisor
            );
        ...
        /// </remarks>
        [JsonProperty("20")]
        public string AdvisorLanguageCode =>
            FundamentalService.Get<string>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_AdvisorLanguageCode
            );
        ...
        /// </remarks>
        [JsonProperty("21")]
        public bool IsLimitedPartnership =>
            FundamentalService.Get<bool>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_IsLimitedPartnership
            );
        ...
        public bool IsREIT =>
            FundamentalService.Get<bool>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_IsREIT
            );
        ...
        /// </remarks>
        [JsonProperty("23")]
        public string PrimaryMIC =>
            FundamentalService.Get<string>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_PrimaryMIC
            );
        ...
        /// </remarks>
        [JsonProperty("24")]
        public int ReportStyle =>
            FundamentalService.Get<int>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_ReportStyle
            );
        ...
        public string YearofEstablishment =>
            FundamentalService.Get<string>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_YearofEstablishment
            );
        ...
        /// </remarks>
        [JsonProperty("26")]
        public bool IsLimitedLiabilityCompany =>
            FundamentalService.Get<bool>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_IsLimitedLiabilityCompany
            );
        ...
        /// </remarks>
        [JsonProperty("27")]
        public DateTime ExpectedFiscalYearEnd =>
            FundamentalService.Get<DateTime>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.CompanyReference_ExpectedFiscalYearEnd
            );
