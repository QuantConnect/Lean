...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class ForeignCurrencyTranslationAdjustmentsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("ForeignCurrencyTranslationAdjustments.TwoMonths was retired by Morningstar in 2026; use ForeignCurrencyTranslationAdjustments.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("ForeignCurrencyTranslationAdjustments.TwoMonths was retired by Morningstar in 2026; use ForeignCurrencyTranslationAdjustments.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("ForeignCurrencyTranslationAdjustments.NineMonths was retired by Morningstar in 2026; use ForeignCurrencyTranslationAdjustments.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("ForeignCurrencyTranslationAdjustments.NineMonths was retired by Morningstar in 2026; use ForeignCurrencyTranslationAdjustments.ThreeMonths (also available: SixMonths, TwelveMonths).");
