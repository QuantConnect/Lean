...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class ForeignCurrencyTranslationAdjustmentsBalanceSheet : MultiPeriodField
    {
        ...
        public double ThreeMonths => throw new NotSupportedException("ForeignCurrencyTranslationAdjustments is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("6M")]
        [Obsolete("ForeignCurrencyTranslationAdjustments is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double SixMonths => throw new NotSupportedException("ForeignCurrencyTranslationAdjustments is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("9M")]
        [Obsolete("ForeignCurrencyTranslationAdjustments is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double NineMonths => throw new NotSupportedException("ForeignCurrencyTranslationAdjustments is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("12M")]
        [Obsolete("ForeignCurrencyTranslationAdjustments is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double TwelveMonths => throw new NotSupportedException("ForeignCurrencyTranslationAdjustments is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("ForeignCurrencyTranslationAdjustments is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
