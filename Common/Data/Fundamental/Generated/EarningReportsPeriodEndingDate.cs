    ...
    public class EarningReportsPeriodEndingDate : MultiPeriodField<DateTime>
    {
        ...
        public DateTime OneMonth =>
            FundamentalService.Get<DateTime>(
                ...
                SecurityIdentifier,
                FundamentalProperty.EarningReports_PeriodEndingDate_OneMonth
            );
        ...
        public DateTime TwoMonths =>
            FundamentalService.Get<DateTime>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningReports_PeriodEndingDate_TwoMonths
            );
        ...
        public DateTime ThreeMonths =>
            FundamentalService.Get<DateTime>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningReports_PeriodEndingDate_ThreeMonths
            );
        ...
        public DateTime SixMonths =>
            FundamentalService.Get<DateTime>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningReports_PeriodEndingDate_SixMonths
            );
        ...
        public DateTime NineMonths =>
            FundamentalService.Get<DateTime>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningReports_PeriodEndingDate_NineMonths
            );
        ...
        public DateTime TwelveMonths =>
            FundamentalService.Get<DateTime>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningReports_PeriodEndingDate_TwelveMonths
            );
        ...
        public override DateTime GetPeriodValue(string period) =>
            FundamentalService.Get<DateTime>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"EarningReports_PeriodEndingDate_{ConvertPeriod(period)}"
                )
            );
