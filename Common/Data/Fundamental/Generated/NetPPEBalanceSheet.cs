...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NetPPEBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("NetPPE.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use NetPPE.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("NetPPE.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use NetPPE.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("NetPPE.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use NetPPE.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("NetPPE.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use NetPPE.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("NetPPE.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use NetPPE.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("NetPPE.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use NetPPE.ThreeMonths (also available: SixMonths, TwelveMonths).");
