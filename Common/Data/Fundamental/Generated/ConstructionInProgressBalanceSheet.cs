...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class ConstructionInProgressBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("ConstructionInProgress.OneMonth was retired by Morningstar in 2026; use ConstructionInProgress.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("ConstructionInProgress.OneMonth was retired by Morningstar in 2026; use ConstructionInProgress.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("ConstructionInProgress.TwoMonths was retired by Morningstar in 2026; use ConstructionInProgress.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("ConstructionInProgress.TwoMonths was retired by Morningstar in 2026; use ConstructionInProgress.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("ConstructionInProgress.NineMonths was retired by Morningstar in 2026; use ConstructionInProgress.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("ConstructionInProgress.NineMonths was retired by Morningstar in 2026; use ConstructionInProgress.ThreeMonths (also available: SixMonths, TwelveMonths).");
