...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class DepreciationAmortizationDepletionIncomeStatement : MultiPeriodField
    {
        ...
        /// </summary>
        public override bool HasValue => FundamentalService.Get<double>(TimeProvider.GetUtcNow(), SecurityIdentifier, FundamentalProperty.FinancialStatements_IncomeStatement_DepreciationAmortizationDepletion_TwelveMonths) != NoValue;
