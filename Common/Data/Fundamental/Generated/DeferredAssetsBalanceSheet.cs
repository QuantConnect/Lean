...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class DeferredAssetsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("DeferredAssets.NineMonths was retired by Morningstar in 2026; use DeferredAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("DeferredAssets.NineMonths was retired by Morningstar in 2026; use DeferredAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");
