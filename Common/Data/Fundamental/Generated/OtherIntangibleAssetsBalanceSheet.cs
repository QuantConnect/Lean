...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class OtherIntangibleAssetsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("OtherIntangibleAssets.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use OtherIntangibleAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("OtherIntangibleAssets.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use OtherIntangibleAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("OtherIntangibleAssets.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherIntangibleAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("OtherIntangibleAssets.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherIntangibleAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("OtherIntangibleAssets.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherIntangibleAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("OtherIntangibleAssets.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherIntangibleAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");
