...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NetIncomeDiscontinuousOperationsIncomeStatement : MultiPeriodField
    {
        ...
        /// </summary>
        public override bool HasValue => FundamentalService.Get<double>(TimeProvider.GetUtcNow(), SecurityIdentifier, FundamentalProperty.FinancialStatements_IncomeStatement_NetIncomeDiscontinuousOperations_TwelveMonths) != NoValue;
