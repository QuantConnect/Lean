...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class ProfitonDisposalsCashFlowStatement : MultiPeriodField
    {
        ...
        /// </summary>
        public override bool HasValue => FundamentalService.Get<double>(TimeProvider.GetUtcNow(), SecurityIdentifier, FundamentalProperty.FinancialStatements_CashFlowStatement_ProfitonDisposals_TwelveMonths) != NoValue;
