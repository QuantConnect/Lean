...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CommonStockEquityBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("CommonStockEquity.OneMonth was retired by Morningstar in 2026; use CommonStockEquity.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("CommonStockEquity.OneMonth was retired by Morningstar in 2026; use CommonStockEquity.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("CommonStockEquity.TwoMonths was retired by Morningstar in 2026; use CommonStockEquity.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("CommonStockEquity.TwoMonths was retired by Morningstar in 2026; use CommonStockEquity.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("CommonStockEquity.NineMonths was retired by Morningstar in 2026; use CommonStockEquity.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("CommonStockEquity.NineMonths was retired by Morningstar in 2026; use CommonStockEquity.ThreeMonths (also available: SixMonths, TwelveMonths).");
