...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class OtherAssetsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("OtherAssets.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("OtherAssets.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");
