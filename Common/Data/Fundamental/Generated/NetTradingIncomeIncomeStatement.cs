...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NetTradingIncomeIncomeStatement : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("12M")]
        [Obsolete("NetTradingIncome is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double TwelveMonths => throw new NotSupportedException("NetTradingIncome is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("NetTradingIncome is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
