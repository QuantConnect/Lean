...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class TotalDebtEquityRatioGrowth : MultiPeriodField
    {
        ...
        /// </summary>
        public override bool HasValue => FundamentalService.Get<double>(TimeProvider.GetUtcNow(), SecurityIdentifier, FundamentalProperty.OperationRatios_TotalDebtEquityRatioGrowth_OneYear) != NoValue;
