...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class TreasuryStockBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("TreasuryStock.OneMonth was retired by Morningstar in 2026; use TreasuryStock.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("TreasuryStock.OneMonth was retired by Morningstar in 2026; use TreasuryStock.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("TreasuryStock.TwoMonths was retired by Morningstar in 2026; use TreasuryStock.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("TreasuryStock.TwoMonths was retired by Morningstar in 2026; use TreasuryStock.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("TreasuryStock.NineMonths was retired by Morningstar in 2026; use TreasuryStock.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("TreasuryStock.NineMonths was retired by Morningstar in 2026; use TreasuryStock.ThreeMonths (also available: SixMonths, TwelveMonths).");
