...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class ChangeInReinsuranceRecoverableOnPaidAndUnpaidLossesCashFlowStatement : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("3M")]
        [Obsolete("ChangeInReinsuranceRecoverableOnPaidAndUnpaidLosses was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("ChangeInReinsuranceRecoverableOnPaidAndUnpaidLosses was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("ChangeInReinsuranceRecoverableOnPaidAndUnpaidLosses was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double SixMonths => throw new NotSupportedException("ChangeInReinsuranceRecoverableOnPaidAndUnpaidLosses was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("ChangeInReinsuranceRecoverableOnPaidAndUnpaidLosses was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("ChangeInReinsuranceRecoverableOnPaidAndUnpaidLosses was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("ChangeInReinsuranceRecoverableOnPaidAndUnpaidLosses was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("ChangeInReinsuranceRecoverableOnPaidAndUnpaidLosses was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("ChangeInReinsuranceRecoverableOnPaidAndUnpaidLosses was retired by Morningstar in 2026 for all periods; no replacement is available.");
