...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class OtherCashPaymentsfromOperatingActivitiesCashFlowStatement : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("OtherCashPaymentsfromOperatingActivities.OneMonth was retired by Morningstar in 2026; use OtherCashPaymentsfromOperatingActivities.ThreeMonths (also available: SixMonths, NineMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("OtherCashPaymentsfromOperatingActivities.OneMonth was retired by Morningstar in 2026; use OtherCashPaymentsfromOperatingActivities.ThreeMonths (also available: SixMonths, NineMonths, TwelveMonths).");
