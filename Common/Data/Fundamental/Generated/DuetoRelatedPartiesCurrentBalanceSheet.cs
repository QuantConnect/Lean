...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class DuetoRelatedPartiesCurrentBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("3M")]
        [Obsolete("DuetoRelatedPartiesCurrent was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double ThreeMonths => throw new NotSupportedException("DuetoRelatedPartiesCurrent was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("12M")]
        [Obsolete("DuetoRelatedPartiesCurrent was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double TwelveMonths => throw new NotSupportedException("DuetoRelatedPartiesCurrent was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("DuetoRelatedPartiesCurrent was retired by Morningstar in 2026 for all periods; no replacement is available.");
