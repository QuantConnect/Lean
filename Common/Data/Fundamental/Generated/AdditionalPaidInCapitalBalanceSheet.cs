...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class AdditionalPaidInCapitalBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("AdditionalPaidInCapital.OneMonth was retired by Morningstar in 2026; use AdditionalPaidInCapital.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("AdditionalPaidInCapital.OneMonth was retired by Morningstar in 2026; use AdditionalPaidInCapital.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("AdditionalPaidInCapital.TwoMonths was retired by Morningstar in 2026; use AdditionalPaidInCapital.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("AdditionalPaidInCapital.TwoMonths was retired by Morningstar in 2026; use AdditionalPaidInCapital.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("AdditionalPaidInCapital.NineMonths was retired by Morningstar in 2026; use AdditionalPaidInCapital.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("AdditionalPaidInCapital.NineMonths was retired by Morningstar in 2026; use AdditionalPaidInCapital.ThreeMonths (also available: SixMonths, TwelveMonths).");
