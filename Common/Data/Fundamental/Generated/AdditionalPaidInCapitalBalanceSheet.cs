...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class AdditionalPaidInCapitalBalanceSheet : MultiPeriodField
    {
        ...
        public double OneMonth => throw new NotSupportedException("AdditionalPaidInCapital was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("2M")]
        [Obsolete("AdditionalPaidInCapital was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double TwoMonths => throw new NotSupportedException("AdditionalPaidInCapital was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("3M")]
        [Obsolete("AdditionalPaidInCapital was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double ThreeMonths => throw new NotSupportedException("AdditionalPaidInCapital was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("6M")]
        [Obsolete("AdditionalPaidInCapital was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double SixMonths => throw new NotSupportedException("AdditionalPaidInCapital was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("9M")]
        [Obsolete("AdditionalPaidInCapital was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double NineMonths => throw new NotSupportedException("AdditionalPaidInCapital was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("12M")]
        [Obsolete("AdditionalPaidInCapital was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double TwelveMonths => throw new NotSupportedException("AdditionalPaidInCapital was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("AdditionalPaidInCapital was retired by Morningstar in 2026 for all periods; no replacement is available.");
