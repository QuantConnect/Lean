...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NetDebtBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("NetDebt.OneMonth was retired by Morningstar in 2026; use NetDebt.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("NetDebt.OneMonth was retired by Morningstar in 2026; use NetDebt.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("NetDebt.TwoMonths was retired by Morningstar in 2026; use NetDebt.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("NetDebt.TwoMonths was retired by Morningstar in 2026; use NetDebt.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("NetDebt.NineMonths was retired by Morningstar in 2026; use NetDebt.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("NetDebt.NineMonths was retired by Morningstar in 2026; use NetDebt.ThreeMonths (also available: SixMonths, TwelveMonths).");
