...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NetDebtBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("NetDebt.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use NetDebt.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("NetDebt.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use NetDebt.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("NetDebt.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use NetDebt.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("NetDebt.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use NetDebt.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("NetDebt.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use NetDebt.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("NetDebt.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use NetDebt.ThreeMonths (also available: SixMonths, TwelveMonths).");
