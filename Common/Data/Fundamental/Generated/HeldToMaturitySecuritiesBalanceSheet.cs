...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class HeldToMaturitySecuritiesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("HeldToMaturitySecurities.NineMonths was retired by Morningstar in 2026; use HeldToMaturitySecurities.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("HeldToMaturitySecurities.NineMonths was retired by Morningstar in 2026; use HeldToMaturitySecurities.ThreeMonths (also available: SixMonths, TwelveMonths).");
