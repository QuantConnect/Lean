...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class ROE5YrAvg : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("5Y")]
        public double FiveYears => FundamentalService.Get<double>(Time, SecurityIdentifier, "OperationRatios.ROE5YrAvg.FiveYears");

        /// <summary>
        /// Returns true if the field contains a value for the default period
        /// </summary>
        public override bool HasValue => FundamentalService.Get<double>(Time, SecurityIdentifier, "OperationRatios.ROE5YrAvg.FiveYears") != NoValue;
        ...
        public override double Value
        {
            get
            {
                var defaultValue = FundamentalService.Get<double>(Time, SecurityIdentifier, "OperationRatios.ROE5YrAvg.FiveYears");
        ...
        public override double GetPeriodValue(string period) => FundamentalService.Get<double>(Time, SecurityIdentifier, $"OperationRatios.ROE5YrAvg.{ConvertPeriod(period)}");
        ...
        /// </summary>
        public ROE5YrAvg(DateTime time, SecurityIdentifier securityIdentifier) : base(time, securityIdentifier)
        {
        }
    }
}
