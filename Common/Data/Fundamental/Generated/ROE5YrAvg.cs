    ...
    public class ROE5YrAvg : MultiPeriodField
    {
        ...
        public double FiveYears =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_ROE5YrAvg_FiveYears
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"OperationRatios_ROE5YrAvg_{ConvertPeriod(period)}"
                )
            );
        ...
        /// </summary>
        public ROE5YrAvg(ITimeProvider timeProvider, SecurityIdentifier securityIdentifier)
