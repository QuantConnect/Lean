...
namespace QuantConnect.Data.Fundamental
{
	...
	public class BalanceSheet
	{
		...
		{
			AccountsPayable.UpdateValues(previous.AccountsPayable);
			AccountsReceivable.UpdateValues(previous.AccountsReceivable);
			CurrentAccruedExpenses.UpdateValues(previous.CurrentAccruedExpenses);
			NonCurrentAccruedExpenses.UpdateValues(previous.NonCurrentAccruedExpenses);
			AccruedInvestmentIncome.UpdateValues(previous.AccruedInvestmentIncome);
			AccumulatedDepreciation.UpdateValues(previous.AccumulatedDepreciation);
			GainsLossesNotAffectingRetainedEarnings.UpdateValues(previous.GainsLossesNotAffectingRetainedEarnings);
			AdditionalPaidInCapital.UpdateValues(previous.AdditionalPaidInCapital);
			AllowanceForLoansAndLeaseLosses.UpdateValues(previous.AllowanceForLoansAndLeaseLosses);
			AvailableForSaleSecurities.UpdateValues(previous.AvailableForSaleSecurities);
			CapitalStock.UpdateValues(previous.CapitalStock);
			Cash.UpdateValues(previous.Cash);
			CashEquivalents.UpdateValues(previous.CashEquivalents);
			CashAndCashEquivalents.UpdateValues(previous.CashAndCashEquivalents);
			CashAndDueFromBanks.UpdateValues(previous.CashAndDueFromBanks);
			CashCashEquivalentsAndFederalFundsSold.UpdateValues(previous.CashCashEquivalentsAndFederalFundsSold);
			CashCashEquivalentsAndMarketableSecurities.UpdateValues(previous.CashCashEquivalentsAndMarketableSecurities);
			CommonStock.UpdateValues(previous.CommonStock);
			CurrentAssets.UpdateValues(previous.CurrentAssets);
			CurrentDebt.UpdateValues(previous.CurrentDebt);
			CurrentDebtAndCapitalLeaseObligation.UpdateValues(previous.CurrentDebtAndCapitalLeaseObligation);
			CurrentLiabilities.UpdateValues(previous.CurrentLiabilities);
			CurrentCapitalLeaseObligation.UpdateValues(previous.CurrentCapitalLeaseObligation);
			DeferredAssets.UpdateValues(previous.DeferredAssets);
			DeferredCosts.UpdateValues(previous.DeferredCosts);
			NonCurrentDeferredLiabilities.UpdateValues(previous.NonCurrentDeferredLiabilities);
			CurrentDeferredLiabilities.UpdateValues(previous.CurrentDeferredLiabilities);
			DeferredPolicyAcquisitionCosts.UpdateValues(previous.DeferredPolicyAcquisitionCosts);
			CurrentDeferredRevenue.UpdateValues(previous.CurrentDeferredRevenue);
			NonCurrentDeferredRevenue.UpdateValues(previous.NonCurrentDeferredRevenue);
			DeferredTaxAssets.UpdateValues(previous.DeferredTaxAssets);
			CurrentDeferredTaxesAssets.UpdateValues(previous.CurrentDeferredTaxesAssets);
			CurrentDeferredTaxesLiabilities.UpdateValues(previous.CurrentDeferredTaxesLiabilities);
			NonCurrentDeferredTaxesAssets.UpdateValues(previous.NonCurrentDeferredTaxesAssets);
			NonCurrentDeferredTaxesLiabilities.UpdateValues(previous.NonCurrentDeferredTaxesLiabilities);
			EquityInvestments.UpdateValues(previous.EquityInvestments);
			FederalFundsPurchasedAndSecuritiesSoldUnderAgreementToRepurchase.UpdateValues(previous.FederalFundsPurchasedAndSecuritiesSoldUnderAgreementToRepurchase);
			FederalFundsSoldAndSecuritiesPurchaseUnderAgreementsToResell.UpdateValues(previous.FederalFundsSoldAndSecuritiesPurchaseUnderAgreementsToResell);
			FixedMaturitiesAvailableForSale.UpdateValues(previous.FixedMaturitiesAvailableForSale);
			FixedMaturitiesHeldToMaturity.UpdateValues(previous.FixedMaturitiesHeldToMaturity);
			FixedMaturitiesTrading.UpdateValues(previous.FixedMaturitiesTrading);
			FixedMaturityInvestments.UpdateValues(previous.FixedMaturityInvestments);
			FuturePolicyBenefits.UpdateValues(previous.FuturePolicyBenefits);
			GeneralPartnershipCapital.UpdateValues(previous.GeneralPartnershipCapital);
			Goodwill.UpdateValues(previous.Goodwill);
			GoodwillAndOtherIntangibleAssets.UpdateValues(previous.GoodwillAndOtherIntangibleAssets);
			GrossLoan.UpdateValues(previous.GrossLoan);
			GrossPPE.UpdateValues(previous.GrossPPE);
			HeldToMaturitySecurities.UpdateValues(previous.HeldToMaturitySecurities);
			IncomeTaxPayable.UpdateValues(previous.IncomeTaxPayable);
			InterestBearingDepositsLiabilities.UpdateValues(previous.InterestBearingDepositsLiabilities);
			InterestPayable.UpdateValues(previous.InterestPayable);
			InterestBearingDepositsAssets.UpdateValues(previous.InterestBearingDepositsAssets);
			Inventory.UpdateValues(previous.Inventory);
			InvestmentsAndAdvances.UpdateValues(previous.InvestmentsAndAdvances);
			LimitedPartnershipCapital.UpdateValues(previous.LimitedPartnershipCapital);
			LongTermDebt.UpdateValues(previous.LongTermDebt);
			LongTermDebtAndCapitalLeaseObligation.UpdateValues(previous.LongTermDebtAndCapitalLeaseObligation);
			LongTermInvestments.UpdateValues(previous.LongTermInvestments);
			LongTermCapitalLeaseObligation.UpdateValues(previous.LongTermCapitalLeaseObligation);
			MinorityInterest.UpdateValues(previous.MinorityInterest);
			MoneyMarketInvestments.UpdateValues(previous.MoneyMarketInvestments);
			NetLoan.UpdateValues(previous.NetLoan);
			NetPPE.UpdateValues(previous.NetPPE);
			NonInterestBearingDeposits.UpdateValues(previous.NonInterestBearingDeposits);
			CurrentNotesPayable.UpdateValues(previous.CurrentNotesPayable);
			NotesReceivable.UpdateValues(previous.NotesReceivable);
			NonCurrentNoteReceivables.UpdateValues(previous.NonCurrentNoteReceivables);
			OtherCurrentLiabilities.UpdateValues(previous.OtherCurrentLiabilities);
			OtherIntangibleAssets.UpdateValues(previous.OtherIntangibleAssets);
			OtherShortTermInvestments.UpdateValues(previous.OtherShortTermInvestments);
			Payables.UpdateValues(previous.Payables);
			PayablesAndAccruedExpenses.UpdateValues(previous.PayablesAndAccruedExpenses);
			PolicyReservesBenefits.UpdateValues(previous.PolicyReservesBenefits);
			PolicyholderFunds.UpdateValues(previous.PolicyholderFunds);
			PreferredSecuritiesOutsideStockEquity.UpdateValues(previous.PreferredSecuritiesOutsideStockEquity);
			PreferredStock.UpdateValues(previous.PreferredStock);
			PremiumsReceivable.UpdateValues(previous.PremiumsReceivable);
			PrepaidAssets.UpdateValues(previous.PrepaidAssets);
			NonCurrentPrepaidAssets.UpdateValues(previous.NonCurrentPrepaidAssets);
			Receivables.UpdateValues(previous.Receivables);
			RedeemablePreferredStock.UpdateValues(previous.RedeemablePreferredStock);
			ReinsuranceRecoverable.UpdateValues(previous.ReinsuranceRecoverable);
			RetainedEarnings.UpdateValues(previous.RetainedEarnings);
			SecuritiesLendingCollateral.UpdateValues(previous.SecuritiesLendingCollateral);
			SecurityAgreeToBeResell.UpdateValues(previous.SecurityAgreeToBeResell);
			SecuritySoldNotYetRepurchased.UpdateValues(previous.SecuritySoldNotYetRepurchased);
			SeparateAccountAssets.UpdateValues(previous.SeparateAccountAssets);
			SeparateAccountBusiness.UpdateValues(previous.SeparateAccountBusiness);
			ShortTermInvestmentsAvailableForSale.UpdateValues(previous.ShortTermInvestmentsAvailableForSale);
			ShortTermInvestmentsHeldToMaturity.UpdateValues(previous.ShortTermInvestmentsHeldToMaturity);
			ShortTermInvestmentsTrading.UpdateValues(previous.ShortTermInvestmentsTrading);
			StockholdersEquity.UpdateValues(previous.StockholdersEquity);
			TotalTaxPayable.UpdateValues(previous.TotalTaxPayable);
			TotalAssets.UpdateValues(previous.TotalAssets);
			TotalDeposits.UpdateValues(previous.TotalDeposits);
			TotalInvestments.UpdateValues(previous.TotalInvestments);
			TotalLiabilities.UpdateValues(previous.TotalLiabilities);
			TotalNonCurrentAssets.UpdateValues(previous.TotalNonCurrentAssets);
			TotalNonCurrentLiabilities.UpdateValues(previous.TotalNonCurrentLiabilities);
			TotalPartnershipCapital.UpdateValues(previous.TotalPartnershipCapital);
			TradingAssets.UpdateValues(previous.TradingAssets);
			TradingLiabilities.UpdateValues(previous.TradingLiabilities);
			TradingSecurities.UpdateValues(previous.TradingSecurities);
			TreasuryStock.UpdateValues(previous.TreasuryStock);
			UnearnedIncome.UpdateValues(previous.UnearnedIncome);
			UnearnedPremiums.UpdateValues(previous.UnearnedPremiums);
			UnpaidLossAndLossReserve.UpdateValues(previous.UnpaidLossAndLossReserve);
			InvestedCapital.UpdateValues(previous.InvestedCapital);
			CurrentDeferredAssets.UpdateValues(previous.CurrentDeferredAssets);
			NonCurrentDeferredAssets.UpdateValues(previous.NonCurrentDeferredAssets);
			SecuritiesAndInvestments.UpdateValues(previous.SecuritiesAndInvestments);
			TotalLiabilitiesNetMinorityInterest.UpdateValues(previous.TotalLiabilitiesNetMinorityInterest);
			TotalNonCurrentLiabilitiesNetMinorityInterest.UpdateValues(previous.TotalNonCurrentLiabilitiesNetMinorityInterest);
			TotalEquityGrossMinorityInterest.UpdateValues(previous.TotalEquityGrossMinorityInterest);
			GrossAccountsReceivable.UpdateValues(previous.GrossAccountsReceivable);
			NonCurrentAccountsReceivable.UpdateValues(previous.NonCurrentAccountsReceivable);
			AccruedInterestReceivable.UpdateValues(previous.AccruedInterestReceivable);
			AdvanceFromFederalHomeLoanBanks.UpdateValues(previous.AdvanceFromFederalHomeLoanBanks);
			AllowanceForDoubtfulAccountsReceivable.UpdateValues(previous.AllowanceForDoubtfulAccountsReceivable);
			AllowanceForNotesReceivable.UpdateValues(previous.AllowanceForNotesReceivable);
			AssetsHeldForSale.UpdateValues(previous.AssetsHeldForSale);
			AssetsOfDiscontinuedOperations.UpdateValues(previous.AssetsOfDiscontinuedOperations);
			BankAcceptanceExecutedAndOutstanding.UpdateValues(previous.BankAcceptanceExecutedAndOutstanding);
			BankIndebtedness.UpdateValues(previous.BankIndebtedness);
			BankLoan.UpdateValues(previous.BankLoan);
			BankOwnedLifeInsurance.UpdateValues(previous.BankOwnedLifeInsurance);
			SecurityBorrowed.UpdateValues(previous.SecurityBorrowed);
			BuildingsAndImprovements.UpdateValues(previous.BuildingsAndImprovements);
			CasualtyClaims.UpdateValues(previous.CasualtyClaims);
			CededUnearnedPremiums.UpdateValues(previous.CededUnearnedPremiums);
			CommercialLoan.UpdateValues(previous.CommercialLoan);
			CommercialPaper.UpdateValues(previous.CommercialPaper);
			CommonStockEquity.UpdateValues(previous.CommonStockEquity);
			CommonStocksAvailableForSale.UpdateValues(previous.CommonStocksAvailableForSale);
			ConstructionInProgress.UpdateValues(previous.ConstructionInProgress);
			ConsumerLoan.UpdateValues(previous.ConsumerLoan);
			MinimumPensionLiabilities.UpdateValues(previous.MinimumPensionLiabilities);
			CustomerAcceptances.UpdateValues(previous.CustomerAcceptances);
			DeferredAcquisitionCosts.UpdateValues(previous.DeferredAcquisitionCosts);
			DeferredFinancingCosts.UpdateValues(previous.DeferredFinancingCosts);
			DefinedPensionBenefit.UpdateValues(previous.DefinedPensionBenefit);
			DerivativeProductLiabilities.UpdateValues(previous.DerivativeProductLiabilities);
			DerivativeAssets.UpdateValues(previous.DerivativeAssets);
			DividendsPayable.UpdateValues(previous.DividendsPayable);
			ESOPDebtGuarantee.UpdateValues(previous.ESOPDebtGuarantee);
			EmployeeBenefits.UpdateValues(previous.EmployeeBenefits);
			FacilitiesAndOther.UpdateValues(previous.FacilitiesAndOther);
			FederalFundsPurchased.UpdateValues(previous.FederalFundsPurchased);
			FederalFundsSold.UpdateValues(previous.FederalFundsSold);
			FederalHomeLoanBankStock.UpdateValues(previous.FederalHomeLoanBankStock);
			FinancialAssets.UpdateValues(previous.FinancialAssets);
			FinancialInstrumentsSoldUnderAgreementsToRepurchase.UpdateValues(previous.FinancialInstrumentsSoldUnderAgreementsToRepurchase);
			FinishedGoods.UpdateValues(previous.FinishedGoods);
			FlightFleetVehicleAndRelatedEquipments.UpdateValues(previous.FlightFleetVehicleAndRelatedEquipments);
			ForeclosedAssets.UpdateValues(previous.ForeclosedAssets);
			ForeignComponent.UpdateValues(previous.ForeignComponent);
			ForeignCurrencyTranslationAdjustments.UpdateValues(previous.ForeignCurrencyTranslationAdjustments);
			FuelAndNaturalGas.UpdateValues(previous.FuelAndNaturalGas);
			GuaranteedInvestmentContract.UpdateValues(previous.GuaranteedInvestmentContract);
			InventoriesAdjustmentsAllowances.UpdateValues(previous.InventoriesAdjustmentsAllowances);
			InvestmentTaxCredits.UpdateValues(previous.InvestmentTaxCredits);
			InvestmentsInAffiliatesSubsidiariesAssociatesAndJointVentures.UpdateValues(previous.InvestmentsInAffiliatesSubsidiariesAssociatesAndJointVentures);
			InvestmentsInOtherVenturesUnderEquityMethod.UpdateValues(previous.InvestmentsInOtherVenturesUnderEquityMethod);
			InvestmentsInVariableInterestEntity.UpdateValues(previous.InvestmentsInVariableInterestEntity);
			LandAndImprovements.UpdateValues(previous.LandAndImprovements);
			Leases.UpdateValues(previous.Leases);
			LiabilitiesOfDiscontinuedOperations.UpdateValues(previous.LiabilitiesOfDiscontinuedOperations);
			LimitedPartnership.UpdateValues(previous.LimitedPartnership);
			LineOfCredit.UpdateValues(previous.LineOfCredit);
			LoansHeldForSale.UpdateValues(previous.LoansHeldForSale);
			LoansReceivable.UpdateValues(previous.LoansReceivable);
			MachineryFurnitureEquipment.UpdateValues(previous.MachineryFurnitureEquipment);
			MaterialsAndSupplies.UpdateValues(previous.MaterialsAndSupplies);
			MineralProperties.UpdateValues(previous.MineralProperties);
			MortgageLoan.UpdateValues(previous.MortgageLoan);
			MortgageAndConsumerloans.UpdateValues(previous.MortgageAndConsumerloans);
			NaturalResourceAssets.UpdateValues(previous.NaturalResourceAssets);
			NetOtherUnrealizedGainLoss.UpdateValues(previous.NetOtherUnrealizedGainLoss);
			NetUnrealizedGainLossForeignCurrency.UpdateValues(previous.NetUnrealizedGainLossForeignCurrency);
			NetUnrealizedGainLossInvestments.UpdateValues(previous.NetUnrealizedGainLossInvestments);
			GrossNotesReceivable.UpdateValues(previous.GrossNotesReceivable);
			OtherAssets.UpdateValues(previous.OtherAssets);
			OtherCapitalStock.UpdateValues(previous.OtherCapitalStock);
			OtherCurrentAssets.UpdateValues(previous.OtherCurrentAssets);
			OtherCurrentBorrowings.UpdateValues(previous.OtherCurrentBorrowings);
			OtherDeferredCosts.UpdateValues(previous.OtherDeferredCosts);
			OtherDeposits.UpdateValues(previous.OtherDeposits);
			OtherEquityAdjustments.UpdateValues(previous.OtherEquityAdjustments);
			OtherInterestEarningAssets.UpdateValues(previous.OtherInterestEarningAssets);
			OtherInventories.UpdateValues(previous.OtherInventories);
			OtherInvestedAssets.UpdateValues(previous.OtherInvestedAssets);
			OtherNonCurrentAssets.UpdateValues(previous.OtherNonCurrentAssets);
			OtherProperties.UpdateValues(previous.OtherProperties);
			OtherRealEstateOwned.UpdateValues(previous.OtherRealEstateOwned);
			OtherReceivables.UpdateValues(previous.OtherReceivables);
			Patents.UpdateValues(previous.Patents);
			NonCurrentPensionAndOtherPostretirementBenefitPlans.UpdateValues(previous.NonCurrentPensionAndOtherPostretirementBenefitPlans);
			PolicyLoans.UpdateValues(previous.PolicyLoans);
			PreferredStockEquity.UpdateValues(previous.PreferredStockEquity);
			PreferredStockOfSubsidiary.UpdateValues(previous.PreferredStockOfSubsidiary);
			PreferredStocksAvailableForSale.UpdateValues(previous.PreferredStocksAvailableForSale);
			PrepaidReinsurancePremiums.UpdateValues(previous.PrepaidReinsurancePremiums);
			Properties.UpdateValues(previous.Properties);
			CurrentProvisions.UpdateValues(previous.CurrentProvisions);
			LongTermProvisions.UpdateValues(previous.LongTermProvisions);
			PurchasedComponents.UpdateValues(previous.PurchasedComponents);
			RawMaterials.UpdateValues(previous.RawMaterials);
			RealEstateHeldForSale.UpdateValues(previous.RealEstateHeldForSale);
			RealEstateAndRealEstateJointVenturesHeldForInvestment.UpdateValues(previous.RealEstateAndRealEstateJointVenturesHeldForInvestment);
			ReceivablesAdjustmentsAllowances.UpdateValues(previous.ReceivablesAdjustmentsAllowances);
			RegulatoryAssets.UpdateValues(previous.RegulatoryAssets);
			RegulatoryLiabilities.UpdateValues(previous.RegulatoryLiabilities);
			ReinsuranceBalancesPayable.UpdateValues(previous.ReinsuranceBalancesPayable);
			ReinsuranceReceivables.UpdateValues(previous.ReinsuranceReceivables);
			ReinsuranceRecoverableForPaidLosses.UpdateValues(previous.ReinsuranceRecoverableForPaidLosses);
			ReinsuranceRecoverableForUnpaidLosses.UpdateValues(previous.ReinsuranceRecoverableForUnpaidLosses);
			RestrictedCash.UpdateValues(previous.RestrictedCash);
			RestrictedCashAndCashEquivalents.UpdateValues(previous.RestrictedCashAndCashEquivalents);
			RestrictedCashAndInvestments.UpdateValues(previous.RestrictedCashAndInvestments);
			RestrictedCommonStock.UpdateValues(previous.RestrictedCommonStock);
			RestrictedInvestments.UpdateValues(previous.RestrictedInvestments);
			SecuritiesLendingPayable.UpdateValues(previous.SecuritiesLendingPayable);
			StudentLoan.UpdateValues(previous.StudentLoan);
			TaxesReceivable.UpdateValues(previous.TaxesReceivable);
			TimeDepositsPlaced.UpdateValues(previous.TimeDepositsPlaced);
			TotalCapitalization.UpdateValues(previous.TotalCapitalization);
			TotalDeferredCreditsAndOtherNonCurrentLiabilities.UpdateValues(previous.TotalDeferredCreditsAndOtherNonCurrentLiabilities);
			UnbilledReceivables.UpdateValues(previous.UnbilledReceivables);
			UnrealizedGainLoss.UpdateValues(previous.UnrealizedGainLoss);
			WorkInProcess.UpdateValues(previous.WorkInProcess);
			OtherNonCurrentLiabilities.UpdateValues(previous.OtherNonCurrentLiabilities);
			CapitalLeaseObligations.UpdateValues(previous.CapitalLeaseObligations);
			OtherLiabilities.UpdateValues(previous.OtherLiabilities);
			OtherPayable.UpdateValues(previous.OtherPayable);
			TangibleBookValue.UpdateValues(previous.TangibleBookValue);
			TotalEquity.UpdateValues(previous.TotalEquity);
			WorkingCapital.UpdateValues(previous.WorkingCapital);
			TotalDebt.UpdateValues(previous.TotalDebt);
			CashValueOfLifeInsurance.UpdateValues(previous.CashValueOfLifeInsurance);
			CommonUtilityPlant.UpdateValues(previous.CommonUtilityPlant);
			ElectricUtilityPlant.UpdateValues(previous.ElectricUtilityPlant);
			NaturalGasFuelAndOther.UpdateValues(previous.NaturalGasFuelAndOther);
			NetUtilityPlant.UpdateValues(previous.NetUtilityPlant);
			WaterProduction.UpdateValues(previous.WaterProduction);
			OrdinarySharesNumber.UpdateValues(previous.OrdinarySharesNumber);
			PreferredSharesNumber.UpdateValues(previous.PreferredSharesNumber);
			TreasurySharesNumber.UpdateValues(previous.TreasurySharesNumber);
			TradingAndOtherReceivable.UpdateValues(previous.TradingAndOtherReceivable);
			EquityAttributableToOwnersOfParent.UpdateValues(previous.EquityAttributableToOwnersOfParent);
			SecuritiesLoaned.UpdateValues(previous.SecuritiesLoaned);
			ParticipatingPolicyholderEquity.UpdateValues(previous.ParticipatingPolicyholderEquity);
			NetTangibleAssets.UpdateValues(previous.NetTangibleAssets);
			DuefromRelatedPartiesCurrent.UpdateValues(previous.DuefromRelatedPartiesCurrent);
			DuefromRelatedPartiesNonCurrent.UpdateValues(previous.DuefromRelatedPartiesNonCurrent);
			DuetoRelatedParties.UpdateValues(previous.DuetoRelatedParties);
			DuetoRelatedPartiesCurrent.UpdateValues(previous.DuetoRelatedPartiesCurrent);
			DuetoRelatedPartiesNonCurrent.UpdateValues(previous.DuetoRelatedPartiesNonCurrent);
			NetAssets.UpdateValues(previous.NetAssets);
			InvestmentProperties.UpdateValues(previous.InvestmentProperties);
			InvestmentsinSubsidiariesatCost.UpdateValues(previous.InvestmentsinSubsidiariesatCost);
			InvestmentsinAssociatesatCost.UpdateValues(previous.InvestmentsinAssociatesatCost);
			InvestmentsinJointVenturesatCost.UpdateValues(previous.InvestmentsinJointVenturesatCost);
			InvestmentinFinancialAssets.UpdateValues(previous.InvestmentinFinancialAssets);
			FinanceLeaseReceivables.UpdateValues(previous.FinanceLeaseReceivables);
			ConvertibleLoansCurrent.UpdateValues(previous.ConvertibleLoansCurrent);
			BankLoansCurrent.UpdateValues(previous.BankLoansCurrent);
			OtherLoansCurrent.UpdateValues(previous.OtherLoansCurrent);
			AccruedandDeferredIncome.UpdateValues(previous.AccruedandDeferredIncome);
			BankLoansNonCurrent.UpdateValues(previous.BankLoansNonCurrent);
			OtherLoansNonCurrent.UpdateValues(previous.OtherLoansNonCurrent);
			OtherReserves.UpdateValues(previous.OtherReserves);
			LoansandAdvancestoBank.UpdateValues(previous.LoansandAdvancestoBank);
			LoansandAdvancestoCustomer.UpdateValues(previous.LoansandAdvancestoCustomer);
			TreasuryBillsandOtherEligibleBills.UpdateValues(previous.TreasuryBillsandOtherEligibleBills);
			EquitySharesInvestments.UpdateValues(previous.EquitySharesInvestments);
			DepositsbyBank.UpdateValues(previous.DepositsbyBank);
			CustomerAccounts.UpdateValues(previous.CustomerAccounts);
			ItemsinTheCourseofTransmissiontoOtherBanks.UpdateValues(previous.ItemsinTheCourseofTransmissiontoOtherBanks);
			TradingandFinancialLiabilities.UpdateValues(previous.TradingandFinancialLiabilities);
			DebtSecuritiesinIssue.UpdateValues(previous.DebtSecuritiesinIssue);
			SubordinatedLiabilities.UpdateValues(previous.SubordinatedLiabilities);
			ProvisionsTotal.UpdateValues(previous.ProvisionsTotal);
			OperatingLeaseAssets.UpdateValues(previous.OperatingLeaseAssets);
			ClaimsOutstanding.UpdateValues(previous.ClaimsOutstanding);
			LongTermContracts.UpdateValues(previous.LongTermContracts);
			RealEstate.UpdateValues(previous.RealEstate);
			PaymentofBills.UpdateValues(previous.PaymentofBills);
			LiabilitiesHeldforSaleCurrent.UpdateValues(previous.LiabilitiesHeldforSaleCurrent);
			LiabilitiesHeldforSaleNonCurrent.UpdateValues(previous.LiabilitiesHeldforSaleNonCurrent);
			UnclassifiedCurrentAssets.UpdateValues(previous.UnclassifiedCurrentAssets);
			DebtSecurities.UpdateValues(previous.DebtSecurities);
			TotalFinancialLeaseObligations.UpdateValues(previous.TotalFinancialLeaseObligations);
			AccruedandDeferredIncomeCurrent.UpdateValues(previous.AccruedandDeferredIncomeCurrent);
			AccruedandDeferredIncomeNonCurrent.UpdateValues(previous.AccruedandDeferredIncomeNonCurrent);
			FinanceLeaseReceivablesCurrent.UpdateValues(previous.FinanceLeaseReceivablesCurrent);
			FinanceLeaseReceivablesNonCurrent.UpdateValues(previous.FinanceLeaseReceivablesNonCurrent);
			FinancialLiabilitiesCurrent.UpdateValues(previous.FinancialLiabilitiesCurrent);
			FinancialLiabilitiesNonCurrent.UpdateValues(previous.FinancialLiabilitiesNonCurrent);
			FinancialAssetsDesignatedasFairValueThroughProfitorLossTotal.UpdateValues(previous.FinancialAssetsDesignatedasFairValueThroughProfitorLossTotal);
			TaxesAssetsCurrent.UpdateValues(previous.TaxesAssetsCurrent);
			OtherEquityInterest.UpdateValues(previous.OtherEquityInterest);
			InterestBearingBorrowingsNonCurrent.UpdateValues(previous.InterestBearingBorrowingsNonCurrent);
			NonInterestBearingBorrowingsNonCurrent.UpdateValues(previous.NonInterestBearingBorrowingsNonCurrent);
			TradeandOtherPayablesNonCurrent.UpdateValues(previous.TradeandOtherPayablesNonCurrent);
			InterestBearingBorrowingsCurrent.UpdateValues(previous.InterestBearingBorrowingsCurrent);
			NonInterestBearingBorrowingsCurrent.UpdateValues(previous.NonInterestBearingBorrowingsCurrent);
			PensionandOtherPostRetirementBenefitPlansCurrent.UpdateValues(previous.PensionandOtherPostRetirementBenefitPlansCurrent);
			CashandBalanceswithCentralBanks.UpdateValues(previous.CashandBalanceswithCentralBanks);
			PlacementwithBanksandOtherFinancialInstitutions.UpdateValues(previous.PlacementwithBanksandOtherFinancialInstitutions);
			OtherLoanAssets.UpdateValues(previous.OtherLoanAssets);
			HedgingAssetsTotal.UpdateValues(previous.HedgingAssetsTotal);
			AssetsPledgedasCollateralSubjecttoSaleorRepledgingTotal.UpdateValues(previous.AssetsPledgedasCollateralSubjecttoSaleorRepledgingTotal);
			TaxAssetsTotal.UpdateValues(previous.TaxAssetsTotal);
			AdvancesfromCentralBanks.UpdateValues(previous.AdvancesfromCentralBanks);
			CertificatesofDepositsandOtherDebtSecuritiesIssued.UpdateValues(previous.CertificatesofDepositsandOtherDebtSecuritiesIssued);
			DepositCertificates.UpdateValues(previous.DepositCertificates);
			DebenturesandDebtCertificates.UpdateValues(previous.DebenturesandDebtCertificates);
			InterestBearingBorrowingsTotal.UpdateValues(previous.InterestBearingBorrowingsTotal);
			NonInterestBearingBorrowingsTotal.UpdateValues(previous.NonInterestBearingBorrowingsTotal);
			OtherBorrowedFunds.UpdateValues(previous.OtherBorrowedFunds);
			FinancialLiabilitiesDesignatedasFairValueThroughProfitorLossTotal.UpdateValues(previous.FinancialLiabilitiesDesignatedasFairValueThroughProfitorLossTotal);
			FinancialLiabilitiesMeasuredatAmortizedCostTotal.UpdateValues(previous.FinancialLiabilitiesMeasuredatAmortizedCostTotal);
			LoanCapital.UpdateValues(previous.LoanCapital);
			HedgingLiabilitiesTotal.UpdateValues(previous.HedgingLiabilitiesTotal);
			LiabilitiesRecognizedforFairValueChangesinPortfolioHedgeofInterestRateRisk.UpdateValues(previous.LiabilitiesRecognizedforFairValueChangesinPortfolioHedgeofInterestRateRisk);
			AccruedLiabilitiesTotal.UpdateValues(previous.AccruedLiabilitiesTotal);
			DeferredIncomeTotal.UpdateValues(previous.DeferredIncomeTotal);
			DeferredTaxLiabilitiesTotal.UpdateValues(previous.DeferredTaxLiabilitiesTotal);
			ReinsuranceAssets.UpdateValues(previous.ReinsuranceAssets);
			ReinsuranceShareofInsuranceContract.UpdateValues(previous.ReinsuranceShareofInsuranceContract);
			ReinsuranceShareofAccruedPolicyholderClaims.UpdateValues(previous.ReinsuranceShareofAccruedPolicyholderClaims);
			DepositsMadeunderAssumedReinsuranceContract.UpdateValues(previous.DepositsMadeunderAssumedReinsuranceContract);
			InsuranceContractAssets.UpdateValues(previous.InsuranceContractAssets);
			InsuranceReceivables.UpdateValues(previous.InsuranceReceivables);
			InsuranceContractLiabilities.UpdateValues(previous.InsuranceContractLiabilities);
			InsurancePayables.UpdateValues(previous.InsurancePayables);
			DepositsReceivedunderCededInsuranceContract.UpdateValues(previous.DepositsReceivedunderCededInsuranceContract);
			InvestmentContractLiabilities.UpdateValues(previous.InvestmentContractLiabilities);
			ConstructionGrants.UpdateValues(previous.ConstructionGrants);
			DeferredCostCurrent.UpdateValues(previous.DeferredCostCurrent);
			PensionAndOtherPostretirementBenefitPlansTotal.UpdateValues(previous.PensionAndOtherPostretirementBenefitPlansTotal);
			LiabilitiesHeldforSaleTotal.UpdateValues(previous.LiabilitiesHeldforSaleTotal);
			HedgingAssetsNonCurrent.UpdateValues(previous.HedgingAssetsNonCurrent);
			HedgingAssetsCurrent.UpdateValues(previous.HedgingAssetsCurrent);
			ConvertibleLoansTotal.UpdateValues(previous.ConvertibleLoansTotal);
			BankLoansTotal.UpdateValues(previous.BankLoansTotal);
			OtherLoansTotal.UpdateValues(previous.OtherLoansTotal);
			HedgingLiabilitiesNonCurrent.UpdateValues(previous.HedgingLiabilitiesNonCurrent);
			HedgingLiabilitiesCurrent.UpdateValues(previous.HedgingLiabilitiesCurrent);
			InsuranceFundsNonCurrent.UpdateValues(previous.InsuranceFundsNonCurrent);
			InsuranceFundsCurrent.UpdateValues(previous.InsuranceFundsCurrent);
			DebtTotal.UpdateValues(previous.DebtTotal);
			ComTreShaNum.UpdateValues(previous.ComTreShaNum);
			PreTreShaNum.UpdateValues(previous.PreTreShaNum);
			NetDebt.UpdateValues(previous.NetDebt);
			ShareIssued.UpdateValues(previous.ShareIssued);
			AssetsHeldForSaleCurrent.UpdateValues(previous.AssetsHeldForSaleCurrent);
			AssetsHeldForSaleNonCurrent.UpdateValues(previous.AssetsHeldForSaleNonCurrent);
			BiologicalAssets.UpdateValues(previous.BiologicalAssets);
			CashRestrictedOrPledged.UpdateValues(previous.CashRestrictedOrPledged);
			ConvertibleLoansNonCurrent.UpdateValues(previous.ConvertibleLoansNonCurrent);
			FinancialOrDerivativeInvestmentCurrentLiabilities.UpdateValues(previous.FinancialOrDerivativeInvestmentCurrentLiabilities);
			LoanAndLoanReceivables.UpdateValues(previous.LoanAndLoanReceivables);
