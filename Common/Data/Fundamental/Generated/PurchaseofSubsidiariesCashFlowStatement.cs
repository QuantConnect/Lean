    ...
    public class PurchaseofSubsidiariesCashFlowStatement : MultiPeriodField
    {
        ...
        public double ThreeMonths =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_CashFlowStatement_PurchaseofSubsidiaries_ThreeMonths
            );
        ...
        public double SixMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_CashFlowStatement_PurchaseofSubsidiaries_SixMonths
            );
        ...
        public double NineMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_CashFlowStatement_PurchaseofSubsidiaries_NineMonths
            );
        ...
        public double TwelveMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_CashFlowStatement_PurchaseofSubsidiaries_TwelveMonths
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"FinancialStatements_CashFlowStatement_PurchaseofSubsidiaries_{ConvertPeriod(period)}"
                )
            );
