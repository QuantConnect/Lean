...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class AccumulatedDepreciationBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("AccumulatedDepreciation.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use AccumulatedDepreciation.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("AccumulatedDepreciation.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use AccumulatedDepreciation.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("AccumulatedDepreciation.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use AccumulatedDepreciation.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("AccumulatedDepreciation.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use AccumulatedDepreciation.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("AccumulatedDepreciation.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use AccumulatedDepreciation.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("AccumulatedDepreciation.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use AccumulatedDepreciation.ThreeMonths (also available: SixMonths, TwelveMonths).");
