...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class LoansReceivableBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("LoansReceivable.TwoMonths was retired by Morningstar in 2026; use LoansReceivable.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("LoansReceivable.TwoMonths was retired by Morningstar in 2026; use LoansReceivable.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("LoansReceivable.NineMonths was retired by Morningstar in 2026; use LoansReceivable.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("LoansReceivable.NineMonths was retired by Morningstar in 2026; use LoansReceivable.ThreeMonths (also available: SixMonths, TwelveMonths).");
