...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class SecurityBorrowedBalanceSheet : MultiPeriodField
    {
        ...
        public double ThreeMonths => throw new NotSupportedException("SecurityBorrowed was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("12M")]
        [Obsolete("SecurityBorrowed was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double TwelveMonths => throw new NotSupportedException("SecurityBorrowed was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("SecurityBorrowed was retired by Morningstar in 2026 for all periods; no replacement is available.");
