...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class OtherCapitalStockBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("OtherCapitalStock.NineMonths was retired by Morningstar in 2026; use OtherCapitalStock.OneMonth (also available: ThreeMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("OtherCapitalStock.NineMonths was retired by Morningstar in 2026; use OtherCapitalStock.OneMonth (also available: ThreeMonths, TwelveMonths).");
        ...
        public override IReadOnlyDictionary<string, double> GetPeriodValues()
        {
            ...
            foreach (var kvp in new[] { new Tuple<string, double>("1M",OneMonth), new Tuple<string, double>("3M",ThreeMonths), new Tuple<string, double>("12M",TwelveMonths) })
            {
