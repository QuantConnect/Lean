...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class ClaimsOutstandingBalanceSheet : MultiPeriodField
    {
        ...
        public double ThreeMonths => throw new NotSupportedException("ClaimsOutstanding was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("12M")]
        [Obsolete("ClaimsOutstanding was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double TwelveMonths => throw new NotSupportedException("ClaimsOutstanding was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("ClaimsOutstanding was retired by Morningstar in 2026 for all periods; no replacement is available.");
