...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class MaterialsAndSuppliesBalanceSheet : MultiPeriodField
    {
        ...
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("MaterialsAndSupplies was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("MaterialsAndSupplies was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("MaterialsAndSupplies was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("MaterialsAndSupplies was retired by Morningstar in 2026 for all periods; no replacement is available.");
