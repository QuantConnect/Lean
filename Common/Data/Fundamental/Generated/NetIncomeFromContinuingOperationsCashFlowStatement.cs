...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NetIncomeFromContinuingOperationsCashFlowStatement : MultiPeriodField
    {
        ...
        /// </summary>
        public override bool HasValue => FundamentalService.Get<double>(TimeProvider.GetUtcNow(), SecurityIdentifier, FundamentalProperty.FinancialStatements_CashFlowStatement_NetIncomeFromContinuingOperations_TwelveMonths) != NoValue;
