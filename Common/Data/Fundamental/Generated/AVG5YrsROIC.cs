    ...
    public class AVG5YrsROIC : MultiPeriodField
    {
        ...
        public double FiveYears =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_AVG5YrsROIC_FiveYears
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"OperationRatios_AVG5YrsROIC_{ConvertPeriod(period)}"
                )
            );
        ...
        /// </summary>
        public AVG5YrsROIC(ITimeProvider timeProvider, SecurityIdentifier securityIdentifier)
