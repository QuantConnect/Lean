...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class LossonExtinguishmentofDebtIncomeStatement : MultiPeriodField
    {
        ...
        /// </summary>
        public override bool HasValue => FundamentalService.Get<double>(TimeProvider.GetUtcNow(), SecurityIdentifier, FundamentalProperty.FinancialStatements_IncomeStatement_LossonExtinguishmentofDebt_TwelveMonths) != NoValue;
