...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class OtherInterestExpenseIncomeStatement : MultiPeriodField
    {
        ...
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("OtherInterestExpense was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("OtherInterestExpense was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("OtherInterestExpense was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("OtherInterestExpense was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double SixMonths => throw new NotSupportedException("OtherInterestExpense was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("OtherInterestExpense was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("OtherInterestExpense was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("OtherInterestExpense was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("OtherInterestExpense was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("OtherInterestExpense was retired by Morningstar in 2026 for all periods; no replacement is available.");
