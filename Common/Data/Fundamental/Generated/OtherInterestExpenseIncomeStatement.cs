...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class OtherInterestExpenseIncomeStatement : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("OtherInterestExpense.OneMonth was retired by Morningstar in 2026; use OtherInterestExpense.ThreeMonths (also available: SixMonths, NineMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("OtherInterestExpense.OneMonth was retired by Morningstar in 2026; use OtherInterestExpense.ThreeMonths (also available: SixMonths, NineMonths, TwelveMonths).");
