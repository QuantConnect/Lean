...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class InvestmentsAndAdvancesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("InvestmentsAndAdvances.OneMonth was retired by Morningstar in 2026; use InvestmentsAndAdvances.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("InvestmentsAndAdvances.OneMonth was retired by Morningstar in 2026; use InvestmentsAndAdvances.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("InvestmentsAndAdvances.TwoMonths was retired by Morningstar in 2026; use InvestmentsAndAdvances.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("InvestmentsAndAdvances.TwoMonths was retired by Morningstar in 2026; use InvestmentsAndAdvances.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("InvestmentsAndAdvances.NineMonths was retired by Morningstar in 2026; use InvestmentsAndAdvances.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("InvestmentsAndAdvances.NineMonths was retired by Morningstar in 2026; use InvestmentsAndAdvances.ThreeMonths (also available: SixMonths, TwelveMonths).");
