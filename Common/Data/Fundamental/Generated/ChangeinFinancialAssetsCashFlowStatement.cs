    ...
    public class ChangeinFinancialAssetsCashFlowStatement : MultiPeriodField
    {
        ...
        public double TwelveMonths =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_CashFlowStatement_ChangeinFinancialAssets_TwelveMonths
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"FinancialStatements_CashFlowStatement_ChangeinFinancialAssets_{ConvertPeriod(period)}"
                )
            );
