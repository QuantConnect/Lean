...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class FinishedGoodsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("FinishedGoods.OneMonth was retired by Morningstar in 2026; use FinishedGoods.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("FinishedGoods.OneMonth was retired by Morningstar in 2026; use FinishedGoods.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("FinishedGoods.TwoMonths was retired by Morningstar in 2026; use FinishedGoods.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("FinishedGoods.TwoMonths was retired by Morningstar in 2026; use FinishedGoods.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("FinishedGoods.NineMonths was retired by Morningstar in 2026; use FinishedGoods.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("FinishedGoods.NineMonths was retired by Morningstar in 2026; use FinishedGoods.ThreeMonths (also available: SixMonths, TwelveMonths).");
