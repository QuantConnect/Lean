...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CurrentProvisionsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("CurrentProvisions.TwoMonths was retired by Morningstar in 2026; use CurrentProvisions.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("CurrentProvisions.TwoMonths was retired by Morningstar in 2026; use CurrentProvisions.ThreeMonths (also available: SixMonths, TwelveMonths).");
