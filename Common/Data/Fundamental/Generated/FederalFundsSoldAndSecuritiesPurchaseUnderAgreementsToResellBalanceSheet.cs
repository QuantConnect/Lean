...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class FederalFundsSoldAndSecuritiesPurchaseUnderAgreementsToResellBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("FederalFundsSoldAndSecuritiesPurchaseUnderAgreementsToResell.NineMonths was retired by Morningstar in 2026; use FederalFundsSoldAndSecuritiesPurchaseUnderAgreementsToResell.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("FederalFundsSoldAndSecuritiesPurchaseUnderAgreementsToResell.NineMonths was retired by Morningstar in 2026; use FederalFundsSoldAndSecuritiesPurchaseUnderAgreementsToResell.ThreeMonths (also available: SixMonths, TwelveMonths).");
