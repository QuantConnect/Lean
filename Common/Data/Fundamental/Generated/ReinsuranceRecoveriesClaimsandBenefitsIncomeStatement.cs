...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class ReinsuranceRecoveriesClaimsandBenefitsIncomeStatement : MultiPeriodField
    {
        ...
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("ReinsuranceRecoveriesClaimsandBenefits was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("ReinsuranceRecoveriesClaimsandBenefits was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double SixMonths => throw new NotSupportedException("ReinsuranceRecoveriesClaimsandBenefits was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("ReinsuranceRecoveriesClaimsandBenefits was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("ReinsuranceRecoveriesClaimsandBenefits was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("ReinsuranceRecoveriesClaimsandBenefits was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("ReinsuranceRecoveriesClaimsandBenefits was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("ReinsuranceRecoveriesClaimsandBenefits was retired by Morningstar in 2026 for all periods; no replacement is available.");
