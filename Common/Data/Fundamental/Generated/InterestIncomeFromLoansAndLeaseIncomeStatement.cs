...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class InterestIncomeFromLoansAndLeaseIncomeStatement : MultiPeriodField
    {
        ...
        public double OneMonth => throw new NotSupportedException("InterestIncomeFromLoansAndLease was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("3M")]
        [Obsolete("InterestIncomeFromLoansAndLease was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double ThreeMonths => throw new NotSupportedException("InterestIncomeFromLoansAndLease was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("6M")]
        [Obsolete("InterestIncomeFromLoansAndLease was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double SixMonths => throw new NotSupportedException("InterestIncomeFromLoansAndLease was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("9M")]
        [Obsolete("InterestIncomeFromLoansAndLease was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double NineMonths => throw new NotSupportedException("InterestIncomeFromLoansAndLease was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("12M")]
        [Obsolete("InterestIncomeFromLoansAndLease was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double TwelveMonths => throw new NotSupportedException("InterestIncomeFromLoansAndLease was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("InterestIncomeFromLoansAndLease was retired by Morningstar in 2026 for all periods; no replacement is available.");
