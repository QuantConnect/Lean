    ...
    public class ProvisionForLoanLeaseAndOtherLossesCashFlowStatement : MultiPeriodField
    {
        ...
        public double ThreeMonths =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_CashFlowStatement_ProvisionForLoanLeaseAndOtherLosses_ThreeMonths
            );
        ...
        public double SixMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_CashFlowStatement_ProvisionForLoanLeaseAndOtherLosses_SixMonths
            );
        ...
        public double NineMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_CashFlowStatement_ProvisionForLoanLeaseAndOtherLosses_NineMonths
            );
        ...
        public double TwelveMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_CashFlowStatement_ProvisionForLoanLeaseAndOtherLosses_TwelveMonths
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"FinancialStatements_CashFlowStatement_ProvisionForLoanLeaseAndOtherLosses_{ConvertPeriod(period)}"
                )
            );
