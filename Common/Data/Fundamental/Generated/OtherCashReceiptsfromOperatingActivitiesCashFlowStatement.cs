...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class OtherCashReceiptsfromOperatingActivitiesCashFlowStatement : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("OtherCashReceiptsfromOperatingActivities.OneMonth was retired by Morningstar in 2026; use OtherCashReceiptsfromOperatingActivities.ThreeMonths (also available: SixMonths, NineMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("OtherCashReceiptsfromOperatingActivities.OneMonth was retired by Morningstar in 2026; use OtherCashReceiptsfromOperatingActivities.ThreeMonths (also available: SixMonths, NineMonths, TwelveMonths).");
