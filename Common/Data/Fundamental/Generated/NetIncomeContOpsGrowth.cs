    ...
    public class NetIncomeContOpsGrowth : MultiPeriodField
    {
        ...
        public double OneYear =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_NetIncomeContOpsGrowth_OneYear
            );
        ...
        public double ThreeYears =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_NetIncomeContOpsGrowth_ThreeYears
            );
        ...
        public double ThreeMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_NetIncomeContOpsGrowth_ThreeMonths
            );
        ...
        public double FiveYears =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_NetIncomeContOpsGrowth_FiveYears
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"OperationRatios_NetIncomeContOpsGrowth_{ConvertPeriod(period)}"
                )
            );
