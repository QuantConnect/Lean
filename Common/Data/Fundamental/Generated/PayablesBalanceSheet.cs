...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class PayablesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("Payables.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use Payables.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("Payables.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use Payables.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("Payables.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use Payables.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("Payables.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use Payables.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("Payables.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use Payables.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("Payables.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use Payables.ThreeMonths (also available: SixMonths, TwelveMonths).");
