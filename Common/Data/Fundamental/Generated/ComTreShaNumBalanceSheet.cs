...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class ComTreShaNumBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("3M")]
        [Obsolete("ComTreShaNum was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("ComTreShaNum was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("ComTreShaNum was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("ComTreShaNum was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("ComTreShaNum was retired by Morningstar in 2026 for all periods; no replacement is available.");
