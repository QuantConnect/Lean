    ...
    public class MinorityInterestBalanceSheet : MultiPeriodField
    {
        ...
        public double OneMonth =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_BalanceSheet_MinorityInterest_OneMonth
            );
        ...
        public double TwoMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_BalanceSheet_MinorityInterest_TwoMonths
            );
        ...
        public double ThreeMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_BalanceSheet_MinorityInterest_ThreeMonths
            );
        ...
        public double SixMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_BalanceSheet_MinorityInterest_SixMonths
            );
        ...
        public double NineMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_BalanceSheet_MinorityInterest_NineMonths
            );
        ...
        public double TwelveMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_BalanceSheet_MinorityInterest_TwelveMonths
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"FinancialStatements_BalanceSheet_MinorityInterest_{ConvertPeriod(period)}"
                )
            );
