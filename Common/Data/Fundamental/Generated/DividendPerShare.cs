    ...
    public class DividendPerShare : MultiPeriodField
    {
        ...
        public double OneMonth =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.EarningReports_DividendPerShare_OneMonth
            );
        ...
        public double TwoMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningReports_DividendPerShare_TwoMonths
            );
        ...
        public double ThreeMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningReports_DividendPerShare_ThreeMonths
            );
        ...
        public double SixMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningReports_DividendPerShare_SixMonths
            );
        ...
        public double NineMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningReports_DividendPerShare_NineMonths
            );
        ...
        public double TwelveMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningReports_DividendPerShare_TwelveMonths
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"EarningReports_DividendPerShare_{ConvertPeriod(period)}"
                )
            );
        ...
        /// </summary>
        public DividendPerShare(ITimeProvider timeProvider, SecurityIdentifier securityIdentifier)
