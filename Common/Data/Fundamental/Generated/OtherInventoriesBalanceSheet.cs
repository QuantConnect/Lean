...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class OtherInventoriesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("OtherInventories.OneMonth was retired by Morningstar in 2026; use OtherInventories.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("OtherInventories.OneMonth was retired by Morningstar in 2026; use OtherInventories.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("OtherInventories.NineMonths was retired by Morningstar in 2026; use OtherInventories.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("OtherInventories.NineMonths was retired by Morningstar in 2026; use OtherInventories.ThreeMonths (also available: SixMonths, TwelveMonths).");
