    ...
    public class CashFlowFileDate : MultiPeriodField<DateTime>
    {
        ...
        public DateTime OneMonth =>
            FundamentalService.Get<DateTime>(
                ...
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_CashFlowStatement_CFFileDate_OneMonth
            );
        ...
        /// </summary>
        [JsonProperty("2M")]
        public DateTime TwoMonths =>
            FundamentalService.Get<DateTime>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_CashFlowStatement_CFFileDate_TwoMonths
            );
        ...
        public DateTime ThreeMonths =>
            FundamentalService.Get<DateTime>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_CashFlowStatement_CFFileDate_ThreeMonths
            );
        ...
        /// </summary>
        [JsonProperty("6M")]
        public DateTime SixMonths =>
            FundamentalService.Get<DateTime>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_CashFlowStatement_CFFileDate_SixMonths
            );
        ...
        /// </summary>
        [JsonProperty("9M")]
        public DateTime NineMonths =>
            FundamentalService.Get<DateTime>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_CashFlowStatement_CFFileDate_NineMonths
            );
        ...
        public DateTime TwelveMonths =>
            FundamentalService.Get<DateTime>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_CashFlowStatement_CFFileDate_TwelveMonths
            );
        ...
        public override IReadOnlyDictionary<string, DateTime> GetPeriodValues()
        {
            ...
            foreach (
                var kvp in new[]
                {
                    ...
                    new Tuple<string, DateTime>("2M", TwoMonths),
                    new Tuple<string, DateTime>("3M", ThreeMonths),
                    new Tuple<string, DateTime>("6M", SixMonths),
                    new Tuple<string, DateTime>("9M", NineMonths),
        ...
        public override DateTime GetPeriodValue(string period) =>
            FundamentalService.Get<DateTime>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"FinancialStatements_CashFlowStatement_CFFileDate_{ConvertPeriod(period)}"
                )
            );
        ...
        /// </summary>
        public CashFlowFileDate(ITimeProvider timeProvider, SecurityIdentifier securityIdentifier)
