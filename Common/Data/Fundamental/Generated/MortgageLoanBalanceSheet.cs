...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class MortgageLoanBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("MortgageLoan.NineMonths was retired by Morningstar in 2026; use MortgageLoan.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("MortgageLoan.NineMonths was retired by Morningstar in 2026; use MortgageLoan.ThreeMonths (also available: SixMonths, TwelveMonths).");
