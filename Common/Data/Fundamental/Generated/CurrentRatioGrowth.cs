    ...
    public class CurrentRatioGrowth : MultiPeriodField
    {
        ...
        public double OneYear =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_CurrentRatioGrowth_OneYear
            );
        ...
        public double ThreeYears =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_CurrentRatioGrowth_ThreeYears
            );
        ...
        public double FiveYears =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_CurrentRatioGrowth_FiveYears
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"OperationRatios_CurrentRatioGrowth_{ConvertPeriod(period)}"
                )
            );
        ...
        /// </summary>
        public CurrentRatioGrowth(ITimeProvider timeProvider, SecurityIdentifier securityIdentifier)
