...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NetUtilityPlantBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("NetUtilityPlant.NineMonths was retired by Morningstar in 2026; use NetUtilityPlant.ThreeMonths (also available: TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("NetUtilityPlant.NineMonths was retired by Morningstar in 2026; use NetUtilityPlant.ThreeMonths (also available: TwelveMonths).");
