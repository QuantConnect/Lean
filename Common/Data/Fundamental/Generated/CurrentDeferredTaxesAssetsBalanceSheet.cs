...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CurrentDeferredTaxesAssetsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("CurrentDeferredTaxesAssets.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentDeferredTaxesAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("CurrentDeferredTaxesAssets.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentDeferredTaxesAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        public override IReadOnlyDictionary<string, double> GetPeriodValues()
        {
            ...
            foreach (var kvp in new[] { new Tuple<string, double>("1M",OneMonth), new Tuple<string, double>("2M",TwoMonths), new Tuple<string, double>("3M",ThreeMonths), new Tuple<string, double>("6M",SixMonths), new Tuple<string, double>("12M",TwelveMonths) })
            {
