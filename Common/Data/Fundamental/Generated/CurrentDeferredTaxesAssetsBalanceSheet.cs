...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CurrentDeferredTaxesAssetsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("CurrentDeferredTaxesAssets.OneMonth was retired by Morningstar in 2026; use CurrentDeferredTaxesAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("CurrentDeferredTaxesAssets.OneMonth was retired by Morningstar in 2026; use CurrentDeferredTaxesAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("CurrentDeferredTaxesAssets.TwoMonths was retired by Morningstar in 2026; use CurrentDeferredTaxesAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("CurrentDeferredTaxesAssets.TwoMonths was retired by Morningstar in 2026; use CurrentDeferredTaxesAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("CurrentDeferredTaxesAssets.NineMonths was retired by Morningstar in 2026; use CurrentDeferredTaxesAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("CurrentDeferredTaxesAssets.NineMonths was retired by Morningstar in 2026; use CurrentDeferredTaxesAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");
