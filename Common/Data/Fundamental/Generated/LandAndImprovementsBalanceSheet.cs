...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class LandAndImprovementsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("LandAndImprovements.OneMonth was retired by Morningstar in 2026; use LandAndImprovements.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("LandAndImprovements.OneMonth was retired by Morningstar in 2026; use LandAndImprovements.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("LandAndImprovements.TwoMonths was retired by Morningstar in 2026; use LandAndImprovements.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("LandAndImprovements.TwoMonths was retired by Morningstar in 2026; use LandAndImprovements.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("LandAndImprovements.NineMonths was retired by Morningstar in 2026; use LandAndImprovements.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("LandAndImprovements.NineMonths was retired by Morningstar in 2026; use LandAndImprovements.ThreeMonths (also available: SixMonths, TwelveMonths).");
