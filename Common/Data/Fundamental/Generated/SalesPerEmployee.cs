...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class SalesPerEmployee : MultiPeriodField
    {
        ...
        /// </summary>
        public override bool HasValue => FundamentalService.Get<double>(TimeProvider.GetUtcNow(), SecurityIdentifier, FundamentalProperty.OperationRatios_SalesPerEmployee_OneYear) != NoValue;
