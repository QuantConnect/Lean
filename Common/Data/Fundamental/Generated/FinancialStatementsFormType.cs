    ...
    public class FinancialStatementsFormType : MultiPeriodField<string>
    {
        ...
        public string OneMonth =>
            FundamentalService.Get<string>(
                ...
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_FormType_OneMonth
            );
        ...
        public string TwoMonths =>
            FundamentalService.Get<string>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_FormType_TwoMonths
            );
        ...
        public string ThreeMonths =>
            FundamentalService.Get<string>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_FormType_ThreeMonths
            );
        ...
        public string SixMonths =>
            FundamentalService.Get<string>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_FormType_SixMonths
            );
        ...
        public string NineMonths =>
            FundamentalService.Get<string>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_FormType_NineMonths
            );
        ...
        public string TwelveMonths =>
            FundamentalService.Get<string>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_FormType_TwelveMonths
            );
        ...
        public override string GetPeriodValue(string period) =>
            FundamentalService.Get<string>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"FinancialStatements_FormType_{ConvertPeriod(period)}"
                )
            );
