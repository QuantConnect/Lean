...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CurrentDeferredTaxesLiabilitiesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("CurrentDeferredTaxesLiabilities.NineMonths was retired by Morningstar in 2026; use CurrentDeferredTaxesLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("CurrentDeferredTaxesLiabilities.NineMonths was retired by Morningstar in 2026; use CurrentDeferredTaxesLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).");
