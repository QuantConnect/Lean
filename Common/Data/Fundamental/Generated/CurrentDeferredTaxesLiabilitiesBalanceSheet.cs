...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CurrentDeferredTaxesLiabilitiesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("3M")]
        [Obsolete("CurrentDeferredTaxesLiabilities was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double ThreeMonths => throw new NotSupportedException("CurrentDeferredTaxesLiabilities was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("6M")]
        [Obsolete("CurrentDeferredTaxesLiabilities was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double SixMonths => throw new NotSupportedException("CurrentDeferredTaxesLiabilities was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("9M")]
        [Obsolete("CurrentDeferredTaxesLiabilities was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double NineMonths => throw new NotSupportedException("CurrentDeferredTaxesLiabilities was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("12M")]
        [Obsolete("CurrentDeferredTaxesLiabilities was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double TwelveMonths => throw new NotSupportedException("CurrentDeferredTaxesLiabilities was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("CurrentDeferredTaxesLiabilities was retired by Morningstar in 2026 for all periods; no replacement is available.");
