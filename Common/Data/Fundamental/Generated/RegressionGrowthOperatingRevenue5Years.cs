    ...
    public class RegressionGrowthOperatingRevenue5Years : MultiPeriodField
    {
        ...
        public double FiveYears =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_RegressionGrowthOperatingRevenue5Years_FiveYears
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"OperationRatios_RegressionGrowthOperatingRevenue5Years_{ConvertPeriod(period)}"
                )
            );
