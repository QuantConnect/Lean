...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class TotalDeferredCreditsAndOtherNonCurrentLiabilitiesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("TotalDeferredCreditsAndOtherNonCurrentLiabilities.NineMonths was retired by Morningstar in 2026; use TotalDeferredCreditsAndOtherNonCurrentLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("TotalDeferredCreditsAndOtherNonCurrentLiabilities.NineMonths was retired by Morningstar in 2026; use TotalDeferredCreditsAndOtherNonCurrentLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).");
