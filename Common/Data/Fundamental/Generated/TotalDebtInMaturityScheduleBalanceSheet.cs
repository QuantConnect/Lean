...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class TotalDebtInMaturityScheduleBalanceSheet : MultiPeriodField
    {
        ...
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("TotalDebtInMaturitySchedule was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("TotalDebtInMaturitySchedule was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("TotalDebtInMaturitySchedule was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("TotalDebtInMaturitySchedule was retired by Morningstar in 2026 for all periods; no replacement is available.");
