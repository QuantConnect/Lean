...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class TotalDebtInMaturityScheduleBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("3M")]
        [Obsolete("TotalDebtInMaturitySchedule is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double ThreeMonths => throw new NotSupportedException("TotalDebtInMaturitySchedule is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("12M")]
        [Obsolete("TotalDebtInMaturitySchedule is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double TwelveMonths => throw new NotSupportedException("TotalDebtInMaturitySchedule is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("TotalDebtInMaturitySchedule is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
