...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class EarningsFromEquityInterestIncomeStatement : MultiPeriodField
    {
        ...
        /// </summary>
        public override bool HasValue => FundamentalService.Get<double>(TimeProvider.GetUtcNow(), SecurityIdentifier, FundamentalProperty.FinancialStatements_IncomeStatement_EarningsFromEquityInterest_TwelveMonths) != NoValue;
