...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class DividendIncomeIncomeStatement : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("DividendIncome.OneMonth was retired by Morningstar in 2026; use DividendIncome.TwoMonths (also available: ThreeMonths, SixMonths, NineMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("DividendIncome.OneMonth was retired by Morningstar in 2026; use DividendIncome.TwoMonths (also available: ThreeMonths, SixMonths, NineMonths, TwelveMonths).");
