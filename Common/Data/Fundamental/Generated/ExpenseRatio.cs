    ...
    public class ExpenseRatio : MultiPeriodField
    {
        ...
        public double OneYear =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_ExpenseRatio_OneYear
            );
        ...
        public double ThreeMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_ExpenseRatio_ThreeMonths
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"OperationRatios_ExpenseRatio_{ConvertPeriod(period)}"
                )
            );
        ...
        /// </summary>
        public ExpenseRatio(ITimeProvider timeProvider, SecurityIdentifier securityIdentifier)
