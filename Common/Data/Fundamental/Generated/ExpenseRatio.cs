...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class ExpenseRatio : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1Y")]
        public double OneYear => FundamentalService.Get<double>(Time, SecurityIdentifier, "OperationRatios.ExpenseRatio.OneYear");

        /// <summary>
        /// Gets/sets the ThreeMonths period value for the field
        /// </summary>
        [JsonProperty("3M")]
        public double ThreeMonths => FundamentalService.Get<double>(Time, SecurityIdentifier, "OperationRatios.ExpenseRatio.ThreeMonths");

        /// <summary>
        /// Returns true if the field contains a value for the default period
        /// </summary>
        public override bool HasValue => FundamentalService.Get<double>(Time, SecurityIdentifier, "OperationRatios.ExpenseRatio.OneYear") != NoValue;
        ...
        public override double Value
        {
            get
            {
                var defaultValue = FundamentalService.Get<double>(Time, SecurityIdentifier, "OperationRatios.ExpenseRatio.OneYear");
        ...
        public override double GetPeriodValue(string period) => FundamentalService.Get<double>(Time, SecurityIdentifier, $"OperationRatios.ExpenseRatio.{ConvertPeriod(period)}");
        ...
        /// </summary>
        public ExpenseRatio(DateTime time, SecurityIdentifier securityIdentifier) : base(time, securityIdentifier)
        {
        }
    }
}
