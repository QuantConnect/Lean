    ...
    public class GrossProfitAnnual5YrGrowth : MultiPeriodField
    {
        ...
        public double OneYear =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_GrossProfitAnnual5YrGrowth_OneYear
            );
        ...
        public double ThreeYears =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_GrossProfitAnnual5YrGrowth_ThreeYears
            );
        ...
        public double FiveYears =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_GrossProfitAnnual5YrGrowth_FiveYears
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"OperationRatios_GrossProfitAnnual5YrGrowth_{ConvertPeriod(period)}"
                )
            );
