...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CashBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("Cash.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use Cash.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("Cash.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use Cash.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("Cash.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use Cash.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("Cash.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use Cash.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("Cash.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use Cash.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("Cash.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use Cash.ThreeMonths (also available: SixMonths, TwelveMonths).");
