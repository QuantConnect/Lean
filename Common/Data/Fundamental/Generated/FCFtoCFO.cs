    ...
    public class FCFtoCFO : MultiPeriodField
    {
        ...
        public double OneYear =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_FCFtoCFO_OneYear
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                Enum.Parse<FundamentalProperty>($"OperationRatios_FCFtoCFO_{ConvertPeriod(period)}")
            );
        ...
        /// </summary>
        public FCFtoCFO(ITimeProvider timeProvider, SecurityIdentifier securityIdentifier)
