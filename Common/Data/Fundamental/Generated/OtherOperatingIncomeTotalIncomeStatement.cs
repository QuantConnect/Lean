...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class OtherOperatingIncomeTotalIncomeStatement : MultiPeriodField
    {
        ...
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("OtherOperatingIncomeTotal was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("OtherOperatingIncomeTotal was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("OtherOperatingIncomeTotal was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("OtherOperatingIncomeTotal was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double SixMonths => throw new NotSupportedException("OtherOperatingIncomeTotal was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("OtherOperatingIncomeTotal was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("OtherOperatingIncomeTotal was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("OtherOperatingIncomeTotal was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("OtherOperatingIncomeTotal was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("OtherOperatingIncomeTotal was retired by Morningstar in 2026 for all periods; no replacement is available.");
