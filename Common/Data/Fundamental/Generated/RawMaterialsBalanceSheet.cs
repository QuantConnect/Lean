...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class RawMaterialsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("RawMaterials.TwoMonths was retired by Morningstar in 2026; use RawMaterials.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("RawMaterials.TwoMonths was retired by Morningstar in 2026; use RawMaterials.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("RawMaterials.NineMonths was retired by Morningstar in 2026; use RawMaterials.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("RawMaterials.NineMonths was retired by Morningstar in 2026; use RawMaterials.ThreeMonths (also available: SixMonths, TwelveMonths).");
