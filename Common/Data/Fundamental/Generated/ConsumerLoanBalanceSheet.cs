...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class ConsumerLoanBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("ConsumerLoan.NineMonths was retired by Morningstar in 2026; use ConsumerLoan.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("ConsumerLoan.NineMonths was retired by Morningstar in 2026; use ConsumerLoan.ThreeMonths (also available: SixMonths, TwelveMonths).");
