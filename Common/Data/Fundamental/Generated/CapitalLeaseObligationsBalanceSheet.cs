...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CapitalLeaseObligationsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("CapitalLeaseObligations.OneMonth was retired by Morningstar in 2026; use CapitalLeaseObligations.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("CapitalLeaseObligations.OneMonth was retired by Morningstar in 2026; use CapitalLeaseObligations.ThreeMonths (also available: SixMonths, TwelveMonths).");
