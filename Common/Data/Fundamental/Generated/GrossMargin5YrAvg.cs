    ...
    public class GrossMargin5YrAvg : MultiPeriodField
    {
        ...
        public double FiveYears =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_GrossMargin5YrAvg_FiveYears
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"OperationRatios_GrossMargin5YrAvg_{ConvertPeriod(period)}"
                )
            );
        ...
        /// </summary>
        public GrossMargin5YrAvg(ITimeProvider timeProvider, SecurityIdentifier securityIdentifier)
