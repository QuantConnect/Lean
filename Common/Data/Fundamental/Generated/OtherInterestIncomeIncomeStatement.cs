...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class OtherInterestIncomeIncomeStatement : MultiPeriodField
    {
        ...
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("OtherInterestIncome was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("OtherInterestIncome was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("OtherInterestIncome was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("OtherInterestIncome was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double SixMonths => throw new NotSupportedException("OtherInterestIncome was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("OtherInterestIncome was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("OtherInterestIncome was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("OtherInterestIncome was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("OtherInterestIncome was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("OtherInterestIncome was retired by Morningstar in 2026 for all periods; no replacement is available.");
