...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class OtherInterestIncomeIncomeStatement : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("OtherInterestIncome.OneMonth was retired by Morningstar in 2026; use OtherInterestIncome.ThreeMonths (also available: SixMonths, NineMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("OtherInterestIncome.OneMonth was retired by Morningstar in 2026; use OtherInterestIncome.ThreeMonths (also available: SixMonths, NineMonths, TwelveMonths).");
