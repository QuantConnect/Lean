...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class OtherShortTermInvestmentsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("OtherShortTermInvestments.OneMonth was retired by Morningstar in 2026; use OtherShortTermInvestments.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("OtherShortTermInvestments.OneMonth was retired by Morningstar in 2026; use OtherShortTermInvestments.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("OtherShortTermInvestments.NineMonths was retired by Morningstar in 2026; use OtherShortTermInvestments.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("OtherShortTermInvestments.NineMonths was retired by Morningstar in 2026; use OtherShortTermInvestments.ThreeMonths (also available: SixMonths, TwelveMonths).");
