...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class OtherShortTermInvestmentsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("OtherShortTermInvestments.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherShortTermInvestments.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("OtherShortTermInvestments.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherShortTermInvestments.ThreeMonths (also available: SixMonths, TwelveMonths).");
