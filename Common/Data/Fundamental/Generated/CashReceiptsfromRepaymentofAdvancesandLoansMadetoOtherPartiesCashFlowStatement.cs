...
namespace QuantConnect.Data.Fundamental
{
    ...
    /// </summary>
    public class CashReceiptsfromRepaymentofAdvancesandLoansMadetoOtherPartiesCashFlowStatement
        : MultiPeriodField
    {
        /// <summary>
        /// The default period
        ...
        public double SixMonths =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_CashFlowStatement_CashReceiptsfromRepaymentofAdvancesandLoansMadetoOtherParties_SixMonths
            );
        ...
        public double TwelveMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_CashFlowStatement_CashReceiptsfromRepaymentofAdvancesandLoansMadetoOtherParties_TwelveMonths
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"FinancialStatements_CashFlowStatement_CashReceiptsfromRepaymentofAdvancesandLoansMadetoOtherParties_{ConvertPeriod(period)}"
                )
            );
