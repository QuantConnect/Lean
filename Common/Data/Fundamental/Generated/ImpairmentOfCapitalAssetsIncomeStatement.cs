...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class ImpairmentOfCapitalAssetsIncomeStatement : MultiPeriodField
    {
        ...
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("ImpairmentOfCapitalAssets was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("ImpairmentOfCapitalAssets was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("ImpairmentOfCapitalAssets was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("ImpairmentOfCapitalAssets was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("ImpairmentOfCapitalAssets was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("ImpairmentOfCapitalAssets was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double SixMonths => throw new NotSupportedException("ImpairmentOfCapitalAssets was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("ImpairmentOfCapitalAssets was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("ImpairmentOfCapitalAssets was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("ImpairmentOfCapitalAssets was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("ImpairmentOfCapitalAssets was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("ImpairmentOfCapitalAssets was retired by Morningstar in 2026 for all periods; no replacement is available.");
