...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NonCurrentDeferredTaxesAssetsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("NonCurrentDeferredTaxesAssets.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use NonCurrentDeferredTaxesAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("NonCurrentDeferredTaxesAssets.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use NonCurrentDeferredTaxesAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("NonCurrentDeferredTaxesAssets.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use NonCurrentDeferredTaxesAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("NonCurrentDeferredTaxesAssets.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use NonCurrentDeferredTaxesAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");
