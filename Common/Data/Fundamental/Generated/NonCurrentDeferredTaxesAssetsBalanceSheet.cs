...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NonCurrentDeferredTaxesAssetsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        public override bool HasValue => FundamentalService.Get<double>(TimeProvider.GetUtcNow(), SecurityIdentifier, FundamentalProperty.FinancialStatements_BalanceSheet_NonCurrentDeferredTaxesAssets_TwelveMonths) != NoValue;
