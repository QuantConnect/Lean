...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CommonStockBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("CommonStock.OneMonth was retired by Morningstar in 2026; use CommonStock.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("CommonStock.OneMonth was retired by Morningstar in 2026; use CommonStock.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("CommonStock.TwoMonths was retired by Morningstar in 2026; use CommonStock.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("CommonStock.TwoMonths was retired by Morningstar in 2026; use CommonStock.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("CommonStock.NineMonths was retired by Morningstar in 2026; use CommonStock.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("CommonStock.NineMonths was retired by Morningstar in 2026; use CommonStock.ThreeMonths (also available: SixMonths, TwelveMonths).");
