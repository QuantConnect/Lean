...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class LoansHeldForSaleBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("LoansHeldForSale.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use LoansHeldForSale.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("LoansHeldForSale.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use LoansHeldForSale.ThreeMonths (also available: SixMonths, TwelveMonths).");
