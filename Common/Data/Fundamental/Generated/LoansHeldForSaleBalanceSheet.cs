...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class LoansHeldForSaleBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("LoansHeldForSale.NineMonths was retired by Morningstar in 2026; use LoansHeldForSale.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("LoansHeldForSale.NineMonths was retired by Morningstar in 2026; use LoansHeldForSale.ThreeMonths (also available: SixMonths, TwelveMonths).");
