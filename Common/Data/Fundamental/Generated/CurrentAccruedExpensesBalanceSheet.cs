...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CurrentAccruedExpensesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("CurrentAccruedExpenses.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use CurrentAccruedExpenses.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("CurrentAccruedExpenses.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use CurrentAccruedExpenses.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("CurrentAccruedExpenses.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentAccruedExpenses.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("CurrentAccruedExpenses.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentAccruedExpenses.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("CurrentAccruedExpenses.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentAccruedExpenses.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("CurrentAccruedExpenses.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentAccruedExpenses.ThreeMonths (also available: SixMonths, TwelveMonths).");
