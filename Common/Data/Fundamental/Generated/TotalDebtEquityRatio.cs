...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class TotalDebtEquityRatio : MultiPeriodField
    {
        ...
        /// </summary>
        public override bool HasValue => FundamentalService.Get<double>(TimeProvider.GetUtcNow(), SecurityIdentifier, FundamentalProperty.OperationRatios_TotalDebtEquityRatio_OneYear) != NoValue;
