    ...
    public class TotalDebtEquityRatio : MultiPeriodField
    {
        ...
        public double OneYear =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_TotalDebtEquityRatio_OneYear
            );
        ...
        public double OneMonth =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_TotalDebtEquityRatio_OneMonth
            );
        ...
        public double TwoMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_TotalDebtEquityRatio_TwoMonths
            );
        ...
        public double ThreeMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_TotalDebtEquityRatio_ThreeMonths
            );
        ...
        public double SixMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_TotalDebtEquityRatio_SixMonths
            );
        ...
        public double NineMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_TotalDebtEquityRatio_NineMonths
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"OperationRatios_TotalDebtEquityRatio_{ConvertPeriod(period)}"
                )
            );
