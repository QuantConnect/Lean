...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class GainLossOnInvestmentSecuritiesCashFlowStatement : MultiPeriodField
    {
        ...
        /// </summary>
        public override bool HasValue => FundamentalService.Get<double>(TimeProvider.GetUtcNow(), SecurityIdentifier, FundamentalProperty.FinancialStatements_CashFlowStatement_GainLossOnInvestmentSecurities_TwelveMonths) != NoValue;
