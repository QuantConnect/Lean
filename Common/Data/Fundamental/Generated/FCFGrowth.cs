...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class FCFGrowth : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1Y")]
        public double OneYear => FundamentalService.Get<double>(Time, SecurityIdentifier, "OperationRatios.FCFGrowth.OneYear");

        /// <summary>
        /// Gets/sets the ThreeYears period value for the field
        /// </summary>
        [JsonProperty("3Y")]
        public double ThreeYears => FundamentalService.Get<double>(Time, SecurityIdentifier, "OperationRatios.FCFGrowth.ThreeYears");

        /// <summary>
        /// Gets/sets the FiveYears period value for the field
        /// </summary>
        [JsonProperty("5Y")]
        public double FiveYears => FundamentalService.Get<double>(Time, SecurityIdentifier, "OperationRatios.FCFGrowth.FiveYears");

        /// <summary>
        /// Returns true if the field contains a value for the default period
        /// </summary>
        public override bool HasValue => FundamentalService.Get<double>(Time, SecurityIdentifier, "OperationRatios.FCFGrowth.OneYear") != NoValue;
        ...
        public override double Value
        {
            get
            {
                var defaultValue = FundamentalService.Get<double>(Time, SecurityIdentifier, "OperationRatios.FCFGrowth.OneYear");
        ...
        public override double GetPeriodValue(string period) => FundamentalService.Get<double>(Time, SecurityIdentifier, $"OperationRatios.FCFGrowth.{ConvertPeriod(period)}");
        ...
        /// </summary>
        public FCFGrowth(DateTime time, SecurityIdentifier securityIdentifier) : base(time, securityIdentifier)
        {
        }
    }
}
