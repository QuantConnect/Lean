...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class UnpaidLossAndLossReserveBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("UnpaidLossAndLossReserve.NineMonths was retired by Morningstar in 2026; use UnpaidLossAndLossReserve.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("UnpaidLossAndLossReserve.NineMonths was retired by Morningstar in 2026; use UnpaidLossAndLossReserve.ThreeMonths (also available: SixMonths, TwelveMonths).");
