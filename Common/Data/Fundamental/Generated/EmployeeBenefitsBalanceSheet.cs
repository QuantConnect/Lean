...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class EmployeeBenefitsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("EmployeeBenefits.TwoMonths was retired by Morningstar in 2026; use EmployeeBenefits.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("EmployeeBenefits.TwoMonths was retired by Morningstar in 2026; use EmployeeBenefits.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("EmployeeBenefits.NineMonths was retired by Morningstar in 2026; use EmployeeBenefits.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("EmployeeBenefits.NineMonths was retired by Morningstar in 2026; use EmployeeBenefits.ThreeMonths (also available: SixMonths, TwelveMonths).");
