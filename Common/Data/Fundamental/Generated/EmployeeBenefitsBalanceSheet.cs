...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class EmployeeBenefitsBalanceSheet : MultiPeriodField
    {
        ...
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("EmployeeBenefits was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("EmployeeBenefits was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("EmployeeBenefits was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("EmployeeBenefits was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double SixMonths => throw new NotSupportedException("EmployeeBenefits was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("EmployeeBenefits was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("EmployeeBenefits was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("EmployeeBenefits was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("EmployeeBenefits was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("EmployeeBenefits was retired by Morningstar in 2026 for all periods; no replacement is available.");
