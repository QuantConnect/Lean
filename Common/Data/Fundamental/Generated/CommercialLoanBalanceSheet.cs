...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CommercialLoanBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("CommercialLoan.NineMonths was retired by Morningstar in 2026; use CommercialLoan.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("CommercialLoan.NineMonths was retired by Morningstar in 2026; use CommercialLoan.ThreeMonths (also available: SixMonths, TwelveMonths).");
