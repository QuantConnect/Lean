...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class RentandLandingFeesCostofRevenueIncomeStatement : MultiPeriodField
    {
        ...
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("RentandLandingFeesCostofRevenue was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("RentandLandingFeesCostofRevenue was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double SixMonths => throw new NotSupportedException("RentandLandingFeesCostofRevenue was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("RentandLandingFeesCostofRevenue was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("RentandLandingFeesCostofRevenue was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("RentandLandingFeesCostofRevenue was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("RentandLandingFeesCostofRevenue was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("RentandLandingFeesCostofRevenue was retired by Morningstar in 2026 for all periods; no replacement is available.");
