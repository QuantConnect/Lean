...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class DepositCertificatesBalanceSheet : MultiPeriodField
    {
        ...
        public double ThreeMonths => throw new NotSupportedException("DepositCertificates was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("12M")]
        [Obsolete("DepositCertificates was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double TwelveMonths => throw new NotSupportedException("DepositCertificates was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("DepositCertificates was retired by Morningstar in 2026 for all periods; no replacement is available.");
