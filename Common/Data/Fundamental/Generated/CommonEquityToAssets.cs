...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CommonEquityToAssets : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("CommonEquityToAssets.OneMonth was retired by Morningstar in 2026; use CommonEquityToAssets.ThreeMonths (also available: SixMonths, OneYear).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("CommonEquityToAssets.OneMonth was retired by Morningstar in 2026; use CommonEquityToAssets.ThreeMonths (also available: SixMonths, OneYear).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("CommonEquityToAssets.TwoMonths was retired by Morningstar in 2026; use CommonEquityToAssets.ThreeMonths (also available: SixMonths, OneYear).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("CommonEquityToAssets.TwoMonths was retired by Morningstar in 2026; use CommonEquityToAssets.ThreeMonths (also available: SixMonths, OneYear).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("CommonEquityToAssets.NineMonths was retired by Morningstar in 2026; use CommonEquityToAssets.ThreeMonths (also available: SixMonths, OneYear).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("CommonEquityToAssets.NineMonths was retired by Morningstar in 2026; use CommonEquityToAssets.ThreeMonths (also available: SixMonths, OneYear).");
