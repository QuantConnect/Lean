...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NonInterestBearingBorrowingsTotalBalanceSheet : MultiPeriodField
    {
        ...
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("NonInterestBearingBorrowingsTotal was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("NonInterestBearingBorrowingsTotal was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("NonInterestBearingBorrowingsTotal was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("NonInterestBearingBorrowingsTotal was retired by Morningstar in 2026 for all periods; no replacement is available.");
