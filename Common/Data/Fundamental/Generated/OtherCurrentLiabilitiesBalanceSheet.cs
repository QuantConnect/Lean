...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class OtherCurrentLiabilitiesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("OtherCurrentLiabilities.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use OtherCurrentLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("OtherCurrentLiabilities.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use OtherCurrentLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("OtherCurrentLiabilities.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherCurrentLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("OtherCurrentLiabilities.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherCurrentLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("OtherCurrentLiabilities.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherCurrentLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("OtherCurrentLiabilities.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherCurrentLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).");
