...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class FlightFleetVehicleAndRelatedEquipmentsBalanceSheet : MultiPeriodField
    {
        ...
        public double ThreeMonths => throw new NotSupportedException("FlightFleetVehicleAndRelatedEquipments is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("6M")]
        [Obsolete("FlightFleetVehicleAndRelatedEquipments is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double SixMonths => throw new NotSupportedException("FlightFleetVehicleAndRelatedEquipments is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("12M")]
        [Obsolete("FlightFleetVehicleAndRelatedEquipments is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double TwelveMonths => throw new NotSupportedException("FlightFleetVehicleAndRelatedEquipments is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("FlightFleetVehicleAndRelatedEquipments is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
