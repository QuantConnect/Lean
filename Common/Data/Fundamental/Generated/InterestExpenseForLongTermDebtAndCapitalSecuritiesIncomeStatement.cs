...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class InterestExpenseForLongTermDebtAndCapitalSecuritiesIncomeStatement : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("InterestExpenseForLongTermDebtAndCapitalSecurities.OneMonth was retired by Morningstar in 2026; use InterestExpenseForLongTermDebtAndCapitalSecurities.ThreeMonths (also available: SixMonths, NineMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("InterestExpenseForLongTermDebtAndCapitalSecurities.OneMonth was retired by Morningstar in 2026; use InterestExpenseForLongTermDebtAndCapitalSecurities.ThreeMonths (also available: SixMonths, NineMonths, TwelveMonths).");
