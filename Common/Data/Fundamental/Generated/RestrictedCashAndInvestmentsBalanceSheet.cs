...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class RestrictedCashAndInvestmentsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("RestrictedCashAndInvestments.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use RestrictedCashAndInvestments.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("RestrictedCashAndInvestments.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use RestrictedCashAndInvestments.ThreeMonths (also available: SixMonths, TwelveMonths).");
