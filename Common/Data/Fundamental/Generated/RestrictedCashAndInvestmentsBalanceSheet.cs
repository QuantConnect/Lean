...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class RestrictedCashAndInvestmentsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("RestrictedCashAndInvestments.NineMonths was retired by Morningstar in 2026; use RestrictedCashAndInvestments.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("RestrictedCashAndInvestments.NineMonths was retired by Morningstar in 2026; use RestrictedCashAndInvestments.ThreeMonths (also available: SixMonths, TwelveMonths).");
