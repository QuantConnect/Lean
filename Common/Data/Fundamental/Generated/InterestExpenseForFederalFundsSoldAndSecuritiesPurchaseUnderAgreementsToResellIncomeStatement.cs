...
namespace QuantConnect.Data.Fundamental
{
    ...
    /// </summary>
    public class InterestExpenseForFederalFundsSoldAndSecuritiesPurchaseUnderAgreementsToResellIncomeStatement
        : MultiPeriodField
    {
        /// <summary>
        /// The default period
        ...
        public double ThreeMonths =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_IncomeStatement_InterestExpenseForFederalFundsSoldAndSecuritiesPurchaseUnderAgreementsToResell_ThreeMonths
            );
        ...
        public double SixMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_IncomeStatement_InterestExpenseForFederalFundsSoldAndSecuritiesPurchaseUnderAgreementsToResell_SixMonths
            );
        ...
        public double NineMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_IncomeStatement_InterestExpenseForFederalFundsSoldAndSecuritiesPurchaseUnderAgreementsToResell_NineMonths
            );
        ...
        public double TwelveMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_IncomeStatement_InterestExpenseForFederalFundsSoldAndSecuritiesPurchaseUnderAgreementsToResell_TwelveMonths
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"FinancialStatements_IncomeStatement_InterestExpenseForFederalFundsSoldAndSecuritiesPurchaseUnderAgreementsToResell_{ConvertPeriod(period)}"
                )
            );
