...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class ServiceChargeOnDepositorAccountsIncomeStatement : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("ServiceChargeOnDepositorAccounts.OneMonth was retired by Morningstar in 2026; use ServiceChargeOnDepositorAccounts.ThreeMonths (also available: SixMonths, NineMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("ServiceChargeOnDepositorAccounts.OneMonth was retired by Morningstar in 2026; use ServiceChargeOnDepositorAccounts.ThreeMonths (also available: SixMonths, NineMonths, TwelveMonths).");
