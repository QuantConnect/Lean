...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class InterestExpenseForDepositIncomeStatement : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("InterestExpenseForDeposit.OneMonth was retired by Morningstar in 2026; use InterestExpenseForDeposit.ThreeMonths (also available: SixMonths, NineMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("InterestExpenseForDeposit.OneMonth was retired by Morningstar in 2026; use InterestExpenseForDeposit.ThreeMonths (also available: SixMonths, NineMonths, TwelveMonths).");
