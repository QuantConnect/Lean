...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CurrentAssetsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("CurrentAssets.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use CurrentAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("CurrentAssets.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use CurrentAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("CurrentAssets.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("CurrentAssets.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("CurrentAssets.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("CurrentAssets.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");
