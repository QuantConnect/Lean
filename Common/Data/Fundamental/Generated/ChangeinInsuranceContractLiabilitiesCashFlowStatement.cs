...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class ChangeinInsuranceContractLiabilitiesCashFlowStatement : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("3M")]
        [Obsolete("ChangeinInsuranceContractLiabilities was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double ThreeMonths => throw new NotSupportedException("ChangeinInsuranceContractLiabilities was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("6M")]
        [Obsolete("ChangeinInsuranceContractLiabilities was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double SixMonths => throw new NotSupportedException("ChangeinInsuranceContractLiabilities was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("9M")]
        [Obsolete("ChangeinInsuranceContractLiabilities was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double NineMonths => throw new NotSupportedException("ChangeinInsuranceContractLiabilities was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("12M")]
        [Obsolete("ChangeinInsuranceContractLiabilities was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double TwelveMonths => throw new NotSupportedException("ChangeinInsuranceContractLiabilities was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("ChangeinInsuranceContractLiabilities was retired by Morningstar in 2026 for all periods; no replacement is available.");
