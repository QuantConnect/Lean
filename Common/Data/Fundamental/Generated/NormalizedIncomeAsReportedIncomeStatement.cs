...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NormalizedIncomeAsReportedIncomeStatement : MultiPeriodField
    {
        ...
        /// </summary>
        public override bool HasValue => FundamentalService.Get<double>(TimeProvider.GetUtcNow(), SecurityIdentifier, FundamentalProperty.FinancialStatements_IncomeStatement_NormalizedIncomeAsReported_TwelveMonths) != NoValue;
