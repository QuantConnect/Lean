...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CurrentCapitalLeaseObligationBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("CurrentCapitalLeaseObligation.OneMonth was retired by Morningstar in 2026; use CurrentCapitalLeaseObligation.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("CurrentCapitalLeaseObligation.OneMonth was retired by Morningstar in 2026; use CurrentCapitalLeaseObligation.ThreeMonths (also available: SixMonths, TwelveMonths).");
