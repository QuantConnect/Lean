...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CurrentLiabilitiesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("CurrentLiabilities.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use CurrentLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("CurrentLiabilities.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use CurrentLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("CurrentLiabilities.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("CurrentLiabilities.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("CurrentLiabilities.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("CurrentLiabilities.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).");
