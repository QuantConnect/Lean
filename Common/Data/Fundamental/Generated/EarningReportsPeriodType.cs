    ...
    public class EarningReportsPeriodType : MultiPeriodField<string>
    {
        ...
        public string OneMonth =>
            FundamentalService.Get<string>(
                ...
                SecurityIdentifier,
                FundamentalProperty.EarningReports_PeriodType_OneMonth
            );
        ...
        public string TwoMonths =>
            FundamentalService.Get<string>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningReports_PeriodType_TwoMonths
            );
        ...
        public string ThreeMonths =>
            FundamentalService.Get<string>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningReports_PeriodType_ThreeMonths
            );
        ...
        public string SixMonths =>
            FundamentalService.Get<string>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningReports_PeriodType_SixMonths
            );
        ...
        public string NineMonths =>
            FundamentalService.Get<string>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningReports_PeriodType_NineMonths
            );
        ...
        public string TwelveMonths =>
            FundamentalService.Get<string>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningReports_PeriodType_TwelveMonths
            );
        ...
        public override string GetPeriodValue(string period) =>
            FundamentalService.Get<string>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"EarningReports_PeriodType_{ConvertPeriod(period)}"
                )
            );
