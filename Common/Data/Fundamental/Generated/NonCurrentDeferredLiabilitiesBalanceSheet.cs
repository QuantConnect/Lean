...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NonCurrentDeferredLiabilitiesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("NonCurrentDeferredLiabilities.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use NonCurrentDeferredLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("NonCurrentDeferredLiabilities.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use NonCurrentDeferredLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("NonCurrentDeferredLiabilities.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use NonCurrentDeferredLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("NonCurrentDeferredLiabilities.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use NonCurrentDeferredLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("NonCurrentDeferredLiabilities.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use NonCurrentDeferredLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("NonCurrentDeferredLiabilities.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use NonCurrentDeferredLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).");
