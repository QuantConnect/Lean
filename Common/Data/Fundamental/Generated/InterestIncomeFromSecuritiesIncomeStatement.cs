...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class InterestIncomeFromSecuritiesIncomeStatement : MultiPeriodField
    {
        ...
        /// </summary>
        public override bool HasValue => FundamentalService.Get<double>(TimeProvider.GetUtcNow(), SecurityIdentifier, FundamentalProperty.FinancialStatements_IncomeStatement_InterestIncomeFromSecurities_TwelveMonths) != NoValue;
