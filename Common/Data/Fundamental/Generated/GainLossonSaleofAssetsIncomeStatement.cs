...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class GainLossonSaleofAssetsIncomeStatement : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("GainLossonSaleofAssets.OneMonth was retired by Morningstar in 2026; use GainLossonSaleofAssets.ThreeMonths (also available: SixMonths, NineMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("GainLossonSaleofAssets.OneMonth was retired by Morningstar in 2026; use GainLossonSaleofAssets.ThreeMonths (also available: SixMonths, NineMonths, TwelveMonths).");
