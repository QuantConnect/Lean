...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class GainLossonSaleofAssetsIncomeStatement : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("GainLossonSaleofAssets.OneMonth was retired by Morningstar in 2026; use GainLossonSaleofAssets.SixMonths (also available: TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("GainLossonSaleofAssets.OneMonth was retired by Morningstar in 2026; use GainLossonSaleofAssets.SixMonths (also available: TwelveMonths).");

        /// <summary>
        /// Gets/sets the ThreeMonths period value for the field
        /// </summary>
        [JsonProperty("3M")]
        [Obsolete("GainLossonSaleofAssets.ThreeMonths was retired by Morningstar in 2026; use GainLossonSaleofAssets.SixMonths (also available: TwelveMonths).")]
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("GainLossonSaleofAssets.ThreeMonths was retired by Morningstar in 2026; use GainLossonSaleofAssets.SixMonths (also available: TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("GainLossonSaleofAssets.NineMonths was retired by Morningstar in 2026; use GainLossonSaleofAssets.SixMonths (also available: TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("GainLossonSaleofAssets.NineMonths was retired by Morningstar in 2026; use GainLossonSaleofAssets.SixMonths (also available: TwelveMonths).");
