...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class GainLossonSaleofAssetsIncomeStatement : MultiPeriodField
    {
        ...
        public double OneMonth => throw new NotSupportedException("GainLossonSaleofAssets was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("3M")]
        [Obsolete("GainLossonSaleofAssets was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double ThreeMonths => throw new NotSupportedException("GainLossonSaleofAssets was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("6M")]
        [Obsolete("GainLossonSaleofAssets was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double SixMonths => throw new NotSupportedException("GainLossonSaleofAssets was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("9M")]
        [Obsolete("GainLossonSaleofAssets was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double NineMonths => throw new NotSupportedException("GainLossonSaleofAssets was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("12M")]
        [Obsolete("GainLossonSaleofAssets was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double TwelveMonths => throw new NotSupportedException("GainLossonSaleofAssets was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("GainLossonSaleofAssets was retired by Morningstar in 2026 for all periods; no replacement is available.");
