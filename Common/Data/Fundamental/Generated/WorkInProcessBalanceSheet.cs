...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class WorkInProcessBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("WorkInProcess.OneMonth was retired by Morningstar in 2026; use WorkInProcess.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("WorkInProcess.OneMonth was retired by Morningstar in 2026; use WorkInProcess.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("WorkInProcess.TwoMonths was retired by Morningstar in 2026; use WorkInProcess.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("WorkInProcess.TwoMonths was retired by Morningstar in 2026; use WorkInProcess.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("WorkInProcess.NineMonths was retired by Morningstar in 2026; use WorkInProcess.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("WorkInProcess.NineMonths was retired by Morningstar in 2026; use WorkInProcess.ThreeMonths (also available: SixMonths, TwelveMonths).");
