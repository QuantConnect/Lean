...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class RetainedEarningsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("RetainedEarnings.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use RetainedEarnings.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("RetainedEarnings.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use RetainedEarnings.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("RetainedEarnings.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use RetainedEarnings.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("RetainedEarnings.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use RetainedEarnings.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("RetainedEarnings.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use RetainedEarnings.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("RetainedEarnings.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use RetainedEarnings.ThreeMonths (also available: SixMonths, TwelveMonths).");
