...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CurrentNotesPayableBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("CurrentNotesPayable.OneMonth was retired by Morningstar in 2026; use CurrentNotesPayable.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("CurrentNotesPayable.OneMonth was retired by Morningstar in 2026; use CurrentNotesPayable.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("CurrentNotesPayable.TwoMonths was retired by Morningstar in 2026; use CurrentNotesPayable.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("CurrentNotesPayable.TwoMonths was retired by Morningstar in 2026; use CurrentNotesPayable.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("CurrentNotesPayable.NineMonths was retired by Morningstar in 2026; use CurrentNotesPayable.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("CurrentNotesPayable.NineMonths was retired by Morningstar in 2026; use CurrentNotesPayable.ThreeMonths (also available: SixMonths, TwelveMonths).");
