...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class PreferredStockEquityBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("PreferredStockEquity.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use PreferredStockEquity.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("PreferredStockEquity.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use PreferredStockEquity.ThreeMonths (also available: SixMonths, TwelveMonths).");
