...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class PreferredStockEquityBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("PreferredStockEquity.OneMonth was retired by Morningstar in 2026; use PreferredStockEquity.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("PreferredStockEquity.OneMonth was retired by Morningstar in 2026; use PreferredStockEquity.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("PreferredStockEquity.TwoMonths was retired by Morningstar in 2026; use PreferredStockEquity.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("PreferredStockEquity.TwoMonths was retired by Morningstar in 2026; use PreferredStockEquity.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("PreferredStockEquity.NineMonths was retired by Morningstar in 2026; use PreferredStockEquity.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("PreferredStockEquity.NineMonths was retired by Morningstar in 2026; use PreferredStockEquity.ThreeMonths (also available: SixMonths, TwelveMonths).");
