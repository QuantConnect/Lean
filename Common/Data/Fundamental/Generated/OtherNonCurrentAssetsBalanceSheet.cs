...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class OtherNonCurrentAssetsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("OtherNonCurrentAssets.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use OtherNonCurrentAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("OtherNonCurrentAssets.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use OtherNonCurrentAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("OtherNonCurrentAssets.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherNonCurrentAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("OtherNonCurrentAssets.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherNonCurrentAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("OtherNonCurrentAssets.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherNonCurrentAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("OtherNonCurrentAssets.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherNonCurrentAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");
