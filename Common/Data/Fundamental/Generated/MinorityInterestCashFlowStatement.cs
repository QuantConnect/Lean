...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class MinorityInterestCashFlowStatement : MultiPeriodField
    {
        ...
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("MinorityInterest was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("MinorityInterest was retired by Morningstar in 2026 for all periods; no replacement is available.");
