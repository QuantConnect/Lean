...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class OtherPropertiesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("OtherProperties.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use OtherProperties.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("OtherProperties.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use OtherProperties.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("OtherProperties.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherProperties.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("OtherProperties.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherProperties.ThreeMonths (also available: SixMonths, TwelveMonths).");
