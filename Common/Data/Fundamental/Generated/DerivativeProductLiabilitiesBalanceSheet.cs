...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class DerivativeProductLiabilitiesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("DerivativeProductLiabilities.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use DerivativeProductLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("DerivativeProductLiabilities.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use DerivativeProductLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("DerivativeProductLiabilities.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use DerivativeProductLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("DerivativeProductLiabilities.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use DerivativeProductLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("DerivativeProductLiabilities.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use DerivativeProductLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("DerivativeProductLiabilities.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use DerivativeProductLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).");
