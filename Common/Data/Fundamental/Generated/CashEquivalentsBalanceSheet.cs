...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CashEquivalentsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("CashEquivalents.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use CashEquivalents.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("CashEquivalents.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use CashEquivalents.ThreeMonths (also available: SixMonths, TwelveMonths).");
