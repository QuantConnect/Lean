...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class ConvertibleLoansTotalBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("3M")]
        [Obsolete("ConvertibleLoansTotal was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("ConvertibleLoansTotal was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("ConvertibleLoansTotal was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("ConvertibleLoansTotal was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("ConvertibleLoansTotal was retired by Morningstar in 2026 for all periods; no replacement is available.");
