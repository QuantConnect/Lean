    ...
    public class DaysInInventory : MultiPeriodField
    {
        ...
        public double OneYear =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_DaysInInventory_OneYear
            );
        ...
        public double ThreeMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_DaysInInventory_ThreeMonths
            );
        ...
        public double SixMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_DaysInInventory_SixMonths
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"OperationRatios_DaysInInventory_{ConvertPeriod(period)}"
                )
            );
        ...
        /// </summary>
        public DaysInInventory(ITimeProvider timeProvider, SecurityIdentifier securityIdentifier)
