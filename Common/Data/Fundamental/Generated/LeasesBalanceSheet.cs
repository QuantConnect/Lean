...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class LeasesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("Leases.OneMonth was retired by Morningstar in 2026; use Leases.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("Leases.OneMonth was retired by Morningstar in 2026; use Leases.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("Leases.TwoMonths was retired by Morningstar in 2026; use Leases.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("Leases.TwoMonths was retired by Morningstar in 2026; use Leases.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("Leases.NineMonths was retired by Morningstar in 2026; use Leases.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("Leases.NineMonths was retired by Morningstar in 2026; use Leases.ThreeMonths (also available: SixMonths, TwelveMonths).");
