...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class InterestBearingDepositsLiabilitiesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("InterestBearingDepositsLiabilities.NineMonths was retired by Morningstar in 2026; use InterestBearingDepositsLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("InterestBearingDepositsLiabilities.NineMonths was retired by Morningstar in 2026; use InterestBearingDepositsLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).");
