    ...
    public class FinancialStatementsPeriodEndingDate : MultiPeriodField<DateTime>
    {
        ...
        public DateTime OneMonth =>
            FundamentalService.Get<DateTime>(
                ...
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_PeriodEndingDate_OneMonth
            );
        ...
        public DateTime TwoMonths =>
            FundamentalService.Get<DateTime>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_PeriodEndingDate_TwoMonths
            );
        ...
        public DateTime ThreeMonths =>
            FundamentalService.Get<DateTime>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_PeriodEndingDate_ThreeMonths
            );
        ...
        public DateTime SixMonths =>
            FundamentalService.Get<DateTime>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_PeriodEndingDate_SixMonths
            );
        ...
        public DateTime NineMonths =>
            FundamentalService.Get<DateTime>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_PeriodEndingDate_NineMonths
            );
        ...
        public DateTime TwelveMonths =>
            FundamentalService.Get<DateTime>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_PeriodEndingDate_TwelveMonths
            );
        ...
        public override DateTime GetPeriodValue(string period) =>
            FundamentalService.Get<DateTime>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"FinancialStatements_PeriodEndingDate_{ConvertPeriod(period)}"
                )
            );
