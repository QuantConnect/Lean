...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class TaxesReceivableBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("TaxesReceivable.TwoMonths was retired by Morningstar in 2026; use TaxesReceivable.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("TaxesReceivable.TwoMonths was retired by Morningstar in 2026; use TaxesReceivable.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("TaxesReceivable.NineMonths was retired by Morningstar in 2026; use TaxesReceivable.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("TaxesReceivable.NineMonths was retired by Morningstar in 2026; use TaxesReceivable.ThreeMonths (also available: SixMonths, TwelveMonths).");
