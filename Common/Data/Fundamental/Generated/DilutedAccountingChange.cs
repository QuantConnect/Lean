...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class DilutedAccountingChange : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("3M")]
        [Obsolete("DilutedAccountingChange is no longer provided by Morningstar in any period since the 2026 feed migration; no direct replacement is provided.")]
        public double ThreeMonths => throw new NotSupportedException("DilutedAccountingChange is no longer provided by Morningstar in any period since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("6M")]
        [Obsolete("DilutedAccountingChange is no longer provided by Morningstar in any period since the 2026 feed migration; no direct replacement is provided.")]
        public double SixMonths => throw new NotSupportedException("DilutedAccountingChange is no longer provided by Morningstar in any period since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("9M")]
        [Obsolete("DilutedAccountingChange is no longer provided by Morningstar in any period since the 2026 feed migration; no direct replacement is provided.")]
        public double NineMonths => throw new NotSupportedException("DilutedAccountingChange is no longer provided by Morningstar in any period since the 2026 feed migration; no direct replacement is provided.");
        ...
        public double TwelveMonths => throw new NotSupportedException("DilutedAccountingChange is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("DilutedAccountingChange is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
