...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class AdvanceFromFederalHomeLoanBanksBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("AdvanceFromFederalHomeLoanBanks.NineMonths was retired by Morningstar in 2026; use AdvanceFromFederalHomeLoanBanks.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("AdvanceFromFederalHomeLoanBanks.NineMonths was retired by Morningstar in 2026; use AdvanceFromFederalHomeLoanBanks.ThreeMonths (also available: SixMonths, TwelveMonths).");
