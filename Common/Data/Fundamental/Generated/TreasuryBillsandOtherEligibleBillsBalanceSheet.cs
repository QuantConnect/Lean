...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class TreasuryBillsandOtherEligibleBillsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("3M")]
        [Obsolete("TreasuryBillsandOtherEligibleBills was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("TreasuryBillsandOtherEligibleBills was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("TreasuryBillsandOtherEligibleBills was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("TreasuryBillsandOtherEligibleBills was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("TreasuryBillsandOtherEligibleBills was retired by Morningstar in 2026 for all periods; no replacement is available.");
