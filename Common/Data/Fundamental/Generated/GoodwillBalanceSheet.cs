...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class GoodwillBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("Goodwill.OneMonth was retired by Morningstar in 2026; use Goodwill.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("Goodwill.OneMonth was retired by Morningstar in 2026; use Goodwill.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("Goodwill.TwoMonths was retired by Morningstar in 2026; use Goodwill.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("Goodwill.TwoMonths was retired by Morningstar in 2026; use Goodwill.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("Goodwill.NineMonths was retired by Morningstar in 2026; use Goodwill.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("Goodwill.NineMonths was retired by Morningstar in 2026; use Goodwill.ThreeMonths (also available: SixMonths, TwelveMonths).");
