...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CurrentRatio : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("CurrentRatio.OneMonth was retired by Morningstar in 2026; use CurrentRatio.ThreeMonths (also available: SixMonths, OneYear).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("CurrentRatio.OneMonth was retired by Morningstar in 2026; use CurrentRatio.ThreeMonths (also available: SixMonths, OneYear).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("CurrentRatio.TwoMonths was retired by Morningstar in 2026; use CurrentRatio.ThreeMonths (also available: SixMonths, OneYear).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("CurrentRatio.TwoMonths was retired by Morningstar in 2026; use CurrentRatio.ThreeMonths (also available: SixMonths, OneYear).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("CurrentRatio.NineMonths was retired by Morningstar in 2026; use CurrentRatio.ThreeMonths (also available: SixMonths, OneYear).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("CurrentRatio.NineMonths was retired by Morningstar in 2026; use CurrentRatio.ThreeMonths (also available: SixMonths, OneYear).");
