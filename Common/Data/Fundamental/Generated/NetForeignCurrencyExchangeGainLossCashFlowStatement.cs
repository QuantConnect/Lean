...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NetForeignCurrencyExchangeGainLossCashFlowStatement : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("NetForeignCurrencyExchangeGainLoss was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double OneMonth => throw new NotSupportedException("NetForeignCurrencyExchangeGainLoss was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("3M")]
        [Obsolete("NetForeignCurrencyExchangeGainLoss was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double ThreeMonths => throw new NotSupportedException("NetForeignCurrencyExchangeGainLoss was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("6M")]
        [Obsolete("NetForeignCurrencyExchangeGainLoss was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double SixMonths => throw new NotSupportedException("NetForeignCurrencyExchangeGainLoss was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("9M")]
        [Obsolete("NetForeignCurrencyExchangeGainLoss was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double NineMonths => throw new NotSupportedException("NetForeignCurrencyExchangeGainLoss was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("12M")]
        [Obsolete("NetForeignCurrencyExchangeGainLoss was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double TwelveMonths => throw new NotSupportedException("NetForeignCurrencyExchangeGainLoss was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("NetForeignCurrencyExchangeGainLoss was retired by Morningstar in 2026 for all periods; no replacement is available.");
