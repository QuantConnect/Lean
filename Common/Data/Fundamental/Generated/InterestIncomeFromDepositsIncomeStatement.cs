...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class InterestIncomeFromDepositsIncomeStatement : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("InterestIncomeFromDeposits.OneMonth was retired by Morningstar in 2026; use InterestIncomeFromDeposits.ThreeMonths (also available: SixMonths, NineMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("InterestIncomeFromDeposits.OneMonth was retired by Morningstar in 2026; use InterestIncomeFromDeposits.ThreeMonths (also available: SixMonths, NineMonths, TwelveMonths).");
