...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class InterestIncomeFromDepositsIncomeStatement : MultiPeriodField
    {
        ...
        public double OneMonth => throw new NotSupportedException("InterestIncomeFromDeposits was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("3M")]
        [Obsolete("InterestIncomeFromDeposits was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double ThreeMonths => throw new NotSupportedException("InterestIncomeFromDeposits was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("6M")]
        [Obsolete("InterestIncomeFromDeposits was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double SixMonths => throw new NotSupportedException("InterestIncomeFromDeposits was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("9M")]
        [Obsolete("InterestIncomeFromDeposits was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double NineMonths => throw new NotSupportedException("InterestIncomeFromDeposits was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("12M")]
        [Obsolete("InterestIncomeFromDeposits was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double TwelveMonths => throw new NotSupportedException("InterestIncomeFromDeposits was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("InterestIncomeFromDeposits was retired by Morningstar in 2026 for all periods; no replacement is available.");
