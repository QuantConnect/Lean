...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class TotalTaxPayableBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("TotalTaxPayable.OneMonth was retired by Morningstar in 2026; use TotalTaxPayable.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("TotalTaxPayable.OneMonth was retired by Morningstar in 2026; use TotalTaxPayable.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("TotalTaxPayable.TwoMonths was retired by Morningstar in 2026; use TotalTaxPayable.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("TotalTaxPayable.TwoMonths was retired by Morningstar in 2026; use TotalTaxPayable.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("TotalTaxPayable.NineMonths was retired by Morningstar in 2026; use TotalTaxPayable.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("TotalTaxPayable.NineMonths was retired by Morningstar in 2026; use TotalTaxPayable.ThreeMonths (also available: SixMonths, TwelveMonths).");
