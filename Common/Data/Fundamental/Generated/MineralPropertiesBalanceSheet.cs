...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class MineralPropertiesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("MineralProperties.NineMonths was retired by Morningstar in 2026; use MineralProperties.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("MineralProperties.NineMonths was retired by Morningstar in 2026; use MineralProperties.ThreeMonths (also available: SixMonths, TwelveMonths).");
