...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class BankLoansTotalBalanceSheet : MultiPeriodField
    {
        ...
        public double ThreeMonths => throw new NotSupportedException("BankLoansTotal is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("12M")]
        [Obsolete("BankLoansTotal is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double TwelveMonths => throw new NotSupportedException("BankLoansTotal is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("BankLoansTotal is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
