...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class TradingSecuritiesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("6M")]
        [Obsolete("TradingSecurities.SixMonths was retired by Morningstar in 2026; use TradingSecurities.ThreeMonths (also available: TwelveMonths).")]
        [JsonIgnore]
        public double SixMonths => throw new NotSupportedException("TradingSecurities.SixMonths was retired by Morningstar in 2026; use TradingSecurities.ThreeMonths (also available: TwelveMonths).");
