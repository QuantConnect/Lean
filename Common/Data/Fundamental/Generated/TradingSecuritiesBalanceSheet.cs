...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class TradingSecuritiesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("3M")]
        [Obsolete("TradingSecurities was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("TradingSecurities was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("TradingSecurities was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double SixMonths => throw new NotSupportedException("TradingSecurities was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("TradingSecurities was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("TradingSecurities was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("TradingSecurities was retired by Morningstar in 2026 for all periods; no replacement is available.");
