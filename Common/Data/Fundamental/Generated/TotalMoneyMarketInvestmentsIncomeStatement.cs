...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class TotalMoneyMarketInvestmentsIncomeStatement : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("TotalMoneyMarketInvestments.OneMonth was retired by Morningstar in 2026; use TotalMoneyMarketInvestments.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("TotalMoneyMarketInvestments.OneMonth was retired by Morningstar in 2026; use TotalMoneyMarketInvestments.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("TotalMoneyMarketInvestments.NineMonths was retired by Morningstar in 2026; use TotalMoneyMarketInvestments.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("TotalMoneyMarketInvestments.NineMonths was retired by Morningstar in 2026; use TotalMoneyMarketInvestments.ThreeMonths (also available: SixMonths, TwelveMonths).");
