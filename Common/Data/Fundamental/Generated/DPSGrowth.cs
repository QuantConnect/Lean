    ...
    public class DPSGrowth : MultiPeriodField
    {
        ...
        public double OneYear =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.EarningRatios_DPSGrowth_OneYear
            );
        ...
        public double ThreeMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningRatios_DPSGrowth_ThreeMonths
            );
        ...
        public double ThreeYears =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningRatios_DPSGrowth_ThreeYears
            );
        ...
        public double FiveYears =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningRatios_DPSGrowth_FiveYears
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                Enum.Parse<FundamentalProperty>($"EarningRatios_DPSGrowth_{ConvertPeriod(period)}")
            );
        ...
        /// </summary>
        public DPSGrowth(ITimeProvider timeProvider, SecurityIdentifier securityIdentifier)
