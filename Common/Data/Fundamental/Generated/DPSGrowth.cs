...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class DPSGrowth : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1Y")]
        public double OneYear => FundamentalService.Get<double>(Time, SecurityIdentifier, "EarningRatios.DPSGrowth.OneYear");

        /// <summary>
        /// Gets/sets the ThreeMonths period value for the field
        /// </summary>
        [JsonProperty("3M")]
        public double ThreeMonths => FundamentalService.Get<double>(Time, SecurityIdentifier, "EarningRatios.DPSGrowth.ThreeMonths");

        /// <summary>
        /// Gets/sets the ThreeYears period value for the field
        /// </summary>
        [JsonProperty("3Y")]
        public double ThreeYears => FundamentalService.Get<double>(Time, SecurityIdentifier, "EarningRatios.DPSGrowth.ThreeYears");

        /// <summary>
        /// Gets/sets the FiveYears period value for the field
        /// </summary>
        [JsonProperty("5Y")]
        public double FiveYears => FundamentalService.Get<double>(Time, SecurityIdentifier, "EarningRatios.DPSGrowth.FiveYears");

        /// <summary>
        /// Returns true if the field contains a value for the default period
        /// </summary>
        public override bool HasValue => FundamentalService.Get<double>(Time, SecurityIdentifier, "EarningRatios.DPSGrowth.OneYear") != NoValue;
        ...
        public override double Value
        {
            get
            {
                var defaultValue = FundamentalService.Get<double>(Time, SecurityIdentifier, "EarningRatios.DPSGrowth.OneYear");
        ...
        public override double GetPeriodValue(string period) => FundamentalService.Get<double>(Time, SecurityIdentifier, $"EarningRatios.DPSGrowth.{ConvertPeriod(period)}");
        ...
        /// </summary>
        public DPSGrowth(DateTime time, SecurityIdentifier securityIdentifier) : base(time, securityIdentifier)
        {
        }
    }
}
