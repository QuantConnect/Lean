...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class MachineryFurnitureEquipmentBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("MachineryFurnitureEquipment.OneMonth was retired by Morningstar in 2026; use MachineryFurnitureEquipment.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("MachineryFurnitureEquipment.OneMonth was retired by Morningstar in 2026; use MachineryFurnitureEquipment.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("MachineryFurnitureEquipment.TwoMonths was retired by Morningstar in 2026; use MachineryFurnitureEquipment.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("MachineryFurnitureEquipment.TwoMonths was retired by Morningstar in 2026; use MachineryFurnitureEquipment.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("MachineryFurnitureEquipment.NineMonths was retired by Morningstar in 2026; use MachineryFurnitureEquipment.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("MachineryFurnitureEquipment.NineMonths was retired by Morningstar in 2026; use MachineryFurnitureEquipment.ThreeMonths (also available: SixMonths, TwelveMonths).");
