...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NonCurrentNoteReceivablesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("NonCurrentNoteReceivables.NineMonths was retired by Morningstar in 2026; use NonCurrentNoteReceivables.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("NonCurrentNoteReceivables.NineMonths was retired by Morningstar in 2026; use NonCurrentNoteReceivables.ThreeMonths (also available: SixMonths, TwelveMonths).");
