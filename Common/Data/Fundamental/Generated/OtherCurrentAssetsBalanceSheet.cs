...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class OtherCurrentAssetsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("OtherCurrentAssets.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use OtherCurrentAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("OtherCurrentAssets.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use OtherCurrentAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("OtherCurrentAssets.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherCurrentAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("OtherCurrentAssets.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherCurrentAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("OtherCurrentAssets.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherCurrentAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("OtherCurrentAssets.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use OtherCurrentAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");
