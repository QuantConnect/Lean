...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CashReceiptsfromSecuritiesRelatedActivitiesCashFlowStatement : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("6M")]
        [Obsolete("CashReceiptsfromSecuritiesRelatedActivities is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double SixMonths => throw new NotSupportedException("CashReceiptsfromSecuritiesRelatedActivities is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("12M")]
        [Obsolete("CashReceiptsfromSecuritiesRelatedActivities is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double TwelveMonths => throw new NotSupportedException("CashReceiptsfromSecuritiesRelatedActivities is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("CashReceiptsfromSecuritiesRelatedActivities is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
