...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class InventoriesAdjustmentsAllowancesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("InventoriesAdjustmentsAllowances.NineMonths was retired by Morningstar in 2026; use InventoriesAdjustmentsAllowances.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("InventoriesAdjustmentsAllowances.NineMonths was retired by Morningstar in 2026; use InventoriesAdjustmentsAllowances.ThreeMonths (also available: SixMonths, TwelveMonths).");
