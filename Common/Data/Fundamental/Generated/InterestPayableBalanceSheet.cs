...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class InterestPayableBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("InterestPayable.OneMonth was retired by Morningstar in 2026; use InterestPayable.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("InterestPayable.OneMonth was retired by Morningstar in 2026; use InterestPayable.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("InterestPayable.TwoMonths was retired by Morningstar in 2026; use InterestPayable.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("InterestPayable.TwoMonths was retired by Morningstar in 2026; use InterestPayable.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("InterestPayable.NineMonths was retired by Morningstar in 2026; use InterestPayable.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("InterestPayable.NineMonths was retired by Morningstar in 2026; use InterestPayable.ThreeMonths (also available: SixMonths, TwelveMonths).");
