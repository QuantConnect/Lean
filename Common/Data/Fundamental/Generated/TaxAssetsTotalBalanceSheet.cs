...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class TaxAssetsTotalBalanceSheet : MultiPeriodField
    {
        ...
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("TaxAssetsTotal was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("TaxAssetsTotal was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("TaxAssetsTotal was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("TaxAssetsTotal was retired by Morningstar in 2026 for all periods; no replacement is available.");
