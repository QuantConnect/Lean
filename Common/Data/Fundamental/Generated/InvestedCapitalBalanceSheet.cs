...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class InvestedCapitalBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("InvestedCapital.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use InvestedCapital.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("InvestedCapital.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use InvestedCapital.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("InvestedCapital.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use InvestedCapital.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("InvestedCapital.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use InvestedCapital.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("InvestedCapital.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use InvestedCapital.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("InvestedCapital.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use InvestedCapital.ThreeMonths (also available: SixMonths, TwelveMonths).");
