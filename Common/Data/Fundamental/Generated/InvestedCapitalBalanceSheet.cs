...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class InvestedCapitalBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("InvestedCapital.OneMonth was retired by Morningstar in 2026; use InvestedCapital.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("InvestedCapital.OneMonth was retired by Morningstar in 2026; use InvestedCapital.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("InvestedCapital.TwoMonths was retired by Morningstar in 2026; use InvestedCapital.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("InvestedCapital.TwoMonths was retired by Morningstar in 2026; use InvestedCapital.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("InvestedCapital.NineMonths was retired by Morningstar in 2026; use InvestedCapital.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("InvestedCapital.NineMonths was retired by Morningstar in 2026; use InvestedCapital.ThreeMonths (also available: SixMonths, TwelveMonths).");
