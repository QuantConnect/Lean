    ...
    public class PeriodAuditor : MultiPeriodField<string>
    {
        ...
        public string OneMonth =>
            FundamentalService.Get<string>(
                ...
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_PeriodAuditor_OneMonth
            );
        ...
        public string TwoMonths =>
            FundamentalService.Get<string>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_PeriodAuditor_TwoMonths
            );
        ...
        public string ThreeMonths =>
            FundamentalService.Get<string>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_PeriodAuditor_ThreeMonths
            );
        ...
        public string SixMonths =>
            FundamentalService.Get<string>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_PeriodAuditor_SixMonths
            );
        ...
        public string NineMonths =>
            FundamentalService.Get<string>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_PeriodAuditor_NineMonths
            );
        ...
        public string TwelveMonths =>
            FundamentalService.Get<string>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_PeriodAuditor_TwelveMonths
            );
        ...
        public override string GetPeriodValue(string period) =>
            FundamentalService.Get<string>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"FinancialStatements_PeriodAuditor_{ConvertPeriod(period)}"
                )
            );
        ...
        /// </summary>
        public PeriodAuditor(ITimeProvider timeProvider, SecurityIdentifier securityIdentifier)
