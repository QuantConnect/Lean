...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class OtherEquityAdjustmentsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("OtherEquityAdjustments.TwoMonths was retired by Morningstar in 2026; use OtherEquityAdjustments.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("OtherEquityAdjustments.TwoMonths was retired by Morningstar in 2026; use OtherEquityAdjustments.ThreeMonths (also available: SixMonths, TwelveMonths).");
