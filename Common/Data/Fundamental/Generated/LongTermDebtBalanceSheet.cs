...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class LongTermDebtBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("LongTermDebt.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use LongTermDebt.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("LongTermDebt.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use LongTermDebt.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("LongTermDebt.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use LongTermDebt.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("LongTermDebt.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use LongTermDebt.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("LongTermDebt.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use LongTermDebt.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("LongTermDebt.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use LongTermDebt.ThreeMonths (also available: SixMonths, TwelveMonths).");
