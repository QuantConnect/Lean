...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CurrentDebtBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("CurrentDebt.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use CurrentDebt.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("CurrentDebt.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use CurrentDebt.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("CurrentDebt.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentDebt.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("CurrentDebt.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentDebt.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("CurrentDebt.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentDebt.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("CurrentDebt.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use CurrentDebt.ThreeMonths (also available: SixMonths, TwelveMonths).");
