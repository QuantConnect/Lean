...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class TotalFinancialLeaseObligationsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        public override bool HasValue => FundamentalService.Get<double>(TimeProvider.GetUtcNow(), SecurityIdentifier, FundamentalProperty.FinancialStatements_BalanceSheet_TotalFinancialLeaseObligations_TwelveMonths) != NoValue;
