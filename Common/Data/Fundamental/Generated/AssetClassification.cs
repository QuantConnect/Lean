    ...
    public class AssetClassification : FundamentalTimeDependentProperty
    {
        ...
        public int StockType =>
            FundamentalService.Get<int>(
                ...
                _securityIdentifier,
                FundamentalProperty.AssetClassification_StockType
            );
        ...
        public int StyleBox =>
            FundamentalService.Get<int>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.AssetClassification_StyleBox
            );
        ...
        public string GrowthGrade =>
            FundamentalService.Get<string>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.AssetClassification_GrowthGrade
            );
        ...
        /// </remarks>
        [JsonProperty("3003")]
        public string FinancialHealthGrade =>
            FundamentalService.Get<string>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.AssetClassification_FinancialHealthGrade
            );
        ...
        public string ProfitabilityGrade =>
            FundamentalService.Get<string>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.AssetClassification_ProfitabilityGrade
            );
        ...
        /// </remarks>
        [JsonProperty("3005")]
        public int MorningstarIndustryCode =>
            FundamentalService.Get<int>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.AssetClassification_MorningstarIndustryCode
            );
        ...
        /// </remarks>
        [JsonProperty("3006")]
        public int MorningstarIndustryGroupCode =>
            FundamentalService.Get<int>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.AssetClassification_MorningstarIndustryGroupCode
            );
        ...
        /// </remarks>
        [JsonProperty("3007")]
        public int MorningstarSectorCode =>
            FundamentalService.Get<int>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.AssetClassification_MorningstarSectorCode
            );
        ...
        /// </remarks>
        [JsonProperty("3008")]
        public int MorningstarEconomySphereCode =>
            FundamentalService.Get<int>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.AssetClassification_MorningstarEconomySphereCode
            );
        ...
        public int SIC =>
            FundamentalService.Get<int>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.AssetClassification_SIC
            );
        ...
        public int NAICS =>
            FundamentalService.Get<int>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.AssetClassification_NAICS
            );
        ...
        public double StyleScore =>
            FundamentalService.Get<double>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.AssetClassification_StyleScore
            );
        ...
        public double SizeScore =>
            FundamentalService.Get<double>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.AssetClassification_SizeScore
            );
        ...
        public double GrowthScore =>
            FundamentalService.Get<double>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.AssetClassification_GrowthScore
            );
        ...
        public double ValueScore =>
            FundamentalService.Get<double>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.AssetClassification_ValueScore
            );
        ...
        public double NACE =>
            FundamentalService.Get<double>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.AssetClassification_NACE
            );
        ...
        public int CANNAICS =>
            FundamentalService.Get<int>(
                _timeProvider.GetUtcNow(),
                _securityIdentifier,
                FundamentalProperty.AssetClassification_CANNAICS
            );
