...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class InterestBearingDepositsAssetsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("InterestBearingDepositsAssets.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use InterestBearingDepositsAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("InterestBearingDepositsAssets.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use InterestBearingDepositsAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");
