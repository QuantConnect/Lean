...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class InterestBearingDepositsAssetsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("InterestBearingDepositsAssets.NineMonths was retired by Morningstar in 2026; use InterestBearingDepositsAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("InterestBearingDepositsAssets.NineMonths was retired by Morningstar in 2026; use InterestBearingDepositsAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");
