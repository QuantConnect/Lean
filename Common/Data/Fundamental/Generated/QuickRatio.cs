...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class QuickRatio : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("QuickRatio.OneMonth was retired by Morningstar in 2026; use QuickRatio.ThreeMonths (also available: SixMonths, OneYear).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("QuickRatio.OneMonth was retired by Morningstar in 2026; use QuickRatio.ThreeMonths (also available: SixMonths, OneYear).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("QuickRatio.TwoMonths was retired by Morningstar in 2026; use QuickRatio.ThreeMonths (also available: SixMonths, OneYear).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("QuickRatio.TwoMonths was retired by Morningstar in 2026; use QuickRatio.ThreeMonths (also available: SixMonths, OneYear).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("QuickRatio.NineMonths was retired by Morningstar in 2026; use QuickRatio.ThreeMonths (also available: SixMonths, OneYear).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("QuickRatio.NineMonths was retired by Morningstar in 2026; use QuickRatio.ThreeMonths (also available: SixMonths, OneYear).");
