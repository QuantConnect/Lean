...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class OtherPayableBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("OtherPayable.OneMonth was retired by Morningstar in 2026; use OtherPayable.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("OtherPayable.OneMonth was retired by Morningstar in 2026; use OtherPayable.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("OtherPayable.TwoMonths was retired by Morningstar in 2026; use OtherPayable.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("OtherPayable.TwoMonths was retired by Morningstar in 2026; use OtherPayable.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("OtherPayable.NineMonths was retired by Morningstar in 2026; use OtherPayable.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("OtherPayable.NineMonths was retired by Morningstar in 2026; use OtherPayable.ThreeMonths (also available: SixMonths, TwelveMonths).");
