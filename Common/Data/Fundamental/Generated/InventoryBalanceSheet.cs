...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class InventoryBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("Inventory.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use Inventory.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("Inventory.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use Inventory.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("Inventory.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use Inventory.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("Inventory.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use Inventory.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("Inventory.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use Inventory.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("Inventory.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use Inventory.ThreeMonths (also available: SixMonths, TwelveMonths).");
