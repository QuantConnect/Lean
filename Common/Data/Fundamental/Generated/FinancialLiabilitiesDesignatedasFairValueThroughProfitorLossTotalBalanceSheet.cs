...
namespace QuantConnect.Data.Fundamental
{
    ...
    /// </summary>
    public class FinancialLiabilitiesDesignatedasFairValueThroughProfitorLossTotalBalanceSheet
        : MultiPeriodField
    {
        /// <summary>
        /// The default period
        ...
        public double ThreeMonths =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_BalanceSheet_FinancialLiabilitiesDesignatedasFairValueThroughProfitorLossTotal_ThreeMonths
            );
        ...
        public double TwelveMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_BalanceSheet_FinancialLiabilitiesDesignatedasFairValueThroughProfitorLossTotal_TwelveMonths
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"FinancialStatements_BalanceSheet_FinancialLiabilitiesDesignatedasFairValueThroughProfitorLossTotal_{ConvertPeriod(period)}"
                )
            );
