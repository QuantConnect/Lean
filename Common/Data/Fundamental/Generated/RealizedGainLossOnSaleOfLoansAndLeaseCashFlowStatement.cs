...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class RealizedGainLossOnSaleOfLoansAndLeaseCashFlowStatement : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("RealizedGainLossOnSaleOfLoansAndLease.OneMonth was retired by Morningstar in 2026; use RealizedGainLossOnSaleOfLoansAndLease.ThreeMonths (also available: SixMonths, NineMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("RealizedGainLossOnSaleOfLoansAndLease.OneMonth was retired by Morningstar in 2026; use RealizedGainLossOnSaleOfLoansAndLease.ThreeMonths (also available: SixMonths, NineMonths, TwelveMonths).");
