...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class MoneyMarketInvestmentsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("MoneyMarketInvestments.NineMonths was retired by Morningstar in 2026; use MoneyMarketInvestments.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("MoneyMarketInvestments.NineMonths was retired by Morningstar in 2026; use MoneyMarketInvestments.ThreeMonths (also available: SixMonths, TwelveMonths).");
