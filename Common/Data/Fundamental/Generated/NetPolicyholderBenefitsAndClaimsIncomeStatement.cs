...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NetPolicyholderBenefitsAndClaimsIncomeStatement : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("3M")]
        [Obsolete("NetPolicyholderBenefitsAndClaims is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double ThreeMonths => throw new NotSupportedException("NetPolicyholderBenefitsAndClaims is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("6M")]
        [Obsolete("NetPolicyholderBenefitsAndClaims is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double SixMonths => throw new NotSupportedException("NetPolicyholderBenefitsAndClaims is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("9M")]
        [Obsolete("NetPolicyholderBenefitsAndClaims is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double NineMonths => throw new NotSupportedException("NetPolicyholderBenefitsAndClaims is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("12M")]
        [Obsolete("NetPolicyholderBenefitsAndClaims is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double TwelveMonths => throw new NotSupportedException("NetPolicyholderBenefitsAndClaims is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("NetPolicyholderBenefitsAndClaims is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
