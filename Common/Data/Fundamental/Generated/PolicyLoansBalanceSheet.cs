...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class PolicyLoansBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("3M")]
        [Obsolete("PolicyLoans was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("PolicyLoans was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("PolicyLoans was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("PolicyLoans was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("PolicyLoans was retired by Morningstar in 2026 for all periods; no replacement is available.");
