...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CashPaymentsforDepositsbyBanksandCustomersCashFlowStatement : MultiPeriodField
    {
        ...
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("CashPaymentsforDepositsbyBanksandCustomers was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("CashPaymentsforDepositsbyBanksandCustomers was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("CashPaymentsforDepositsbyBanksandCustomers was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("CashPaymentsforDepositsbyBanksandCustomers was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double SixMonths => throw new NotSupportedException("CashPaymentsforDepositsbyBanksandCustomers was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("CashPaymentsforDepositsbyBanksandCustomers was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("CashPaymentsforDepositsbyBanksandCustomers was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("CashPaymentsforDepositsbyBanksandCustomers was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("CashPaymentsforDepositsbyBanksandCustomers was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("CashPaymentsforDepositsbyBanksandCustomers was retired by Morningstar in 2026 for all periods; no replacement is available.");
