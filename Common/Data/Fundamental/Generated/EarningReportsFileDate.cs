    ...
    public class EarningReportsFileDate : MultiPeriodField<DateTime>
    {
        ...
        public DateTime OneMonth =>
            FundamentalService.Get<DateTime>(
                ...
                SecurityIdentifier,
                FundamentalProperty.EarningReports_FileDate_OneMonth
            );
        ...
        public DateTime TwoMonths =>
            FundamentalService.Get<DateTime>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningReports_FileDate_TwoMonths
            );
        ...
        public DateTime ThreeMonths =>
            FundamentalService.Get<DateTime>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningReports_FileDate_ThreeMonths
            );
        ...
        public DateTime SixMonths =>
            FundamentalService.Get<DateTime>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningReports_FileDate_SixMonths
            );
        ...
        public DateTime NineMonths =>
            FundamentalService.Get<DateTime>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningReports_FileDate_NineMonths
            );
        ...
        public DateTime TwelveMonths =>
            FundamentalService.Get<DateTime>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.EarningReports_FileDate_TwelveMonths
            );
        ...
        public override DateTime GetPeriodValue(string period) =>
            FundamentalService.Get<DateTime>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                Enum.Parse<FundamentalProperty>($"EarningReports_FileDate_{ConvertPeriod(period)}")
            );
