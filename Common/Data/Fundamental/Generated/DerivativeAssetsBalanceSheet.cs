...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class DerivativeAssetsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("3M")]
        [Obsolete("DerivativeAssets is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double ThreeMonths => throw new NotSupportedException("DerivativeAssets is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("6M")]
        [Obsolete("DerivativeAssets is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double SixMonths => throw new NotSupportedException("DerivativeAssets is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("12M")]
        [Obsolete("DerivativeAssets is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double TwelveMonths => throw new NotSupportedException("DerivativeAssets is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("DerivativeAssets is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
