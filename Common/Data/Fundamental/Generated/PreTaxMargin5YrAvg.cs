    ...
    public class PreTaxMargin5YrAvg : MultiPeriodField
    {
        ...
        public double FiveYears =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_PreTaxMargin5YrAvg_FiveYears
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"OperationRatios_PreTaxMargin5YrAvg_{ConvertPeriod(period)}"
                )
            );
        ...
        /// </summary>
        public PreTaxMargin5YrAvg(ITimeProvider timeProvider, SecurityIdentifier securityIdentifier)
