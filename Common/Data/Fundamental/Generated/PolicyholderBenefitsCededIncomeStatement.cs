    ...
    public class PolicyholderBenefitsCededIncomeStatement : MultiPeriodField
    {
        ...
        public double TwelveMonths =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.FinancialStatements_IncomeStatement_PolicyholderBenefitsCeded_TwelveMonths
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"FinancialStatements_IncomeStatement_PolicyholderBenefitsCeded_{ConvertPeriod(period)}"
                )
            );
