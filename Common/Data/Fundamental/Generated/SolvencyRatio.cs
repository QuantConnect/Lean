    ...
    public class SolvencyRatio : MultiPeriodField
    {
        ...
        public double OneYear =>
            FundamentalService.Get<double>(
                ...
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_SolvencyRatio_OneYear
            );
        ...
        public double ThreeMonths =>
            FundamentalService.Get<double>(
                TimeProvider.GetUtcNow(),
                SecurityIdentifier,
                FundamentalProperty.OperationRatios_SolvencyRatio_ThreeMonths
            );
        ...
        public override double GetPeriodValue(string period) =>
            FundamentalService.Get<double>(
                ...
                Enum.Parse<FundamentalProperty>(
                    $"OperationRatios_SolvencyRatio_{ConvertPeriod(period)}"
                )
            );
        ...
        /// </summary>
        public SolvencyRatio(ITimeProvider timeProvider, SecurityIdentifier securityIdentifier)
