...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class DeferredTaxAssetsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("DeferredTaxAssets.NineMonths was retired by Morningstar in 2026; use DeferredTaxAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("DeferredTaxAssets.NineMonths was retired by Morningstar in 2026; use DeferredTaxAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");
