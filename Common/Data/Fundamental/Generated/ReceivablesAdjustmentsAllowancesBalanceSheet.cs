...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class ReceivablesAdjustmentsAllowancesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("ReceivablesAdjustmentsAllowances.NineMonths was retired by Morningstar in 2026; use ReceivablesAdjustmentsAllowances.ThreeMonths (also available: TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("ReceivablesAdjustmentsAllowances.NineMonths was retired by Morningstar in 2026; use ReceivablesAdjustmentsAllowances.ThreeMonths (also available: TwelveMonths).");
