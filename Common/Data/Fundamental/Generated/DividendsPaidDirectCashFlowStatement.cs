...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class DividendsPaidDirectCashFlowStatement : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("12M")]
        [Obsolete("DividendsPaidDirect is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double TwelveMonths => throw new NotSupportedException("DividendsPaidDirect is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("DividendsPaidDirect is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
