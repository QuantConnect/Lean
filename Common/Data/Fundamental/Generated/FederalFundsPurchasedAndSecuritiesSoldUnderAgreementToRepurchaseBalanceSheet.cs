...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class FederalFundsPurchasedAndSecuritiesSoldUnderAgreementToRepurchaseBalanceSheet : MultiPeriodField
    {
        ...
        public double ThreeMonths => throw new NotSupportedException("FederalFundsPurchasedAndSecuritiesSoldUnderAgreementToRepurchase is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("6M")]
        [Obsolete("FederalFundsPurchasedAndSecuritiesSoldUnderAgreementToRepurchase is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double SixMonths => throw new NotSupportedException("FederalFundsPurchasedAndSecuritiesSoldUnderAgreementToRepurchase is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("12M")]
        [Obsolete("FederalFundsPurchasedAndSecuritiesSoldUnderAgreementToRepurchase is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double TwelveMonths => throw new NotSupportedException("FederalFundsPurchasedAndSecuritiesSoldUnderAgreementToRepurchase is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("FederalFundsPurchasedAndSecuritiesSoldUnderAgreementToRepurchase is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
