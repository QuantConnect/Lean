...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class TotalEquityGrossMinorityInterestBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("TotalEquityGrossMinorityInterest.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use TotalEquityGrossMinorityInterest.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("TotalEquityGrossMinorityInterest.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use TotalEquityGrossMinorityInterest.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("TotalEquityGrossMinorityInterest.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use TotalEquityGrossMinorityInterest.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("TotalEquityGrossMinorityInterest.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use TotalEquityGrossMinorityInterest.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("TotalEquityGrossMinorityInterest.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use TotalEquityGrossMinorityInterest.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("TotalEquityGrossMinorityInterest.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use TotalEquityGrossMinorityInterest.ThreeMonths (also available: SixMonths, TwelveMonths).");
