...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NonCurrentAccruedExpensesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("NonCurrentAccruedExpenses.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use NonCurrentAccruedExpenses.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("NonCurrentAccruedExpenses.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use NonCurrentAccruedExpenses.ThreeMonths (also available: SixMonths, TwelveMonths).");
