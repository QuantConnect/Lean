...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NonInterestBearingDepositsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("NonInterestBearingDeposits.NineMonths was retired by Morningstar in 2026; use NonInterestBearingDeposits.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("NonInterestBearingDeposits.NineMonths was retired by Morningstar in 2026; use NonInterestBearingDeposits.ThreeMonths (also available: SixMonths, TwelveMonths).");
