...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class DebtToAssets : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("DebtToAssets.OneMonth was retired by Morningstar in 2026; use DebtToAssets.ThreeMonths (also available: SixMonths, OneYear).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("DebtToAssets.OneMonth was retired by Morningstar in 2026; use DebtToAssets.ThreeMonths (also available: SixMonths, OneYear).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("DebtToAssets.TwoMonths was retired by Morningstar in 2026; use DebtToAssets.ThreeMonths (also available: SixMonths, OneYear).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("DebtToAssets.TwoMonths was retired by Morningstar in 2026; use DebtToAssets.ThreeMonths (also available: SixMonths, OneYear).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("DebtToAssets.NineMonths was retired by Morningstar in 2026; use DebtToAssets.ThreeMonths (also available: SixMonths, OneYear).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("DebtToAssets.NineMonths was retired by Morningstar in 2026; use DebtToAssets.ThreeMonths (also available: SixMonths, OneYear).");
