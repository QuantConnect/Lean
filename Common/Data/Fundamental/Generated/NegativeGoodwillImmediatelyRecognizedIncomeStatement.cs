...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NegativeGoodwillImmediatelyRecognizedIncomeStatement : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("3M")]
        [Obsolete("NegativeGoodwillImmediatelyRecognized is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double ThreeMonths => throw new NotSupportedException("NegativeGoodwillImmediatelyRecognized is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("6M")]
        [Obsolete("NegativeGoodwillImmediatelyRecognized is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double SixMonths => throw new NotSupportedException("NegativeGoodwillImmediatelyRecognized is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        [JsonProperty("12M")]
        [Obsolete("NegativeGoodwillImmediatelyRecognized is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.")]
        public double TwelveMonths => throw new NotSupportedException("NegativeGoodwillImmediatelyRecognized is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("NegativeGoodwillImmediatelyRecognized is no longer provided by Morningstar since the 2026 feed migration; no direct replacement is provided.");
