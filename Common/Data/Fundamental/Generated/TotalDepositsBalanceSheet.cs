...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class TotalDepositsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("TotalDeposits.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use TotalDeposits.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("TotalDeposits.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use TotalDeposits.ThreeMonths (also available: SixMonths, TwelveMonths).");
