...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CashAndCashEquivalentsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("CashAndCashEquivalents.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use CashAndCashEquivalents.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double OneMonth => throw new NotSupportedException("CashAndCashEquivalents.OneMonth is no longer provided by Morningstar since the 2026 feed migration; use CashAndCashEquivalents.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("CashAndCashEquivalents.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use CashAndCashEquivalents.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double TwoMonths => throw new NotSupportedException("CashAndCashEquivalents.TwoMonths is no longer provided by Morningstar since the 2026 feed migration; use CashAndCashEquivalents.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("CashAndCashEquivalents.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use CashAndCashEquivalents.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        public double NineMonths => throw new NotSupportedException("CashAndCashEquivalents.NineMonths is no longer provided by Morningstar since the 2026 feed migration; use CashAndCashEquivalents.ThreeMonths (also available: SixMonths, TwelveMonths).");
