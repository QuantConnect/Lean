...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class NonCurrentDeferredTaxesLiabilitiesBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("NonCurrentDeferredTaxesLiabilities.OneMonth was retired by Morningstar in 2026; use NonCurrentDeferredTaxesLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("NonCurrentDeferredTaxesLiabilities.OneMonth was retired by Morningstar in 2026; use NonCurrentDeferredTaxesLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("NonCurrentDeferredTaxesLiabilities.TwoMonths was retired by Morningstar in 2026; use NonCurrentDeferredTaxesLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("NonCurrentDeferredTaxesLiabilities.TwoMonths was retired by Morningstar in 2026; use NonCurrentDeferredTaxesLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("NonCurrentDeferredTaxesLiabilities.NineMonths was retired by Morningstar in 2026; use NonCurrentDeferredTaxesLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("NonCurrentDeferredTaxesLiabilities.NineMonths was retired by Morningstar in 2026; use NonCurrentDeferredTaxesLiabilities.ThreeMonths (also available: SixMonths, TwelveMonths).");
