...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class GeneralPartnershipCapitalBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("6M")]
        [Obsolete("GeneralPartnershipCapital.SixMonths was retired by Morningstar in 2026; use GeneralPartnershipCapital.ThreeMonths (also available: TwelveMonths).")]
        [JsonIgnore]
        public double SixMonths => throw new NotSupportedException("GeneralPartnershipCapital.SixMonths was retired by Morningstar in 2026; use GeneralPartnershipCapital.ThreeMonths (also available: TwelveMonths).");
