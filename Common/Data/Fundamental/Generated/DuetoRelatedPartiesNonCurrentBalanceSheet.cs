...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class DuetoRelatedPartiesNonCurrentBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("3M")]
        [Obsolete("DuetoRelatedPartiesNonCurrent was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double ThreeMonths => throw new NotSupportedException("DuetoRelatedPartiesNonCurrent was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [Obsolete("DuetoRelatedPartiesNonCurrent was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        [JsonIgnore]
        public double TwelveMonths => throw new NotSupportedException("DuetoRelatedPartiesNonCurrent was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("DuetoRelatedPartiesNonCurrent was retired by Morningstar in 2026 for all periods; no replacement is available.");
