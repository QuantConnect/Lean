...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class CurrentDeferredAssetsBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("CurrentDeferredAssets.OneMonth was retired by Morningstar in 2026; use CurrentDeferredAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("CurrentDeferredAssets.OneMonth was retired by Morningstar in 2026; use CurrentDeferredAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");

        /// <summary>
        /// Gets/sets the TwoMonths period value for the field
        /// </summary>
        [JsonProperty("2M")]
        [Obsolete("CurrentDeferredAssets.TwoMonths was retired by Morningstar in 2026; use CurrentDeferredAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double TwoMonths => throw new NotSupportedException("CurrentDeferredAssets.TwoMonths was retired by Morningstar in 2026; use CurrentDeferredAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("CurrentDeferredAssets.NineMonths was retired by Morningstar in 2026; use CurrentDeferredAssets.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("CurrentDeferredAssets.NineMonths was retired by Morningstar in 2026; use CurrentDeferredAssets.ThreeMonths (also available: SixMonths, TwelveMonths).");
