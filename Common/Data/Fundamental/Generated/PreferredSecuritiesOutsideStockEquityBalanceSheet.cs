...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class PreferredSecuritiesOutsideStockEquityBalanceSheet : MultiPeriodField
    {
        ...
        /// </summary>
        [JsonProperty("1M")]
        [Obsolete("PreferredSecuritiesOutsideStockEquity.OneMonth was retired by Morningstar in 2026; use PreferredSecuritiesOutsideStockEquity.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double OneMonth => throw new NotSupportedException("PreferredSecuritiesOutsideStockEquity.OneMonth was retired by Morningstar in 2026; use PreferredSecuritiesOutsideStockEquity.ThreeMonths (also available: SixMonths, TwelveMonths).");
        ...
        /// </summary>
        [JsonProperty("9M")]
        [Obsolete("PreferredSecuritiesOutsideStockEquity.NineMonths was retired by Morningstar in 2026; use PreferredSecuritiesOutsideStockEquity.ThreeMonths (also available: SixMonths, TwelveMonths).")]
        [JsonIgnore]
        public double NineMonths => throw new NotSupportedException("PreferredSecuritiesOutsideStockEquity.NineMonths was retired by Morningstar in 2026; use PreferredSecuritiesOutsideStockEquity.ThreeMonths (also available: SixMonths, TwelveMonths).");
