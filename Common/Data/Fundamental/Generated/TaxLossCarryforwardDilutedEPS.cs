...
namespace QuantConnect.Data.Fundamental
{
    ...
    public class TaxLossCarryforwardDilutedEPS : MultiPeriodField
    {
        ...
        public double ThreeMonths => throw new NotSupportedException("TaxLossCarryforwardDilutedEPS was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("6M")]
        [Obsolete("TaxLossCarryforwardDilutedEPS was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double SixMonths => throw new NotSupportedException("TaxLossCarryforwardDilutedEPS was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("9M")]
        [Obsolete("TaxLossCarryforwardDilutedEPS was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double NineMonths => throw new NotSupportedException("TaxLossCarryforwardDilutedEPS was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        [JsonProperty("12M")]
        [Obsolete("TaxLossCarryforwardDilutedEPS was retired by Morningstar in 2026 for all periods; no replacement is available.")]
        public double TwelveMonths => throw new NotSupportedException("TaxLossCarryforwardDilutedEPS was retired by Morningstar in 2026 for all periods; no replacement is available.");
        ...
        /// </summary>
        public override double Value => throw new NotSupportedException("TaxLossCarryforwardDilutedEPS was retired by Morningstar in 2026 for all periods; no replacement is available.");
