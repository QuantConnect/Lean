...
namespace QuantConnect.Data.Auxiliary
{
    ...
    public static class MapFileZipHelper
    {
        ...
        /// </summary>
        public static string GetMapFileZipFileName(
            string market,
            DateTime date,
        ...
        /// </summary>
        public static IEnumerable<MapFile> ReadMapFileZip(
            Stream file,
            string market,
            SecurityType securityType
        )
        ...
        /// </summary>
        private static MapFile SafeRead(
            string filename,
        ...
        )
        {
            ...
            try
            {
                return new MapFile(
                    permtick,
                    contents.Select(s => MapFileRow.Parse(s, market, securityType))
                );
            }
            catch
            {
