...
namespace QuantConnect.Data
{
    ...
    public abstract class BaseData : IBaseData
    {
        ...
        /// </summary>
        protected static readonly List<Resolution> AllResolutions = Enum.GetValues(
                typeof(Resolution)
            )
            .Cast<Resolution>()
            .ToList();
        ...
        /// </summary>
        protected static readonly List<Resolution> DailyResolution = new List<Resolution>
        {
            Resolution.Daily
        };
        ...
        /// </summary>
        protected static readonly List<Resolution> MinuteResolution = new List<Resolution>
        {
            Resolution.Minute
        };
        ...
        /// </summary>
        protected static readonly List<Resolution> HighResolution = new List<Resolution>
        {
            Resolution.Minute,
            Resolution.Second,
            Resolution.Tick
        ...
        /// </summary>
        protected static readonly List<Resolution> OptionResolutions = new List<Resolution>
        {
            Resolution.Daily,
            Resolution.Hour,
            Resolution.Minute
        ...
        public virtual BaseData Reader(
...
#pragma warning restore 618
        ...
        public virtual SubscriptionDataSource GetSource(
            SubscriptionDataConfig config,
            DateTime date,
            bool isLiveMode
        )
