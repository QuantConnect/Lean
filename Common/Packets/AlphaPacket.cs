...
namespace QuantConnect.Packets
{
    ...
    /// </summary>
    public class AlphaPacket : Packet
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AlphaPacket"/> class
        /// </summary>
        public AlphaPacket()
            : base(PacketType.Alpha)
        {
        }
        ...
        public AlphaPacket(string algorithmId, List<Alpha> alphas)
            : base(PacketType.Alpha)
        {
