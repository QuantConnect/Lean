...
namespace QuantConnect.Packets
{
    ...
    public class AlphaResultPacket : Packet
    {
        ...
        public AlphaResultPacket(string algorithmId, int userId, List<Insight> insights = null, List<OrderEvent> orderEvents = null, List<Order> orders = null, PortfolioState portfolio = null)
            : base(PacketType.AlphaResult)
        {
            UserId = userId;
