...
namespace QuantConnect.Interfaces
{
    ...
    public interface IShortableProvider
    {
        ...
        /// <returns>All shortable Symbols including the quantity shortable at the given time. Null if all Symbols are shortable without restrictions.</returns>
        ...
        /// <param name="localTime">Local time of the algorithm</param>
        /// <returns>The quantity shortable for the given Symbol. Null if the Symbol is shortable without restrictions.</returns>
