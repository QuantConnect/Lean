...
namespace QuantConnect.Interfaces
{
    ...
    public interface IHistoryProvider
    {
        ...
        void Initialize(AlgorithmNodePacket job, IMapFileProvider mapFileProvider, IFactorFileProvider factorFileProvider, IDataFileProvider dataFileProvider, Action<int> statusUpdate, IDataCacheProvider dataCacheProvider);
