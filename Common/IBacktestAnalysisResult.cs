...
{
    /// <summary>
    /// Marker interface for context objects attached to a <see cref="IBacktestAnalysisResult"/>.
    /// </summary>
    ...
    /// </summary>
    public interface IBacktestAnalysisResult
    {
        /// <summary>
        ...
        /// <summary>
        /// The diagnostic context carrying sample data about the detected issue.
        /// </summary>
        IBacktestAnalysisContext Context { get; set; }

        /// <summary>
        /// Human-readable suggestions for resolving the detected issue.
        /// </summary>
        IReadOnlyList<string> PotentialSolutions { get; set; }
    }
}
