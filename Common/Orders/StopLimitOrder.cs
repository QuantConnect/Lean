...
namespace QuantConnect.Orders
{
    ...
    public class StopLimitOrder : Order
    {
        ...
        public StopLimitOrder(Symbol symbol, decimal quantity, decimal stopPrice, decimal limitPrice, DateTime time, string tag = "", IOrderProperties properties = null, OrderUserProperties userProperties = null)
