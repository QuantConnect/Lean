...
namespace QuantConnect.Orders
{
    ...
    {
        /// <summary>
        /// Determines if the specifies status is in a closed state.
        /// </summary>
        ...
        /// <summary>
        /// Determines if the specifies status is in an open state.
        /// </summary>
        /// <param name="status">The status to check</param>
        ...
        public static bool IsLimitOrder(this Order order)
        {
            return order is LimitOrder || order is StopLimitOrder;
        }
        ...
        public static bool IsStopOrder(this Order order)
        {
            return order is StopMarketOrder || order is StopLimitOrder;
        }
    }
}
