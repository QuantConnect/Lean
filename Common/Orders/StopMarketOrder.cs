...
namespace QuantConnect.Orders
{
    ...
    public class StopMarketOrder : Order
    {
        ...
        public StopMarketOrder(Symbol symbol, decimal quantity, decimal stopPrice, DateTime time, string tag = "", IOrderProperties properties = null, OrderUserProperties userProperties = null)
