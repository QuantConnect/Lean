...
namespace QuantConnect.Orders
{
    ...
    public class OptionExerciseOrder : Order
    {
        ...
        public OptionExerciseOrder(Symbol symbol, decimal quantity, DateTime time, string tag = "", IOrderProperties properties = null, OrderUserProperties userProperties = null)
