...
namespace QuantConnect.Orders
{
    public class BracketOrder : Order
    {
        ...
        public BracketOrder(Symbol symbol, decimal quantity, decimal entryPrice, decimal stopPrice, decimal limitPrice, decimal trailingStopLoss, DateTime time, string tag = "", IOrderProperties properties = null)
        ...
        {
            get { return OrderType.Bracket; }
        }

        public override Order Clone()
        {
            var order = new BracketOrder { EntryPrice = EntryPrice, StopPrice = StopPrice, LimitPrice = LimitPrice };
            CopyTo(order);
            return order;
        }
