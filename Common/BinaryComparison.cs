...
namespace QuantConnect
{
    ...
    public class BinaryComparison
    {
        ...
        /// </summary>
        public static readonly BinaryComparison NotEqual = new BinaryComparison(
        ...
        /// </summary>
        public static readonly BinaryComparison LessThan = new BinaryComparison(
        ...
        /// </summary>
        public static readonly BinaryComparison GreaterThan = new BinaryComparison(
        ...
        /// </summary>
        public static readonly BinaryComparison LessThanOrEqual = new BinaryComparison(
        ...
        /// </summary>
        public static readonly BinaryComparison GreaterThanOrEqual = new BinaryComparison(
        ...
        /// </summary>
        public bool Evaluate<T>(T left, T right) => OfType<T>.GetFunc(Type)(left, right);

        /// <summary>
        /// Gets a function capable of performing this <see cref="BinaryComparison"/>
        /// </summary>
        public Func<T, T, bool> GetEvaluator<T>() => OfType<T>.GetFunc(Type);

        /// <summary>
        /// Gets an expression representing this <see cref="BinaryComparison"/>
        /// </summary>
        public Expression<Func<T, T, bool>> GetExpression<T>() => OfType<T>.GetExpression(Type);
        ...
        {
            private static readonly Expression<Func<T, T, bool>> EqualExpr =
                MakeBinaryComparisonLambdaOrNull(ExpressionType.Equal);
            private static readonly Expression<Func<T, T, bool>> NotEqualExpr =
                MakeBinaryComparisonLambdaOrNull(ExpressionType.NotEqual);
            private static readonly Expression<Func<T, T, bool>> LessThanExpr =
                MakeBinaryComparisonLambdaOrNull(ExpressionType.LessThan);
            private static readonly Expression<Func<T, T, bool>> LessThanOrEqualExpr =
                MakeBinaryComparisonLambdaOrNull(ExpressionType.LessThanOrEqual);
            private static readonly Expression<Func<T, T, bool>> GreaterThanExpr =
                MakeBinaryComparisonLambdaOrNull(ExpressionType.GreaterThan);
            private static readonly Expression<Func<T, T, bool>> GreaterThanOrEqualExpr =
                MakeBinaryComparisonLambdaOrNull(ExpressionType.GreaterThanOrEqual);
            ...
            private static readonly Func<T, T, bool> GreaterThanOrEqualFunc =
                GreaterThanOrEqualExpr?.Compile();
            ...
            private static Expression<Func<T, T, bool>> MakeBinaryComparisonLambdaOrNull(
                ExpressionType type
            )
            {
                try
