...
namespace QuantConnect.ToolBox.AlgoSeekOptionsConverter
{
    ...
    /// </summary>
    public class AlgoSeekOptionsProcessorOld
    {
        ...
        public AlgoSeekOptionsProcessorOld(Symbol symbol, DateTime date, TickType tickType, Resolution resolution, string dataDirectory)
        {
            _symbol = Safe(symbol);
            _tickType = tickType;
            _referenceDate = date;
