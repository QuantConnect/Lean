...
namespace QuantConnect.Algorithm.Framework.Execution
{
    ...
    public class StandardDeviationExecutionModel : ExecutionModel
    {
        ...
        protected virtual bool PriceIsFavorable(SymbolData data, decimal unorderedQuantity)
        {
            ...
            if (PythonInstance.TryExecuteMethod(nameof(PriceIsFavorable), out bool result, data, unorderedQuantity))
            {
                return result;
            }
        ...
        {
            // Check if this method was overridden in Python
            if (PythonInstance.TryExecuteMethod(nameof(IsSafeToRemove), out bool result, algorithm, symbol))
            {
                return result;
            }
