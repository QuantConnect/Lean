                ...
                )
                {
                    ...
                    var atmContract = chain
                        ...
                        .Where(contract =>
                            ...
                            && chain.Underlying.Price > contract.Strike - 10
                        )
                        .OrderBy(x => x.Strike)
                        .First();
                    ...
                    {
                        Leg.Create(atmContract.Symbol, -1),
                        Leg.Create(atmContract.Symbol.Underlying, 100)
                    };
        ...
        public override void OnOrderEvent(OrderEvent orderEvent)
        {
            ...
            if (orderEvent.Status.IsFill() && (Time - _submittionTime) < TimeSpan.FromMinutes(10))
            {
                ...
                throw new RegressionTestException(
                    $"Unexpected fill time {Time} submittion time {_submittionTime}"
                );
            }
        }
