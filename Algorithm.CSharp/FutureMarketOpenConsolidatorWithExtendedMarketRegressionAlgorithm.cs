...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class FutureMarketOpenConsolidatorWithExtendedMarketRegressionAlgorithm
        : FutureMarketOpenConsolidatorRegressionAlgorithm
    {
        protected override bool ExtendedMarketHours => true;
        protected override List<DateTime> ExpectedOpens =>
            new List<DateTime>()
            {
        ...
        protected override List<DateTime> ExpectedCloses =>
            new List<DateTime>()
            {
