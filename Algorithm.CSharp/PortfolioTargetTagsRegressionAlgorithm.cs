...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class PortfolioTargetTagsRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public override void OnEndOfAlgorithm()
        {
            ...
            {
                throw new TestException("The portfolio targets tag were not checked");
            }
        }
        ...
        private class CustomExecutionModel : ImmediateExecutionModel
        {
            ...
            public override void Execute(QCAlgorithm algorithm, IPortfolioTarget[] targets)
            {
                ...
                foreach (var target in targets)
                {
                    ...
                    {
                        throw new TestException($"Unexpected portfolio target tag: {target.Tag} - Expected: {expectedTag}");
                    }
                }
