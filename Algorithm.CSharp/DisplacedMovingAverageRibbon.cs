...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class DisplacedMovingAverageRibbon : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Estimated Monthly Alpha Value", "$1140059.8124"},
            {"Total Accumulated Estimated Alpha Value", "$83270285.3831"},
            {"Mean Population Estimated Insight Value", "$13878380.8972"},
            {"Mean Population Direction", "100%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "100%"},
            {"Rolling Averaged Population Magnitude", "0%"},
            {"OrderListHash", "717689249"}
        };
    }
}
