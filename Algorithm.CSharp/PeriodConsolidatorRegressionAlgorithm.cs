...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class PeriodConsolidatorRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public override void OnEndOfAlgorithm()
        {
            ...
            {
                throw new TestException($"Unexpected consolidated data count. Period: {_periodConsolidation.Count} Count: {_countConsolidation.Count}");
            }
            ...
            while (_countConsolidation.TryDequeue(out var countData))
            {
                ...
                {
                    throw new TestException($"Unexpected consolidated data. Period: '{periodData}' != Count: '{countData}'");
                }
            }
