...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class UniverseUnchangedRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Information Ratio", "0.899"},
            {"Tracking Error", "0.173"},
            {"Treynor Ratio", "0.756"},
            {"Total Fees", "$14.03"},
            {"Estimated Strategy Capacity", "$85000000.00"},
            ...
            {"Estimated Monthly Alpha Value", "$-1105069"},
            {"Total Accumulated Estimated Alpha Value", "$-521838.1"},
            {"Mean Population Estimated Insight Value", "$-26091.91"},
