...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class CoarseFundamentalTop3Algorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Net Profit", "-1.516%"},
            {"Sharpe Ratio", "-2.433"},
            {"Probabilistic Sharpe Ratio", "23.268%"},
            {"Loss Rate", "50%"},
            {"Win Rate", "50%"},
            ...
            {"Information Ratio", "-1.416"},
            {"Tracking Error", "0.126"},
            {"Treynor Ratio", "-0.702"},
            {"Total Fees", "$11.63"},
            {"Fitness Score", "0.013"},
            {"Kelly Criterion Estimate", "-7.009"},
            {"Kelly Criterion Probability Value", "0.606"},
            {"Sortino Ratio", "-5.053"},
            {"Return Over Maximum Drawdown", "-11.692"},
            ...
            {"Estimated Monthly Alpha Value", "$503826.5055"},
            {"Total Accumulated Estimated Alpha Value", "$254712.2889"},
            {"Mean Population Estimated Insight Value", "$36387.4698"},
            {"Mean Population Direction", "16.6667%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "1.941%"},
            {"Rolling Averaged Population Magnitude", "0%"},
            {"OrderListHash", "-1080765789"}
        };
    }
}
