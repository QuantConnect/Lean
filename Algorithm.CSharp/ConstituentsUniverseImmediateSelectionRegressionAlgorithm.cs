    ...
    public class ConstituentsUniverseImmediateSelectionRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public override void OnSecuritiesChanged(SecurityChanges changes)
        {
            if (!_securitiesChanged)
            {
                ...
                if (Time != StartDate)
                {
                    throw new TestException($"Universe selection should have been triggered right away on {StartDate} " +
                ...
                {
                    throw new TestException($"Expected {_expectedConstituents.Count} stocks to be added to the algorithm, " +
                ...
                {
                    throw new TestException("Not all constituents were added to the algorithm");
                }
