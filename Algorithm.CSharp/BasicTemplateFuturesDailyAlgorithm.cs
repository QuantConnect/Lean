...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class BasicTemplateFuturesDailyAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        /// </summary>
        public virtual long DataPoints => 13257;
        ...
        public virtual Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.09%"},
            {"Average Loss", "-0.01%"},
            {"Compounding Annual Return", "-0.515%"},
            {"Drawdown", "0.500%"},
            {"Expectancy", "-0.839"},
            {"Net Profit", "-0.519%"},
            {"Sharpe Ratio", "-1.872"},
            ...
            {"Treynor Ratio", "3.026"},
            {"Total Fees", "$170.20"},
            {"Estimated Strategy Capacity", "$82000.00"},
            ...
            {"OrderListHash", "d3973f082f4b6d539228c1286824df89"}
        };
    }
}
