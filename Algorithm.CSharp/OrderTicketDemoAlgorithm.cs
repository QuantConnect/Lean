...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class OrderTicketDemoAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "-0.01%"},
            {"Compounding Annual Return", "92.042%"},
            {"Drawdown", "0.100%"},
            {"Expectancy", "-1"},
            {"Net Profit", "0.838%"},
            {"Sharpe Ratio", "12.963"},
            {"Probabilistic Sharpe Ratio", "99.094%"},
            {"Loss Rate", "100%"},
            {"Win Rate", "0%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "0.249"},
            ...
            {"Sortino Ratio", "151.345"},
            {"Return Over Maximum Drawdown", "1186.143"},
            ...
            {"OrderListHash", "e0ce1c9d6b49328a99c19ed5f1b9bc17"}
        };
    }
}
