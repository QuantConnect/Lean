...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class OrderTicketDemoAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "-0.01%"},
            {"Compounding Annual Return", "79.956%"},
            {"Drawdown", "0.100%"},
            {"Expectancy", "-1"},
            {"Net Profit", "0.754%"},
            {"Sharpe Ratio", "12.736"},
            {"Probabilistic Sharpe Ratio", "99.180%"},
            {"Loss Rate", "100%"},
            {"Win Rate", "0%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "0.219"},
            ...
            {"Sortino Ratio", "160.254"},
            {"Return Over Maximum Drawdown", "1139.48"},
            {"Portfolio Turnover", "0.087"},
