...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class HSIFutureHourRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public virtual Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Sharpe Ratio", "-0.945"},
            {"Sortino Ratio", "-0.765"},
            {"Probabilistic Sharpe Ratio", "1.002%"},
            {"Loss Rate", "68%"},
            {"Win Rate", "32%"},
            {"Profit-Loss Ratio", "0.73"},
            {"Alpha", "0"},
            {"Beta", "0"},
            {"Annual Standard Deviation", "1.064"},
            {"Annual Variance", "1.133"},
            {"Information Ratio", "-0.938"},
            {"Tracking Error", "1.064"},
            {"Treynor Ratio", "0"},
            {"Total Fees", "$1520.00"},
            {"Estimated Strategy Capacity", "$3400000.00"},
            {"Lowest Capacity Asset", "HSI VL6DN7UV65S9"},
            {"Portfolio Turnover", "4964.94%"},
            {"Drawdown Recovery", "1"},
            {"OrderListHash", "ff999d1db7061c5f63de9147014b953c"}
        };
    }
}
