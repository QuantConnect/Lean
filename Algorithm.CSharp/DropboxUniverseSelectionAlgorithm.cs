...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class DropboxUniverseSelectionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.08%"},
            {"Average Loss", "-0.08%"},
            {"Compounding Annual Return", "15.639%"},
            {"Drawdown", "10.600%"},
            {"Expectancy", "0.078"},
            {"Net Profit", "15.639%"},
            {"Sharpe Ratio", "1.126"},
            {"Probabilistic Sharpe Ratio", "52.370%"},
            {"Loss Rate", "45%"},
            {"Win Rate", "55%"},
            ...
            {"Sortino Ratio", "1.323"},
            {"Return Over Maximum Drawdown", "1.48"},
            {"Portfolio Turnover", "1.279"},
            ...
            {"OrderListHash", "33eb7f76c97fb4fb8ccea093b126447a"}
        };
    }
}
