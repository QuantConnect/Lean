...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class DropboxUniverseSelectionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Total Fees", "$6806.57"},
            {"Fitness Score", "0.694"},
            {"Kelly Criterion Estimate", "5.364"},
            {"Kelly Criterion Probability Value", "0"},
            {"Sortino Ratio", "1.261"},
            {"Return Over Maximum Drawdown", "1.404"},
            {"Portfolio Turnover", "1.296"},
            {"Total Insights Generated", "5059"},
            {"Total Insights Closed", "5046"},
            {"Total Insights Analysis Completed", "5046"},
            {"Long Insight Count", "2536"},
            {"Short Insight Count", "0"},
            {"Long/Short Ratio", "100%"},
            {"Estimated Monthly Alpha Value", "$5122313.3159"},
            {"Total Accumulated Estimated Alpha Value", "$62349935.9735"},
            {"Mean Population Estimated Insight Value", "$12356.3092"},
            {"Mean Population Direction", "53.6688%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "44.8811%"},
            {"Rolling Averaged Population Magnitude", "0%"},
            {"OrderListHash", "1500160221"}
        };
    }
}
