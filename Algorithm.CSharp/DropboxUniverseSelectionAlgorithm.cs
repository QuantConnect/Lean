...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class DropboxUniverseSelectionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.08%"},
            {"Average Loss", "-0.08%"},
            {"Compounding Annual Return", "16.035%"},
            {"Drawdown", "10.600%"},
            {"Expectancy", "0.079"},
            {"Net Profit", "16.035%"},
            {"Sharpe Ratio", "1.148"},
            {"Probabilistic Sharpe Ratio", "53.185%"},
            {"Loss Rate", "45%"},
            {"Win Rate", "55%"},
            ...
            {"Sortino Ratio", "1.352"},
            {"Return Over Maximum Drawdown", "1.518"},
            {"Portfolio Turnover", "1.298"},
            ...
            {"OrderListHash", "308f1e2c29ccdcdcc731f9bde4cc7f52"}
        };
    }
}
