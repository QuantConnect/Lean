...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class OptionStrategyFilteringUniversePutCalendarSpreadRegressionAlgorithm : OptionStrategyFilteringUniverseBaseAlgorithm
    {
        ...
        {
            _func = u => u.IncludeWeeklys().Strikes(-10, +10).Expiration(0, 180).PutCalendarSpread(0, 30, 50);
            _expectedCount = 2;
        ...
        protected override void TestFiltering(OptionChain chain)
        {
            ...
            var strategy = OptionStrategies.PutCalendarSpread(_optionSymbol, strike, nearExpiry, farExpiry);
            Buy(strategy, 1);
        }
        ...
        /// </summary>
        public override long DataPoints => 461383;
