...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class ManuallySetMarketHoursAndSymbolPropertiesDatabaseEntriesAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        public override void Initialize()
        {
            ...
            {
                throw new TestException("Expected the SPY CFD market hours to be the same as the underlying equity market hours.");
            }

            if (!ReferenceEquals(spyCfd.SymbolProperties, equitySymbolProperties))
            {
                throw new TestException("Expected the SPY CFD symbol properties to be the same as the underlying equity symbol properties.");
            }
            ...
            {
                throw new TestException("Expected the AUDUSD CFD market hours to be the same as the underlying forex market hours.");
            }

            if (!ReferenceEquals(audUsdCfd.SymbolProperties, audUsdForexSymbolProperties))
            {
                throw new TestException("Expected the AUDUSD CFD symbol properties to be the same as the underlying forex symbol properties.");
            }
        }
