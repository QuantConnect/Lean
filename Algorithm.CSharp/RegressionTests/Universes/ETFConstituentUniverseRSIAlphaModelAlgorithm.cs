...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class ETFConstituentUniverseRSIAlphaModelAlgorithm
        : QCAlgorithm,
            IRegressionAlgorithmDefinition
    {
        ...
        {
            private Dictionary<Symbol, SymbolData> _rsiSymbolData =
            ...
            public override IEnumerable<Insight> Update(QCAlgorithm algorithm, Slice data)
            {
                ...
                var algoConstituents = data
                    .Bars.Keys.Where(x =>
                        algorithm.Securities[x].Cache.HasData(typeof(ETFConstituentUniverse))
                    )
                ...
                var constituents = algoConstituents.ToDictionary(x => x.Symbol, x => x);
                ...
                foreach (var bar in data.Bars.Values)
                {
                    ...
                    if (!_rsiSymbolData.ContainsKey(bar.Symbol))
                    {
                        ...
                        _rsiSymbolData[bar.Symbol] = new SymbolData(
                            bar.Symbol,
                            algorithm,
                            constituent,
                            7
                ...
                foreach (var kvp in _rsiSymbolData)
                {
                    ...
                    var direction =
                        averageLoss > averageGain ? InsightDirection.Down : InsightDirection.Up;
                    ...
                    yield return Insight.Price(
                        ...
                        TimeSpan.FromDays(1),
                        direction,
                        (double)(direction == InsightDirection.Down ? averageLoss : averageGain),
        ...
        private class SymbolData
        {
            ...
            public SymbolData(
                ...
                ETFConstituentUniverse constituent,
                int period
            )
            {
                Symbol = symbol;
