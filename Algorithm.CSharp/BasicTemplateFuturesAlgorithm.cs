...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    {
        // Oats futures
        private const string UnderlyingTicker = Futures.Softs.OrangeJuice;
        ...
        public override void OnData(Slice slice)
        {
            ...
            else
            {
                ...
                {
                    if (holding.Value.Quantity != 0)
                        MarketOrder(holding.Key, -holding.Value.Quantity);
                }*/
            }
            ...
            Console.WriteLine("P/L: {0}", Portfolio.TotalUnrealisedProfit);
        }
