...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class BasicTemplateFuturesAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.00%"},
            {"Average Loss", "0.00%"},
            {"Compounding Annual Return", "-99.591%"},
            {"Drawdown", "4.400%"},
            {"Expectancy", "-0.746"},
            {"Net Profit", "-4.420%"},
            {"Sharpe Ratio", "-66.622"},
            ...
            {"Sortino Ratio", "-57.967"},
            {"Return Over Maximum Drawdown", "-22.56"},
            {"Portfolio Turnover", "99.049"},
            ...
            {"OrderListHash", "b93166016670340765b0dde999c6364d"}
        };
    }
}
