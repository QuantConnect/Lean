...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class MACDTrendAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Total Insights Closed", "83"},
            {"Total Insights Analysis Completed", "83"},
            {"Long Insight Count", "42"},
            {"Short Insight Count", "0"},
            {"Long/Short Ratio", "100%"},
            {"Estimated Monthly Alpha Value", "$30884.8426"},
            {"Total Accumulated Estimated Alpha Value", "$4136724.3977"},
            {"Mean Population Estimated Insight Value", "$49840.0530"},
            {"Mean Population Direction", "46.7415%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "30.0672%"},
            {"Rolling Averaged Population Magnitude", "0%"},
            {"OrderListHash", "-1431136632"}
        };
    }
}
