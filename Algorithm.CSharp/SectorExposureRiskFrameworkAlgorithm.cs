...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class SectorExposureRiskFrameworkAlgorithm : QCAlgorithmFramework, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.12%"},
            {"Average Loss", "-0.02%"},
            {"Compounding Annual Return", "-43.892%"},
            {"Drawdown", "2.700%"},
            {"Expectancy", "2.172"},
            {"Net Profit", "-2.347%"},
            {"Sharpe Ratio", "-5.076"},
            {"Loss Rate", "50%"},
            {"Win Rate", "50%"},
            {"Profit-Loss Ratio", "5.34"},
            {"Alpha", "-0.389"},
            {"Beta", "0.872"},
            {"Annual Standard Deviation", "0.097"},
            {"Annual Variance", "0.009"},
            {"Information Ratio", "-11.487"},
            {"Tracking Error", "0.033"},
            {"Treynor Ratio", "-0.566"},
            {"Total Fees", "$27.44"},
            {"Total Insights Generated", "39"},
            {"Total Insights Closed", "36"},
            {"Total Insights Analysis Completed", "33"},
            {"Long Insight Count", "39"},
            {"Short Insight Count", "0"},
            {"Long/Short Ratio", "100%"},
            {"Estimated Monthly Alpha Value", "$-4362112"},
            {"Total Accumulated Estimated Alpha Value", "$-2205290"},
            {"Mean Population Estimated Insight Value", "$-61258.06"},
            {"Mean Population Direction", "54.5455%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "64.4276%"},
