...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class SectorExposureRiskFrameworkAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Estimated Monthly Alpha Value", "$-3205010"},
            {"Total Accumulated Estimated Alpha Value", "$-1513477"},
            {"Mean Population Estimated Insight Value", "$-60539.09"},
            {"Mean Population Direction", "32%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "57.5578%"},
            {"Rolling Averaged Population Magnitude", "0%"},
            {"OrderListHash", "6ef90545f4b8ed16e3cc86f24566da94"}
        };
    }
}
