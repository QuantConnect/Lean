...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class SectorExposureRiskFrameworkAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.02%"},
            {"Average Loss", "-2.00%"},
            {"Compounding Annual Return", "-99.866%"},
            {"Drawdown", "22.400%"},
            {"Expectancy", "-0.831"},
            {"Start Equity", "100000"},
            {"End Equity", "77598.11"},
            ...
            {"Alpha", "-0.811"},
            {"Beta", "0.977"},
            {"Annual Standard Deviation", "0.872"},
            {"Annual Variance", "0.76"},
            {"Information Ratio", "-0.93"},
            {"Tracking Error", "0.867"},
            {"Treynor Ratio", "-1.02"},
            {"Total Fees", "$27.18"},
            {"Estimated Strategy Capacity", "$64000000.00"},
            {"Lowest Capacity Asset", "AIG R735QTJ8XC9X"},
            {"Portfolio Turnover", "13.60%"},
            {"OrderListHash", "5e88835b1460f50ebca9824d5a4ddea9"}
        };
    }
}
