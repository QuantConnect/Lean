...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class ComboMarketOrderAlgorithm : ComboOrderAlgorithm
    {
        ...
        public override void OnOrderEvent(OrderEvent orderEvent)
        {
            ...
            {
                throw new TestException($"The fee for each order should be {orderEvent.AbsoluteFillQuantity * 0.65m} USD, but for order {orderEvent.OrderId} was {orderEvent.OrderFee}");
            }
        }
