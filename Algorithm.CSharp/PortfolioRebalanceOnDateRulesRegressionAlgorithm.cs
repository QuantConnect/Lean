...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class PortfolioRebalanceOnDateRulesRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.06%"},
            {"Average Loss", "-0.04%"},
            {"Compounding Annual Return", "11.475%"},
            {"Drawdown", "18.200%"},
            {"Expectancy", "1.111"},
            {"Net Profit", "24.266%"},
            {"Sharpe Ratio", "0.693"},
            {"Probabilistic Sharpe Ratio", "29.798%"},
            {"Loss Rate", "19%"},
            {"Win Rate", "81%"},
            ...
            {"Treynor Ratio", "16.212"},
            {"Total Fees", "$298.88"},
            {"Estimated Strategy Capacity", "$73000000.00"},
            {"Lowest Capacity Asset", "IBM"},
            {"Fitness Score", "0.002"},
            ...
            {"OrderListHash", "23efc9f10d431a80342fe330226e8f46"}
        };
    }
}
