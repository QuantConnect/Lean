...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class PortfolioRebalanceOnDateRulesRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.07%"},
            {"Average Loss", "-0.04%"},
            {"Compounding Annual Return", "11.426%"},
            {"Drawdown", "18.200%"},
            {"Expectancy", "1.171"},
            {"Net Profit", "24.157%"},
            {"Sharpe Ratio", "0.69"},
            {"Probabilistic Sharpe Ratio", "29.665%"},
            {"Loss Rate", "21%"},
            {"Win Rate", "79%"},
            ...
            {"Treynor Ratio", "16.597"},
            {"Total Fees", "$328.83"},
            {"Estimated Strategy Capacity", "$72000000.00"},
            ...
            {"OrderListHash", "33e816ef126a583346d0446a76965d1e"}
        };
    }
}
