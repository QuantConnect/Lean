...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class ConvertToFrameworkAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Total Fees", "$754.82"},
            {"Fitness Score", "0.024"},
            {"Kelly Criterion Estimate", "-0.802"},
            {"Kelly Criterion Probability Value", "0.529"},
            {"Sortino Ratio", "-0.224"},
            ...
            {"Estimated Monthly Alpha Value", "$-537847.3"},
            {"Total Accumulated Estimated Alpha Value", "$-72039420"},
            {"Mean Population Estimated Insight Value", "$-847522.6"},
            {"Mean Population Direction", "51.7647%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "48.2217%"},
            {"Rolling Averaged Population Magnitude", "0%"},
            {"OrderListHash", "-366752584"}
        };
    }
}
