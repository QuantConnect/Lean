...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class OptionGreeksRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public override void Initialize()
        {
            ...
            _itmCallSymbol = QuantConnect.Symbol.CreateOption(
                equity.Symbol,
                Market.USA,
            ...
            _otmCallSymbol = QuantConnect.Symbol.CreateOption(
                equity.Symbol,
                Market.USA,
                OptionStyle.American,
                OptionRight.Call,
            ...
            _itmPutSymbol = QuantConnect.Symbol.CreateOption(
                equity.Symbol,
                Market.USA,
                OptionStyle.American,
                OptionRight.Put,
            ...
            _otmPutSymbol = QuantConnect.Symbol.CreateOption(
                equity.Symbol,
                Market.USA,
                OptionStyle.American,
                OptionRight.Put,
                ...
                foreach (var contractKvp in chain.Contracts)
                {
                    ...
                    if (delta >= expected + error || delta <= expected - error)
                    {
                        throw new RegressionTestException(
                            $"{symbol.Value} greeks not calculated accurately! Expected: {expected}, Estimation: {delta}"
                        );
                    }
                }
