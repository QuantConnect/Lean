...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class ScheduledUniverseSelectionModelRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.16%"},
            {"Average Loss", "-0.09%"},
            {"Compounding Annual Return", "50.148%"},
            {"Drawdown", "1.100%"},
            {"Expectancy", "0.852"},
            {"Net Profit", "3.685%"},
            {"Sharpe Ratio", "7.031"},
            {"Probabilistic Sharpe Ratio", "99.080%"},
            {"Loss Rate", "33%"},
            {"Win Rate", "67%"},
            ...
            {"Sortino Ratio", "43.153"},
            {"Return Over Maximum Drawdown", "123.962"},
            ...
            {"OrderListHash", "dab85bfb6d52d234d2c70e2874630962"}
        };
    }
}
