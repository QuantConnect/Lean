...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class WarmupIndicatorRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "0%"},
            {"Compounding Annual Return", "21.702%"},
            {"Drawdown", "1.200%"},
            {"Expectancy", "0"},
            {"Net Profit", "2.155%"},
            {"Sharpe Ratio", "2.95"},
            {"Probabilistic Sharpe Ratio", "79.081%"},
            {"Loss Rate", "0%"},
            {"Win Rate", "0%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "0.149"},
            ...
            {"Sortino Ratio", "11.146"},
            {"Return Over Maximum Drawdown", "18.172"},
