...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class NullBuyingPowerOptionBullCallSpreadAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public override void OnData(Slice slice)
        {
                ...
                slice.OptionChains.TryGetValue(_optionSymbol, out var chain))
            {
                ...
                foreach (var ticket in tickets)
                {
                    ...
                    {
                        throw new TestException($"There should be no restriction on buying {ticket.Quantity} of {ticket.Symbol} with BuyingPowerModel.Null");
                    }
                }
            }
        }
        ...
        public override void OnEndOfAlgorithm()
        {
            ...
            {
                throw new TestException("The TotalMarginUsed should be zero to avoid margin calls.");
            }
        }
