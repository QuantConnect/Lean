    ...
    public class OrderImmutabilityRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public override void OnData(Slice data)
        {
            if (!Portfolio.Invested)
            {
                ...
                if (_originalOrder.Time != UtcTime)
                {
                    ...
                    throw new TestException("Order Time should be UtcTime!");
                }
            }
        }
        ...
        public override void OnOrderEvent(OrderEvent orderEvent)
        {
            ...
            if (orderV1 == orderV2)
            {
                ...
                throw new TestException("Orders should be clones, hence not equal!");
            }
            ...
            if (orderV2.BrokerId.SequenceEqual(orderV3.BrokerId))
            {
                ...
                throw new TestException("Broker IDs should not be the same!");
            }
            ...
            if (orderV4.Quantity == orderV1.Quantity)
            {
                ...
                throw new TestException("Order quantity should not be the same!");
            }

            if (orderV4.Tag == orderV1.Tag)
            {
                Error("Order tag should not be the same!");
                throw new TestException("Order tag should not be the same!");
            }
        }
        ...
        public override void OnEndOfAlgorithm()
        {
            ...
            if (updatedOrder.Quantity == _originalOrder.Quantity)
            {
                ...
                throw new TestException("Quantities should have been updated!");
            }

            if (updatedOrder.Tag == _originalOrder.Tag)
            {
                Error("Tag should have been updated!");
                throw new TestException("Tag should have been updated!");
            }
        }
