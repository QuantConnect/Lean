...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class OptionStrategyFilteringUniversePutButterflyRegressionAlgorithm : OptionStrategyFilteringUniverseBaseAlgorithm
    {
        ...
        {
            _func = u => u.IncludeWeeklys().Strikes(-10, +10).Expiration(0, 180).PutButterfly(30, 5);
            _expectedCount = 3;
        ...
        protected override void TestFiltering(OptionChain chain)
        {
            ...
            var strategy = OptionStrategies.PutButterfly(_optionSymbol, itmStrike, atmStrike, otmStrike, expiry);
            Buy(strategy, 1);
        }
