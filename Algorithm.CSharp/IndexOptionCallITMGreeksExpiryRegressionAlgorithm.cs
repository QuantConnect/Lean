...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class IndexOptionCallITMGreeksExpiryRegressionAlgorithm
        : QCAlgorithm,
            IRegressionAlgorithmDefinition
    {
        ...
        public override void Initialize()
        {
            ...
            spx.VolatilityModel = new StandardDeviationOfReturnsVolatilityModel(
                60,
                Resolution.Minute,
        ...
        public override void OnData(Slice slice)
        {
            ...
            var theta = slice
                ...
                .ToList();
            var impliedVol = slice
                .OptionChains.Values.OrderByDescending(y => y.Contracts.Values.Sum(x => x.Volume))
                .First()
                .Contracts.Values.Select(x => x.ImpliedVolatility)
                .ToList();
            var vega = slice
                .OptionChains.Values.OrderByDescending(y => y.Contracts.Values.Sum(x => x.Volume))
                .First()
