...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class BasicTemplateFuturesWithExtendedMarketAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.00%"},
            {"Average Loss", "0.00%"},
            {"Compounding Annual Return", "-99.477%"},
            {"Drawdown", "4.200%"},
            {"Expectancy", "-0.743"},
            {"Net Profit", "-4.226%"},
            {"Sharpe Ratio", "-63.429"},
            ...
            {"Annual Variance", "0"},
            {"Information Ratio", "-75.588"},
            {"Tracking Error", "0.227"},
            {"Treynor Ratio", "-15.395"},
            {"Total Fees", "$6133.80"},
            ...
            {"Sortino Ratio", "-63.799"},
            {"Return Over Maximum Drawdown", "-23.572"},
            {"Portfolio Turnover", "97.563"},
            ...
            {"OrderListHash", "365150e4f26efc320ab5cc459f9fdecc"}
        };
    }
}
