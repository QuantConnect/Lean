...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class VolumeWeightedAveragePriceExecutionModelRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.04%"},
            {"Average Loss", "-0.01%"},
            {"Compounding Annual Return", "453.837%"},
            {"Drawdown", "1.200%"},
            {"Expectancy", "2.225"},
            {"Net Profit", "2.213%"},
            {"Sharpe Ratio", "12.478"},
            {"Probabilistic Sharpe Ratio", "71.927%"},
            {"Loss Rate", "31%"},
            {"Win Rate", "69%"},
            ...
            {"Return Over Maximum Drawdown", "518.944"},
