...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class VolumeWeightedAveragePriceExecutionModelRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.04%"},
            {"Average Loss", "-0.01%"},
            {"Compounding Annual Return", "476.260%"},
            {"Drawdown", "1.200%"},
            {"Expectancy", "2.431"},
            {"Net Profit", "2.264%"},
            {"Sharpe Ratio", "12.794"},
            {"Probabilistic Sharpe Ratio", "71.693%"},
            {"Loss Rate", "32%"},
            {"Win Rate", "68%"},
            ...
            {"Return Over Maximum Drawdown", "544.901"},
            ...
            {"OrderListHash", "37d71ed4f7b110716d20b4e0c970df67"}
        };
    }
}
