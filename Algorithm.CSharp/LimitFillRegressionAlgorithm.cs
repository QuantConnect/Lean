...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class LimitFillRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.01%"},
            {"Average Loss", "-0.01%"},
            {"Compounding Annual Return", "-5.308%"},
            {"Drawdown", "0.300%"},
            {"Expectancy", "-0.202"},
            {"Net Profit", "-0.070%"},
            {"Sharpe Ratio", "-0.788"},
            {"Probabilistic Sharpe Ratio", "42.298%"},
            {"Loss Rate", "50%"},
            {"Win Rate", "50%"},
            ...
            {"Sortino Ratio", "-3.047"},
            {"Return Over Maximum Drawdown", "-18.995"},
            ...
            {"OrderListHash", "7d1c770dc30351077ee86e8cfb44e2fb"}
        };
    }
}
