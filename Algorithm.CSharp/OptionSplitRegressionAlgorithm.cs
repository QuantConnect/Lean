...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class OptionSplitRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Return Over Maximum Drawdown", "-94.472"},
            ...
            {"Estimated Monthly Alpha Value", "$-0.225"},
            {"Total Accumulated Estimated Alpha Value", "$-0.03"},
            {"Mean Population Estimated Insight Value", "$-0.03"},
