...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class OptionStrategyFilteringUniverseConversionRegressionAlgorithm : OptionStrategyFilteringUniverseBaseAlgorithm
    {
        ...
        {
            _func = u => u.IncludeWeeklys().Strikes(-10, +10).Expiration(0, 180).Conversion(30, -5);
            _expectedCount = 2;
        ...
        protected override void TestFiltering(OptionChain chain)
        {
            ...
            var strategy = OptionStrategies.ReverseConversion(_optionSymbol, strike, expiry);
            Buy(strategy, 1);
        }
        ...
        public override Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"OrderListHash", "6c25e68e11265e955a193336421c5019"}
        };
    }
}
