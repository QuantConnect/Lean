...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class CompositeAlphaModelFrameworkAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.01%"},
            {"Average Loss", "-0.38%"},
            {"Compounding Annual Return", "1193.754%"},
            {"Drawdown", "1.700%"},
            {"Expectancy", "-0.320"},
            {"Net Profit", "3.327%"},
            {"Sharpe Ratio", "7.388"},
            {"Probabilistic Sharpe Ratio", "80.988%"},
            {"Loss Rate", "33%"},
            {"Win Rate", "67%"},
            ...
            {"Sortino Ratio", "161.362"},
            {"Return Over Maximum Drawdown", "1624.775"},
