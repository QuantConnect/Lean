...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class OptionEquityBearPutSpreadRegressionAlgorithm
        ...
        public override void OnData(Slice slice)
        {
            if (!Portfolio.Invested)
            {
                ...
                )
                {
                    ...
                    var shortPut = putContracts.First(contract =>
                        contract.Strike < longPut.Strike && contract.Expiry == longPut.Expiry
                    );
