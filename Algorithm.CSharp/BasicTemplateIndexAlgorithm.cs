...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class BasicTemplateIndexAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        /// </summary>
        public virtual long DataPoints => 16320;
        ...
        public virtual Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "-53.10%"},
            {"Compounding Annual Return", "-92.343%"},
            {"Drawdown", "10.000%"},
            {"Expectancy", "-1"},
            {"Net Profit", "-9.810%"},
            {"Sharpe Ratio", "-4.81"},
            ...
            {"Sortino Ratio", "-1.84"},
            {"Return Over Maximum Drawdown", "-9.449"},
            ...
            {"OrderListHash", "3bd6c0044bceabb4a8aff69ddccec641"}
        };
    }
}
