...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class SetHoldingsMultipleTargetsRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.00%"},
            {"Average Loss", "0.00%"},
            {"Compounding Annual Return", "306.509%"},
            {"Drawdown", "2.300%"},
            {"Expectancy", "-0.915"},
            {"Net Profit", "1.809%"},
            {"Sharpe Ratio", "10.551"},
            {"Probabilistic Sharpe Ratio", "64.713%"},
            {"Loss Rate", "92%"},
            {"Win Rate", "8%"},
            ...
            {"Sortino Ratio", "16.648"},
            {"Return Over Maximum Drawdown", "110.863"},
            ...
            {"OrderListHash", "a44346b38fea0714e022897b789f60e4"}
        };
    }
}
