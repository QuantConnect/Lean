...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class OptionStrategyFilteringUniverseCallSpreadRegressionAlgorithm : OptionStrategyFilteringUniverseBaseAlgorithm
    {
        ...
        {
            _func = u => u.IncludeWeeklys().Strikes(-10, +10).Expiration(0, 180).CallSpread(30, 5, -10);
            _expectedCount = 2;
        ...
        protected override void TestFiltering(OptionChain chain)
        {
            ...
            var strategy = OptionStrategies.BullCallSpread(_optionSymbol, lowerStrike, higherStrike, expiry);
            Buy(strategy, 1);
        }
