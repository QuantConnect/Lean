...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class CustomDataWorksWithDifferentExchangesRegressionAlgorithm
        : QCAlgorithm,
            IRegressionAlgorithmDefinition
    {
        ...
        public override void Initialize()
        {
            ...
            var firstCustomSecurity = AddData<ExampleCustomData>(
                market1.Symbol,
                Resolution.Hour,
                TimeZones.Utc,
                false
            ...
            var secondCustomSecurity = AddData<ExampleCustomData>(
                market2.Symbol,
                Resolution.Hour,
                TimeZones.Utc,
                false
            ...
            {
                throw new RegressionTestException(
                    $"The time zone of security {secondCustomSecurity} should be {TimeZones.Utc}, but it was {secondCustomSecurity.Exchange.TimeZone}"
                );
            }
        ...
        public override void OnData(Slice slice)
        {
            ...
            {
                throw new RegressionTestException(
                    $"{ActiveSecurities.Count.ToString().ToCamelCase()} data points were expected, but only {slice.Count} were received"
                );
            }
        }
