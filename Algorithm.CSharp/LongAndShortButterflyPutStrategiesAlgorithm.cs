...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class LongAndShortButterflyPutStrategiesAlgorithm : OptionStrategyFactoryMethodsBaseAlgorithm
    {
        ...
        protected override void AssertStrategyPositionGroup(IPositionGroup positionGroup)
        {
            ...
            {
                throw new TestException($"Expected position group to have 3 positions. Actual: {positionGroup.Positions.Count()}");
            }
            ...
            {
                throw new TestException($"Expected higher strike position quantity to be 2. Actual: {higherStrikePosition.Quantity}");
            }
            ...
            {
                throw new TestException($"Expected lower strike position quantity to be 2. Actual: {lowerStrikePosition.Quantity}");
            }
            ...
            {
                throw new TestException($"Expected middle strike position quantity to be -4. Actual: {middleStrikePosition.Quantity}");
            }
        }
