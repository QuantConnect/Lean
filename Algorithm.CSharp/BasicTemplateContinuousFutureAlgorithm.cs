...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class BasicTemplateContinuousFutureAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "1.77%"},
            {"Average Loss", "-0.43%"},
            {"Compounding Annual Return", "10.305%"},
            {"Drawdown", "0.900%"},
            {"Expectancy", "2.068"},
            {"Start Equity", "100000"},
            {"End Equity", "105061.7"},
            ...
            {"Sharpe Ratio", "1.527"},
            {"Sortino Ratio", "1.948"},
            {"Probabilistic Sharpe Ratio", "82.514%"},
            {"Loss Rate", "40%"},
            {"Win Rate", "60%"},
