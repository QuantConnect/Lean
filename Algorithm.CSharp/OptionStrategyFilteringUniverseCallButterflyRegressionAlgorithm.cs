...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class OptionStrategyFilteringUniverseCallButterflyRegressionAlgorithm : OptionStrategyFilteringUniverseBaseAlgorithm
    {
        ...
        {
            _func = u => u.IncludeWeeklys().Strikes(-10, +10).Expiration(0, 180).CallButterfly(30, 5);
            _expectedCount = 3;
        ...
        protected override void TestFiltering(OptionChain chain)
        {
            ...
            var strategy = OptionStrategies.CallButterfly(_optionSymbol, otmStrike, atmStrike, itmStrike, expiry);
            Buy(strategy, 1);
        }
