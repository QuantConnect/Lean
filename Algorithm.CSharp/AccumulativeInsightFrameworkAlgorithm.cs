...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class AccumulativeInsightPortfolioRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.00%"},
            {"Average Loss", "0.00%"},
            {"Compounding Annual Return", "-10.655%"},
            {"Drawdown", "0.200%"},
            {"Expectancy", "-0.560"},
            {"Net Profit", "-0.154%"},
            {"Sharpe Ratio", "-9.813"},
            ...
            {"Annual Variance", "0.000"},
            {"Information Ratio", "-2.269"},
            ...
            {"Mean Population Estimated Insight Value", "$250.0"},
            {"Mean Population Direction", "55.0%"},
