...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class AddUniverseSelectionModelCoarseAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.01%"},
            {"Average Loss", "-0.01%"},
            {"Compounding Annual Return", "-75.304%"},
            {"Drawdown", "5.800%"},
            {"Expectancy", "-0.721"},
            {"Net Profit", "-5.585%"},
            {"Sharpe Ratio", "-3.272"},
            {"Probabilistic Sharpe Ratio", "5.830%"},
            {"Loss Rate", "85%"},
            {"Win Rate", "15%"},
            ...
            {"Sortino Ratio", "-4.468"},
            {"Return Over Maximum Drawdown", "-13.06"},
            ...
            {"OrderListHash", "c75f1d25e0c94b359cde6e7d14ffb044"}
        };
    }
}
