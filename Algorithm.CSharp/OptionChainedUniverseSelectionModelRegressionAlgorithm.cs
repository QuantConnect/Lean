...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class OptionChainedUniverseSelectionModelRegressionAlgorithm
        : QCAlgorithm,
            IRegressionAlgorithmDefinition
    {
        public override void Initialize()
        {
            ...
            var universe = AddUniverse(
                "my-minute-universe-name",
                time => new List<string> { "AAPL", "TWX" }
            );
        ...
        public override void OnData(Slice slice)
        {
            ...
            {
                var values = slice
                    .OptionChains.Where(x => (x.Key == "?AAPL" || x.Key == "?TWX"))
                    .Select(x => x.Value);
