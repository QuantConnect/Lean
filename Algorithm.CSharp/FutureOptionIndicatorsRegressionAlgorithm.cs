...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    {
        protected override string ExpectedGreeks { get; set; } =
            "Implied Volatility: 0.17269,Delta: 0.55278,Gamma: 0.00156,Vega: 5.60955,Theta: -0.64434,Rho: -0.0084";
        ...
        public override void Initialize()
        {
            ...
            var underlying = AddFutureContract(
            ...
            var option = AddFutureOptionContract(
                OptionChainProvider
                    .GetOptionContractList(underlying, Time)
