...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class BasicTemplateOptionsFrameworkAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.10%"},
            {"Average Loss", "-0.18%"},
            {"Compounding Annual Return", "-52.004%"},
            {"Drawdown", "1.500%"},
            {"Expectancy", "0.560"},
            {"Start Equity", "100000"},
            {"End Equity", "98999.50"},
            ...
            {"Sharpe Ratio", "-5.196"},
            {"Sortino Ratio", "0"},
            {"Probabilistic Sharpe Ratio", "5.456%"},
            {"Loss Rate", "0%"},
            {"Win Rate", "100%"},
            ...
            {"Information Ratio", "-10.083"},
            {"Tracking Error", "0.089"},
            {"Treynor Ratio", "-0.736"},
            {"Total Fees", "$4.00"},
            {"Estimated Strategy Capacity", "$0"},
            {"Lowest Capacity Asset", "AAPL R735QTJ8XC9X"},
            {"Portfolio Turnover", "13.39%"},
            {"OrderListHash", "c4307c30c2058ecf38d87476b785be3d"}
        };
    }
}
