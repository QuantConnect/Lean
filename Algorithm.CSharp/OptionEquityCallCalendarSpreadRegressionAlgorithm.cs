...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class OptionEquityCallCalendarSpreadRegressionAlgorithm
        ...
        public override void OnData(Slice slice)
        {
            if (!Portfolio.Invested)
            {
                ...
                )
                {
                    ...
                    var longCall = contracts.First(contract =>
                        contract.Expiry > shortCall.Expiry && contract.Strike == shortCall.Strike
                    );
                    ...
                    AssertOptionStrategyIsPresent(
                        OptionStrategyDefinitions.CallCalendarSpread.Name,
                        10
                    );
