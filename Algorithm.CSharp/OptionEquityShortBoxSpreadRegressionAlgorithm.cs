...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class OptionEquityShortBoxSpreadRegressionAlgorithm
        ...
        public override void OnData(Slice slice)
        {
            if (!Portfolio.Invested)
            {
                ...
                )
                {
                    ...
                    var orderCosts =
                        sellSideCall.AskPrice
                        - buySideCall.BidPrice
                        + buySidePut.AskPrice
                        - sellSidePut.BidPrice;
