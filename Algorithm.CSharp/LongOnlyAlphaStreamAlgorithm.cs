...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class LongOnlyAlphaStreamAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.99%"},
            {"Average Loss", "-0.40%"},
            {"Compounding Annual Return", "216.657%"},
            {"Drawdown", "2.300%"},
            {"Expectancy", "0.381"},
            {"Net Profit", "1.485%"},
            {"Sharpe Ratio", "7.298"},
            {"Probabilistic Sharpe Ratio", "64.956%"},
            {"Loss Rate", "60%"},
            {"Win Rate", "40%"},
            {"Profit-Loss Ratio", "2.45"},
            {"Alpha", "-0.36"},
            {"Beta", "1.003"},
            {"Annual Standard Deviation", "0.223"},
            {"Annual Variance", "0.05"},
            {"Information Ratio", "-100.295"},
            ...
            {"Return Over Maximum Drawdown", "68.711"},
            ...
            {"OrderListHash", "6830b7a06bddd58dff9ceff807604f17"}
        };
    }
}
