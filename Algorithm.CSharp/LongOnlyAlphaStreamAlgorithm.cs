...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class LongOnlyAlphaStreamAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.99%"},
            {"Average Loss", "-0.60%"},
            {"Compounding Annual Return", "209.950%"},
            {"Drawdown", "2.300%"},
            {"Expectancy", "0.319"},
            {"Net Profit", "1.457%"},
            {"Sharpe Ratio", "4.273"},
            {"Probabilistic Sharpe Ratio", "64.492%"},
            {"Loss Rate", "50%"},
            {"Win Rate", "50%"},
            ...
            {"Information Ratio", "-34.573"},
            {"Tracking Error", "0.004"},
            {"Treynor Ratio", "0.939"},
            {"Total Fees", "$293.06"},
            {"Fitness Score", "0.999"},
            {"Kelly Criterion Estimate", "-7.353"},
            {"Kelly Criterion Probability Value", "0.598"},
            {"Sortino Ratio", "79228162514264337593543950335"},
            {"Return Over Maximum Drawdown", "68.936"},
            ...
            {"Estimated Monthly Alpha Value", "$74387.0416"},
            {"Total Accumulated Estimated Alpha Value", "$11984.5789"},
            {"Mean Population Estimated Insight Value", "$1498.0724"},
            {"Mean Population Direction", "62.5%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "73.0394%"},
            {"Rolling Averaged Population Magnitude", "0%"},
            {"OrderListHash", "-301373296"}
        };
    }
}
