...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class CustomDataObjectStoreRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public override void Initialize()
        {
            ...
            ObjectStore.Save("ExampleCustomData",
        ...
        public override void OnEndOfAlgorithm()
        {
            ...
            if (customSecurity.Price == 0)
            {
                throw new Exception("Custom security price was not expected to be zero");
            }
        }
        ...
        public class ExampleCustomData : BaseData
        {
            ...
            {
                return new SubscriptionDataSource("ExampleCustomData", SubscriptionTransportMedium.ObjectStore, FileFormat.Csv);
            }
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Annual Variance", "0"},
            {"Information Ratio", "-6.301"},
            {"Tracking Error", "0.432"},
            {"Treynor Ratio", "0"},
            {"Total Fees", "$0.00"},
