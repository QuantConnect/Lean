...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class CustomDataObjectStoreRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public override void Initialize()
        {
            ...
            ObjectStore.Save("CustomData/ExampleCustomData",
        ...
        public class ExampleCustomData : BaseData
        {
            ...
            {
                return new SubscriptionDataSource("CustomData/ExampleCustomData", SubscriptionTransportMedium.ObjectStore, FileFormat.Csv);
            }
