...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    class BacktestingBrokerageRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public void VerifyMarketOrder(Order order, OrderEvent orderEvent)
        {
            switch (order.Status)
            {
                ...
                case OrderStatus.PartiallyFilled:
                    ...
                    {
                        throw new TestException("LastFillTime should not be null");
                    }

                    if (order.Quantity / 2 != orderEvent.FillQuantity)
                    {
                        throw new TestException("Order size should be half");
                    }
                    break;
                ...
                case OrderStatus.Filled:
                    ...
                    {
                        throw new TestException("Order should not finish during the CreatedTime bar");
                    }
                    break;
        ...
        public void VerifyOptionExercise(Order order, OrderEvent orderEvent)
        {
            ...
            {
                throw new TestException("OptionExercise order price should be strike price!!");
            }

            if (orderEvent.Quantity != -1)
            {
                throw new TestException("OrderEvent Quantity should be -1");
            }
        }
        ...
        public override void OnEndOfAlgorithm()
        {
            ...
            {
                throw new TestException("Portfolio does not contain the Symbols we purchased");
            }
            ...
            {
                throw new TestException("Options holding does not match expected outcome");
            }
            ...
            {
                throw new TestException("Equity holding for exercised option does not match expected outcome");
            }
            ...
            {
                throw new TestException("Equity holding does not match expected outcome");
            }
        }
