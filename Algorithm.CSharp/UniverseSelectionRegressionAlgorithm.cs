...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class UniverseSelectionRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.64%"},
            {"Average Loss", "0%"},
            {"Compounding Annual Return", "-56.457%"},
            {"Drawdown", "3.800%"},
            {"Expectancy", "0"},
            {"Net Profit", "-3.798%"},
            {"Sharpe Ratio", "-2.778"},
            {"Probabilistic Sharpe Ratio", "13.951%"},
            {"Loss Rate", "0%"},
            {"Win Rate", "100%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "-0.504"},
            ...
            {"Information Ratio", "-1.619"},
            {"Tracking Error", "0.206"},
            {"Treynor Ratio", "8.385"},
            {"Total Fees", "$4.00"},
            {"Estimated Strategy Capacity", "$870000.00"},
            {"Lowest Capacity Asset", "GOOAV"},
            {"Fitness Score", "0.008"},
            {"Kelly Criterion Estimate", "0"},
            {"Kelly Criterion Probability Value", "0"},
            {"Sortino Ratio", "-3.802"},
            {"Return Over Maximum Drawdown", "-14.863"},
            ...
            {"OrderListHash", "85223bdfd1780299b09eb90717be90c3"}
        };
    }
}
