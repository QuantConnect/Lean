...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class UniverseSelectionRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.64%"},
            {"Average Loss", "0%"},
            {"Compounding Annual Return", "-74.209%"},
            {"Drawdown", "6.600%"},
            {"Expectancy", "0"},
            {"Net Profit", "-6.117%"},
            {"Sharpe Ratio", "-3.749"},
            {"Probabilistic Sharpe Ratio", "11.842%"},
            {"Loss Rate", "0%"},
            {"Win Rate", "100%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "-1.113"},
            ...
            {"Information Ratio", "-2.933"},
            {"Tracking Error", "0.311"},
            {"Treynor Ratio", "10.179"},
            {"Total Fees", "$5.00"},
            {"Fitness Score", "0.017"},
            {"Kelly Criterion Estimate", "0"},
            {"Kelly Criterion Probability Value", "0"},
            {"Sortino Ratio", "-2.583"},
            {"Return Over Maximum Drawdown", "-11.312"},
            ...
            {"Estimated Monthly Alpha Value", "$6025.7709"},
            {"Total Accumulated Estimated Alpha Value", "$3448.08"},
            {"Mean Population Estimated Insight Value", "$3448.08"},
            {"Mean Population Direction", "100%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "100%"},
            {"Rolling Averaged Population Magnitude", "0%"},
            {"OrderListHash", "1708668597"}
        };
    }
}
