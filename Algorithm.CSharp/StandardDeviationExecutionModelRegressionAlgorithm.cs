...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class StandardDeviationExecutionModelRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.04%"},
            {"Average Loss", "0.00%"},
            {"Compounding Annual Return", "1271.081%"},
            {"Drawdown", "0.600%"},
            {"Expectancy", "44.618"},
            {"Net Profit", "3.404%"},
            {"Sharpe Ratio", "37.706"},
            {"Probabilistic Sharpe Ratio", "99.778%"},
            {"Loss Rate", "1%"},
            {"Win Rate", "99%"},
            {"Profit-Loss Ratio", "45.15"},
            {"Alpha", "5.822"},
            {"Beta", "0.795"},
            {"Annual Standard Deviation", "0.195"},
            {"Annual Variance", "0.038"},
            {"Information Ratio", "55.607"},
            ...
            {"Return Over Maximum Drawdown", "19606.916"},
