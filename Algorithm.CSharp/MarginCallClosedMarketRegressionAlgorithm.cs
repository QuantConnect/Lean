...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class MarginCallClosedMarketRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.42%"},
            {"Average Loss", "0%"},
            {"Compounding Annual Return", "1724.832%"},
            {"Drawdown", "5.500%"},
            {"Expectancy", "0"},
            {"Net Profit", "3.783%"},
            {"Sharpe Ratio", "16.919"},
            {"Probabilistic Sharpe Ratio", "67.111%"},
            {"Loss Rate", "0%"},
            {"Win Rate", "100%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "3.71"},
            ...
            {"Return Over Maximum Drawdown", "219.189"},
            ...
            {"Estimated Monthly Alpha Value", "$11508.2219"},
            {"Total Accumulated Estimated Alpha Value", "$1854.1024"},
            {"Mean Population Estimated Insight Value", "$1854.1024"},
            {"Mean Population Direction", "100%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "100%"},
            {"Rolling Averaged Population Magnitude", "0%"},
            {"OrderListHash", "1697316056"}
        };
    }
}
