...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class LongAndShortButterflyCallStrategiesAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public override void OnEndOfAlgorithm()
        {
            ...
            {
                throw new Exception(
                    "Expected 6 orders to have been submitted and filled, 3 for buying the butterfly call and 3 for the liquidation." +
                    $" Actual {ordersCount}");
            }
        }
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"OrderListHash", "d730a3c924f70919a8a25caa1d19165f"}
        };
    }
}
