...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class LongAndShortButterflyCallStrategiesAlgorithm
        : OptionStrategyFactoryMethodsBaseAlgorithm
    {
        ...
        protected override void TradeStrategy(OptionChain chain)
        {
            ...
            foreach (var group in contractsByExpiry)
            {
                ...
                {
                    // Ready to trade
                    _butterflyCall = OptionStrategies.ButterflyCall(
                        _optionSymbol,
                        otmStrike,
                        atmStrike,
                        itmStrike,
                    ...
                    _shortButterflyCall = OptionStrategies.ShortButterflyCall(
                        _optionSymbol,
                        otmStrike,
                        atmStrike,
                        itmStrike,
        ...
        protected override void AssertStrategyPositionGroup(IPositionGroup positionGroup)
        {
            ...
            var lowerStrikePosition = positionGroup.Positions.Single(x =>
                x.Symbol.ID.OptionRight == OptionRight.Call
                && x.Symbol.ID.StrikePrice == lowerStrike
            );
            ...
            var middleStrike = _butterflyCall
