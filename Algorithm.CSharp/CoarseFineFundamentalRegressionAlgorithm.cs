...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class CoarseFineFundamentalRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Net Profit", "1.164%"},
            {"Sharpe Ratio", "2.845"},
            {"Probabilistic Sharpe Ratio", "64.717%"},
            {"Loss Rate", "0%"},
            {"Win Rate", "100%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "0.237"},
            ...
            {"Sortino Ratio", "31.132"},
            {"Return Over Maximum Drawdown", "23.867"},
            ...
            {"Estimated Monthly Alpha Value", "$-69139.23"},
            {"Total Accumulated Estimated Alpha Value", "$-34953.72"},
            {"Mean Population Estimated Insight Value", "$-34953.72"},
            {"Mean Population Direction", "0%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "0%"},
            {"Rolling Averaged Population Magnitude", "0%"},
            {"OrderListHash", "-1455841420"}
        };
    }
}
