...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class CoarseFineFundamentalRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "-0.86%"},
            {"Compounding Annual Return", "-18.906%"},
            {"Drawdown", "1.300%"},
            {"Expectancy", "-1"},
            {"Net Profit", "-0.858%"},
            {"Sharpe Ratio", "-3.722"},
            {"Probabilistic Sharpe Ratio", "9.881%"},
            {"Loss Rate", "100%"},
            {"Win Rate", "0%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "-0.167"},
            ...
            {"Treynor Ratio", "15.565"},
            {"Total Fees", "$2.00"},
            {"Fitness Score", "0"},
            {"Kelly Criterion Estimate", "0"},
            {"Kelly Criterion Probability Value", "0"},
            {"Sortino Ratio", "-15.008"},
            {"Return Over Maximum Drawdown", "-14.343"},
            ...
            {"Estimated Monthly Alpha Value", "$7322.8104"},
            {"Total Accumulated Estimated Alpha Value", "$3702.0875"},
            {"Mean Population Estimated Insight Value", "$3702.0875"},
