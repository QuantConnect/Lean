...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class IndexOptionShortCallITMExpiryRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "49.16%"},
            {"Average Loss", "0%"},
            {"Compounding Annual Return", "-78.983%"},
            {"Drawdown", "13.000%"},
            {"Expectancy", "0"},
            {"Net Profit", "-10.394%"},
            {"Sharpe Ratio", "-1.803"},
            {"Probabilistic Sharpe Ratio", "1.422%"},
            {"Loss Rate", "0%"},
            {"Win Rate", "100%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "-0.656"},
            ...
            {"Sortino Ratio", "-0.648"},
            {"Return Over Maximum Drawdown", "-6.938"},
            ...
            {"OrderListHash", "801982876855c6e0fa46c064b7146f1e"}
        };
    }
}
