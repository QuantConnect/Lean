...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class IndexOptionShortPutITMExpiryRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "50.61%"},
            {"Average Loss", "0%"},
            {"Compounding Annual Return", "295.835%"},
            {"Drawdown", "2.400%"},
            {"Expectancy", "0"},
            {"Net Profit", "10.164%"},
            {"Sharpe Ratio", "4.935"},
            {"Probabilistic Sharpe Ratio", "84.352%"},
            {"Loss Rate", "0%"},
            {"Win Rate", "100%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "1.83"},
            ...
            {"Sortino Ratio", "40.419"},
            {"Return Over Maximum Drawdown", "321.055"},
            ...
            {"OrderListHash", "6e7549b1d93ea0a5191cb49563d7bbad"}
        };
    }
}
