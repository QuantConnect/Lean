...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class OptionEquityCoveredCallRegressionAlgorithm
        ...
        public override void OnData(Slice slice)
        {
            if (!Portfolio.Invested)
            {
                ...
                )
                {
                    ...
                    var underlyingMarginRequirements = Securities[atmContract.Symbol.Underlying]
                        .BuyingPowerModel.GetInitialMarginRequirement(
                            new InitialMarginParameters(
                                Securities[atmContract.Symbol.Underlying],
                                500
                            )
                        );
