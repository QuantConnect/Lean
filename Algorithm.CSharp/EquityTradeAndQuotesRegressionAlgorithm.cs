...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class EquityTradeAndQuotesRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.12%"},
            {"Average Loss", "-0.10%"},
            {"Compounding Annual Return", "-88.521%"},
            {"Drawdown", "3.400%"},
            {"Expectancy", "-0.238"},
            {"Net Profit", "-2.922%"},
            {"Sharpe Ratio", "-8.755"},
            {"Probabilistic Sharpe Ratio", "0.505%"},
            {"Loss Rate", "65%"},
            {"Win Rate", "35%"},
            ...
            {"Information Ratio", "-16.501"},
            {"Tracking Error", "0.123"},
            {"Treynor Ratio", "-2.185"},
            {"Total Fees", "$669.79"},
            {"Fitness Score", "0.021"},
            {"Kelly Criterion Estimate", "51.181"},
            {"Kelly Criterion Probability Value", "0.207"},
            {"Sortino Ratio", "-7.371"},
            {"Return Over Maximum Drawdown", "-30.297"},
            {"Portfolio Turnover", "49.963"},
            {"Total Insights Generated", "250"},
            {"Total Insights Closed", "249"},
            {"Total Insights Analysis Completed", "249"},
            {"Long Insight Count", "125"},
            {"Short Insight Count", "0"},
            {"Long/Short Ratio", "100%"},
            {"Estimated Monthly Alpha Value", "$12256.2708"},
            {"Total Accumulated Estimated Alpha Value", "$2110.8022"},
            {"Mean Population Estimated Insight Value", "$8.477117"},
            {"Mean Population Direction", "50.7104%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "53.7275%"},
