...
namespace QuantConnect.Algorithm.CSharp
{
    public class BlackLittermanPortfolioOptimizationFrameworkAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "-0.16%"},
            {"Compounding Annual Return", "73.621%"},
            {"Drawdown", "1.100%"},
            {"Expectancy", "-1"},
            {"Net Profit", "0.759%"},
            {"Sharpe Ratio", "4.139"},
            {"Probabilistic Sharpe Ratio", "61.261%"},
            {"Loss Rate", "100%"},
            {"Win Rate", "0%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "-0.302"},
            {"Beta", "0.568"},
            {"Annual Standard Deviation", "0.114"},
            {"Annual Variance", "0.013"},
            {"Information Ratio", "-10.008"},
            ...
            {"Return Over Maximum Drawdown", "81.628"},
