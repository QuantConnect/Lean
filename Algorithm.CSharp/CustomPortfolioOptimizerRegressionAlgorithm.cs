...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class CustomPortfolioOptimizerRegressionAlgorithm : MeanVarianceOptimizationFrameworkAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "-0.11%"},
            {"Compounding Annual Return", "772.281%"},
            {"Drawdown", "3.300%"},
            {"Expectancy", "-1"},
            {"Net Profit", "3.011%"},
            {"Sharpe Ratio", "12.424"},
            {"Probabilistic Sharpe Ratio", "62.192%"},
            {"Loss Rate", "100%"},
            {"Win Rate", "0%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "1.935"},
            ...
            {"Information Ratio", "14.319"},
            {"Tracking Error", "0.287"},
            {"Treynor Ratio", "2.907"},
            {"Total Fees", "$40.73"},
            {"Estimated Strategy Capacity", "$3500000.00"},
            {"Lowest Capacity Asset", "AIG R735QTJ8XC9X"},
            {"Portfolio Turnover", "52.22%"},
            {"OrderListHash", "be05bf0e71329297b1a00a482ecc802f"}
        };
    }
}
