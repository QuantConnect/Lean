...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class ConsolidateScanRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public override void Initialize()
        {
                ...
                (TradeBar bar) =>
                {
                    ...
                    if (expectedTime != Time)
                    {
                        throw new RegressionTestException(
                            $"Unexpected consolidation time {expectedTime} != {Time}"
                        );
                    }
            ...
            Consolidate(
                ...
                (TradeBar bar) =>
                {
                    ...
                    {
                        throw new RegressionTestException(
                            $"Unexpected consolidation time {expectedTime} != {Time} 3 hours"
                        );
                    }
                }
            );
            ...
            Consolidate(
                ...
                (TradeBar bar) =>
                {
                    ...
                    {
                        throw new RegressionTestException(
                            $"Unexpected consolidation time {expectedTime} != {Time} 2 days"
                        );
                    }
                }
            );
        ...
        {
            if (
                _consolidationDaily.Count != 0
                || _consolidationHourly.Count != 0
                || _consolidation2Days.Count != 0
            )
            {
