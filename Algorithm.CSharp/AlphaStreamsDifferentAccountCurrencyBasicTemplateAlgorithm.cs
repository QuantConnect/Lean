...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class AlphaStreamsDifferentAccountCurrencyBasicTemplateAlgorithm : AlphaStreamsWithHoldingsBasicTemplateAlgorithm
    {
        ...
        public override Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "-0.01%"},
            {"Compounding Annual Return", "-94.117%"},
            {"Drawdown", "3.100%"},
            {"Expectancy", "-1"},
            {"Net Profit", "-2.080%"},
            {"Sharpe Ratio", "-2.473"},
            ...
            {"Alpha", "0.002"},
            {"Beta", "1.002"},
            {"Annual Standard Deviation", "0.339"},
            {"Annual Variance", "0.115"},
            {"Information Ratio", "0.915"},
            ...
            {"Return Over Maximum Drawdown", "56.477"},
            ...
            {"OrderListHash", "a2fbea18ae1b6692626f8da934e4f4ef"}
        };
    }
}
