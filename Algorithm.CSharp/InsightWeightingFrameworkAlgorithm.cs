...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class InsightWeightingFrameworkAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.00%"},
            {"Average Loss", "0.00%"},
            {"Compounding Annual Return", "38.431%"},
            {"Drawdown", "0.600%"},
            {"Expectancy", "-0.744"},
            {"Net Profit", "0.417%"},
            {"Sharpe Ratio", "5.54"},
            {"Probabilistic Sharpe Ratio", "67.184%"},
            {"Loss Rate", "75%"},
            {"Win Rate", "25%"},
            ...
            {"Return Over Maximum Drawdown", "69.788"},
            {"Portfolio Turnover", "0.064"},
            ...
            {"OrderListHash", "9e8b7e29897e8502def33dae5b16b70e"}
        };
    }
}
