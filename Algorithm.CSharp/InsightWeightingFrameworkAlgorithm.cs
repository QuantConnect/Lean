...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class InsightWeightingFrameworkAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "0.00%"},
            {"Compounding Annual Return", "37.028%"},
            {"Drawdown", "0.600%"},
            {"Expectancy", "-1"},
            {"Net Profit", "0.404%"},
            {"Sharpe Ratio", "5.408"},
            {"Probabilistic Sharpe Ratio", "66.754%"},
            {"Loss Rate", "100%"},
            {"Win Rate", "0%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "-0.192"},
            ...
            {"Return Over Maximum Drawdown", "65.155"},
            {"Portfolio Turnover", "0.068"},
            ...
            {"OrderListHash", "f2091789106c3a616bcca92a6e382d7b"}
        };
    }
}
