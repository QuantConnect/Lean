...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class OptionEquityReverseConversionRegressionAlgorithm
        ...
        public override void OnData(Slice slice)
        {
            if (!Portfolio.Invested)
            {
                ...
                )
                {
                    ...
                    var put = contracts.Single(contract =>
                        contract.Right == OptionRight.Put
                        && contract.Expiry == call.Expiry
                    ...
                    var putInTheMoneyAmount = ((Option)Securities[put.Symbol]).GetIntrinsicValue(
                        Securities[underlying].Price
                    );
