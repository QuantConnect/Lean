...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class OptionEquityBearCallLadderRegressionAlgorithm
        ...
        public override void OnData(Slice slice)
        {
            if (!Portfolio.Invested)
            {
                ...
                )
                {
                    ...
                    var lowStrikeCall = callContracts.First(contract =>
                        contract.Strike == callContracts.Min(x => x.Strike)
                    );
                    ...
                    var expectedMarginUsage =
                        (midStrikeCall.Strike - lowStrikeCall.Strike)
                        * Securities[lowStrikeCall.Symbol].SymbolProperties.ContractMultiplier
                        * 5;
