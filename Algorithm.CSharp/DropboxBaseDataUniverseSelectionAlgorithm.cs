...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class DropboxBaseDataUniverseSelectionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.07%"},
            {"Average Loss", "-0.07%"},
            {"Compounding Annual Return", "14.438%"},
            {"Drawdown", "10.600%"},
            {"Expectancy", "0.066"},
            {"Net Profit", "14.438%"},
            {"Sharpe Ratio", "1.043"},
            {"Probabilistic Sharpe Ratio", "49.256%"},
            {"Loss Rate", "46%"},
            {"Win Rate", "54%"},
            ...
            {"Sortino Ratio", "1.218"},
            {"Return Over Maximum Drawdown", "1.36"},
            {"Portfolio Turnover", "1.625"},
            ...
            {"OrderListHash", "e1b42fe7dbf7dc940a03ffc5dd7c8d09"}
        };
    }
}
