...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class DropboxBaseDataUniverseSelectionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Total Fees", "$8669.33"},
            {"Fitness Score", "0.675"},
            {"Kelly Criterion Estimate", "5.113"},
            {"Kelly Criterion Probability Value", "0"},
            {"Sortino Ratio", "1.124"},
            {"Return Over Maximum Drawdown", "1.242"},
            {"Portfolio Turnover", "1.64"},
            {"Total Insights Generated", "6441"},
            {"Total Insights Closed", "6428"},
            {"Total Insights Analysis Completed", "6428"},
            {"Long Insight Count", "3227"},
            {"Short Insight Count", "0"},
            {"Long/Short Ratio", "100%"},
            {"Estimated Monthly Alpha Value", "$5408154.0591"},
            {"Total Accumulated Estimated Alpha Value", "$65829253.0196"},
            {"Mean Population Estimated Insight Value", "$10241.0163"},
            {"Mean Population Direction", "54.851%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "48.406%"},
            {"Rolling Averaged Population Magnitude", "0%"},
            {"OrderListHash", "-960517453"}
        };
    }
}
