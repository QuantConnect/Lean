...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class CfdTimeZonesRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Total Fees", "$0.00"},
            {"Fitness Score", "0.5"},
            {"Kelly Criterion Estimate", "50.319"},
            {"Kelly Criterion Probability Value", "0.335"},
            {"Sortino Ratio", "79228162514264337593543950335"},
            {"Return Over Maximum Drawdown", "-325.922"},
            {"Portfolio Turnover", "9.561"},
            {"Total Insights Generated", "167"},
            {"Total Insights Closed", "166"},
            {"Total Insights Analysis Completed", "166"},
            {"Long Insight Count", "84"},
            {"Short Insight Count", "0"},
            {"Long/Short Ratio", "100%"},
            {"Estimated Monthly Alpha Value", "€0"},
            {"Total Accumulated Estimated Alpha Value", "€0"},
            {"Mean Population Estimated Insight Value", "€0"},
            {"Mean Population Direction", "49.1659%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "48.9758%"},
            {"Rolling Averaged Population Magnitude", "0%"},
            {"OrderListHash", "962851151"}
        };
    }
}
