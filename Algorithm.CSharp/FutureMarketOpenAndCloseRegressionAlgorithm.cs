...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class FutureMarketOpenAndCloseRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public void EveryDayBeforeMarketClose()
        {
            ...
            {
                throw new TestException($"Expected market close date was {expectedMarketClose} but received {Time}");
            }
        }
        ...
        public void EveryDayAfterMarketOpen()
        {
            ...
            {
                throw new TestException($"Expected market open date was {expectedMarketOpen} but received {Time}");
            }
        }
        ...
        public override void OnEndOfAlgorithm()
        {
            ...
            {
                throw new TestException($"_afterMarketOpenQueue and _beforeMarketCloseQueue should be empty");
            }
        }
