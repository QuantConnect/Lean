...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class OptionStrategyFilteringUniverseSingleCallRegressionAlgorithm : OptionStrategyFilteringUniverseBaseAlgorithm
    {
        ...
        {
            _func = u => u.IncludeWeeklys().Strikes(-10, +10).Expiration(0, 180).SingleCall(30, 0);
            _expectedCount = 1;
        ...
        protected override void TestFiltering(OptionChain chain)
        {
            ...
            var strategy = OptionStrategies.NakedCall(_optionSymbol, strike, expiry);
            Buy(strategy, 1);
        }
        ...
        /// </summary>
        public override long DataPoints => 461173;
