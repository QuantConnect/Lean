...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class EmitInsightsAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Net Profit", "-0.794%"},
            {"Sharpe Ratio", "-2.224"},
            {"Probabilistic Sharpe Ratio", "32.477%"},
            {"Loss Rate", "50%"},
            {"Win Rate", "50%"},
            ...
            {"Information Ratio", "-8.118"},
            {"Tracking Error", "0.204"},
            {"Treynor Ratio", "-1.441"},
            {"Total Fees", "$16.26"},
            {"Fitness Score", "0.003"},
            {"Kelly Criterion Estimate", "12.309"},
            {"Kelly Criterion Probability Value", "0.369"},
            {"Sortino Ratio", "-20.203"},
            {"Return Over Maximum Drawdown", "-38.512"},
