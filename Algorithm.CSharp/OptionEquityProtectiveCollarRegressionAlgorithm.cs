...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class OptionEquityProtectiveCollarRegressionAlgorithm
        ...
        public override void OnData(Slice slice)
        {
            if (!Portfolio.Invested)
            {
                ...
                )
                {
                    ...
                    var put = contracts.First(contract =>
                    ...
                    AssertOptionStrategyIsPresent(
                        OptionStrategyDefinitions.ProtectiveCollar.Name,
                        1
                    );

                    var putOutOfTheMoneyAmount = (
                        (Option)Securities[put.Symbol]
                    ).OutOfTheMoneyAmount(Securities[underlying].Price);
                    var expectedMarginUsage =
                        Math.Min(putOutOfTheMoneyAmount + 0.1m * put.Strike, 0.25m * call.Strike)
                        * 100;
