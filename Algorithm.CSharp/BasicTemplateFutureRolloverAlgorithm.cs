...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class BasicTemplateFutureRolloverAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "0%"},
            {"Compounding Annual Return", "3.059%"},
            {"Drawdown", "0.000%"},
            {"Expectancy", "0"},
            ...
            {"Sharpe Ratio", "1.307"},
            {"Sortino Ratio", "0"},
            {"Probabilistic Sharpe Ratio", "83.897%"},
            {"Loss Rate", "0%"},
            {"Win Rate", "0%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "0.017"},
            ...
            {"OrderListHash", "83ed55b1489daabcf77218c3c81e9db3"}
        };
    }  
}
