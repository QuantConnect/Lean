...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class NoMarginCallExpectedRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "2.46%"},
            {"Average Loss", "-1.94%"},
            {"Compounding Annual Return", "10080.272%"},
            {"Drawdown", "9.800%"},
            {"Expectancy", "0.363"},
            {"Net Profit", "6.089%"},
            {"Sharpe Ratio", "42.74"},
            {"Probabilistic Sharpe Ratio", "63.951%"},
            {"Loss Rate", "40%"},
            {"Win Rate", "60%"},
            ...
            {"Annual Variance", "0.684"},
            {"Information Ratio", "54.843"},
            {"Tracking Error", "0.61"},
            {"Treynor Ratio", "9.5"},
            {"Total Fees", "$103.40"},
            {"Fitness Score", "0.999"},
            {"Kelly Criterion Estimate", "43.259"},
            {"Kelly Criterion Probability Value", "0.234"},
            {"Sortino Ratio", "79228162514264337593543950335"},
            {"Return Over Maximum Drawdown", "121.243"},
            ...
            {"Estimated Monthly Alpha Value", "$127826.6777"},
            {"Total Accumulated Estimated Alpha Value", "$20594.2981"},
            {"Mean Population Estimated Insight Value", "$2288.2553"},
            {"Mean Population Direction", "55.5556%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "30.1964%"},
            {"Rolling Averaged Population Magnitude", "0%"},
            {"OrderListHash", "24037640"}
        };
    }
}
