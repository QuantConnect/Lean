...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class ConsolidateDifferentTickTypesRegressionAlgorithm: QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public void OnQuoteTick(Tick tick)
        {
            ...
            {
                throw new TestException($"The type of the tick should be Quote, but was {tick.TickType}");
            }
        }
        ...
        public void OnTradeTick(Tick tick)
        {
            ...
            {
                throw new TestException($"The type of the tick should be Trade, but was {tick.TickType}");
            }
        }
        ...
        public override void OnEndOfAlgorithm()
        {
            ...
            {
                throw new TestException($"There should have been at least one tick in OnQuoteTick() method, but there wasn't");
            }

            if (!_thereIsAtLeastOneTradeTick)
            {
                throw new TestException($"There should have been at least one tick in OnTradeTick() method, but there wasn't");
            }
        }
