...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class SetHoldingsLiquidateExistingHoldingsMultipleTargetsRegressionAlgorithm
        : SetHoldingsMultipleTargetsRegressionAlgorithm
    {
        public override void OnData(Slice data)
        {
            ...
            {
                SetHoldings(
                    new List<PortfolioTarget> { new("SPY", 0.8m), new("IBM", 0.2m) },
