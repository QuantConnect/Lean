...
namespace QuantConnect.Algorithm.Examples
{
    ...
    public class CustomChartingGBPJPYAlgorithm : QCAlgorithm
    {
        ...
        public override void Initialize()
        {
            ...
            AddSecurity(SecurityType.Forex, "gbpjpy", resolution: Resolution.Minute);

            //Chart - Master Container for the Chart:
            Chart equityPlot = new Chart("Trade Plot");
            ...
            equityPlot.AddSeries(buyOrders);
            equityPlot.AddSeries(sellOrders);
            equityPlot.AddSeries(assetPrice);
            AddChart(equityPlot);
        ...
        public void OnData(TradeBars data)
        {
            ...
            {
                Order("gbpjpy", (int)(Portfolio.Cash / data["gbpjpy"].Close));
