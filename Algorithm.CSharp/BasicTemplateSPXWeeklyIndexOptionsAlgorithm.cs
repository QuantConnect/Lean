...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class BasicTemplateSPXWeeklyIndexOptionsAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        /// </summary>
        public virtual long DataPoints => 65035;
        ...
        public virtual Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "-0.73%"},
            {"Compounding Annual Return", "50.548%"},
            {"Drawdown", "0.400%"},
            {"Expectancy", "-1"},
            {"Net Profit", "0.526%"},
            {"Sharpe Ratio", "-12.9"},
            ...
            {"Sortino Ratio", "72.247"},
            {"Return Over Maximum Drawdown", "562.121"},
            ...
            {"OrderListHash", "48a9e8aac74570beac9f3fd58a8a8fab"}
        };
    }
}
