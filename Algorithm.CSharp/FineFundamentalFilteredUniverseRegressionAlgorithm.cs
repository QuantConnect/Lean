...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class FineFundamentalFilteredUniverseRegressionAlgorithm
        : QCAlgorithm,
            IRegressionAlgorithmDefinition
    {
        ...
        public override void Initialize()
        {
            ...
            AddUniverse(
                new ConstituentsUniverse(customUniverseSymbol, UniverseSettings),
            ...
            if (!Portfolio.Invested)
            {
                if (slice.Keys.Single().Value != "AAPL")
                {
                    throw new RegressionTestException(
                        $"Unexpected symbol was added to the universe: {slice.Keys.Single()}"
                    );
                }
