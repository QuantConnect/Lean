...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class ContinuousBackMonthRawFutureRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "6.43%"},
            {"Average Loss", "0%"},
            {"Compounding Annual Return", "13.184%"},
            {"Drawdown", "1.600%"},
            {"Expectancy", "0"},
            {"Start Equity", "100000"},
            {"End Equity", "106433.2"},
            ...
            {"Sharpe Ratio", "1.346"},
            {"Sortino Ratio", "0.782"},
            {"Probabilistic Sharpe Ratio", "65.794%"},
            {"Adjusted Sharpe Ratio", "1.491"},
            {"Loss Rate", "0%"},
            {"Win Rate", "100%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "0.069"},
            ...
            {"Drawdown Recovery", "2"},
            {"OrderListHash", "825ea8c1a4d37ce547f5698ffcdf5e89"}
        };
    }
}
