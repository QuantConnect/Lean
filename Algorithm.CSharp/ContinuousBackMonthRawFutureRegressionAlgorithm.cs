...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class ContinuousBackMonthRawFutureRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        /// </summary>
        public int AlgorithmHistoryDataPoints => 145;
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "1.48%"},
            {"Average Loss", "0%"},
            {"Compounding Annual Return", "15.404%"},
            {"Drawdown", "1.600%"},
            {"Expectancy", "0"},
            {"Start Equity", "100000"},
            {"End Equity", "107478.9"},
            ...
            {"Sharpe Ratio", "1.595"},
            {"Sortino Ratio", "0.919"},
            {"Probabilistic Sharpe Ratio", "85.092%"},
            {"Loss Rate", "0%"},
            {"Win Rate", "100%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "0.076"},
            ...
            {"OrderListHash", "1885b50189e4934573546f3c572bb6fe"}
        };
    }
}
