...
namespace QuantConnect.Algorithm.CSharp.AltData
{
    public class CachedAlternativeDataAlgorithm : QCAlgorithm
    {
        ...
        public override void Initialize()
        {
            ...
            _usEnergy = AddData<USEnergyWeeklySupplyEstimate>(USEnergy.GrossInputsIntoRefineries).Symbol;
        }
        ...
        public override void OnData(Slice data)
        {
            ...
            {
                var inputIntoRefineries = data.Get<USEnergyWeeklySupplyEstimate>(_usEnergy);
