...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class OptionEquityBullCallSpreadRegressionAlgorithm
        ...
        public override void OnData(Slice slice)
        {
            if (!Portfolio.Invested)
            {
                ...
                )
                {
                    ...
                    var shortCall = callContracts.First(contract =>
                        contract.Strike > longCall.Strike && contract.Expiry == longCall.Expiry
                    );
