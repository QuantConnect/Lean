...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class OptionChainSubscriptionRemovalRegressionAlgorithm
        : QCAlgorithm,
            IRegressionAlgorithmDefinition
    {
        ...
        {
            _optionCount += changes.AddedSecurities.Count(security =>
        ...
        public override void OnEndOfAlgorithm()
        {
            if (_optionCount != 45)
            {
                throw new RegressionTestException(
                    $"Unexpected option count {_optionCount}, expected 45"
                );
            }
        }
        ...
        private string GetStatusLog()
        {
            ...
            {
                throw new RegressionTestException(
                    "Subscriptions aren't getting removed as expected!"
                );
            }
        ...
        {
            public TestOptionUniverseSelectionModel(
