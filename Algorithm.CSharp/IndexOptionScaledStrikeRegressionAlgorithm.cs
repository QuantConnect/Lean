...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class IndexOptionScaledStrikeRegressionAlgorithm
        : QCAlgorithm,
        ...
        public override void OnEndOfAlgorithm()
        {
            ...
            if (!exerciseOrders.Where(x => x.Tag.Contains("OTM")).Any())
            {
                throw new RegressionTestException(
                    $"At least one order should have been exercised OTM"
                );
            }
            ...
            {
                throw new RegressionTestException(
                    $"At least one order should have been exercised ITM"
                );
            }
            ...
            {
                throw new RegressionTestException(
                    $"Since one order was expected to be exercised ITM, Total Portfolio Value was expected to be higher than {_initialCash}, but was {Portfolio.TotalPortfolioValue}"
                );
            }
        }
