...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class AddUniverseSelectionModelAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "-0.01%"},
            {"Compounding Annual Return", "-14.727%"},
            {"Drawdown", "3.300%"},
            {"Expectancy", "-1"},
            {"Net Profit", "-0.174%"},
            {"Sharpe Ratio", "-0.149"},
            {"Probabilistic Sharpe Ratio", "44.980%"},
            {"Loss Rate", "100%"},
            {"Win Rate", "0%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "-2.03"},
            {"Beta", "0.996"},
            {"Annual Standard Deviation", "0.374"},
            {"Annual Variance", "0.14"},
            {"Information Ratio", "-6.762"},
            {"Tracking Error", "0.301"},
            {"Treynor Ratio", "-0.056"},
            {"Total Fees", "$23.21"},
