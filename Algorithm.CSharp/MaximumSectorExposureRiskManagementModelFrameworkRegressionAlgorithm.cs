...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class MaximumSectorExposureRiskManagementModelFrameworkRegressionAlgorithm : BaseFrameworkRegressionAlgorithm
    {
        ...
        /// </summary>
        public override int AlgorithmHistoryDataPoints => 25;
        ...
        public override Dictionary<string, string> ExpectedStatistics => new()
        {
            ...
            {"Average Win", "0.11%"},
            {"Average Loss", "-0.16%"},
            {"Compounding Annual Return", "-2.359%"},
            {"Drawdown", "1.300%"},
            {"Expectancy", "-0.524"},
            {"Start Equity", "100000"},
            {"End Equity", "99413.42"},
            ...
            {"Sharpe Ratio", "-1.246"},
            {"Sortino Ratio", "-0.969"},
            {"Probabilistic Sharpe Ratio", "12.238%"},
            {"Loss Rate", "71%"},
            {"Win Rate", "29%"},
            ...
            {"Drawdown Recovery", "0"},
            {"OrderListHash", "a665b4d8fe35423cad9bef8fae2f09fa"}
        };
    }
}
