...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class FutureOptionDailyRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public override void Initialize()
        {
            ...
            {
                throw new TestException($"Contract {DcOption} was not the expected contract {expectedContract}");
            }
        ...
        public override void OnEndOfAlgorithm()
        {
            ...
            {
                throw new TestException("Future option order failed to fill correctly");
            }
        }
