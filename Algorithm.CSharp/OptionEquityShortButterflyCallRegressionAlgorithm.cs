...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class OptionEquityShortButterflyCallRegressionAlgorithm
            ...
            if (!Portfolio.Invested)
            {
                ...
                )
                {
                    ...
                    var expectedMarginUsage = Math.Max(
                        (middleCall.Strike - lowerCall.Strike)
                            * Securities[lowerCall.Symbol].SymbolProperties.ContractMultiplier
                            * 10,
                        0
                    );
