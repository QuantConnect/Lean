...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class LongAndShortStrangleStrategiesAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public override void OnEndOfAlgorithm()
        {
            ...
            if (ordersCount != 4)
            {
                throw new Exception("Expected 4 orders to have been submitted and filled, 2 for buying the strangle and 2 for the liquidation." +
                    $" Actual {ordersCount}");
            }
        }
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"OrderListHash", "1f7c12a505b1c6e8f0bc6f5aa217e57b"}
        };
    }
}
