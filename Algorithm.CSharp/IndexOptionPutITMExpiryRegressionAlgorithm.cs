...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class IndexOptionPutITMExpiryRegressionAlgorithm
        : QCAlgorithm,
            IRegressionAlgorithmDefinition
    {
        ...
        )
        {
            ...
            {
                throw new RegressionTestException(
                    $"Liquidated index option contract, but not at the expected time. Expected: {expectedLiquidationTimeUtc:yyyy-MM-dd HH:mm:ss} - found {orderEvent.UtcTime:yyyy-MM-dd HH:mm:ss}"
                );
            }
