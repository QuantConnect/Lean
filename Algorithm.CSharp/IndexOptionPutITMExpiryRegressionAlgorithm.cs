...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class IndexOptionPutITMExpiryRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "-51.16%"},
            {"Compounding Annual Return", "-80.025%"},
            {"Drawdown", "13.400%"},
            {"Expectancy", "-1"},
            {"Net Profit", "-10.714%"},
            {"Sharpe Ratio", "-1.782"},
            {"Probabilistic Sharpe Ratio", "1.398%"},
            {"Loss Rate", "100%"},
            {"Win Rate", "0%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "-0.668"},
            ...
            {"Sortino Ratio", "-0.637"},
            {"Return Over Maximum Drawdown", "-6.835"},
            ...
            {"OrderListHash", "7252ee0ef12a787fae0061031b51f2db"}
        };
    }
}
