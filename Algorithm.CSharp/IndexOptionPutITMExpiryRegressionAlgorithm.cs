...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class IndexOptionPutITMExpiryRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "-50.30%"},
            {"Compounding Annual Return", "-77.379%"},
            {"Drawdown", "12.500%"},
            {"Expectancy", "-1"},
            {"Net Profit", "-9.924%"},
            {"Sharpe Ratio", "-1.96"},
            {"Probabilistic Sharpe Ratio", "0.631%"},
            {"Loss Rate", "100%"},
            {"Win Rate", "0%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "-0.641"},
            ...
            {"Sortino Ratio", "-0.699"},
            {"Return Over Maximum Drawdown", "-7.51"},
            ...
            {"OrderListHash", "25c9f7e8351e78fbce8e7f7c6a9d0c26"}
        };
    }
}
