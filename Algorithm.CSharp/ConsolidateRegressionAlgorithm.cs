...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class ConsolidateRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "0%"},
            {"Compounding Annual Return", "258383798.521%"},
            {"Drawdown", "15.900%"},
            {"Expectancy", "0"},
            {"Net Profit", "16.184%"},
            {"Sharpe Ratio", "43159514181.761"},
            {"Probabilistic Sharpe Ratio", "0%"},
            {"Loss Rate", "0%"},
            {"Win Rate", "0%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "69060512456.974"},
            {"Beta", "8.93"},
            {"Annual Standard Deviation", "1.6"},
            {"Annual Variance", "2.56"},
            {"Information Ratio", "48505472683.136"},
            {"Tracking Error", "1.424"},
            {"Treynor Ratio", "7733930812.687"},
            {"Total Fees", "$20.35"},
            ...
            {"Return Over Maximum Drawdown", "23999.418"},
            {"Portfolio Turnover", "3.517"},
