...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class BasicTemplateFuturesFrameworkWithExtendedMarketAlgorithm : BasicTemplateFuturesFrameworkAlgorithm
    {
        ...
        public override Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "0%"},
            {"Compounding Annual Return", "-80.190%"},
            {"Drawdown", "4.000%"},
            {"Expectancy", "0"},
            {"Net Profit", "-2.067%"},
            {"Sharpe Ratio", "-6.098"},
            {"Probabilistic Sharpe Ratio", "9.123%"},
            {"Loss Rate", "0%"},
            {"Win Rate", "0%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "-1.19"},
            ...
            {"Sortino Ratio", "-14.529"},
            {"Return Over Maximum Drawdown", "-53.434"},
            ...
            {"OrderListHash", "6dd1fcfd6f33998cb8d872a89e0426a4"}
        };
    }
}
