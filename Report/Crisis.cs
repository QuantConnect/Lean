...
namespace QuantConnect.Report
{
    ...
    public class Crisis
    {
        ...
        /// </summary>
        public static readonly Dictionary<CrisisEvent, Crisis> Events = new Dictionary<
            CrisisEvent,
            Crisis
        >
        {
            ...
            },
            {
                ...
                new Crisis("Flash Crash 2010", new DateTime(2010, 5, 1), new DateTime(2010, 5, 22))
            },
            {
            ...
            },
            {
                ...
                new Crisis("Meme Season 2021", new DateTime(2021, 1, 1), new DateTime(2021, 5, 15))
            },
            {
            ...
            {
                CrisisEvent.AIBoom,
                new Crisis("AI Boom 2022-Present", new DateTime(2022, 11, 30), DateTime.Now)
            },
        };
