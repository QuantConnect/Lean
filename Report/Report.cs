    ...
    public class Report
    {
        ...
        public Report(string name, string description, string version, BacktestResult backtest, LiveResult live, string pointInTimePortfolioDestination = null)
        {
            ...
            _elements = new List<IReportElement>
            {
                ...
                new TextReportElement("account currency", ReportKey.AccountCurrency, backtestConfiguration?.AccountCurrency),
                new TextReportElement("live account currency", ReportKey.LiveAccountCurrency, liveConfiguration?.AccountCurrency),
                new TextReportElement("brokerage", ReportKey.Brokerage, backtestConfiguration?.BrokerageName.ToString()),
                new TextReportElement("live brokerage", ReportKey.LiveBrokerage, liveConfiguration?.BrokerageName.ToString()),
                new TextReportElement("account type", ReportKey.AccountType, backtestConfiguration?.AccountType.ToString()),
                new TextReportElement("live account type", ReportKey.LiveAccountType, liveConfiguration?.AccountType.ToString()),
