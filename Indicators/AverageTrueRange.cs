...
namespace QuantConnect.Indicators
{
    ...
    public class AverageTrueRange : TradeBarIndicator
    {
        ...
        /// </summary>
        public IndicatorBase<TradeBarBase> TrueRange { get; private set; } 
            ...
            : base(name)
        {
            ...
            TradeBarBase previous = null;
            TrueRange = new FunctionalIndicator<TradeBarBase>(name + "_TrueRange", currentBar =>
            {
        ...
        public static decimal ComputeTrueRange(TradeBarBase previous, TradeBarBase current)
        {
