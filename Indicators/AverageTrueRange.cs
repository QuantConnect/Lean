...
namespace QuantConnect.Indicators
{
    ...
    public class AverageTrueRange : TradeBarIndicator
    {
        ...
        /// </summary>
        public IndicatorBase<VolumeBar> TrueRange { get; private set; } 
            ...
            : base(name)
        {
            ...
            VolumeBar previous = null;
            TrueRange = new FunctionalIndicator<VolumeBar>(name + "_TrueRange", currentBar =>
            {
        ...
        public static decimal ComputeTrueRange(VolumeBar previous, VolumeBar current)
        {
