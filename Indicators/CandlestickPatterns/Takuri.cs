    ...
    public class Takuri : CandlestickPattern
    {
        ...
        public Takuri(string name)
            : base(
                ...
                Math.Max(
                    ...
                    CandleSettings.Get(CandleSettingType.ShadowVeryLong).AveragePeriod
                ) + 1
            )
        {
            ...
            _shadowVeryShortAveragePeriod = CandleSettings
                ...
                .AveragePeriod;
            _shadowVeryLongAveragePeriod = CandleSettings
                .Get(CandleSettingType.ShadowVeryLong)
                .AveragePeriod;
        }
        ...
        )
        {
            if (!IsReady)
            {
                ...
                {
                    _shadowVeryLongPeriodTotal += GetCandleRange(
            ...
            _shadowVeryShortPeriodTotal +=
                GetCandleRange(CandleSettingType.ShadowVeryShort, input)
                - GetCandleRange(
                    CandleSettingType.ShadowVeryShort,
                    window[_shadowVeryShortAveragePeriod]
                );

            _shadowVeryLongPeriodTotal +=
                GetCandleRange(CandleSettingType.ShadowVeryLong, input)
                - GetCandleRange(
                    CandleSettingType.ShadowVeryLong,
                    window[_shadowVeryLongAveragePeriod]
                );
