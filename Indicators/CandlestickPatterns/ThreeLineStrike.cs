    ...
    public class ThreeLineStrike : CandlestickPattern
    {
        ...
        )
        {
            ...
            if (
                ...
                window[2].Open
                    >= Math.Min(window[3].Open, window[3].Close)
                        - GetCandleAverage(CandleSettingType.Near, _nearPeriodTotal[3], window[3])
                && window[2].Open
                    <= Math.Max(window[3].Open, window[3].Close)
                        + GetCandleAverage(CandleSettingType.Near, _nearPeriodTotal[3], window[3])
                &&
                ...
                && window[1].Open
                    <= Math.Max(window[2].Open, window[2].Close)
                        + GetCandleAverage(CandleSettingType.Near, _nearPeriodTotal[2], window[2])
                && (
                    (
                        // if three white
