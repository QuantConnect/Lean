...
namespace QuantConnect.Indicators.CandlestickPatterns
{
    ...
    public class ConcealedBabySwallow : CandlestickPattern
    {
        ...
        public ConcealedBabySwallow(string name)
            : base(
                name,
                CandleSettings.Get(CandleSettingType.ShadowVeryShort).AveragePeriod + 3 + 1
            )
        {
        ...
        )
        {
            if (!IsReady)
            {
                ...
                {
                    _shadowVeryShortPeriodTotal[3] += GetCandleRange(
            ...
            if (
                ...
                &&
                // 1st: marubozu
                GetLowerShadow(window[3])
                    < GetCandleAverage(
                        CandleSettingType.ShadowVeryShort,
                        _shadowVeryShortPeriodTotal[3],
                        window[3]
                    )
