...
namespace QuantConnect.Indicators
{
    ...
    public class KeltnerChannels : TradeBarIndicator
    {
        ...
        /// </summary>
        public IndicatorBase<TradeBarBase> UpperBand
        {
            get; private set;
        }
        ...
        /// </summary>
        public IndicatorBase<TradeBarBase> LowerBand
        {
            get; private set;
        }
        ...
        /// </summary>
        public IndicatorBase<TradeBarBase> AverageTrueRange
        {
            get; private set;
        }
            ...
            : base(name)
        {
            ...
            //Compute Lower Band
            LowerBand = new FunctionalIndicator<TradeBarBase>(name + "_LowerBand",
            ...
            //Compute Upper Band
            UpperBand = new FunctionalIndicator<TradeBarBase>(name + "_UpperBand",
