...
{
    /// <summary>
    /// The Mesa Adaptive Moving Average (MAMA) by John Ehlers
    /// </summary>
    public class MesaAdaptiveMovingAverage : WindowIndicator<IndicatorDataPoint>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the MesaAdaptiveMovingAverage class with the specified name and limits
        /// </summary>
        ...
        public MesaAdaptiveMovingAverage(string name, decimal fastLimit = .5m, decimal slowLimit = .05m)
            : base(name, 6)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the MesaAdaptiveMovingAverage class with the default name and limits
        /// </summary>
        /// <param name="fastLimit">The maximum allowed value to alpha of the indicator</param>
        /// <param name="slowLimit">The minimum allowed value to alpha of the indicator</param>
        public MesaAdaptiveMovingAverage(decimal fastLimit = .5m, decimal slowLimit = .05m)
            : this($"MAMA({fastLimit},{slowLimit})", fastLimit, slowLimit)
        {
        }
