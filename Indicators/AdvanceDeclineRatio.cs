...
namespace QuantConnect.Indicators
{
    ...
    /// </summary>
    public class AdvanceDeclineRatio : TradeBarIndicator, IIndicatorWarmUpPeriodProvider
    {
        ...
        /// </summary>
        public AdvanceDeclineRatio(string name) : base(name)
        {
        }
        ...
        protected override decimal ComputeNextValue(TradeBar input)
        {
            ...
            return (decimal)advStocks.Count() / dclStocks.Count();
        }
