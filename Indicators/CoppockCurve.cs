...
namespace QuantConnect.Indicators
{
    ...
    public class CoppockCurve : IndicatorBase<IndicatorDataPoint>
    {
        ...
        /// </summary>
        public CoppockCurve()
            : this("CC_11_14_10", shortRocPeriod: 11, longRocPeriod: 14, lwmaPeriod: 10)
        {
        }
        ...
        public CoppockCurve(int shortRocPeriod, int longRocPeriod, int lwmaPeriod) :
            this($"CC_{shortRocPeriod}_{longRocPeriod}_{lwmaPeriod}", shortRocPeriod, longRocPeriod, lwmaPeriod)
        {
        }
