...
namespace QuantConnect.Tests.Engine.DataFeeds
{
    ...
    public class DataManagerTests
    {
        ...
        [Test]
        public void UniverseMembersAreCleanedUpWhenUniverseIsRemovedAndReAddedInSameTimeStep()
        {
            AlgorithmRunner.RunLocalBacktest("OptionUniverseRemovedAndReAddedMemberCleanupRegressionAlgorithm",
                new Dictionary<string, string>
                {
                    {"Total Orders", "0"},
                    {"Average Win", "0%"},
                ...
                Language.Python,
                AlgorithmStatus.Completed,
                algorithmLocation: "../../../Algorithm.Python/OptionUniverseRemovedAndReAddedMemberCleanupRegressionAlgorithm.py");
        }
