...
namespace QuantConnect.Tests.Engine.DataFeeds.Enumerators
{
    ...
    public class FillForwardEnumeratorTests
    {
        ...
        public void FillForwardsUntilSubscriptionEnd()
        {
            ...
            using var fillForwardEnumerator = new FillForwardEnumerator(
                enumerator,
                exchange,
                Ref.Create(fillForwardResolution),
                false,
                subscriptionEndTime,
                dataResolution,
                exchange.TimeZone,
        ...
        public void DelistingEvents()
        {
            ...
            Assert.AreEqual(
                ...
                ((Delisting)fillForwardEnumerator.Current).Type
            );
        ...
        public void GetReferenceDateIntervals_RoundDown(bool strictEndTimes)
        {
            ...
            // Time should advance!
            Assert.AreEqual(
                new DateTime(2017, 7, 22, 17, 1, 0),
                fillForwardEnumerator.Current.Time
            );
            Assert.AreEqual(
                new DateTime(2017, 7, 23, 17, 1, 0),
                fillForwardEnumerator.Current.EndTime
            );
            Assert.AreEqual(1, fillForwardEnumerator.Current.Value);
        ...
        public void FillsForwardMidDay()
        {
            ...
            Assert.AreEqual(
                dataResolution,
                fillForwardEnumerator.Current.EndTime - fillForwardEnumerator.Current.Time
            );
        ...
        public void FillsForwardFromPreMarket()
        {
            ...
            var fillForwardEnumerator = new FillForwardEnumerator(
                enumerator,
                exchange,
                Ref.Create(TimeSpan.FromMinutes(1)),
                isExtendedMarketHours,
                data.Last().EndTime,
                dataResolution,
                exchange.TimeZone,
        ...
        public void FillsForwardFromPreMarketMinuteToSecond()
        {
            ...
            var fillForwardEnumerator = new FillForwardEnumerator(
                enumerator,
                exchange,
                Ref.Create(TimeSpan.FromSeconds(1)),
                isExtendedMarketHours,
                data.Last().EndTime,
                dataResolution,
                exchange.TimeZone,
            ...
            for (var i = 1; i < 60; i++)
            {
                Assert.IsTrue(fillForwardEnumerator.MoveNext());
                Assert.AreEqual(
                    reference.Date.Add(new TimeSpan(9, 30, i)),
                    fillForwardEnumerator.Current.EndTime
                );
                Assert.AreEqual(1, fillForwardEnumerator.Current.Value);
                Assert.IsTrue(fillForwardEnumerator.Current.IsFillForward);
            ...
            Assert.IsTrue(fillForwardEnumerator.MoveNext());
            Assert.AreEqual(
                reference.Date.Add(new TimeSpan(9, 31, 0)),
                fillForwardEnumerator.Current.EndTime
            );
        ...
        public void FillsForwardToNextDay()
        {
            ...
            var fillForwardEnumerator = new FillForwardEnumerator(
                enumerator,
                exchange,
                Ref.Create(TimeSpan.FromHours(1)),
                isExtendedMarketHours,
                end,
                dataResolution,
                exchange.TimeZone,
        ...
        public void FillsForwardDailyOnHoursInMarketHours(bool strictEndTimes)
        {
            ...
            var exchange = new SecurityExchange(
                MarketHoursDatabase
                    .FromDataFolder()
            ...
            Assert.IsTrue(fillForwardEnumerator.MoveNext());
            Assert.AreEqual(
                reference.Add(expectedBarPeriod),
                fillForwardEnumerator.Current.EndTime
            );
            Assert.AreEqual(0, fillForwardEnumerator.Current.Value);
            Assert.IsFalse(fillForwardEnumerator.Current.IsFillForward);
            ...
            Assert.IsTrue(fillForwardEnumerator.MoveNext());
            Assert.AreEqual(
                fillForwardReferenceTime.AddHours(1),
                fillForwardEnumerator.Current.EndTime
            );
            Assert.AreEqual(0, fillForwardEnumerator.Current.Value);
            Assert.IsTrue(fillForwardEnumerator.Current.IsFillForward);
            ...
            Assert.IsTrue(fillForwardEnumerator.MoveNext());
            Assert.AreEqual(
                fillForwardReferenceTime.AddHours(2),
                fillForwardEnumerator.Current.EndTime
            );
            Assert.AreEqual(0, fillForwardEnumerator.Current.Value);
            Assert.IsTrue(fillForwardEnumerator.Current.IsFillForward);
            ...
            Assert.IsTrue(fillForwardEnumerator.MoveNext());
            Assert.AreEqual(
                fillForwardReferenceTime.AddHours(3),
                fillForwardEnumerator.Current.EndTime
            );
            Assert.AreEqual(0, fillForwardEnumerator.Current.Value);
            Assert.IsTrue(fillForwardEnumerator.Current.IsFillForward);
            ...
            Assert.IsTrue(fillForwardEnumerator.MoveNext());
            Assert.AreEqual(
                fillForwardReferenceTime.AddHours(4),
                fillForwardEnumerator.Current.EndTime
            );
            Assert.AreEqual(0, fillForwardEnumerator.Current.Value);
            Assert.IsTrue(fillForwardEnumerator.Current.IsFillForward);
            ...
            Assert.IsTrue(fillForwardEnumerator.MoveNext());
            Assert.AreEqual(
                fillForwardReferenceTime.AddHours(5),
                fillForwardEnumerator.Current.EndTime
            );
            Assert.AreEqual(0, fillForwardEnumerator.Current.Value);
            Assert.IsTrue(fillForwardEnumerator.Current.IsFillForward);
            ...
            Assert.IsTrue(fillForwardEnumerator.MoveNext());
            Assert.AreEqual(
                fillForwardReferenceTime.AddHours(6),
                fillForwardEnumerator.Current.EndTime
            );
            Assert.AreEqual(0, fillForwardEnumerator.Current.Value);
            Assert.IsTrue(fillForwardEnumerator.Current.IsFillForward);
            ...
            if (!strictEndTimes)
            {
                ...
                Assert.IsTrue(fillForwardEnumerator.MoveNext());
                Assert.AreEqual(
                    fillForwardReferenceTime.AddHours(7),
                    fillForwardEnumerator.Current.EndTime
                );
                Assert.AreEqual(0, fillForwardEnumerator.Current.Value);
                Assert.IsTrue(fillForwardEnumerator.Current.IsFillForward);
            ...
            Assert.IsTrue(fillForwardEnumerator.MoveNext());
            Assert.AreEqual(
                strictEndTimes ? reference.AddDays(1).Add(expectedBarPeriod) : reference.AddDays(2),
                fillForwardEnumerator.Current.EndTime
            );
            Assert.AreEqual(1, fillForwardEnumerator.Current.Value);
            Assert.IsFalse(fillForwardEnumerator.Current.IsFillForward);
        ...
        public void FillsForwardDailyMissingDays(bool strictEndTimes)
        {
            ...
            var fillForwardEnumerator = new FillForwardEnumerator(
                ...
                data.Last().EndTime.AddDays(1.10),
                dataResolution,
                exchange.TimeZone,
                strictEndTimes
            );
        ...
        public void FillsForwardHourlyOnMinutesBeginningOfDay()
        {
            ...
            var data = new BaseData[]
            {
                ...
                {
                    Value = 1,
                    Time = reference.Date.AddHours(9),
                    Period = dataResolution,
                    Volume = 200
                },
            }.ToList();
        ...
        public void FillsForwardMissingDaysOnFillForwardResolutionOfAnHour(bool strictEndTimes)
        {
            ...
            {
                Log.Debug(
                    $"FillsForwardMissingDaysOnFillForwardResolutionOfAnHour(): {fillForwardEnumerator.Current.EndTime.ToStringInvariant()}"
                );
        ...
        public void OandaFillsForwardDailyForexOnWeekends()
        {
            ...
            var data = new BaseData[]
            {
                ...
                {
                    Value = 0,
                    Time = new DateTime(2012, 7, 19, 20, 0, 0),
                    Period = Time.OneDay
                },
                // sunday 7/22
                new QuoteBar
                {
                    Value = 1,
                    Time = new DateTime(2012, 7, 21, 20, 0, 0),
                    Period = Time.OneDay
                },
                // monday 7/23
                new QuoteBar
                {
                    Value = 2,
                    Time = new DateTime(2012, 7, 22, 20, 0, 0),
                    Period = Time.OneDay
                },
            }.ToList();
            var enumerator = data.GetEnumerator();
            ...
            var exchange = new ForexExchange(
                marketHours.GetExchangeHours(market, symbol, SecurityType.Forex)
            );
            ...
            while (fillForwardEnumerator.MoveNext())
            {
                ...
                Log.Debug(
                    fillForwardEnumerator.Current.Time.DayOfWeek
                        + " "
                        + fillForwardEnumerator.Current.Time
                        + " - "
                        + fillForwardEnumerator.Current.EndTime.DayOfWeek
                        + " "
                        + fillForwardEnumerator.Current.EndTime
                );
                dailyBarsEmitted++;
        ...
        public void HandlesDaylightSavingTimeChange()
        {
            ...
            */
            var data = new BaseData[]
            {
                ...
                {
                    Value = 0,
                    Time = new DateTime(2018, 3, 10, 19, 0, 0),
                    Period = Time.OneDay
                },
                // Monday 3/12
                new QuoteBar
                {
                    Value = 1,
                    Time = new DateTime(2018, 3, 11, 20, 0, 0),
                    Period = Time.OneDay
                },
            }.ToList();
            var enumerator = data.GetEnumerator();
        ...
        public void HandlesDaylightSavingTimeChange_InifinteLoop()
        {
            ...
            var data = new BaseData[]
            {
                ...
                {
                    Value = 0,
                    Time = new DateTime(2019, 10, 4, 10, 0, 0),
                    Period = Time.OneDay
                },
                new QuoteBar
                {
                    Value = 1,
                    Time = new DateTime(2019, 10, 8, 11, 0, 0),
                    Period = Time.OneDay
                }
            }.ToList();
            var enumerator = data.GetEnumerator();
        ...
        public void FillsForwardOnMarketOpen_DataMinute_FillForwardSecond()
        {
            ...
            Assert.IsTrue(fillForwardEnumerator.MoveNext());
            Assert.AreEqual(
                reference.AddMinutes(1).AddSeconds(1),
                fillForwardEnumerator.Current.EndTime
            );
            Assert.AreEqual(0, fillForwardEnumerator.Current.Value);
            Assert.IsTrue(fillForwardEnumerator.Current.IsFillForward);
        ...
        public void FillsForwardBarsForDifferentResolutions(
            Resolution resolution,
            Resolution anotherSymbolResolution
        )
        {
            ...
            var parameter = new RegressionTests.AlgorithmStatisticsTestParameters(
                nameof(FillForwardTestAlgorithm),
...
#pragma warning disable CS0162 // Unreachable code detected; used to store expected data
                QuantConnect.Compression.ZipCreateAppendData(
                    ...
                    expectedDataFile,
                    FillForwardTestAlgorithm.Result.Value
                );
#pragma warning restore CS0162
        ...
        private static TestCaseData[] SubscriptionStarts =>
            new[]
            {
        ...
        private static IEnumerable<TestCaseData> DaylightSavingCases(int offsetInHours)
        {
            return SubscriptionStarts.Select(origin =>
            {
                ...
                {
                    DateTimeZone.ForOffset(Offset.FromHours(offsetInHours))
                };
        ...
        public void FillsForwardDaylightSavingTime(
            DateTime reference,
        ...
        )
        {
            ...
            Assert.IsTrue(fillForwardEnumerator.MoveNext());
            Assert.AreEqual(
                data[0].Time.Add(dataResolution),
                fillForwardEnumerator.Current.EndTime
            );
            Assert.IsFalse(fillForwardEnumerator.Current.IsFillForward);
            Assert.AreEqual(
            ...
            Assert.IsTrue(fillForwardEnumerator.MoveNext());
            Assert.AreEqual(
                data[1].Time.Add(dataResolution),
                fillForwardEnumerator.Current.EndTime
            );
            Assert.IsFalse(fillForwardEnumerator.Current.IsFillForward);
            Assert.AreEqual(
            ...
            Assert.IsTrue(fillForwardEnumerator.MoveNext());
            Assert.AreEqual(
                data[2].Time.Add(dataResolution),
                fillForwardEnumerator.Current.EndTime
            );
            Assert.IsFalse(fillForwardEnumerator.Current.IsFillForward);
            Assert.AreEqual(
        ...
        public void FillsForwardDaylightSavingTimeUtcPlus5(
            DateTime reference,
            SecurityExchange exchange
        )
        {
            ...
            Assert.IsTrue(fillForwardEnumerator.MoveNext());
            Assert.AreEqual(
                data[0].Time.AddTicks(2 * dataResolution.Ticks),
                fillForwardEnumerator.Current.EndTime
            );
            Assert.IsTrue(fillForwardEnumerator.Current.IsFillForward);
            Assert.AreEqual(
        ...
        private static TestCaseData[] NoMoveSubscriptionStarts =>
            new[]
            {
                new TestCaseData(
        ...
        public void FillsForwardMiddleWeek(
            DateTime reference,
            SecurityExchange exchange,
            DateTimeZone dataTimeZone
        )
        ...
        public void FillsForwardFromPreMarketWhenDaylightMove()
        {
            ...
            Assert.IsTrue(fillForwardEnumerator.MoveNext());
            Assert.AreEqual(
                data[3].Time.Add(dataResolution),
                fillForwardEnumerator.Current.EndTime
            );
        ...
        private static TestCaseData[] ExchangeSet =>
            new[]
            {
                new TestCaseData(
                    new ForexExchange(),
        ...
        private static IEnumerable<TestCaseData> ExchangeSettings(
            string daylight,
            DateTime start,
            params object[] extra
        )
        {
            ...
            {
                var list = new List<object>(origin.Arguments) { daylight, start };
        ...
        private static IEnumerable<TestCaseData> ExchangeDaylightTimeSet(
            int durationInDays,
        ...
        private static IEnumerable<TestCaseData> ExchangeStandardTimeSet(
            int durationInDays,
            Resolution fillforwardResolution
        )
        {
        ...
        public void FillsForwardBarsAroundDaylightMovementForDifferentResolutions_Enumerator(
            SecurityExchange exchange,
            DateTimeZone dataTimeZone,
            Resolution resolution,
            string dst,
        ...
        )
        {
            ...
            var expectedDataFile =
                $"enum_{dst}_{durationInDays}_{exchange.TimeZone.Id.Replace("/", "_")}_{dataTimeZone.Id.Replace("/", "_")}_{resolution}_{fillforwardResolution}.txt";
...
#pragma warning restore CS0162
        ...
        public void FillsForwardUntilDelisted(int warningDay)
        {
            ...
            var reference = new DateTime(2014, 6, 5).ConvertTo(dataTimeZone, exchange.TimeZone);
            var dataResolution = Time.OneDay;
            var expiry = new DateTime(2014, 6, warningDay).ConvertTo(
                dataTimeZone,
                exchange.TimeZone
            );
            var delisted = new DateTime(2014, 6, 22).ConvertTo(dataTimeZone, exchange.TimeZone);

            var spy = Symbol.CreateOption(
                "SPY",
                Market.USA,
            ...
            var data = new BaseData[]
            {
                ...
                new Delisting(
                    spy,
                    expiry.Date.ConvertTo(dataTimeZone, exchange.TimeZone),
                    100,
            ...
            while (fillForwardEnumerator.MoveNext())
            {
                ...
                Assert.AreEqual(
                    ...
                    fillForwardEnumerator.Current.IsFillForward
                        || (
                            intermediateDay != 0
                            && fillForwardEnumerator.Current.Time.Day
                                == expiry.Day + intermediateDay
                        )
                );
                if (fillForwardEnumerator.Current.IsFillForward)
                {
                    Assert.AreNotEqual(
                        ...
                        fillForwardEnumerator.Current.DataType
                    );
                    counter++;
                }
                else
        ...
        public void FillsForwardUntilDelistedMinuteResolution()
        {
            var exchange = new OptionExchange(SecurityExchangeHours.AlwaysOpen(TimeZones.NewYork));
            DateTimeZone dataTimeZone = DateTimeZone.ForOffset(Offset.FromHours(-5));
            var reference = new DateTime(2014, 6, 5, 10, 10, 0).ConvertTo(
                dataTimeZone,
                exchange.TimeZone
            );
            var dataResolution = Time.OneMinute;
            var expiry = new DateTime(2014, 6, 15).ConvertTo(dataTimeZone, exchange.TimeZone);
            var delisted = new DateTime(2014, 6, 22).ConvertTo(dataTimeZone, exchange.TimeZone);
        ...
        public void FillsForwardSymbolChangedDailyResolution()
        {
            ...
            var data = new BaseData[]
            {
                ...
                new SymbolChangedEvent(
                    symbol,
                    reference.AddDays(3).Date,
                    symbol.Value,
                    symbol.Value
                ),
                new TradeBar
        ...
        [TestCaseSource(nameof(ExchangeStandardTimeSet), new object[] { 7, Resolution.Daily })]
        [TestCaseSource(nameof(ExchangeStandardTimeSet), new object[] { 14, Resolution.Daily })]
        public void FillsForwardBarsAroundDaylightMovementForDifferentResolutions_Algorithm(
            SecurityExchange exchange,
            DateTimeZone dataTimeZone,
            Resolution resolution,
            string dst,
        ...
        )
        {
            ...
            var parameter = new RegressionTests.AlgorithmStatisticsTestParameters(
                nameof(FillForwardDaylightMovementTestAlgorithm),
                new Dictionary<string, string>(),
                Language.CSharp,
                AlgorithmStatus.Completed
            );
            ...
            var expectedDataFile =
                $"alg_{dst}_{durationInDays}_{exchange.TimeZone.Id.Replace("/", "_")}_{dataTimeZone.Id.Replace("/", "_")}_{resolution}.txt";
...
#pragma warning disable CS0162 // Unreachable code detected; used to store expected data
                QuantConnect.Compression.ZipCreateAppendData(
                    ...
                    string.Join(
                        Environment.NewLine,
                        FillForwardDaylightMovementTestAlgorithm.Result.Value
                    ),
                    overrideEntry: true
                );
#pragma warning restore CS0162
            ...
            Assert.AreEqual(
                expected.Length,
                FillForwardDaylightMovementTestAlgorithm.FillForwardBars.Count
            );
            Assert.IsTrue(
                expected.SequenceEqual(FillForwardDaylightMovementTestAlgorithm.FillForwardBars)
            );
        }
        ...
        public void SkipFF2AMOfSundayDST()
        {
            ...
            while (fillForwardEnumerator.MoveNext())
            {
                ...
                {
                    if (
                        fillForwardEnumerator.Current.Time.DayOfWeek == DayOfWeek.Sunday
                        && fillForwardEnumerator.Current.Time.Hour == 2
                    )
                    {
                        Assert.Fail(
                            "Shouldn't fill forward bar of 1AM of Sunday when changed Daylight Saving Time."
                        );
                    }
                }
        ...
        public void FillsForwardNotDelistingAuxiliary()
        {
            ...
            while (fillForwardEnumerator.MoveNext())
            {
                ...
                Assert.GreaterOrEqual(
                    fillForwardEnumerator.Current.EndTime,
                    previous?.EndTime ?? DateTime.MinValue
                );
                Assert.AreEqual(
                    fillForwardEnumerator.Current.DataType != MarketDataType.Auxiliary,
                    fillForwardEnumerator.Current.IsFillForward
            ...
            Assert.AreEqual((int)(data.Last().EndTime - data[1].EndTime).TotalDays, counter);
        ...
        public class FillForwardDaylightMovementTestAlgorithm : FillForwardTestAlgorithm
        {
            ...
            public override void OnData(Slice data)
            {
                if (data.ContainsKey(_symbol))
                {
                    ...
                    {
                        FillForwardBars.Add(
                            $"{bar.Time:yyyy.MM.dd H:m:s} - {bar.EndTime:yyyy.MM.dd H:m:s}"
                        );
                    }
                }
            }
        ...
        public class FillForwardDaylightMovementTestSetupHandler
