...
namespace QuantConnect.Tests.Engine.BrokerageTransactionHandlerTests
{
    ...
    class BrokerageTransactionHandlerTests
    {
        ...
        [Test]
        public void When_LongOrderIsRounded_Expect_OrderQuantityIsFlooredToNearestMultipleOfLotSize()
        {
        ...
        [Test]
        public void When_ShortOrderIsRounded_Expect_OrderQuantityIsCeiledToNearestMultipleOfLotSize()
        {
            //Initializes the transaction handler
            var transactionHandler = new BrokerageTransactionHandler();
            transactionHandler.Initialize(_algorithm, new BacktestingBrokerage(_algorithm), new BacktestingResultHandler());
        ...
        [Test]
        public void When_OrderIsLowerThanLotSize_Expect_OrderIsNotPlaced()
        {
            //Initializes the transaction handler
            var transactionHandler = new BrokerageTransactionHandler();
            transactionHandler.Initialize(_algorithm, new BacktestingBrokerage(_algorithm), new BacktestingResultHandler());
