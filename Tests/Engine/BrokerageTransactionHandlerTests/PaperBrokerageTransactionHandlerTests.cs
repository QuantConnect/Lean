...
{
    [TestFixture]
    public class PaperBrokerageTransactionHandlerTests
    {
        ...
        public void ProcessesOrders()
        {
            ...
            var transactionHandler = new PaperBrokerageTransactionHandler();
        ...
        private class TestablePaperBrokerageTransactionHandler : PaperBrokerageTransactionHandler
        {
