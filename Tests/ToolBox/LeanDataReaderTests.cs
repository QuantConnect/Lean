...
namespace QuantConnect.Tests.ToolBox
{
    ...
    public class LeanDataReaderTests
    {
        ...
        private static IEnumerable<TestCaseData> MinuteZipEntryFileNames
        {
            get
            {
                yield return new TestCaseData(
                    Symbol.CreateCanonicalOption(Symbol.CreateFuture(Futures.Grains.Corn, Market.CBOT, new(2025, 12, 25))),
                    "20251103_ozc_minute_trade_american_call_41000_20251226.csv",
                    4.1m,
                    OptionRight.Call);

                yield return new TestCaseData(
                    Symbol.CreateCanonicalOption(Symbol.CreateFuture(Futures.Currencies.JPY, Market.CME, new(2025, 12, 15))),
                    "20251103_jpu_minute_trade_american_call_62.50000_20251205.csv",
                    0.00625m,
                    OptionRight.Call);

                yield return new TestCaseData(
                    Symbol.CreateCanonicalOption(Symbol.CreateFuture(Futures.Currencies.AUD, Market.CME, new(2025, 12, 15))),
                    "20251103_adu_minute_openinterest_american_put_6350_20260306.csv",
                    0.635m,
                    OptionRight.Put);
                ...
                yield return new TestCaseData(
                    ...
                    "20251103_6n_minute_quote_american_call_5600_20260306.csv",
                    0.56m,
                    OptionRight.Call);

                yield return new TestCaseData(
                    Symbol.CreateCanonicalOption(Symbol.CreateFuture(Futures.Meats.LiveCattle, Market.CME, new(2025, 12, 15))),
                    "20251103_le_minute_quote_american_put_22200_20260306.csv",
                    2.22m,
                    OptionRight.Put);
            }
        }
        ...
        public void ReadSymbolFromZipEntryShouldParseFileNameWithFloatingNumber(Symbol rootSymbol, string fileNameCsv,
            decimal expectedStrike, OptionRight expectedOptionRight)
        {
