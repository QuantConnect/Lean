...
namespace QuantConnect.Tests.ToolBox
{
    ...
    public class LeanDataReaderTests
    {
        ...
        {
            var dataPath = LeanData.GenerateZipFilePath(
                Globals.DataFolder,
                Symbols.AAPL,
                DateTime.UtcNow,
                Resolution.Daily,
            ...
            Assert.IsTrue(
                data.All(baseData => baseData.Symbol == Symbols.AAPL && baseData is TradeBar)
            );
        }
        ...
        {
            var baseFuture = Symbol.CreateFuture(
        ...
        private List<Symbol> LoadFutureChain(
            Symbol baseFuture,
            DateTime date,
            TickType tickType,
            Resolution res
        ...
        private void ConvertMinuteFuturesData(
            Symbol canonical,
            TickType tickType,
            Resolution outputResolution,
            Resolution inputResolution = Resolution.Minute
        )
        {
            ...
            while (date <= _toDate)
            {
                ...
                foreach (var future in futureChain)
                {
                    if (!futures.ContainsKey(future.Value))
                    {
                        ...
                        var config = new SubscriptionDataConfig(
                            LeanData.GetDataType(outputResolution, tickType),
                            future,
                            inputResolution,
                            TimeZones.NewYork,
                            TimeZones.NewYork,
                        ...
                        {
                            sb.Append(
                                LeanData.GenerateLine(bar, SecurityType.Future, outputResolution)
                                    + Environment.NewLine
                            );
                        };
                    }
            ...
            var zip = LeanData.GenerateRelativeZipFilePath(
                canonical,
                _fromDate,
                outputResolution,
                tickType
            ...
            {
                var zipEntry = LeanData.GenerateZipEntryName(
                    future,
                    _fromDate,
                    outputResolution,
                    tickType
        ...
        public void ReadLeanFutureAndOptionDataFromFilePath(
        ...
        public static object[] OptionAndFuturesCases =
        {
            new object[]
            {
                ...
                LeanData.ReadSymbolFromZipEntry(
                    Symbol.Create(Futures.Indices.SP500EMini, SecurityType.Future, Market.CME),
                    Resolution.Minute,
                    "20131008_es_minute_quote_201312_20131220.csv"
                ),
                1411,
                2346061.875
            },
            new object[]
            {
                ...
                LeanData.ReadSymbolFromZipEntry(
                    Symbol.Create(Futures.Metals.Gold, SecurityType.Future, Market.COMEX),
                    Resolution.Minute,
                    "20131010_gc_minute_trade_201312_20131227.csv"
                ),
                1379,
                1791800.9
            },
            new object[]
            {
                ...
                LeanData.ReadSymbolFromZipEntry(
                    Symbol.Create(Futures.Metals.Gold, SecurityType.Future, Market.COMEX),
                    Resolution.Tick,
                    "20131009_gc_tick_quote_201406_20140626.csv"
                ),
                197839,
                259245064.8
            },
            new object[]
            {
                ...
                LeanData.ReadSymbolFromZipEntry(
                    Symbol.Create(Futures.Metals.Gold, SecurityType.Future, Market.COMEX),
                    Resolution.Tick,
                    "20131009_gc_tick_trade_201312_20131227.csv"
                ),
                64712,
                84596673.8
            },
            new object[]
            {
                ...
                LeanData.ReadSymbolFromZipEntry(
                    Symbol.Create(Futures.Indices.SP500EMini, SecurityType.Future, Market.CME),
                    Resolution.Minute,
                    "20131010_es_minute_openinterest_201312.csv"
                ),
                3,
                8119169
            },
            new object[]
            {
                ...
                LeanData.ReadSymbolFromZipEntry(
                    Symbol.Create(Futures.Metals.Gold, SecurityType.Future, Market.COMEX),
                    Resolution.Tick,
                    "20131009_gc_tick_openinterest_201310_20131029.csv"
                ),
                4,
                1312
            },
            new object[]
            {
                ...
                LeanData.ReadSymbolFromZipEntry(
                    Symbol.Create("AAPL", SecurityType.Option, Market.USA),
                    Resolution.Minute,
            ...
            new object[]
            {
                ...
                LeanData.ReadSymbolFromZipEntry(
                    Symbol.Create("GOOG", SecurityType.Option, Market.USA),
                    Resolution.Minute,
        ...
        public void ReadLeanSpotMarketsSecuritiesDataFromFilePath(
            string securityType,
            string market,
            string resolution,
            string ticker,
        ...
        {
            // Arrange
            var filepath = GenerateFilepathForTesting(
                _dataDirectory,
                securityType,
                market,
                resolution,
        ...
        public static string GenerateFilepathForTesting(
