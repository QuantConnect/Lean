...
namespace QuantConnect.Tests.ToolBox
{
    ...
    public class ToolBoxTests
    {
        ...
        [TestCase("--app=ddl --tickers=AAPL --resolution=Daily --from-date=20200820-00:00:00 --to-date=20200830-00:00:00", 1)]
        [TestCase("--app=ddl --resolution=Daily --from-date=20200820-00:00:00 --to-date=20200830-00:00:00", 0)]
        [TestCase("--app=ddl --tickers=AAPL,SPY,TSLA --resolution=Daily --from-date=20200820-00:00:00 --to-date=20200830-00:00:00", 3)]
