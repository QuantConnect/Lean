...
namespace QuantConnect.Tests.Common.Packets
{
    ...
    public class BacktestNodePacketTests
    {
        ...
        {
            var parameter = new RegressionTests.AlgorithmStatisticsTestParameters(
                nameof(CoarseFundamentalTop3Algorithm),
                new Dictionary<string, string>
                {
        ...
        public void RoundTripNullJobDates()
        {
            var job = new BacktestNodePacket(
                ...
                null,
                9m,
                $"{nameof(BacktestNodePacketTests)}.Pepe"
            );
        ...
        public void InitialCashAmountIsRespected()
        {
            ...
            AlgorithmRunner.RunLocalBacktest(
                ...
                parameter.ExpectedFinalStatus,
                initialCash: 1000000
            ); // 1M vs 100K that is set in BasicTemplateDailyAlgorithm (10x)
        }
        ...
        {
            var parameter = new RegressionTests.AlgorithmStatisticsTestParameters(
                nameof(TestInitialCashAmountAlgorithm),
                new Dictionary<string, string>
                {
                    { PerformanceMetrics.TotalOrders, "1" },
                    { "Average Win", "0%" },
            ...
            Assert.AreEqual(
                0,
                TestInitialCashAmountSetupHandler.TestAlgorithm.Portfolio.CashBook["EUR"].Amount
            );
            Assert.AreEqual(
                Currencies.USD,
                TestInitialCashAmountSetupHandler.TestAlgorithm.AccountCurrency
            );
        }
        ...
        public class TestInitialCashAmountSetupHandler
