...
namespace QuantConnect.Tests.Common.Securities.Futures
{
    ...
    public class FuturesExpiryFunctionsTests
    {
        ...
        public void TestGoldExpiryDateFunction()
        {
            ...
            var april2017Func = FuturesExpiryFunctions.FuturesExpiryFunction(april2017);
            ...
            var may2017Func = FuturesExpiryFunctions.FuturesExpiryFunction(may2017);
            ...
            var june2017Func = FuturesExpiryFunctions.FuturesExpiryFunction(june2017);
            ...
            var july2017Func = FuturesExpiryFunctions.FuturesExpiryFunction(july2017);
            ...
            var october2018Func = FuturesExpiryFunctions.FuturesExpiryFunction(october2018);
            ...
            var december2021Func = FuturesExpiryFunctions.FuturesExpiryFunction(december2021);
