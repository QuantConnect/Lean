...
namespace QuantConnect.Tests.Common
{
    ...
    public class OptionPriceModelTests
    {
        ...
        public void PutCallParityTest()
        {
            ...
            var spy = Symbols.SPY;
            var SPY_C_192_Feb19_2016E = GetOptionSymbol(
                spy,
            ...
            var leftPart =
                callPrice + contractCall.Strike * (decimal)Math.Exp((double)-riskFreeRate);
        ...
        public void BlackScholesPortfolioTest()
        {
            ...
            var rightPart =
                greeks.Theta
                + riskFreeRate * underlyingPrice * greeks.Delta
                + 0.5m * impliedVol * impliedVol * underlyingPrice * underlyingPrice * greeks.Gamma;
        ...
        public void ThrowsIfOptionStyleIsNotSupportedByQLPricingModel(
            string qlModelName,
        ...
        )
        {
            ...
            // running evaluation
            var priceModel = (IOptionPriceModel)
                typeof(OptionPriceModels).GetMethod(qlModelName).Invoke(null, new object[] { });
        ...
        public void MatchesIBGreeksNearATMCall(
            OptionStyle style,
            string qlModelName,
            double errorIV,
            double errorDelta,
        ...
        {
            var filename =
                style == OptionStyle.American ? "SPY230811C00450000" : "SPX230811C04500000";
            var symbol = Symbols.SPY; // dummy
            var strike = Parse.Decimal(filename[10..]) / 1000m;
            var optionSymbol = GetOptionSymbol(
                symbol,
                style,
                OptionRight.Call,
                strike,
        ...
        public void MatchesIBGreeksFarATMCall(
            OptionStyle style,
            string qlModelName,
            double errorIV,
            double errorDelta,
        ...
        {
            var filename =
                style == OptionStyle.American ? "SPY230901C00450000" : "SPX230901C04500000";
            var symbol = Symbols.SPY; // dummy
            var strike = Parse.Decimal(filename[10..]) / 1000m;
            var optionSymbol = GetOptionSymbol(
                symbol,
        ...
        public void MatchesIBGreeksNearATMPut(
            OptionStyle style,
            string qlModelName,
            double errorIV,
            double errorDelta,
        ...
        {
            var filename =
                style == OptionStyle.American ? "SPY230811P00450000" : "SPX230811P04500000";
            var symbol = Symbols.SPY; // dummy
            var strike = Parse.Decimal(filename[10..]) / 1000m;
            var optionSymbol = GetOptionSymbol(
                symbol,
        ...
        public void MatchesIBGreeksFarATMPut(
            OptionStyle style,
            string qlModelName,
            double errorIV,
            double errorDelta,
        ...
        {
            var filename =
                style == OptionStyle.American ? "SPY230901P00450000" : "SPX230901P04500000";
            var symbol = Symbols.SPY; // dummy
            var strike = Parse.Decimal(filename[10..]) / 1000m;
            var optionSymbol = GetOptionSymbol(
                symbol,
        ...
        public void MatchesIBGreeksNearITMCall(
            OptionStyle style,
            string qlModelName,
            double errorIV,
            double errorDelta,
        ...
        {
            var filename =
                style == OptionStyle.American ? "SPY230811C00430000" : "SPX230811C04300000";
            var symbol = Symbols.SPY; // dummy
            var strike = Parse.Decimal(filename[10..]) / 1000m;
            var optionSymbol = GetOptionSymbol(
                symbol,
        ...
        public void MatchesIBGreeksFarITMCall(
            OptionStyle style,
            string qlModelName,
            double errorIV,
            double errorDelta,
        ...
        {
            var filename =
                style == OptionStyle.American ? "SPY230901C00430000" : "SPX230901C04300000";
            var symbol = Symbols.SPY; // dummy
            var strike = Parse.Decimal(filename[10..]) / 1000m;
            var optionSymbol = GetOptionSymbol(
                symbol,
        ...
        public void MatchesIBGreeksNearITMPut(
            OptionStyle style,
            string qlModelName,
            double errorIV,
            double errorDelta,
        ...
        {
            var filename =
                style == OptionStyle.American ? "SPY230811P00470000" : "SPX230811P04700000";
            var symbol = Symbols.SPY; // dummy
            var strike = Parse.Decimal(filename[10..]) / 1000m;
            var optionSymbol = GetOptionSymbol(
                symbol,
        ...
        public void MatchesIBGreeksFarITMPut(
            OptionStyle style,
            string qlModelName,
            double errorIV,
            double errorDelta,
        ...
        {
            var filename =
                style == OptionStyle.American ? "SPY230901P00470000" : "SPX230901P04700000";
            var symbol = Symbols.SPY; // dummy
            var strike = Parse.Decimal(filename[10..]) / 1000m;
            var optionSymbol = GetOptionSymbol(
                symbol,
        ...
        public void MatchesIBGreeksNearOTMCall(
            OptionStyle style,
            string qlModelName,
            double errorIV,
            double errorDelta,
        ...
        {
            var filename =
                style == OptionStyle.American ? "SPY230811C00470000" : "SPX230811C04700000";
            var symbol = Symbols.SPY; // dummy
            var strike = Parse.Decimal(filename[10..]) / 1000m;
            var optionSymbol = GetOptionSymbol(
                symbol,
        ...
        public void MatchesIBGreeksFarOTMCall(
            OptionStyle style,
            string qlModelName,
            double errorIV,
            double errorDelta,
        ...
        {
            var filename =
                style == OptionStyle.American ? "SPY230901C00470000" : "SPX230901C04700000";
            var symbol = Symbols.SPY; // dummy
            var strike = Parse.Decimal(filename[10..]) / 1000m;
            var optionSymbol = GetOptionSymbol(
                symbol,
        ...
        public void MatchesIBGreeksNearOTMPut(
            OptionStyle style,
            string qlModelName,
            double errorIV,
            double errorDelta,
        ...
        {
            var filename =
                style == OptionStyle.American ? "SPY230811P00430000" : "SPX230811P04300000";
            var symbol = Symbols.SPY; // dummy
            var strike = Parse.Decimal(filename[10..]) / 1000m;
            var optionSymbol = GetOptionSymbol(
                symbol,
        ...
        public void MatchesIBGreeksFarOTMPut(
            OptionStyle style,
            string qlModelName,
            double errorIV,
            double errorDelta,
        ...
        {
            var filename =
                style == OptionStyle.American ? "SPY230901P00430000" : "SPX230901P04300000";
            var symbol = Symbols.SPY; // dummy
            var strike = Parse.Decimal(filename[10..]) / 1000m;
            var optionSymbol = GetOptionSymbol(
                symbol,
        ...
        private void MatchesIBGreeksTest(
            Symbol symbol,
            Symbol optionSymbol,
            string filename,
            string qlModelName,
        ...
        public void ImpliedVolatilityEstimator(
        ...
        )
        {
            ...
            var payoff = new PlainVanillaPayoff(
                contract.Right == OptionRight.Call ? QLNet.Option.Type.Call : QLNet.Option.Type.Put,
            ...
            var impliedVolEstimate = priceModel.TestImpliedVolEstimator(
                price,
                initialGuess,
                1,
                0.99d,
        ...
        private static Symbol GetOptionSymbol(
            Symbol underlying,
            OptionStyle optionStyle,
            OptionRight optionRight,
            decimal strike = 192m,
        ...
        public static Equity GetEquity(
            Symbol symbol,
            decimal underlyingPrice,
            decimal underlyingVol,
        ...
        class TestOptionPriceModel : QLOptionPriceModel
        {
            public TestOptionPriceModel()
                : base(
                    process => new BinomialVanillaEngine<CoxRossRubinstein>(process, 100),
                    null,
                    null,
                    null
                ) { }

            public double TestImpliedVolEstimator(
                double price,
                double initialGuess,
            ...
            {
                return base.ImpliedVolatilityEstimation(
                    price,
                    initialGuess,
                    timeTillExpiry,
                    riskFreeDiscount,
