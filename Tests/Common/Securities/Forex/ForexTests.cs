...
namespace QuantConnect.Tests.Common.Securities.Forex
{
    ...
    public class ForexTests
    {
        ...
        {
            var config = new SubscriptionDataConfig(typeof(TradeBar), SecurityType.Forex, Symbols.EURUSD, Resolution.Minute, Market.FXCM, TimeZones.NewYork, true, true, true);
