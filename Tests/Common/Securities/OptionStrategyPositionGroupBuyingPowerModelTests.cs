...
namespace QuantConnect.Tests.Common.Securities
{
    ...
    public class OptionStrategyPositionGroupBuyingPowerModelTests
    {
        ...
        public void Setup()
        {
            ...
            _algorithm.SetSecurityInitializer(security =>
            ...
            var callOptionSymbol = Symbols.CreateOptionSymbol(
                "SPY",
                OptionRight.Call,
                strike,
                expiry
            ...
            var putOptionSymbol = Symbols.CreateOptionSymbol(
                "SPY",
                OptionRight.Put,
                strike,
                expiry
        ...
        private static readonly TestCaseData[] HasSufficientBuyingPowerForOrderTestCases = new[]
        {
            ...
            new TestCaseData(
                OptionStrategyDefinitions.NakedCall,
                0,
                (1000000 - 0 * 19400) / (19400 + 0),
                true
            ), // 0 to max long
            new TestCaseData(
                OptionStrategyDefinitions.NakedCall,
                0,
                (1000000 - 0 * 19400) / (19400 + 0) + 1,
                false
            ), // 0 to max long + 1
            new TestCaseData(
                OptionStrategyDefinitions.NakedCall,
            ...
            new TestCaseData(
                OptionStrategyDefinitions.NakedCall,
                0,
                -(1000000 + 0 * 0) / (0 + 11200) - 1,
                false
            ), // 0 to max short + 1
            new TestCaseData(
                OptionStrategyDefinitions.NakedCall,
                20,
                (1000000 - 20 * 19400) / (19400 + 0),
                true
            ), // 20 to max long
            new TestCaseData(
                OptionStrategyDefinitions.NakedCall,
                20,
                (1000000 - 20 * 19400) / (19400 + 0) + 1,
                false
            ), // 20 to max long + 1
            ...
            new TestCaseData(
                OptionStrategyDefinitions.NakedCall,
                20,
                -(1000000 + 20 * 0) / (0 + 11200),
                true
            ), // 20 to max short
            new TestCaseData(
                OptionStrategyDefinitions.NakedCall,
                20,
                -(1000000 + 20 * 0) / (0 + 11200) - 1,
                false
            ), // 20 to max short + 1
            new TestCaseData(
                OptionStrategyDefinitions.NakedCall,
            ...
            new TestCaseData(
                OptionStrategyDefinitions.NakedPut,
                0,
                (1000000 - 0 * 3002) / (3002 + 0),
                true
            ), // 0 to max long
            new TestCaseData(
                OptionStrategyDefinitions.NakedPut,
                0,
                (1000000 - 0 * 3002) / (3002 + 0) + 1,
                false
            ), // 0 to max long + 1
            new TestCaseData(
                OptionStrategyDefinitions.NakedPut,
            ...
            new TestCaseData(
                OptionStrategyDefinitions.NakedPut,
                20,
                (1000000 - 20 * 3002) / (3002 + 0),
                true
            ), // 20 to max long
            new TestCaseData(
                OptionStrategyDefinitions.NakedPut,
                20,
                (1000000 - 20 * 3002) / (3002 + 0) + 1,
                false
            ), // 20 to max long + 1
            ...
            new TestCaseData(
                OptionStrategyDefinitions.CoveredCall,
                0,
                (1000000 - 0 * 19210) / (19210 + 0),
                true
            ), // 0 to max long
            new TestCaseData(
                OptionStrategyDefinitions.CoveredCall,
                0,
                (1000000 - 0 * 19210) / (19210 + 0) + 1,
                false
            ), // 0 to max long + 1
            new TestCaseData(
                OptionStrategyDefinitions.CoveredCall,
                0,
                -(1000000 + 0 * 10250) / (10250 + 11200),
                true
            ), // 0 to max short
            new TestCaseData(
                OptionStrategyDefinitions.CoveredCall,
                0,
                -(1000000 + 0 * 10250) / (10250 + 11200) - 1,
                false
            ), // 0 to max short + 1
            new TestCaseData(
                OptionStrategyDefinitions.CoveredCall,
                20,
                (1000000 - 20 * 19210) / (19210 + 0),
                true
            ), // 20 to max long
            new TestCaseData(
                OptionStrategyDefinitions.CoveredCall,
                20,
                (1000000 - 20 * 19210) / (19210 + 0) + 1,
                false
            ), // 20 to max long + 1
            ...
            new TestCaseData(
                OptionStrategyDefinitions.CoveredCall,
                20,
                -(1000000 + 20 * 10250) / (10250 + 11200),
                true
            ), // 20 to max short
            new TestCaseData(
                OptionStrategyDefinitions.CoveredCall,
                20,
                -(1000000 + 20 * 10250) / (10250 + 11200) - 1,
                false
            ), // 20 to max short + 1
            new TestCaseData(
                OptionStrategyDefinitions.CoveredCall,
            ...
            new TestCaseData(
                OptionStrategyDefinitions.ProtectiveCall,
                0,
                (1000000 - 0 * 10250) / (10250 + 11200),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.CoveredPut,
                0,
                (1000000 - 0 * 10250) / (10250 + 0),
                true
            ), // 0 to max long
            new TestCaseData(
                OptionStrategyDefinitions.CoveredPut,
                0,
                (1000000 - 0 * 10250) / (10250 + 0) + 1,
                false
            ), // 0 to max long + 1
            new TestCaseData(
                OptionStrategyDefinitions.CoveredPut,
                0,
                -(1000000 - 0 * 10250) / (10250 + 2),
                true
            ), // 0 to max short
            new TestCaseData(
                OptionStrategyDefinitions.CoveredPut,
                0,
                -(1000000 - 0 * 10250) / (10250 + 2) - 1,
                false
            ), // 0 to max short + 1
            new TestCaseData(
                OptionStrategyDefinitions.CoveredPut,
                20,
                (1000000 - 20 * 10250) / (10250 + 0),
                true
            ), // 20 to max long
            new TestCaseData(
                OptionStrategyDefinitions.CoveredPut,
                20,
                (1000000 - 20 * 10250) / (10250 + 0) + 1,
                false
            ), // 20 to max long + 1
            ...
            new TestCaseData(
                OptionStrategyDefinitions.CoveredPut,
                20,
                -(1000000 + 20 * 10250) / (10250 + 2),
                true
            ), // 20 to max short
            new TestCaseData(
                OptionStrategyDefinitions.CoveredPut,
                20,
                -(1000000 + 20 * 10250) / (10250 + 2) - 1,
                false
            ), // 20 to max short + 1
            new TestCaseData(
                OptionStrategyDefinitions.CoveredPut,
            ...
            new TestCaseData(
                OptionStrategyDefinitions.ProtectivePut,
                0,
                (1000000 - 0 * 10250) / (10250 + 2),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.ProtectiveCollar,
                0,
                (1000000 - 0 * 26231) / (26231 + 0),
                true
            ), // 0 to max long
            new TestCaseData(
                OptionStrategyDefinitions.ProtectiveCollar,
                0,
                (1000000 - 0 * 26231) / (26231 + 0) + 1,
                false
            ), // 0 to max long + 1
            new TestCaseData(
                OptionStrategyDefinitions.ProtectiveCollar,
                0,
                -(1000000 + 0 * 26231) / (26231 + 1),
                true
            ), // 0 to max short
            new TestCaseData(
                OptionStrategyDefinitions.ProtectiveCollar,
                0,
                -(1000000 + 0 * 26231) / (26231 + 1) - 1,
                false
            ), // 0 to max short + 1
            new TestCaseData(
                OptionStrategyDefinitions.ProtectiveCollar,
                20,
                (1000000 - 20 * 26231) / (26231 + 0),
                true
            ), // 20 to max long
            new TestCaseData(
                OptionStrategyDefinitions.ProtectiveCollar,
                20,
                (1000000 - 20 * 26231) / (26231 + 0) + 1,
                false
            ), // 20 to max long + 1
            ...
            new TestCaseData(
                OptionStrategyDefinitions.ProtectiveCollar,
                20,
                -(1000000 + 20 * 26231) / (26231 + 1),
                true
            ), // 20 to max short
            new TestCaseData(
                OptionStrategyDefinitions.ProtectiveCollar,
                20,
                -(1000000 + 20 * 26231) / (26231 + 1) - 1,
                false
            ), // 20 to max short + 1
            new TestCaseData(
                OptionStrategyDefinitions.ProtectiveCollar,
            ...
            new TestCaseData(
                OptionStrategyDefinitions.Conversion,
                0,
                (1000000 - 0 * 26295) / (26295 + 0),
                true
            ), // 0 to max long
            new TestCaseData(
                OptionStrategyDefinitions.Conversion,
                0,
                (1000000 - 0 * 26295) / (26295 + 0) + 1,
                false
            ), // 0 to max long + 1
            new TestCaseData(
                OptionStrategyDefinitions.Conversion,
                0,
                -(1000000 + 0 * 26231) / (26231 + 146),
                true
            ), // 0 to max short
            new TestCaseData(
                OptionStrategyDefinitions.Conversion,
                0,
                -(1000000 + 0 * 26231) / (26231 + 146) - 1,
                false
            ), // 0 to max short + 1
            new TestCaseData(
                OptionStrategyDefinitions.Conversion,
                20,
                (1000000 - 20 * 26295) / (26295 + 0),
                true
            ), // 20 to max long
            new TestCaseData(
                OptionStrategyDefinitions.Conversion,
                20,
                (1000000 - 20 * 26295) / (26295 + 0) + 1,
                false
            ), // 20 to max long + 1
            ...
            new TestCaseData(
                OptionStrategyDefinitions.Conversion,
                20,
                -(1000000 + 20 * 26231) / (26231 + 146),
                true
            ), // 20 to max short
            new TestCaseData(
                OptionStrategyDefinitions.Conversion,
                20,
                -(1000000 + 20 * 26231) / (26231 + 146) - 1,
                false
            ), // 20 to max short + 1
            new TestCaseData(
                OptionStrategyDefinitions.Conversion,
            ...
            new TestCaseData(
                OptionStrategyDefinitions.ReverseConversion,
                0,
                (1000000 - 0 * 26231) / (26231 + 146),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                ...
                0,
                (1000000 - 0 * 1000) / (1000 + 0),
                true
            ), // 0 to max long
            new TestCaseData(
                OptionStrategyDefinitions.BearCallSpread,
                0,
                (1000000 - 0 * 1000) / (1000 + 0) + 1,
                false
            ), // 0 to max long + 1
            new TestCaseData(
                OptionStrategyDefinitions.BearCallSpread,
            ...
            new TestCaseData(
                OptionStrategyDefinitions.BearCallSpread,
                0,
                -(1000000 + 0 * 0) / (0 + 1200) - 1,
                false
            ), // 0 to max short + 1
            new TestCaseData(
                OptionStrategyDefinitions.BearCallSpread,
                20,
                (1000000 - 20 * 1000) / (1000 + 0),
                true
            ), // 20 to max long
            new TestCaseData(
                OptionStrategyDefinitions.BearCallSpread,
                20,
                (1000000 - 20 * 1000) / (1000 + 0) + 1,
                false
            ), // 20 to max long + 1
            ...
            new TestCaseData(
                OptionStrategyDefinitions.BearPutSpread,
                0,
                (1000000 - 0 * 0) / (0 + 1),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.BullCallSpread,
                0,
                (1000000 - 0 * 0) / (0 + 1200),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.BullPutSpread,
                0,
                (1000000 - 0 * 1000) / (1000 + 0),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.Straddle,
                0,
                (1000000 - 0 * 0) / (0 + 11202),
                true
            ), // 0 to max long
            new TestCaseData(
                OptionStrategyDefinitions.Straddle,
                0,
                (1000000 - 0 * 0) / (0 + 11202) + 1,
                false
            ), // 0 to max long + 1
            new TestCaseData(
                OptionStrategyDefinitions.Straddle,
                0,
                -(1000000 + 0 * 19402) / (19402 + 0),
                true
            ), // 0 to max short
            new TestCaseData(
                OptionStrategyDefinitions.Straddle,
                0,
                -(1000000 + 0 * 19402) / (19402 + 0) - 1,
                false
            ), // 0 to max short + 1
            new TestCaseData(
                OptionStrategyDefinitions.Straddle,
                20,
                (1000000 - 20 * 0) / (0 + 11202),
                true
            ), // 20 to max long
            new TestCaseData(
                OptionStrategyDefinitions.Straddle,
                20,
                (1000000 - 20 * 0) / (0 + 11202) + 1,
                false
            ), // 20 to max long + 1
            ...
            new TestCaseData(
                OptionStrategyDefinitions.Straddle,
                20,
                -(1000000 + 20 * 19402) / (19402 + 0),
                true
            ), // 20 to max short
            new TestCaseData(
                OptionStrategyDefinitions.Straddle,
                20,
                -(1000000 + 20 * 19402) / (19402 + 0) - 1,
                false
            ), // 20 to max short + 1
            new TestCaseData(
                OptionStrategyDefinitions.Straddle,
            ...
            new TestCaseData(
                OptionStrategyDefinitions.ShortStraddle,
                0,
                (1000000 - 0 * 19402) / (19402 + 0),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.Strangle,
                0,
                (1000000 - 0 * 0) / (0 + 10002),
                true
            ), // 0 to max long
            new TestCaseData(
                OptionStrategyDefinitions.Strangle,
                0,
                (1000000 - 0 * 0) / (0 + 10002) + 1,
                false
            ), // 0 to max long + 1
            new TestCaseData(
                OptionStrategyDefinitions.Strangle,
                0,
                -(1000000 + 0 * 18202) / (18202 + 0),
                true
            ), // 0 to max short
            new TestCaseData(
                OptionStrategyDefinitions.Strangle,
                0,
                -(1000000 + 0 * 18202) / (18202 + 0) - 1,
                false
            ), // 0 to max short + 1
            new TestCaseData(
                OptionStrategyDefinitions.Strangle,
                20,
                (1000000 - 20 * 0) / (0 + 10002),
                true
            ), // 20 to max long
            new TestCaseData(
                OptionStrategyDefinitions.Strangle,
                20,
                (1000000 - 20 * 0) / (0 + 10002) + 1,
                false
            ), // 20 to max long + 1
            ...
            new TestCaseData(
                OptionStrategyDefinitions.Strangle,
                20,
                -(1000000 + 20 * 18202) / (18202 + 0),
                true
            ), // 20 to max short
            new TestCaseData(
                OptionStrategyDefinitions.Strangle,
                20,
                -(1000000 + 20 * 18202) / (18202 + 0) - 1,
                false
            ), // 20 to max short + 1
            new TestCaseData(
                OptionStrategyDefinitions.Strangle,
            ...
            new TestCaseData(
                OptionStrategyDefinitions.ShortStrangle,
                0,
                (1000000 - 0 * 18202) / (18202 + 0),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.ButterflyCall,
                0,
                (1000000 - 0 * 0) / (0 + 400),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.ShortButterflyCall,
                0,
                (1000000 - 0 * 1000) / (1000 + 0),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.ButterflyPut,
                0,
                (1000000 - 0 * 0) / (0 + 1),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.ShortButterflyPut,
                0,
                (1000000 - 0 * 1000) / (1000 + 0),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.CallCalendarSpread,
                0,
                (1000000 - 0 * 0) / (0 + 200),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.ShortCallCalendarSpread,
                0,
                (1000000 - 0 * 19400) / (19400 + 0),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.PutCalendarSpread,
                0,
                (1000000 - 0 * 0) / (0 + 1),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.ShortPutCalendarSpread,
                0,
                (1000000 - 0 * 3002) / (3002 + 0),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.IronButterfly,
                0,
                (1000000 - 0 * 1000) / (1000 + 0),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.ShortIronButterfly,
                0,
                (1000000 - 0 * 0) / (0 + 801),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.IronCondor,
                0,
                (1000000 - 0 * 1000) / (1000 + 0),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.ShortIronCondor,
                0,
                (1000000 - 0 * 0) / (0 + 1001),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.BoxSpread,
                0,
                (1000000 - 0 * 0) / (0 + 2003),
                true
            ), // 0 to max long
            new TestCaseData(
                OptionStrategyDefinitions.BoxSpread,
                0,
                (1000000 - 0 * 0) / (0 + 2003) + 1,
                false
            ), // 0 to max long + 1
            new TestCaseData(
                OptionStrategyDefinitions.BoxSpread,
                0,
                -(1000000 + 0 * 2000) / (2000 + 0),
                true
            ), // 0 to max short
            new TestCaseData(
                OptionStrategyDefinitions.BoxSpread,
                0,
                -(1000000 + 0 * 2000) / (2000 + 0) - 1,
                false
            ), // 0 to max short + 1
            new TestCaseData(
                OptionStrategyDefinitions.BoxSpread,
            ...
            new TestCaseData(
                OptionStrategyDefinitions.BoxSpread,
                20,
                -(1000000 + 20 * 2000) / (2000 + 0),
                true
            ), // 20 to max short
            new TestCaseData(
                OptionStrategyDefinitions.BoxSpread,
                20,
                -(1000000 + 20 * 2000) / (2000 + 0) - 1,
                false
            ), // 20 to max short + 1
            new TestCaseData(
                OptionStrategyDefinitions.BoxSpread,
            ...
            new TestCaseData(
                OptionStrategyDefinitions.ShortBoxSpread,
                0,
                (1000000 - 0 * 2000) / (2000 + 0),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.JellyRoll,
                0,
                (1000000 - 0 * 11448) / (11448 + 84),
                true
            ), // 0 to max long
            new TestCaseData(
                OptionStrategyDefinitions.JellyRoll,
                0,
                (1000000 - 0 * 11448) / (11448 + 84) + 1,
                false
            ), // 0 to max long + 1
            new TestCaseData(
                OptionStrategyDefinitions.JellyRoll,
                0,
                -(1000000 + 0 * 11537) / (11537 + 0),
                true
            ), // 0 to max short
            new TestCaseData(
                OptionStrategyDefinitions.JellyRoll,
                0,
                -(1000000 + 0 * 11537) / (11537 + 0) - 1,
                false
            ), // 0 to max short + 1
            new TestCaseData(
                OptionStrategyDefinitions.JellyRoll,
                20,
                (1000000 - 20 * 11448) / (11448 + 84),
                true
            ), // 20 to max long
            new TestCaseData(
                OptionStrategyDefinitions.JellyRoll,
                20,
                (1000000 - 20 * 11448) / (11448 + 84) + 1,
                false
            ), // 20 to max long + 1
            ...
            new TestCaseData(
                OptionStrategyDefinitions.JellyRoll,
                20,
                -(1000000 + 20 * 11537) / (11537 + 0),
                true
            ), // 20 to max short
            new TestCaseData(
                OptionStrategyDefinitions.JellyRoll,
                20,
                -(1000000 + 20 * 11537) / (11537 + 0) - 1,
                false
            ), // 20 to max short + 1
            new TestCaseData(
                OptionStrategyDefinitions.JellyRoll,
            ...
            new TestCaseData(
                OptionStrategyDefinitions.ShortJellyRoll,
                0,
                (1000000 - 0 * 11537) / (11537 + 0),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.BearCallLadder,
                0,
                (1000000 - 0 * 400) / (400 + 0),
                true
            ), // 0 to max long
            new TestCaseData(
                OptionStrategyDefinitions.BearCallLadder,
                0,
                (1000000 - 0 * 400) / (400 + 0) + 1,
                false
            ), // 0 to max long + 1
            new TestCaseData(
                OptionStrategyDefinitions.BearCallLadder,
                0,
                -(1000000 + 0 * 10407) / (10407 + 252),
                true
            ), // 0 to max short
            new TestCaseData(
                OptionStrategyDefinitions.BearCallLadder,
                0,
                -(1000000 + 0 * 10407) / (10407 + 252) - 1,
                false
            ), // 0 to max short + 1
            new TestCaseData(
                OptionStrategyDefinitions.BearCallLadder,
                20,
                (1000000 - 20 * 400) / (400 + 0),
                true
            ), // 20 to max long
            new TestCaseData(
                OptionStrategyDefinitions.BearCallLadder,
                20,
                (1000000 - 20 * 400) / (400 + 0) + 1,
                false
            ), // 20 to max long + 1
            ...
            new TestCaseData(
                OptionStrategyDefinitions.BearCallLadder,
                20,
                -(1000000 + 20 * 10407) / (10407 + 252),
                true
            ), // 20 to max short
            new TestCaseData(
                OptionStrategyDefinitions.BearCallLadder,
                20,
                -(1000000 + 20 * 10407) / (10407 + 252) - 1,
                false
            ), // 20 to max short + 1
            new TestCaseData(
                OptionStrategyDefinitions.BearCallLadder,
            ...
            new TestCaseData(
                OptionStrategyDefinitions.BearPutLadder,
                0,
                (1000000 - 0 * 10533) / (10533 + 346),
                true
            ), // 0 to max long
            new TestCaseData(
                OptionStrategyDefinitions.BearPutLadder,
                0,
                (1000000 - 0 * 10533) / (10533 + 346) + 1,
                false
            ), // 0 to max long + 1
            new TestCaseData(
                OptionStrategyDefinitions.BearPutLadder,
            ...
            new TestCaseData(
                OptionStrategyDefinitions.BearPutLadder,
                20,
                (1000000 - 20 * 10533) / (10533 + 346),
                true
            ), // 20 to max long
            new TestCaseData(
                OptionStrategyDefinitions.BearPutLadder,
                20,
                (1000000 - 20 * 10533) / (10533 + 346) + 1,
                false
            ), // 20 to max long + 1
            ...
            new TestCaseData(
                OptionStrategyDefinitions.BullCallLadder,
                0,
                (1000000 - 0 * 10407) / (10407 + 252),
                true
            ), // 0 to max long
            ...
            new TestCaseData(
                OptionStrategyDefinitions.BullPutLadder,
                0,
                (1000000 - 0 * 400) / (400 + 0),
                true
            ), // 0 to max long
        ...
        public void HasSufficientBuyingPowerForOrder(
            OptionStrategyDefinition optionStrategy,
            int initialPositionQuantity,
            int orderQuantity,
            bool expectedResult
        )
        {
            ...
            var orders = GetPositionGroupOrders(
                initialPositionGroup,
                initialPositionQuantity != 0 ? initialPositionQuantity : 1,
                orderQuantity
            );
            Assert.IsTrue(
                _portfolio.Positions.TryCreatePositionGroup(orders, out var ordersPositionGroup)
            );
        ...
        public void HasSufficientBuyingPowerForReducingStrategyOrder()
        {
            ...
            Assert.IsTrue(
                _portfolio.Positions.TryCreatePositionGroup(orders, out var positionGroup)
            );

            var hasSufficientBuyingPowerResult =
                positionGroup.BuyingPowerModel.HasSufficientBuyingPowerForOrder(
                    new HasSufficientPositionGroupBuyingPowerForOrderParameters(
                        _portfolio,
                        positionGroup,
                        orders
        ...
        // Liquidating
        [TestCase(-10, 0)]
        public void PositionGroupOrderQuantityCalculationForDeltaBuyingPowerFromShortPosition(
        ...
        // Liquidating
        [TestCase(10, 0)]
        public void PositionGroupOrderQuantityCalculationForDeltaBuyingPowerFromLongPosition(
            int initialHoldingsQuantity,
            int finalPositionQuantity
        )
        {
            ...
            var positionGroup = SetUpOptionStrategy(
                OptionStrategyDefinitions.CoveredCall,
            ...
            var usedMargin = _portfolio.TotalMarginUsed;
            var marginPerLongUnit = Math.Abs(
                positionGroup.BuyingPowerModel.GetInitialMarginRequirement(
                    _portfolio,
                    positionGroup
                ) / initialHoldingsQuantity
            );
            ...
            var marginPerNakedShortUnit = Math.Abs(
                shortUnitGroup.BuyingPowerModel.GetInitialMarginRequirement(
                    _portfolio,
                    shortUnitGroup
                )
            );
        ...
        [TestCase(10, 2, +1)]
        [TestCase(10, 2, -1)]
        public void OrderQuantityCalculation(
            int initialHoldingsQuantity,
            decimal targetMarginPercent,
            int targetMarginDirection
        )
        {
            ...
            var currentUsedMargin = Math.Abs(
                positionGroup.BuyingPowerModel.GetInitialMarginRequirement(
                    _portfolio,
                    positionGroup
                )
            ...
            var longUnitMargin = Math.Abs(
                longUnitGroup.BuyingPowerModel.GetInitialMarginRequirement(
                    _portfolio,
                    longUnitGroup
                )
            );
            ...
            {
                expectedQuantity =
                    Math.Abs(initialHoldingsQuantity * targetMarginPercent)
                    * Math.Sign(targetMarginDirection);
                finalPositionQuantity =
                    initialHoldingsQuantity + Math.Sign(initialHoldingsQuantity) * expectedQuantity;
        ...
        public void GetsInitialMarginRequirement(
        ...
        )
        {
            ...
            var initialMarginRequirement = (OptionInitialMargin)
                positionGroup.BuyingPowerModel.GetInitialMarginRequirement(
                    new PositionGroupInitialMarginParameters(_portfolio, positionGroup)
                );

            Assert.AreEqual(
                (double)expectedInitialMarginRequirement,
                (double)initialMarginRequirement.ValueWithoutPremium,
        ...
        public void CoveredCallInitialMarginRequirement(
            OptionStrategyDefinition optionStrategyDefinition,
            int quantity,
            decimal expectedInitialMarginRequirement,
            int strike
        )
        {
            ...
            Assert.AreEqual(
                (double)expectedInitialMarginRequirement,
                (double)initialMarginRequirement.Value,
                (double)(0.2m * expectedInitialMarginRequirement)
            );
        }
        ...
        public void GetsMaintenanceMargin(
            OptionStrategyDefinition optionStrategyDefinition,
            int quantity,
            decimal expectedMaintenanceMargin
        )
        {
            var positionGroup = SetUpOptionStrategy(optionStrategyDefinition, quantity);
            ...
            Assert.AreEqual(
                (double)expectedMaintenanceMargin,
                (double)maintenanceMargin.Value,
                (double)(0.2m * expectedMaintenanceMargin)
            );
        }
        ...
        )
        {
            ...
            if (expectedQuantity != -Math.Abs(initialPositionQuantity)) // Not liquidating
            {
                ...
                var usedMargin = _portfolio.TotalMarginUsed;
                deltaBuyingPower *=
                    deltaBuyingPower > 0 || Math.Abs(deltaBuyingPower) > usedMargin
                        ? 1.00001m
                        : 0.99999m;
            }
            ...
            {
                Assert.AreEqual(
                    Messages.PositionGroupBuyingPowerModel.DeltaCannotBeApplied,
                    result.Reason
                );
            }
        }
        ...
        /// </summary>
        [TestCaseSource(
            nameof(OrderQuantityForDeltaBuyingPowerWithCustomPositionGroupParameterTestCases)
        )]
        ...
        {
            var currentPositionGroup = SetUpOptionStrategy(
                optionStrategyDefinition,
                initialPositionQuantity
            );

            var initialMarginRequirement =
                currentPositionGroup.BuyingPowerModel.GetInitialMarginRequirement(
                    _portfolio,
                    currentPositionGroup
                );
            var maintenanceMargin = currentPositionGroup.BuyingPowerModel.GetMaintenanceMargin(
                _portfolio,
                currentPositionGroup
            );
            // Adjust the delta buying power:
            ...
            var referencePositionGroup = new PositionGroup(
                currentPositionGroup.BuyingPowerModel,
                1,
                currentPositionGroup
                    .Select(position => new Position(
                        position.Symbol,
                        referencePositionSideSign
            ...
            var result = currentPositionGroup.BuyingPowerModel.GetMaximumLotsForDeltaBuyingPower(
                new GetMaximumLotsForDeltaBuyingPowerParameters(
                    _portfolio,
                    referencePositionGroup,
                    referencePositionSideSign * deltaBuyingPower,
                    minimumOrderMarginPortfolioPercentage: 0
                )
            );
        ...
        )
        {
            ...
            var quantity = positionGroup
                .BuyingPowerModel.GetMaximumLotsForTargetBuyingPower(
                    new GetMaximumLotsForTargetBuyingPowerParameters(
                        _portfolio,
                        positionGroup,
                        targetBuyingPowerPercent,
                        minimumOrderMarginPortfolioPercentage: 0
                    )
                )
                .NumberOfLots;
        ...
        /// </summary>
        [TestCaseSource(
            nameof(OrderQuantityForTargetBuyingPowerWithCustomPositionGroupParameterTestCases)
        )]
        ...
        )
        {
            ...
            var quantity = currentPositionGroup
                .BuyingPowerModel.GetMaximumLotsForTargetBuyingPower(
                    new GetMaximumLotsForTargetBuyingPowerParameters(
                        _portfolio,
                        referencePositionGroup,
                        referenceGroupSideSign * targetBuyingPowerPercent,
                        minimumOrderMarginPortfolioPercentage: 0
                    )
                )
                .NumberOfLots;
        ...
        private static readonly TestCaseData[] PositionGroupBuyingPowerTestCases = new[]
        {
            ...
            new TestCaseData(
                ...
                10,
                -1,
                (1000000m - 185000m) + 185000m + 192100m
            ),
            // Going from 10 to 0.
            new TestCaseData(
                OptionStrategyDefinitions.CoveredCall,
            ...
            new TestCaseData(
                ...
                -10,
                1,
                (1000000m - 30000m) + 30000m + 214500m
            ),
            new TestCaseData(
                OptionStrategyDefinitions.CoveredCall,
                -10,
            ...
            new TestCaseData(
                ...
                10,
                -1,
                (1000000m - 102500m) + 102500m + 102500m
            ),
            new TestCaseData(
                OptionStrategyDefinitions.CoveredPut,
                10,
            ...
            new TestCaseData(
                ...
                -10,
                1,
                (1000000m - 102500m) + 102500m + 102520m
            ),
            new TestCaseData(
                OptionStrategyDefinitions.CoveredPut,
                -10,
            ...
            new TestCaseData(
                ...
                10,
                -1,
                (1000000m - 62020m) + 62020m + 262318m
            ),
            new TestCaseData(
                OptionStrategyDefinitions.ProtectiveCollar,
                10,
            ...
            new TestCaseData(
                ...
                -10,
                1,
                (1000000m - 62020m) + 62020m + 262310m
            ),
            new TestCaseData(
                OptionStrategyDefinitions.ProtectiveCollar,
                -10,
            ...
            new TestCaseData(
                ...
                10,
                -1,
                (1000000m - 53030m) + 53030m + 262945m
            ),
            new TestCaseData(
                OptionStrategyDefinitions.Conversion,
                10,
            ...
            new TestCaseData(
                ...
                -10,
                1,
                (1000000m - 52400m) + 52400m + 263778m
            ),
            new TestCaseData(
                OptionStrategyDefinitions.Conversion,
                -10,
            ...
            new TestCaseData(
                ...
                10,
                -1,
                (1000000m - 52400m) + 52400m + 263768m
            ),
            new TestCaseData(
                OptionStrategyDefinitions.ReverseConversion,
                10,
            ...
            new TestCaseData(
                ...
                -10,
                1,
                (1000000m - 53010m) + 53010m + 262915m
            ),
            new TestCaseData(
                OptionStrategyDefinitions.ReverseConversion,
                -10,
            ...
            new TestCaseData(
                ...
                10,
                -1,
                (1000000m - 194000m) + 194000m + 194000m
            ),
            new TestCaseData(
                OptionStrategyDefinitions.NakedCall,
                10,
            ...
            new TestCaseData(
                ...
                -10,
                1,
                (1000000m - 194020m) + 194020m + 194020m
            ),
            new TestCaseData(
                OptionStrategyDefinitions.Straddle,
                -10,
            ...
            new TestCaseData(
                ...
                -10,
                1,
                (1000000m - 182020m) + 182020m + 182020m
            ),
            new TestCaseData(
                OptionStrategyDefinitions.Strangle,
                -10,
            ...
            new TestCaseData(
                ...
                10,
                -1,
                (1000000m - 115319m) + 115319m + 115319m
            ),
            new TestCaseData(
                OptionStrategyDefinitions.JellyRoll,
                10,
            ...
            new TestCaseData(
                ...
                -10,
                1,
                (1000000m - 115372m) + 115372m + 115372m
            ),
            new TestCaseData(
                OptionStrategyDefinitions.JellyRoll,
                -10,
            ...
            new TestCaseData(
                ...
                -10,
                1,
                (1000000m - 106590.4m) + 106590.4m + 106590.4m
            ),
            new TestCaseData(
                OptionStrategyDefinitions.BearCallLadder,
                -10,
            ...
            new TestCaseData(
                ...
                10,
                -1,
                (1000000m - 108789.6m) + 108789.6m + 108789.6m
            ),
            new TestCaseData(
                OptionStrategyDefinitions.BearPutLadder,
                10,
        ...
        public void BuyingPowerForPositionGroupCalculation(
            OptionStrategyDefinition optionStrategyDefinition,
            int initialPositionQuantity,
            int orderQuantity,
            decimal expectedBuyingPower
        )
        {
            var initialPositionGroup = SetUpOptionStrategy(
                optionStrategyDefinition,
                initialPositionQuantity,
                updateCashbook: true
            );
            var orderPositionGroup = initialPositionGroup.WithQuantity(
                Math.Abs(orderQuantity),
                _portfolio.Positions
            );

            var orderDirection =
                Math.Sign(initialPositionQuantity) == Math.Sign(orderQuantity)
                    ? OrderDirection.Buy
                    : OrderDirection.Sell;
            var buyingPower = initialPositionGroup.BuyingPowerModel.GetPositionGroupBuyingPower(
        ...
        public void BuyingPowerForStrategyStartingFromOptionPositionInSameDirection()
        {
            ...
            var spyMay19_300Call = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Call, 300, expiration)
            );
            spyMay19_300Call.SetMarketPrice(new Tick { Value = 110m });
            var spyMay19_350Call = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Call, 350, expiration)
            );
            ...
            var finalPositionGroup = new PositionGroup(
                new OptionStrategyPositionGroupBuyingPowerModel(
                    OptionStrategies.BearCallSpread(
                        spyMay19_300Call.Symbol.Canonical,
                        spyMay19_300Call.StrikePrice,
                        spyMay19_350Call.StrikePrice,
                        expiration
                    )
                ),
                1,
            ...
            // 2. Get the available buying power for the long call
            var buyingPower = finalPositionGroup
                .BuyingPowerModel.GetPositionGroupBuyingPower(
                    new PositionGroupBuyingPowerParameters(
                        _portfolio,
                        finalPositionGroup,
                        OrderDirection.Buy
        ...
        public void BuyingPowerForStrategyStartingFromOptionPositionInOppositeDirection()
        {
            ...
            var finalPositionGroup = new PositionGroup(
                new OptionStrategyPositionGroupBuyingPowerModel(
                    OptionStrategies.NakedCall(
                        spyMay19_350Call.Symbol.Canonical,
                        spyMay19_350Call.StrikePrice,
                        expiration
                    )
                ),
            ...
            var expectedBuyingPower =
                _portfolio.MarginRemaining
                + initialPositionGroup.BuyingPowerModel.GetMaintenanceMargin(
                    new PositionGroupMaintenanceMarginParameters(_portfolio, initialPositionGroup)
                );
        ...
        public void BuyingPowerForStrategyStartingFromOptionPositionInOppositeDirectionAndLiquidating()
        {
            ...
            var quantity = 10 - 12;
            var finalPositionGroup = initialPositionGroup.WithQuantity(
                quantity,
                _portfolio.Positions
            );
        ...
        public void BuyingPowerForOptionStartingFromStrategyWithALegInSameDirection()
        {
            ...
            var initialPositionGroup = _portfolio.Positions.Groups.Single();
            Assert.AreEqual(
                OptionStrategyDefinitions.BearCallSpread.Name,
                initialPositionGroup.BuyingPowerModel.ToString()
            );
        ...
        public void ReservedBuyingPowerImpactCalculation(
            OptionStrategyDefinition optionStrategyDefinition,
            int initialPositionQuantity,
        ...
        )
        {
            ...
            var finalPositionGroup =
                finalQuantity != 0
                    ? initialPositionGroup.WithQuantity(
                        sign * Math.Abs(finalQuantity),
                        _portfolio.Positions
                    )
            ...
            var buyingPowerImpact =
                initialPositionGroup.BuyingPowerModel.GetReservedBuyingPowerImpact(
                    new ReservedBuyingPowerImpactParameters(_portfolio, finalPositionGroup, orders)
                );

            var usedMargin = initialPositionGroup
                .BuyingPowerModel.GetReservedBuyingPowerForPositionGroup(
            ...
            {
                var position = finalPositionGroup.SingleOrDefault(p =>
                    contemplatedChangePosition.Symbol == p.Symbol
                );
                Assert.IsNotNull(position);
                Assert.AreEqual(position.Quantity, contemplatedChangePosition.Quantity);
            }

            var expectedContemplatedInitialMarginRequirement =
                finalQuantity != 0
                    ? (
                        (OptionInitialMargin)
                    ...
                    : 0m;
            var ordersPositions = orders
                .Select(o => o.CreatePositions(_portfolio.Securities))
                .SelectMany(p => p);
            var orderGroup = _portfolio
                .Positions.ResolvePositionGroups(new PositionCollection(ordersPositions))
                .Single();
            var orderGroupInitialMargin = (OptionInitialMargin)
                orderGroup.BuyingPowerModel.GetInitialMarginRequirement(
            ...
            expectedContemplatedInitialMarginRequirement +=
                orderGroupInitialMargin.Value - orderGroupInitialMargin.ValueWithoutPremium;
            ...
            Assert.That(
                buyingPowerImpact.Contemplated,
                Is.EqualTo(expectedContemplatedInitialMarginRequirement).Within(1e-18)
            );
        }
        ...
        private void SetUpOptionStrategy(int initialHoldingsQuantity)
        {
            ...
            Assert.AreEqual(
                initialHoldingsQuantity < 0
                    ? OptionStrategyDefinitions.ShortStraddle.Name
                    : OptionStrategyDefinitions.Straddle.Name,
                positionGroup.BuyingPowerModel.ToString()
            );

            var callOptionPosition = positionGroup.Positions.Single(x =>
                x.Symbol == _callOption.Symbol
            );
            Assert.AreEqual(initialHoldingsQuantity, callOptionPosition.Quantity);

            var putOptionPosition = positionGroup.Positions.Single(x =>
                x.Symbol == _putOption.Symbol
            );
        ...
        {
            var quantity = positionGroup
                .BuyingPowerModel.GetMaximumLotsForDeltaBuyingPower(
                    new GetMaximumLotsForDeltaBuyingPowerParameters(
                        _portfolio,
                        positionGroup,
                        deltaBuyingPower,
        ...
        private List<Order> GetPositionGroupOrders(
            IPositionGroup positionGroup,
            decimal initialPositionGroupQuantity,
            decimal quantity
        )
        {
                ...
                .Positions.Select(position =>
                    Order.CreateOrder(
                        new SubmitOrderRequest(
                            ...
                            position.Symbol,
                            (
                                position.Quantity / initialPositionGroupQuantity
                            ).GetOrderLegGroupQuantity(groupOrderManager),
                            0,
                            0,
                            _algorithm.Time,
                            "",
        ...
        private IPositionGroup SetUpOptionStrategy(
            OptionStrategyDefinition optionStrategyDefinition,
            int initialHoldingsQuantity,
            int? strike = null,
        ...
        )
        {
            ...
            var spyMay19_300Call = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Call, 300, may192023)
            );
            spyMay19_300Call.SetMarketPrice(new Tick { Value = 112m });
            var spyMay19_310Call = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Call, 310, may192023)
            );
            spyMay19_310Call.SetMarketPrice(new Tick { Value = 100m });
            var spyMay19_320Call = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Call, 320, may192023)
            );
            spyMay19_320Call.SetMarketPrice(new Tick { Value = 92m });
            var spyMay19_330Call = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Call, 330, may192023)
            );
            spyMay19_330Call.SetMarketPrice(new Tick { Value = 82m });

            var spyMay17_200Call = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Call, 200, may172023)
            );
            spyMay17_200Call.SetMarketPrice(new Tick { Value = 220m });
            var spyMay17_400Call = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Call, 400, may172023)
            );
            spyMay17_400Call.SetMarketPrice(new Tick { Value = 28m });
            var spyMay17_300Call = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Call, 300, may172023)
            );
            spyMay17_300Call.SetMarketPrice(new Tick { Value = 110m });
            var spyMay17_500Call = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Call, 500, may172023)
            );
            spyMay17_500Call.SetMarketPrice(new Tick { Value = 0.04m });

            var spyMay19_300Put = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Put, 300, may192023)
            );
            spyMay19_300Put.SetMarketPrice(new Tick { Value = 0.02m });
            var spyMay19_310Put = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Put, 310, may192023)
            );
            spyMay19_310Put.SetMarketPrice(new Tick { Value = 0.03m });
            var spyMay19_320Put = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Put, 320, may192023)
            );
            spyMay19_320Put.SetMarketPrice(new Tick { Value = 0.05m });
            var spyMay17_300Put = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Put, 300, may172023)
            );
            spyMay17_300Put.SetMarketPrice(new Tick { Value = 0.01m });

            var jun212024 = new DateTime(2024, 06, 21);

            var spyJun21_534Call = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Call, 534, jun212024)
            );
            spyJun21_534Call.SetMarketPrice(new Tick { Value = 0.01m });
            var spyJun21_524Call = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Call, 524, jun212024)
            );
            spyJun21_524Call.SetMarketPrice(new Tick { Value = 2.29m });
            var spyJun21_542Call = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Call, 542, jun212024)
            );
            spyJun21_542Call.SetMarketPrice(new Tick { Value = 3.047m });
            var spyJun21_546Call = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Call, 546, jun212024)
            );
            spyJun21_546Call.SetMarketPrice(new Tick { Value = 2.53m });
            var spyJun21_550Call = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Call, 550, jun212024)
            );
            spyJun21_550Call.SetMarketPrice(new Tick { Value = 0.01m });
            var spyJun21_554Call = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Call, 554, jun212024)
            );
            spyJun21_554Call.SetMarketPrice(new Tick { Value = 1e-25m });

            var spyJun21_524Put = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Put, 524, jun212024)
            );
            spyJun21_524Put.SetMarketPrice(new Tick { Value = 0.827m });
            var spyJun21_514Put = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Put, 514, jun212024)
            );
            spyJun21_514Put.SetMarketPrice(new Tick { Value = 0.018m });
            var spyJun21_542Put = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Put, 542, jun212024)
            );
            spyJun21_542Put.SetMarketPrice(new Tick { Value = 2.994m });

            var jul192024 = new DateTime(2024, 07, 19);

            var spyJul19_542Call = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Call, 542, jul192024)
            );
            spyJul19_542Call.SetMarketPrice(new Tick { Value = 6.972m });

            var spyJul19_542Put = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Put, 542, jul192024)
            );
            spyJul19_542Put.SetMarketPrice(new Tick { Value = 6.075m });
            var spyJun21_544Put = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Put, 544, jun212024)
            );
            spyJun21_544Put.SetMarketPrice(new Tick { Value = 1e-25m });
            var spyJun21_548Put = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Put, 548, jun212024)
            );
            spyJun21_548Put.SetMarketPrice(new Tick { Value = 0.02m });
            var spyJun21_552Put = _algorithm.AddOptionContract(
                Symbols.CreateOptionSymbol("SPY", OptionRight.Put, 552, jun212024)
            );
            ...
            {
                _equity.Holdings.SetHoldings(
                    _equity.Price,
                    initialHoldingsQuantity * _callOption.ContractMultiplier
                );
                ...
                if (initialHoldingsQuantity < 0)
                {
                    expectedPositionGroupBPMStrategy = OptionStrategyDefinitions
                        .ProtectiveCall
                        .Name;
                }
            }
            else if (optionStrategyDefinition.Name == OptionStrategyDefinitions.ProtectiveCall.Name)
            {
                ...
                spyMay19_300Call.Holdings.SetHoldings(
                    spyMay19_300Call.Price,
                    initialHoldingsQuantity
                );
            ...
            else if (optionStrategyDefinition.Name == OptionStrategyDefinitions.CoveredPut.Name)
            {
                _equity.Holdings.SetHoldings(
                    _equity.Price,
                    -initialHoldingsQuantity * _putOption.ContractMultiplier
                );
                spyMay19_300Put.Holdings.SetHoldings(
                    spyMay19_300Put.Price,
                    -initialHoldingsQuantity
                );
            ...
            else if (optionStrategyDefinition.Name == OptionStrategyDefinitions.ProtectivePut.Name)
            {
                ...
                optionStrategyDefinition.Name == OptionStrategyDefinitions.ProtectiveCollar.Name
            )
            {
                ...
                spyJun21_534Call.Holdings.SetHoldings(
                    spyJun21_534Call.Price,
                    -initialHoldingsQuantity
                );
                spyJun21_514Put.Holdings.SetHoldings(
                    spyJun21_514Put.Price,
                    initialHoldingsQuantity
                );
            }
            else if (optionStrategyDefinition.Name == OptionStrategyDefinitions.Conversion.Name)
            {
                ...
                spyJun21_524Call.Holdings.SetHoldings(
                    spyJun21_524Call.Price,
                    -initialHoldingsQuantity
                );
                spyJun21_524Put.Holdings.SetHoldings(
                    spyJun21_524Put.Price,
                    initialHoldingsQuantity
                );
                ...
                optionStrategyDefinition.Name == OptionStrategyDefinitions.ReverseConversion.Name
            )
            {
            ...
            else if (optionStrategyDefinition.Name == OptionStrategyDefinitions.BearCallSpread.Name)
            {
                ...
                shortCallOption.Holdings.SetHoldings(
                    shortCallOption.Price,
                    -initialHoldingsQuantity
                );
            ...
            {
                spyMay19_310Call.Holdings.SetHoldings(
                    spyMay19_310Call.Price,
                    initialHoldingsQuantity
                );
                spyMay19_300Put.Holdings.SetHoldings(
                    spyMay19_300Put.Price,
            ...
            else if (optionStrategyDefinition.Name == OptionStrategyDefinitions.ButterflyCall.Name)
            {
                ...
                lowerStrikeCallOption.Holdings.SetHoldings(
                    lowerStrikeCallOption.Price,
                    initialHoldingsQuantity
                );
                middleStrikeCallOption.Holdings.SetHoldings(
                    middleStrikeCallOption.Price,
                    -2 * initialHoldingsQuantity
                );
                upperStrikeCallOption.Holdings.SetHoldings(
                    upperStrikeCallOption.Price,
                    initialHoldingsQuantity
                );
                ...
                optionStrategyDefinition.Name == OptionStrategyDefinitions.ShortButterflyCall.Name
            )
            {
                var lowerStrikeCallOption = spyMay19_300Call;
                var middleStrikeCallOption = spyMay19_310Call;
            ...
            else if (optionStrategyDefinition.Name == OptionStrategyDefinitions.ButterflyPut.Name)
            {
                ...
                lowerStrikePutOption.Holdings.SetHoldings(
                    lowerStrikePutOption.Price,
                    initialHoldingsQuantity
                );
                middleStrikePutOption.Holdings.SetHoldings(
                    middleStrikePutOption.Price,
                    -2 * initialHoldingsQuantity
                );
                upperStrikePutOption.Holdings.SetHoldings(
                    upperStrikePutOption.Price,
                    initialHoldingsQuantity
                );
                ...
                optionStrategyDefinition.Name == OptionStrategyDefinitions.ShortButterflyPut.Name
            )
            {
                var lowerStrikePutOption = spyMay19_300Put;
                var middleStrikePutOption = spyMay19_310Put;
                ...
                optionStrategyDefinition.Name == OptionStrategyDefinitions.CallCalendarSpread.Name
            )
            {
                var longCallOption = spyMay19_300Call;
            ...
            )
            {
                ...
                optionStrategyDefinition.Name == OptionStrategyDefinitions.PutCalendarSpread.Name
            )
            {
                var longPutOption = spyMay19_300Put;
            ...
            else if (optionStrategyDefinition.Name == OptionStrategyDefinitions.IronButterfly.Name)
            {
                ...
                optionStrategyDefinition.Name == OptionStrategyDefinitions.ShortIronButterfly.Name
            )
            {
                var shortPutOption = spyMay19_300Put;
                var longPutOption = spyMay19_310Put;
            ...
            else if (optionStrategyDefinition.Name == OptionStrategyDefinitions.IronCondor.Name)
            {
                ...
                optionStrategyDefinition.Name == OptionStrategyDefinitions.ShortIronCondor.Name
            )
            {
                var shortPutOption = spyMay19_300Put;
                var longPutOption = spyMay19_310Put;
            ...
            else if (optionStrategyDefinition.Name == OptionStrategyDefinitions.BearCallLadder.Name)
            {
                ...
                lowStrikeOption.Holdings.SetHoldings(
                    lowStrikeOption.Price,
                    -initialHoldingsQuantity
                );
                middleStrikeOption.Holdings.SetHoldings(
                    middleStrikeOption.Price,
                    initialHoldingsQuantity
                );
                highStrikeOption.Holdings.SetHoldings(
                    highStrikeOption.Price,
                    initialHoldingsQuantity
                );
            ...
            var positionGroup = _portfolio.Positions.Groups.Single();
            Assert.AreEqual(
                expectedPositionGroupBPMStrategy,
                positionGroup.BuyingPowerModel.ToString()
            );
            ...
            if (updateCashbook)
            {
                ...
                foreach (var position in positionGroup)
                {
                    _portfolio
                        .CashBook.Single()
                        .Value.AddAmount(
                            -_portfolio.Securities[position.Symbol].Holdings.HoldingsValue
                        );
                }
            }
