...
namespace QuantConnect.Tests.Common.Securities
{
    ...
    public class OptionStrategyPositionGroupBuyingPowerModelTests
    {
        ...
        private static readonly TestCaseData[] HasSufficientBuyingPowerForOrderTestCases = new[]
        {
            ...
            new TestCaseData(OptionStrategyDefinitions.IronButterfly, -20, -(1000000 - 20 * 1000) / (1000 + 0), true),    // -20 to max short
            new TestCaseData(OptionStrategyDefinitions.IronButterfly, -20, -(1000000 - 20 * 1000) / (1000 + 0) - 1, false),  // -20 to max short + 1
            // Initial margin requirement|premium for ShortIronButterfly with quantities 1 and -1 are 1000|0 and 0|801 respectively
            new TestCaseData(OptionStrategyDefinitions.ShortIronButterfly, 0, (1000000 - 0 * 1000) / (1000 + 0), true), // 0 to max long
            new TestCaseData(OptionStrategyDefinitions.ShortIronButterfly, 0, (1000000 - 0 * 1000) / (1000 + 0) + 1, false), // 0 to max long + 1
            new TestCaseData(OptionStrategyDefinitions.ShortIronButterfly, 0, -(1000000 + 0 * 0) / (0 + 801), true), // 0 to max short
            new TestCaseData(OptionStrategyDefinitions.ShortIronButterfly, 0, -(1000000 + 0 * 0) / (0 + 801) - 1, false),    // 0 to max short + 1
            new TestCaseData(OptionStrategyDefinitions.ShortIronButterfly, 20, (1000000 - 20 * 1000) / (1000 + 0), true),    // 20 to max long
            new TestCaseData(OptionStrategyDefinitions.ShortIronButterfly, 20, (1000000 - 20 * 1000) / (1000 + 0) + 1, false),    // 20 to max long + 1
            new TestCaseData(OptionStrategyDefinitions.ShortIronButterfly, 20, -20, true), // 20 to 0
            new TestCaseData(OptionStrategyDefinitions.ShortIronButterfly, 20, -(1000000 + 20 * 0) / (0 + 801), true), // 20 to max short
            new TestCaseData(OptionStrategyDefinitions.ShortIronButterfly, 20, -(1000000 + 20 * 0) / (0 + 801) - 1, false),  // 20 to max short + 1
            new TestCaseData(OptionStrategyDefinitions.ShortIronButterfly, -20, (1000000 + 20 * 1000) / (1000 + 0), true),   // -20 to max long
            new TestCaseData(OptionStrategyDefinitions.ShortIronButterfly, -20, (1000000 + 20 * 1000) / (1000 + 0) + 1, false),   // -20 to max long + 1
            new TestCaseData(OptionStrategyDefinitions.ShortIronButterfly, -20, 20, true), // -20 to 0
            new TestCaseData(OptionStrategyDefinitions.ShortIronButterfly, -20, -(1000000 - 20 * 0) / (0 + 801), true),    // -20 to max short
        ...
        private static readonly TestCaseData[] InitialMarginRequirementsTestCases = new[]
        {
            ...
            new TestCaseData(OptionStrategyDefinitions.IronButterfly, -1, 1000m),                   // IB:  short iron butterfly
            new TestCaseData(OptionStrategyDefinitions.ShortIronButterfly, 1, 1000m),               // IB:  1010    note: 1% commission
            new TestCaseData(OptionStrategyDefinitions.ShortIronButterfly, -1, 0m),                 // IB:  iron butterfly
        ...
        private static readonly TestCaseData[] OrderQuantityForDeltaBuyingPowerTestCases = new[]
        {
            ...
            // Initial margin requirement (including premium) for ShortIronButterfly with quantity 10 and -10 is 10000 and 8010 respectively
