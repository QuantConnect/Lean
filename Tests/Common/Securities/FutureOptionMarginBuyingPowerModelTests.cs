...
namespace QuantConnect.Tests.Common.Securities
{
    ...
    public class FutureOptionMarginBuyingPowerModelTests
    {
        ...
        public void MarginWithNoFutureOptionHoldings()
        {
            ...
            var futureOptionBuyingPowerModel = new FuturesOptionsMarginModel(
                futureOption: optionSecurity
            );
        ...
        public void MarginRequirementsAreSetCorrectly()
        {
            ...
            var optionSecurity = new QuantConnect.Securities.FutureOption.FutureOption(
                symbol,
                SecurityExchangeHours.AlwaysOpen(tz),
                new Cash(Currencies.USD, 0, 1m),
                new OptionSymbolProperties(SymbolProperties.GetDefault(Currencies.USD)),
            ...
            optionSecurity.Underlying.SetMarketPrice(
                new Tick { Value = 1500, Time = new DateTime(2001, 01, 07) }
            );

            var initialIntradayMarginRequirement =
                futureMarginModel.InitialIntradayMarginRequirement;
            var maintenanceIntradayMarginRequirement =
                futureMarginModel.MaintenanceIntradayMarginRequirement;

            var initialOvernightMarginRequirement =
                futureMarginModel.MaintenanceOvernightMarginRequirement;
            var maintenanceOvernightMarginRequirement =
                futureMarginModel.InitialOvernightMarginRequirement;
        ...
        public void MarginRequirementCrudeOil(
            decimal strike,
            double expected,
        ...
        )
        {
            ...
            optionSecurity.Underlying.SetMarketPrice(
                new Tick { Value = 60, Time = new DateTime(2001, 01, 07) }
            );
            var marginRequirement = FuturesOptionsMarginModel.GetMarginRequirement(
                optionSecurity,
            ...
            Log.Debug(
                $"Side {positionSide}. Right {optionRight}. Strike {strike}. Margin: {marginRequirement}"
            );
        ...
        public void MarginRequirementGold(
            decimal strike,
            double expected,
            OptionRight optionRight,
            PositionSide positionSide,
        ...
        )
        {
            ...
            optionSecurity.Underlying.SetMarketPrice(
                new Tick { Value = 1887, Time = new DateTime(2001, 01, 07) }
            );
            var marginRequirement = FuturesOptionsMarginModel.GetMarginRequirement(
                optionSecurity,
                underlyingRequirement,
        ...
        )
        {
            ...
            optionSecurity.Underlying.SetMarketPrice(
                new Tick { Value = 4172, Time = new DateTime(2001, 01, 07) }
            );
            var marginRequirement = FuturesOptionsMarginModel.GetMarginRequirement(
                optionSecurity,
                underlyingRequirement,
