    ...
    public class PositionGroupCollectionTests
    {
        ...
        public void CombineWith()
        {
            ...
            var group = new PositionGroup(
                new PositionGroupKey(new SecurityPositionGroupBuyingPowerModel(), positions),
        ...
        public void AddDifferentQuantity()
        {
            ...
            var group2 = new PositionGroup(
                new PositionGroupKey(new SecurityPositionGroupBuyingPowerModel(), positions2),
                positions2[0].Quantity,
                positions2
            );
