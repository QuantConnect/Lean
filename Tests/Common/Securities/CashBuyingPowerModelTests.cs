...
namespace QuantConnect.Tests.Common.Securities
{
    ...
    public class CashBuyingPowerModelTests
    {
        ...
        public void LimitBuyBtcWithUsdRequiresUsdInPortfolio()
        {
            ...
            Assert.IsTrue(
                _buyingPowerModel
                    .HasSufficientBuyingPowerForOrder(_portfolio, _btcusd, order)
                    .IsSufficient
            );
        ...
        public void LimitBuyBtcWithEurRequiresEurInPortfolio()
        {
            ...
            Assert.IsTrue(
                _buyingPowerModel
                    .HasSufficientBuyingPowerForOrder(_portfolio, _btceur, order)
                    .IsSufficient
            );
        ...
        public void LimitSellOrderChecksOpenOrders()
        {
            ...
            Assert.IsTrue(
                _buyingPowerModel
                    .HasSufficientBuyingPowerForOrder(_portfolio, _ethusd, order)
                    .IsSufficient
            );
            ...
            Assert.IsTrue(
                _buyingPowerModel
                    .HasSufficientBuyingPowerForOrder(_portfolio, _btcusd, stopOrder)
                    .IsSufficient
            );
        ...
        public void MarketBuyBtcWithUsdRequiresUsdInPortfolioPlusFees()
        {
            ...
            Assert.AreEqual(
                1.98412698m,
                _buyingPowerModel
                    .GetMaximumOrderQuantityForTargetBuyingPower(_portfolio, _btcusd, 1, 0)
                    .Quantity
            );
        ...
        public void MarketBuyBtcWithEurRequiresEurInPortfolioPlusFees()
        {
            ...
            var targetValue =
                20000m * _portfolio.CashBook["EUR"].ConversionRate / _portfolio.TotalPortfolioValue;
            Assert.AreEqual(
                1.98412698m,
                _buyingPowerModel
        ...
        public void MarketSellOrderRequiresBaseCurrencyInPortfolioPlusFees()
        {
            ...
            Assert.AreEqual(
                -0.5m,
                _buyingPowerModel
                    .GetMaximumOrderQuantityForTargetBuyingPower(_portfolio, _btcusd, 0, 0)
                    .Quantity
            );
        }
        ...
        public void MarketBuyOrderChecksOpenOrders()
        {
            ...
            var quantity = _buyingPowerModel
                .GetMaximumOrderQuantityForTargetBuyingPower(
                    _portfolio,
                    _btcusd,
                    500 / _portfolio.TotalPortfolioValue,
                    0
                )
                .Quantity;
            ...
            order = new MarketOrder(
                _btcusd.Symbol,
                quantity + _btcusd.SymbolProperties.LotSize,
                DateTime.UtcNow
            );
            Assert.IsFalse(
                _buyingPowerModel
            ...
            Assert.AreEqual(
                ...
                _buyingPowerModel
                    .GetMaximumOrderQuantityForTargetBuyingPower(
                        _portfolio,
                        _btcusd,
                        0.2m * 15000 / _portfolio.TotalPortfolioValue,
                        0
                    )
                    .Quantity
            );
        ...
        public void CalculatesMaximumOrderQuantityCorrectly()
        {
            ...
            var getMaximumOrderQuantityForTargetValueResult = _buyingPowerModel
                .GetMaximumOrderQuantityForTargetBuyingPower(_portfolio, _btcusd, targetValue, 0)
                .Quantity;
            Assert.AreEqual(0.66137566m, getMaximumOrderQuantityForTargetValueResult);

            var order = new MarketOrder(
                _btcusd.Symbol,
                getMaximumOrderQuantityForTargetValueResult,
                DateTime.UtcNow
            );
            Assert.IsTrue(
                _buyingPowerModel
            ...
            getMaximumOrderQuantityForTargetValueResult = _buyingPowerModel
                .GetMaximumOrderQuantityForTargetBuyingPower(_portfolio, _ethusd, targetValue, 0)
                .Quantity;
            ...
            var quantity = _buyingPowerModel
                .GetMaximumOrderQuantityForTargetBuyingPower(_portfolio, _ethbtc, 1, 0)
                .Quantity;
            ...
            Assert.IsFalse(
                _buyingPowerModel
                    .HasSufficientBuyingPowerForOrder(_portfolio, _ethbtc, order)
                    .IsSufficient
            );

            // 0.82671957 * 12000 + fees <= 10000 EUR
            targetValue =
                10000m * _portfolio.CashBook["EUR"].ConversionRate / _portfolio.TotalPortfolioValue;
            getMaximumOrderQuantityForTargetValueResult = _buyingPowerModel
                .GetMaximumOrderQuantityForTargetBuyingPower(_portfolio, _btceur, targetValue, 0)
                .Quantity;
        ...
        public void CalculatesMaximumOrderQuantityCorrectlySmallerTarget()
        {
            ...
            var getMaximumOrderQuantityForTargetValueResult =
                _buyingPowerModel.GetMaximumOrderQuantityForTargetBuyingPower(
                    _portfolio,
                    _btcusd,
                    0.1m,
                    0
            ...
            var order = new MarketOrder(
                _btcusd.Symbol,
                getMaximumOrderQuantityForTargetValueResult.Quantity,
                DateTime.UtcNow
            );
            Assert.IsTrue(
                _buyingPowerModel
        ...
        public void CalculatesMaximumOrderQuantityCorrectlyForAlmostNoCashRemaining()
        {
            ...
            var getMaximumOrderQuantityForTargetValueResult =
                _buyingPowerModel.GetMaximumOrderQuantityForTargetBuyingPower(
                    _portfolio,
                    _btcusd,
                    10000 / _portfolio.TotalPortfolioValue,
                    0
                );
        ...
        public void MarketBuyOrderChecksExistingHoldings()
        {
            ...
            var quantity = _buyingPowerModel
                .GetMaximumOrderQuantityForTargetBuyingPower(
                    _portfolio,
                    _btcusd,
                    10000m / _portfolio.TotalPortfolioValue,
                    0
                )
                .Quantity;
        ...
        public void MarketBuyBtcWithEurCalculatesBuyingPowerProperlyWithExistingHoldings()
        {
            ...
            var targetValue =
                30000m * _portfolio.CashBook["EUR"].ConversionRate / _portfolio.TotalPortfolioValue;
            Assert.AreEqual(
                1.98412698m,
                _buyingPowerModel
                    .GetMaximumOrderQuantityForTargetBuyingPower(
        ...
        public void MarketBuyOrderUsesAskPriceIfAvailable()
        {
            ...
            var quantity = _buyingPowerModel
                .GetMaximumOrderQuantityForTargetBuyingPower(_portfolio, _btcusd, 1m, 0)
                .Quantity;
        ...
        public void ZeroTargetWithZeroHoldingsIsNotAnError()
        {
            ...
            var result = _buyingPowerModel.GetMaximumOrderQuantityForTargetBuyingPower(
        ...
        public void NonAccountCurrency_NoQuoteCurrencyCash()
        {
            ...
            // HasSufficientBuyingPowerForOrder does check margin requirements
            var order = new MarketOrder(_btcusd.Symbol, quantity, DateTime.UtcNow);
            var result = _buyingPowerModel.HasSufficientBuyingPowerForOrder(
                _portfolio,
                _btcusd,
                order
            );
        ...
        [TestCase("EUR")]
        [TestCase("ARG")]
        public void ZeroNonAccountCurrency_GetMaximumOrderQuantityForTargetValue(
        ...
        )
        {
            ...
            var feeAsAccountCurrency = _algorithm.Portfolio.CashBook.ConvertToAccountCurrency(
                fee.Value
            );
            var expectedQuantity =
                (8800 - feeAsAccountCurrency.Amount) / (_btcusd.AskPrice * 0.88m);
        ...
        public void ZeroNonAccountCurrency_GetBuyingPower()
        {
            ...
            var quantity = _buyingPowerModel
                .GetBuyingPower(new BuyingPowerParameters(_portfolio, _btcusd, OrderDirection.Buy))
                .Value;
        ...
        private void SubmitLimitOrder(Symbol symbol, decimal quantity, decimal limitPrice)
        {
            ...
            {
                EventHandler<List<OrderEvent>> handler = (s, e) =>
                {
                    resetEvent.Set();
                };
