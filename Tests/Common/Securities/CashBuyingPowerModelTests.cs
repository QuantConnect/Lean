...
namespace QuantConnect.Tests.Common.Securities
{
    ...
    public class CashBuyingPowerModelTests
    {
        ...
        public void MarketBuyBtcWithUsdRequiresUsdInPortfolioPlusFees()
        {
            ...
            // Maximum we can market buy with 20000 USD is 1.99401794 BTC
            Assert.AreEqual(1.99401794m, _buyingPowerModel.GetMaximumOrderQuantityForTargetValue(_portfolio, _btcusd, 20000).Quantity);
        ...
        public void MarketBuyBtcWithEurRequiresEurInPortfolioPlusFees()
        {
            ...
            // Maximum we can market buy with 20000 EUR is 1.99401794 BTC
        ...
        public void MarketBuyOrderChecksOpenOrders()
        {
            ...
            // Maximum we can market buy with 500 USD is 0.03323363 BTC
            Assert.AreEqual(0.03323363m, _buyingPowerModel.GetMaximumOrderQuantityForTargetValue(_portfolio, _btcusd, 500).Quantity);
        ...
        public void MarketSellOrderChecksOpenOrders()
        {
            ...
            // Maximum we can market sell with 0.8 BTC is 0.79760717 BTC (for a target position of 0.2 BTC)
            // target value = (1 - 0.8) * price
            Assert.AreEqual(-0.79760717m, _buyingPowerModel.GetMaximumOrderQuantityForTargetValue(_portfolio, _btcusd, 0.2m * 15000).Quantity);
        ...
        public void CalculatesMaximumOrderQuantityCorrectly()
        {
            ...
            // 0.66466667 * 15000 + fees <= 10000 USD
            Assert.AreEqual(0.66467264m, _buyingPowerModel.GetMaximumOrderQuantityForTargetValue(_portfolio, _btcusd, 10000).Quantity);

            // 9.97 * 1000 + fees <= 10000 USD
            Assert.AreEqual(9.97008973m, _buyingPowerModel.GetMaximumOrderQuantityForTargetValue(_portfolio, _ethusd, 10000).Quantity);
            ...
            // 0.83083334 * 12000 + fees <= 10000 EUR
            var targetValue = 10000m * _portfolio.CashBook["EUR"].ConversionRate;
            Assert.AreEqual(0.83084081m, _buyingPowerModel.GetMaximumOrderQuantityForTargetValue(_portfolio, _btceur, targetValue).Quantity);
        }
        ...
        public void CalculatesMaximumOrderQuantityCorrectlySmallerTarget()
        {
            ...
            var getMaximumOrderQuantityForTargetValueResult = _buyingPowerModel.GetMaximumOrderQuantityForTargetValue(_portfolio, _btcusd, 1000);
            // 0.06646726m * 15000m <= 10000 USD cash available
            // 0.06646726m * 15000m + fees <= 1000 USD Target
        ...
        public void CalculatesMaximumOrderQuantityCorrectlyBiggerTarget()
        {
            ...
            var getMaximumOrderQuantityForTargetValueResult = _buyingPowerModel.GetMaximumOrderQuantityForTargetValue(_portfolio, _btcusd, 100000);
            // 0.66666666m * 15000m <= 10000 USD cash available
            // 0.66666666m * 15000m + fees <= 100000 USD Target
        ...
        public void CalculatesMaximumOrderQuantityCorrectlyForAlmostNoCashRemaining()
        {
            ...
            var getMaximumOrderQuantityForTargetValueResult = _buyingPowerModel.GetMaximumOrderQuantityForTargetValue(_portfolio, _btcusd, 10000);
            // We don't have enough cash to buy anything
            Assert.AreEqual(0m, getMaximumOrderQuantityForTargetValueResult.Quantity);
        }
        ...
        public void CalculatesMaximumOrderQuantityCorrectlyForNoOrderFee()
        {
            ...
            _algorithm.SetFinishedWarmingUp();
            var getMaximumOrderQuantityForTargetValueResult  = _buyingPowerModel.GetMaximumOrderQuantityForTargetValue(_portfolio, _btcusd, 10000);
            // 0.66666666m * 15000m <= 100000m USD cash available
            // 0.66666666m * 15000m + fees (0) <= 10000 USD Target
            Assert.AreEqual(0.66666666m, getMaximumOrderQuantityForTargetValueResult.Quantity);
        }
        ...
        public void MarketBuyOrderChecksExistingHoldings()
        {
            ...
            // Maximum we can market buy for (10000-2000) = 8000 USD is 0.79760717 BTC
        ...
        public void MarketBuyBtcWithEurCalculatesBuyingPowerProperlyWithExistingHoldings()
        {
            ...
            var order = new MarketOrder(_btceur.Symbol, 1.994m, DateTime.UtcNow);
            Assert.IsTrue(_buyingPowerModel.HasSufficientBuyingPowerForOrder(_portfolio, _btceur, order).IsSufficient);
        ...
        public void MarketBuyOrderUsesAskPriceIfAvailable()
        {
            ...
            // Maximum we can market buy at ask price with 10000 USD is 0.99204872 BTC
            var quantity = _buyingPowerModel.GetMaximumOrderQuantityForTargetValue(_portfolio, _btcusd, 10000m).Quantity;
