...
namespace QuantConnect.Tests.Common.Data
{
    ...
    public class SubscriptionManagerTests
    {
        ...
        [TestCase(SecurityType.Future, TickType.Trade, typeof(TradeBar), true)]
        ...
        [TestCase(SecurityType.Future, TickType.Quote, typeof(QuoteBar), true)]
        ...
        [TestCase(SecurityType.Future, TickType.OpenInterest, typeof(OpenInterest), true)]

        [TestCase(SecurityType.Option, TickType.Trade, typeof(TradeBar), true)]
        [TestCase(SecurityType.Option, TickType.Trade, typeof(QuoteBar), false)]
        [TestCase(SecurityType.Option, TickType.Trade, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Option, TickType.Quote, typeof(TradeBar), false)]
        [TestCase(SecurityType.Option, TickType.Quote, typeof(QuoteBar), true)]
        [TestCase(SecurityType.Option, TickType.Quote, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Option, TickType.OpenInterest, typeof(TradeBar), false)]
        [TestCase(SecurityType.Option, TickType.OpenInterest, typeof(QuoteBar), false)]
        [TestCase(SecurityType.Option, TickType.OpenInterest, typeof(OpenInterest), true)]

        [TestCase(SecurityType.Equity, TickType.Trade, typeof(TradeBar), true)]
        [TestCase(SecurityType.Equity, TickType.Trade, typeof(QuoteBar), false)]
        [TestCase(SecurityType.Equity, TickType.Trade, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Equity, TickType.Quote, typeof(RenkoBar), true)]

        [TestCase(SecurityType.Forex, TickType.Quote, typeof(TradeBar), false)]
        [TestCase(SecurityType.Forex, TickType.Quote, typeof(QuoteBar), true)]
        [TestCase(SecurityType.Forex, TickType.Quote, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Forex, TickType.Quote, typeof(RenkoBar), true)]

        [TestCase(SecurityType.Cfd, TickType.Quote, typeof(TradeBar), false)]
        [TestCase(SecurityType.Cfd, TickType.Quote, typeof(QuoteBar), true)]
        [TestCase(SecurityType.Cfd, TickType.Quote, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Cfd, TickType.Quote, typeof(RenkoBar), true)]

        [TestCase(SecurityType.Crypto, TickType.Trade, typeof(TradeBar), true)]
        ...
        [TestCase(SecurityType.Crypto, TickType.Trade, typeof(RenkoBar), true)]
        [TestCase(SecurityType.Crypto, TickType.Quote, typeof(TradeBar), false)]
        [TestCase(SecurityType.Crypto, TickType.Quote, typeof(QuoteBar), true)]
        [TestCase(SecurityType.Crypto, TickType.Quote, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Crypto, TickType.Quote, typeof(RenkoBar), true)]
            ...
            bool expected)
        {
            ...
            using var consolidator = new TestConsolidator(typeof(Tick), consolidatorOutputType);
        ...
        [TestCase(SecurityType.Future, TickType.Trade, null, typeof(TradeBar), true)]
        ...
        [TestCase(SecurityType.Future, TickType.Quote, null, typeof(QuoteBar), true)]
        ...
        [TestCase(SecurityType.Future, TickType.OpenInterest, null, typeof(OpenInterest), true)]
        [TestCase(SecurityType.Future, TickType.Trade, TickType.Trade, typeof(TradeBar), true)]
        [TestCase(SecurityType.Future, TickType.Trade, TickType.Quote, typeof(TradeBar), false)]
        [TestCase(SecurityType.Future, TickType.Trade, TickType.OpenInterest, typeof(TradeBar), false)]
        [TestCase(SecurityType.Future, TickType.Quote, TickType.Trade, typeof(QuoteBar), false)]
        [TestCase(SecurityType.Future, TickType.Quote, TickType.Quote, typeof(QuoteBar), true)]
        [TestCase(SecurityType.Future, TickType.Quote, TickType.OpenInterest, typeof(QuoteBar), false)]
        [TestCase(SecurityType.Future, TickType.OpenInterest, TickType.Trade, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Future, TickType.OpenInterest, TickType.Quote, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Future, TickType.OpenInterest, TickType.OpenInterest, typeof(OpenInterest), true)]

        [TestCase(SecurityType.Option, TickType.Trade, null, typeof(TradeBar), true)]
        [TestCase(SecurityType.Option, TickType.Trade, null, typeof(QuoteBar), false)]
        [TestCase(SecurityType.Option, TickType.Trade, null, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Option, TickType.Quote, null, typeof(TradeBar), false)]
        [TestCase(SecurityType.Option, TickType.Quote, null, typeof(QuoteBar), true)]
        [TestCase(SecurityType.Option, TickType.Quote, null, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Option, TickType.OpenInterest, null, typeof(TradeBar), false)]
        [TestCase(SecurityType.Option, TickType.OpenInterest, null, typeof(QuoteBar), false)]
        [TestCase(SecurityType.Option, TickType.OpenInterest, null, typeof(OpenInterest), true)]
        [TestCase(SecurityType.Option, TickType.Trade, TickType.Trade, typeof(TradeBar), true)]
        [TestCase(SecurityType.Option, TickType.Trade, TickType.Quote, typeof(TradeBar), false)]
        [TestCase(SecurityType.Option, TickType.Trade, TickType.OpenInterest, typeof(TradeBar), false)]
        [TestCase(SecurityType.Option, TickType.Quote, TickType.Trade, typeof(QuoteBar), false)]
        [TestCase(SecurityType.Option, TickType.Quote, TickType.Quote, typeof(QuoteBar), true)]
        [TestCase(SecurityType.Option, TickType.Quote, TickType.OpenInterest, typeof(QuoteBar), false)]
        [TestCase(SecurityType.Option, TickType.OpenInterest, TickType.Trade, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Option, TickType.OpenInterest, TickType.Quote, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Option, TickType.OpenInterest, TickType.OpenInterest, typeof(OpenInterest), true)]

        [TestCase(SecurityType.Equity, TickType.Trade, null, typeof(TradeBar), true)]
        [TestCase(SecurityType.Equity, TickType.Trade, null, typeof(QuoteBar), false)]
        [TestCase(SecurityType.Equity, TickType.Trade, null, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Equity, TickType.Quote, null, typeof(TradeBar), false)]
        [TestCase(SecurityType.Equity, TickType.Quote, null, typeof(QuoteBar), true)]
        [TestCase(SecurityType.Equity, TickType.Quote, null, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Equity, TickType.OpenInterest, null, typeof(TradeBar), false)]
        [TestCase(SecurityType.Equity, TickType.OpenInterest, null, typeof(QuoteBar), false)]
        [TestCase(SecurityType.Equity, TickType.OpenInterest, null, typeof(OpenInterest), true)]
        [TestCase(SecurityType.Equity, TickType.Quote, null, typeof(RenkoBar), true)]
        [TestCase(SecurityType.Equity, TickType.Trade, TickType.Trade, typeof(TradeBar), true)]
        [TestCase(SecurityType.Equity, TickType.Trade, TickType.Quote, typeof(TradeBar), false)]
        [TestCase(SecurityType.Equity, TickType.Trade, TickType.OpenInterest, typeof(TradeBar), false)]
        [TestCase(SecurityType.Equity, TickType.Quote, TickType.Trade, typeof(QuoteBar), false)]
        [TestCase(SecurityType.Equity, TickType.Quote, TickType.Quote, typeof(QuoteBar), true)]
        [TestCase(SecurityType.Equity, TickType.Quote, TickType.OpenInterest, typeof(QuoteBar), false)]
        [TestCase(SecurityType.Equity, TickType.OpenInterest, TickType.Trade, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Equity, TickType.OpenInterest, TickType.Quote, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Equity, TickType.OpenInterest, TickType.OpenInterest, typeof(OpenInterest), true)]

        [TestCase(SecurityType.Forex, TickType.Trade, null, typeof(TradeBar), true)]
        ...
        [TestCase(SecurityType.Forex, TickType.Quote, null, typeof(QuoteBar), true)]
        ...
        [TestCase(SecurityType.Forex, TickType.OpenInterest, null, typeof(OpenInterest), true)]
        [TestCase(SecurityType.Forex, TickType.Quote, null, typeof(RenkoBar), true)]
        [TestCase(SecurityType.Forex, TickType.Trade, TickType.Trade, typeof(TradeBar), true)]
        [TestCase(SecurityType.Forex, TickType.Trade, TickType.Quote, typeof(TradeBar), false)]
        [TestCase(SecurityType.Forex, TickType.Trade, TickType.OpenInterest, typeof(TradeBar), false)]
        [TestCase(SecurityType.Forex, TickType.Quote, TickType.Trade, typeof(QuoteBar), false)]
        [TestCase(SecurityType.Forex, TickType.Quote, TickType.Quote, typeof(QuoteBar), true)]
        [TestCase(SecurityType.Forex, TickType.Quote, TickType.OpenInterest, typeof(QuoteBar), false)]
        [TestCase(SecurityType.Forex, TickType.OpenInterest, TickType.Trade, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Forex, TickType.OpenInterest, TickType.Quote, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Forex, TickType.OpenInterest, TickType.OpenInterest, typeof(OpenInterest), true)]

        [TestCase(SecurityType.Cfd, TickType.Trade, null, typeof(TradeBar), true)]
        ...
        [TestCase(SecurityType.Cfd, TickType.Quote, null, typeof(QuoteBar), true)]
        ...
        [TestCase(SecurityType.Cfd, TickType.OpenInterest, null, typeof(OpenInterest), true)]
        [TestCase(SecurityType.Cfd, TickType.Quote, null, typeof(RenkoBar), true)]
        [TestCase(SecurityType.Cfd, TickType.Trade, TickType.Trade, typeof(TradeBar), true)]
        [TestCase(SecurityType.Cfd, TickType.Trade, TickType.Quote, typeof(TradeBar), false)]
        [TestCase(SecurityType.Cfd, TickType.Trade, TickType.OpenInterest, typeof(TradeBar), false)]
        [TestCase(SecurityType.Cfd, TickType.Quote, TickType.Trade, typeof(QuoteBar), false)]
        [TestCase(SecurityType.Cfd, TickType.Quote, TickType.Quote, typeof(QuoteBar), true)]
        [TestCase(SecurityType.Cfd, TickType.Quote, TickType.OpenInterest, typeof(QuoteBar), false)]
        [TestCase(SecurityType.Cfd, TickType.OpenInterest, TickType.Trade, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Cfd, TickType.OpenInterest, TickType.Quote, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Cfd, TickType.OpenInterest, TickType.OpenInterest, typeof(OpenInterest), true)]

        [TestCase(SecurityType.Crypto, TickType.Trade, null, typeof(TradeBar), true)]
        ...
        [TestCase(SecurityType.Crypto, TickType.Quote, null, typeof(QuoteBar), true)]
        ...
        [TestCase(SecurityType.Crypto, TickType.OpenInterest, null, typeof(OpenInterest), true)]
        [TestCase(SecurityType.Crypto, TickType.Quote, null, typeof(RenkoBar), true)]
        [TestCase(SecurityType.Crypto, TickType.Trade, TickType.Trade, typeof(TradeBar), true)]
        [TestCase(SecurityType.Crypto, TickType.Trade, TickType.Quote, typeof(TradeBar), false)]
        [TestCase(SecurityType.Crypto, TickType.Trade, TickType.OpenInterest, typeof(TradeBar), false)]
        [TestCase(SecurityType.Crypto, TickType.Quote, TickType.Trade, typeof(QuoteBar), false)]
        [TestCase(SecurityType.Crypto, TickType.Quote, TickType.Quote, typeof(QuoteBar), true)]
        [TestCase(SecurityType.Crypto, TickType.Quote, TickType.OpenInterest, typeof(QuoteBar), false)]
        [TestCase(SecurityType.Crypto, TickType.OpenInterest, TickType.Trade, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Crypto, TickType.OpenInterest, TickType.Quote, typeof(OpenInterest), false)]
        [TestCase(SecurityType.Crypto, TickType.OpenInterest, TickType.OpenInterest, typeof(OpenInterest), true)]
