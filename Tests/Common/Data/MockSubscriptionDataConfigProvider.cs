...
namespace QuantConnect.Tests.Common.Data
{
    internal class MockSubscriptionDataConfigProvider : ISubscriptionDataConfigProvider
    {
        ...
        public static void SetSubscriptionDataConfigProvider(
            IFillModel fillModel,
            SubscriptionDataConfig subscriptionDataConfig)
        {
            var provider = new MockSubscriptionDataConfigProvider(subscriptionDataConfig);
            var baseType = fillModel as FillModel;
            baseType?.SetSubscriptionDataConfigProvider(provider);
        }
    }
}
