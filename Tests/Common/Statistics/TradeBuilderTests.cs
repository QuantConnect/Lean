...
namespace QuantConnect.Tests.Common.Statistics
{
    ...
    public class TradeBuilderTests
    {
        ...
        public void AllInAllOutLong(FillGroupingMethod groupingMethod, FillMatchingMethod matchingMethod)
        {
            ...
            // Buy 1k
            builder.ProcessFill(new OrderEvent(1, Symbols.EURUSD, time, OrderStatus.Filled, OrderDirection.Buy, fillPrice: 1.08m, fillQuantity: 1000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
            ...
            // Sell 1k
            builder.ProcessFill(new OrderEvent(2, Symbols.EURUSD, time.AddMinutes(10), OrderStatus.Filled, OrderDirection.Sell, fillPrice: 1.09m, fillQuantity: -1000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
        ...
        public void AllInAllOutShort(FillGroupingMethod groupingMethod, FillMatchingMethod matchingMethod)
        {
            ...
            // Sell 1k
            builder.ProcessFill(new OrderEvent(1, Symbols.EURUSD, time, OrderStatus.Filled, OrderDirection.Sell, fillPrice: 1.08m, fillQuantity: -1000, orderFee: OrderFee,accountCurrency:AccountCurrency), ConversionRate);
            ...
            // Buy 1k
            builder.ProcessFill(new OrderEvent(2, Symbols.EURUSD, time.AddMinutes(10), OrderStatus.Filled, OrderDirection.Buy, fillPrice: 1.09m, fillQuantity: 1000, orderFee: OrderFee,accountCurrency:AccountCurrency), ConversionRate);
        ...
        public void ScaleInAllOutLong(FillGroupingMethod groupingMethod, FillMatchingMethod matchingMethod)
        {
            ...
            // Buy 1k
            builder.ProcessFill(new OrderEvent(2, Symbols.EURUSD, time.AddMinutes(10), OrderStatus.Filled, OrderDirection.Buy, fillPrice: 1.07m, fillQuantity: 1000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
            ...
            // Sell 2k
            builder.ProcessFill(new OrderEvent(3, Symbols.EURUSD, time.AddMinutes(20), OrderStatus.Filled, OrderDirection.Sell, fillPrice: 1.09m, fillQuantity: -2000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
        ...
        public void ScaleInAllOutShort(FillGroupingMethod groupingMethod, FillMatchingMethod matchingMethod)
        {
            ...
            // Sell 1k
            builder.ProcessFill(new OrderEvent(2, Symbols.EURUSD, time.AddMinutes(10), OrderStatus.Filled, OrderDirection.Sell, fillPrice: 1.07m, fillQuantity: -1000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
            ...
            // Buy 2k
            builder.ProcessFill(new OrderEvent(3, Symbols.EURUSD, time.AddMinutes(20), OrderStatus.Filled, OrderDirection.Buy, fillPrice: 1.09m, fillQuantity: 2000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
        ...
        public void AllInScaleOutLong(FillGroupingMethod groupingMethod, FillMatchingMethod matchingMethod)
        {
            ...
            // Buy 2k
            builder.ProcessFill(new OrderEvent(1, Symbols.EURUSD, time, OrderStatus.Filled, OrderDirection.Buy, fillPrice: 1.07m, fillQuantity: 2000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
            ...
            // Sell 1k
            builder.ProcessFill(new OrderEvent(2, Symbols.EURUSD, time.AddMinutes(10), OrderStatus.Filled, OrderDirection.Sell, fillPrice: 1.08m, fillQuantity: -1000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
            ...
            // Sell 1k
            builder.ProcessFill(new OrderEvent(3, Symbols.EURUSD, time.AddMinutes(20), OrderStatus.Filled, OrderDirection.Sell, fillPrice: 1.09m, fillQuantity: -1000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
        ...
        public void AllInScaleOutShort(FillGroupingMethod groupingMethod, FillMatchingMethod matchingMethod)
        {
            ...
            // Sell 2k
            builder.ProcessFill(new OrderEvent(1, Symbols.EURUSD, time, OrderStatus.Filled, OrderDirection.Sell, fillPrice: 1.07m, fillQuantity: -2000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
            ...
            // Buy 1k
            builder.ProcessFill(new OrderEvent(2, Symbols.EURUSD, time.AddMinutes(10), OrderStatus.Filled, OrderDirection.Buy, fillPrice: 1.08m, fillQuantity: 1000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
            ...
            // Buy 1k
            builder.ProcessFill(new OrderEvent(3, Symbols.EURUSD, time.AddMinutes(20), OrderStatus.Filled, OrderDirection.Buy, fillPrice: 1.09m, fillQuantity: 1000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
        ...
        public void ReversalLongToShort(FillGroupingMethod groupingMethod, FillMatchingMethod matchingMethod)
        {
            ...
            // Buy 1k
            builder.ProcessFill(new OrderEvent(1, Symbols.EURUSD, time, OrderStatus.Filled, OrderDirection.Buy, fillPrice: 1.07m, fillQuantity: 1000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
            ...
            // Sell 2k
            builder.ProcessFill(new OrderEvent(2, Symbols.EURUSD, time.AddMinutes(10), OrderStatus.Filled, OrderDirection.Sell, fillPrice: 1.08m, fillQuantity: -2000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
        ...
        public void ReversalShortToLong(FillGroupingMethod groupingMethod, FillMatchingMethod matchingMethod)
        {
            ...
            // Sell 1k
            builder.ProcessFill(new OrderEvent(1, Symbols.EURUSD, time, OrderStatus.Filled, OrderDirection.Sell, fillPrice: 1.07m, fillQuantity: -1000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
            ...
            // Buy 2k
            builder.ProcessFill(new OrderEvent(2, Symbols.EURUSD, time.AddMinutes(10), OrderStatus.Filled, OrderDirection.Buy, fillPrice: 1.08m, fillQuantity: 2000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
        ...
        public void ScaleInScaleOut1Long(FillGroupingMethod groupingMethod, FillMatchingMethod matchingMethod)
        {
            ...
            // Buy 1k
            builder.ProcessFill(new OrderEvent(4, Symbols.EURUSD, time.AddMinutes(30), OrderStatus.Filled, OrderDirection.Buy, fillPrice: 1.08m, fillQuantity: 1000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);

            Assert.IsTrue(builder.HasOpenPosition(Symbols.EURUSD));

            // Sell 2k
            builder.ProcessFill(new OrderEvent(5, Symbols.EURUSD, time.AddMinutes(40), OrderStatus.Filled, OrderDirection.Sell, fillPrice: 1.09m, fillQuantity: -2000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
        ...
        public void ScaleInScaleOut1Short(FillGroupingMethod groupingMethod, FillMatchingMethod matchingMethod)
        {
            ...
            // Sell 1k
            builder.ProcessFill(new OrderEvent(4, Symbols.EURUSD, time.AddMinutes(30), OrderStatus.Filled, OrderDirection.Sell, fillPrice: 1.08m, fillQuantity: -1000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);

            Assert.IsTrue(builder.HasOpenPosition(Symbols.EURUSD));

            // Buy 2k
            builder.ProcessFill(new OrderEvent(5, Symbols.EURUSD, time.AddMinutes(40), OrderStatus.Filled, OrderDirection.Buy, fillPrice: 1.09m, fillQuantity: 2000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
        ...
        public void ScaleInScaleOut2Long(FillGroupingMethod groupingMethod, FillMatchingMethod matchingMethod)
        {
            ...
            // Sell 3k
            builder.ProcessFill(new OrderEvent(5, Symbols.EURUSD, time.AddMinutes(40), OrderStatus.Filled, OrderDirection.Sell, fillPrice: 1.09m, fillQuantity: -3000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
        ...
        public void ScaleInScaleOut2Short(FillGroupingMethod groupingMethod, FillMatchingMethod matchingMethod)
        {
            ...
            // Buy 3k
            builder.ProcessFill(new OrderEvent(5, Symbols.EURUSD, time.AddMinutes(40), OrderStatus.Filled, OrderDirection.Buy, fillPrice: 1.09m, fillQuantity: 3000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
        ...
        public void ScaleInScaleOut3Long(FillGroupingMethod groupingMethod, FillMatchingMethod matchingMethod)
        {
            ...
            // Sell 2k
            builder.ProcessFill(new OrderEvent(4, Symbols.EURUSD, time.AddMinutes(30), OrderStatus.Filled, OrderDirection.Sell, fillPrice: 1.10m, fillQuantity: -2000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);

            Assert.IsTrue(builder.HasOpenPosition(Symbols.EURUSD));

            // Buy 1k
            builder.ProcessFill(new OrderEvent(5, Symbols.EURUSD, time.AddMinutes(40), OrderStatus.Filled, OrderDirection.Buy, fillPrice: 1.08m, fillQuantity: 1000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);

            Assert.IsTrue(builder.HasOpenPosition(Symbols.EURUSD));

            // Sell 2k
            builder.ProcessFill(new OrderEvent(6, Symbols.EURUSD, time.AddMinutes(50), OrderStatus.Filled, OrderDirection.Sell, fillPrice: 1.09m, fillQuantity: -2000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
        ...
        public void ScaleInScaleOut3Short(FillGroupingMethod groupingMethod, FillMatchingMethod matchingMethod)
        {
            ...
            // Buy 2k
            builder.ProcessFill(new OrderEvent(4, Symbols.EURUSD, time.AddMinutes(30), OrderStatus.Filled, OrderDirection.Buy, fillPrice: 1.10m, fillQuantity: 2000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);

            Assert.IsTrue(builder.HasOpenPosition(Symbols.EURUSD));

            // Sell 1k
            builder.ProcessFill(new OrderEvent(5, Symbols.EURUSD, time.AddMinutes(40), OrderStatus.Filled, OrderDirection.Sell, fillPrice: 1.08m, fillQuantity: -1000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);

            Assert.IsTrue(builder.HasOpenPosition(Symbols.EURUSD));

            // Buy 2k
            builder.ProcessFill(new OrderEvent(6, Symbols.EURUSD, time.AddMinutes(50), OrderStatus.Filled, OrderDirection.Buy, fillPrice: 1.09m, fillQuantity: 2000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate);
        ...
        public void AllInAllOutLongWithMultiplier(FillGroupingMethod groupingMethod, FillMatchingMethod matchingMethod)
        {
            ...
            // Buy 1k
            builder.ProcessFill(new OrderEvent(1, Symbols.EURUSD, time, OrderStatus.Filled, OrderDirection.Buy, fillPrice: 1.08m, fillQuantity: 1000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate, multiplier);
            ...
            // Sell 1k
            builder.ProcessFill(new OrderEvent(2, Symbols.EURUSD, time.AddMinutes(10), OrderStatus.Filled, OrderDirection.Sell, fillPrice: 1.09m, fillQuantity: -1000, orderFee: OrderFee, accountCurrency: AccountCurrency), ConversionRate, multiplier);
