...
namespace QuantConnect.Tests.Common.Statistics
{
    ...
    class PortfolioStatisticsTests
    {
        ...
        public void ITMOptionAssignmentWithDifferentTradingDaysPerYearValue(
            ...
            decimal expectedAnnualStandardDeviation,
            decimal expectedSharpeRatio,
            decimal expectedTrackingError,
            decimal expectedProbabilisticSharpeRatio
        )
        {
            var listPerformance = new List<double> { -0.009025132, 0.003653969, 0, 0 };
            var listBenchmark = new List<double>
            {
                -0.011587791300935783,
                0.00054375782787618543,
                0.022165997700413956,
                0.006263266301918822
            };
        ...
        private PortfolioStatistics GetPortfolioStatistics(
            bool win,
            int tradingDaysPerYear,
        ...
        )
        {
            ...
            var profitLoss = new SortedDictionary<DateTime, decimal>(
                trades.ToDictionary(x => x.ExitTime, x => x.ProfitLoss)
            );
