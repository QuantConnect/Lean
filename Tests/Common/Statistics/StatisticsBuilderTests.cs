...
namespace QuantConnect.Tests.Common.Statistics
{
    ...
    public class StatisticsBuilderTests
    {
        ...
        public void MisalignedValues_ShouldThrow_DuringGeneration()
        {
            ...
            {
                new ChartPoint(
                    DateTime.SpecifyKind(new DateTime(2019, 1, 1, 16, 0, 0), DateTimeKind.Utc),
                    100
                ),
                new ChartPoint(
                    DateTime.SpecifyKind(new DateTime(2019, 1, 2, 16, 0, 0), DateTimeKind.Utc),
                    102
                ),
                new ChartPoint(
                    DateTime.SpecifyKind(new DateTime(2019, 1, 3, 16, 0, 0), DateTimeKind.Utc),
                    110
                ),
                new ChartPoint(
                    DateTime.SpecifyKind(new DateTime(2019, 1, 4, 16, 0, 0), DateTimeKind.Utc),
                    110
                ),
                new ChartPoint(
                    DateTime.SpecifyKind(new DateTime(2019, 1, 5, 16, 0, 0), DateTimeKind.Utc),
                    120
                ),
                new ChartPoint(
                    DateTime.SpecifyKind(new DateTime(2019, 1, 6, 16, 0, 0), DateTimeKind.Utc),
                    130
                ),
            };
            ...
            {
                new ChartPoint(
                    DateTime.SpecifyKind(new DateTime(2018, 12, 31, 16, 0, 0), DateTimeKind.Utc),
                    100000
                ),
                new ChartPoint(
                    DateTime.SpecifyKind(new DateTime(2019, 1, 1, 16, 0, 0), DateTimeKind.Utc),
            ...
            {
                new ChartPoint(
                    DateTime.SpecifyKind(new DateTime(2018, 12, 31), DateTimeKind.Utc),
                    1000m * 100m
                ),
                new ChartPoint(
                    DateTime.SpecifyKind(new DateTime(2019, 1, 1, 16, 0, 0), DateTimeKind.Utc),
                ...
                new ChartPoint(
                    DateTime.SpecifyKind(new DateTime(2019, 1, 5, 16, 0, 0), DateTimeKind.Utc),
                    0.090909090909090m * 100m
                ),
                new ChartPoint(
                    DateTime.SpecifyKind(new DateTime(2019, 1, 6, 16, 0, 0), DateTimeKind.Utc),
                    0.083333333333333m * 100m
                )
            };
                ...
                () =>
                {
                    StatisticsBuilder.Generate(
                        ...
                        new QuantConnect.Securities.SecurityTransactionManager(
                            null,
                            new QuantConnect.Securities.SecurityManager(
