...
namespace QuantConnect.Tests.Common.Orders.Fills
{
    ...
    public class ImmediateFillModelTests
    {
        ...
        [Test]
        public void PerformsTrailingStopLimitImmediateFillBuy([Values] bool isInternal, [Values] bool trailingAsPercentage)
        {
            var model = new ImmediateFillModel();
            // Assume market price is $100:
            var order = trailingAsPercentage
            ...
            AssertFilled(fill, order.Quantity, security.High);
        }

        [Test]
        public void PerformsTrailingStopLimitFillBuy([Values] bool isInternal, [Values] bool trailingAsPercentage)
        {
            var model = new ImmediateFillModel();
            // Assume market price is $100:
            var order = trailingAsPercentage
        ...
        [Test]
        public void PerformsTrailingStopLimitImmediateFillSell([Values] bool isInternal, [Values] bool trailingAsPercentage)
        {
            var model = new ImmediateFillModel();
            // Assume market price is $100:
            var order = trailingAsPercentage
        ...
        [Test]
        public void PerformsTrailingStopLimitFillSell([Values] bool isInternal, [Values] bool trailingAsPercentage)
        {
            var model = new ImmediateFillModel();
            // Assume market price is $100:
            var order = trailingAsPercentage
        ...
        [TestCase(100, 101, 102, true)]
        [TestCase(100, 101, 102, false)]
        [TestCase(-100, 99, 98, true)]
        [TestCase(-100, 99, 98, false)]
        public void TrailingStopLimitDoesNotFillUsingDataBeforeSubmitTime(decimal orderQuantity, decimal stopPrice,
            decimal limitPrice, bool isInternal)
        {
            var time = new DateTime(2018, 9, 24, 9, 30, 0);
