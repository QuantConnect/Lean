    ...
    public partial class EquityFillModelTests
    {
        ...
        public void PerformsStopMarketFillSell()
        {
            ...
            security.SetMarketPrice(
                new TradeBar(Noon, Symbols.SPY, 102m, 102.5m, 101m, 101.5m, 100)
            );
        ...
        [TestCase(100, 290.50)]
        [TestCase(-100, 291.50)]
        public void PerformsStopMarketFillWithTickTradeData(
        ...
        [TestCase(100, 290.50)]
        [TestCase(-100, 291.50)]
        public void StopMarketOrderDoesNotFillUsingQuoteBar(
            decimal orderQuantity,
            decimal stopPrice
        )
        {
        ...
        [TestCase(100, 290.50)]
        [TestCase(-100, 291.50)]
        public void StopMarketOrderDoesNotFillUsingTickTypeQuote(
            decimal orderQuantity,
            decimal stopPrice
        )
        {
        ...
        [TestCase(100, 290.50)]
        [TestCase(-100, 291.50)]
        public void StopMarketOrderFillsAtOpenWithUnfavourableGap(
            decimal orderQuantity,
            decimal stopPrice
        )
        {
        ...
        )
        {
            ...
            tradeBar = new TradeBar(
                time,
                Symbols.SPY,
                stopPrice - 0.01m * Math.Sign(orderQuantity),
                292m,
                289m,
                stopPrice,
                12345
