...
namespace QuantConnect.Tests.Common.Orders.Fees
{
    ...
    public class InteractiveBrokersFeeModelTests
    {
        ...
        public void USAFutureFee(Symbol symbol, decimal expectedFee)
        {
            ...
            var fee = _feeModel.GetOrderFee(
                new OrderFeeParameters(security, new MarketOrder(security.Symbol, 1000, time))
            );
        ...
        private static TestCaseData[] USAFuturesFeeTestCases()
        {
            return new[]
            {
                ...
                new
                {
                    Symbol = Futures.Indices.Dow30EMini,
                    Type = SecurityType.Future,
                    ExpectedFee = 2.15m
                },
                new
                {
                    Symbol = Futures.Indices.Russell2000EMini,
                    Type = SecurityType.Future,
                    ExpectedFee = 2.15m
                },
                new
                ...
                new
                {
                    Symbol = Futures.Indices.NASDAQ100EMini,
                    Type = SecurityType.Future,
                    ExpectedFee = 2.15m
                },
                ...
                {
                    Symbol = Futures.Indices.Dow30EMini,
                    Type = SecurityType.FutureOption,
                    ExpectedFee = 1.42m
                },
                new
                {
                ...
                new
                {
                    Symbol = Futures.Indices.MicroDow30EMini,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.57m
                },
                new
                {
                    Symbol = Futures.Indices.MicroRussell2000EMini,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.57m
                },
                new
                {
                    Symbol = Futures.Indices.MicroSP500EMini,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.57m
                },
                new
                {
                    Symbol = Futures.Indices.MicroNASDAQ100EMini,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.57m
                },
                new
                {
                    Symbol = Futures.Financials.MicroY2TreasuryBond,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.57m
                },
                new
                {
                    Symbol = Futures.Financials.MicroY5TreasuryBond,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.57m
                },
                new
                {
                    Symbol = Futures.Financials.MicroY10TreasuryNote,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.57m
                },
                new
                {
                    Symbol = Futures.Financials.MicroY30TreasuryBond,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.57m
                },
                new
                {
                    Symbol = Futures.Metals.MicroGold,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.57m
                },
                new
                {
                    Symbol = Futures.Metals.MicroSilver,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.57m
                },
                new
                {
                    Symbol = Futures.Energy.MicroCrudeOilWTI,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.57m
                },
                ...
                new
                {
                    Symbol = Futures.Currencies.MicroBTC,
                    Type = SecurityType.Future,
                    ExpectedFee = 4.77m
                },
                new
                {
                    Symbol = Futures.Currencies.MicroEther,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.42m
                },
                ...
                new
                {
                    Symbol = Futures.Currencies.EuroFXEmini,
                    Type = SecurityType.Future,
                    ExpectedFee = 1.37m
                },
                new
                ...
                new
                {
                    Symbol = Futures.Currencies.MicroAUD,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.41m
                },
                new
                {
                    Symbol = Futures.Currencies.MicroEUR,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.41m
                },
                new
                {
                    Symbol = Futures.Currencies.MicroGBP,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.41m
                },
                new
                {
                    Symbol = Futures.Currencies.MicroCADUSD,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.41m
                },
                new
                {
                    Symbol = Futures.Currencies.MicroJPY,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.41m
                },
                new
                {
                    Symbol = Futures.Currencies.MicroCHF,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.41m
                },
                new
                {
                    Symbol = Futures.Currencies.MicroUSDJPY,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.41m
                },
                new
                {
                    Symbol = Futures.Currencies.MicroINRUSD,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.41m
                },
                new
                {
                    Symbol = Futures.Currencies.MicroCAD,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.41m
                },
                new
                {
                    Symbol = Futures.Currencies.MicroUSDCHF,
                    Type = SecurityType.Future,
                    ExpectedFee = 0.41m
                },
                new
                ...
                new
                {
                    Symbol = Futures.Metals.MicroPalladium,
                    Type = SecurityType.Future,
                    ExpectedFee = 2.47m
                },
                new
                ...
                new
                {
                    Symbol = Futures.Energy.MicroCoalAPIFivefobNewcastleArgusMcCloskey,
                    Type = SecurityType.Future,
                    ExpectedFee = 2.47m
                },
                new
                ...
                new
                {
                    Symbol = Futures.Energy.MicroSingaporeFOBMarineFuelZeroPointFivePercetPlatts,
                    Type = SecurityType.Future,
                    ExpectedFee = 2.47m
                },
                new
                {
                    Symbol = Futures.Currencies.USD,
                    Type = SecurityType.Future,
                    ExpectedFee = 2.47m
                },
                new
                {
                    Symbol = Futures.Currencies.CAD,
                    Type = SecurityType.Future,
                    ExpectedFee = 2.47m
                },
                new
                ...
                .Select(x =>
                {
                    var symbol = Symbols.CreateFutureSymbol(
                        x.Symbol,
