...
namespace QuantConnect.Tests.Common.Brokerages
{
    ...
    public class GDAXBrokerageModelTests
    {
        ...
        {
            Assert.AreEqual(1, _unit.GetLeverage(TestsHelpers.GetSecurity()));
        }

        [Test]
        public void GetFeeModelTest()
        {
            Assert.IsInstanceOf<GDAXFeeModel>(_unit.GetFeeModel(TestsHelpers.GetSecurity()));
        }

        [Test]
        public void GetBuyingPowerModelTest()
        {
            Assert.IsInstanceOf<CashBuyingPowerModel>(_unit.GetBuyingPowerModel(TestsHelpers.GetSecurity()));
        }
        ...
        public void CanUpdateOrderTest()
        {
            ...
            Assert.AreEqual(false, _unit.CanUpdateOrder(TestsHelpers.GetSecurity(), Mock.Of<Order>(),
        ...
        public void CanSubmitOrder_WhenBrokerageIdIsCorrect(bool isUpdate)
        {
            ...
            Assert.AreEqual(!isUpdate, _unit.CanSubmitOrder(TestsHelpers.GetSecurity(), order.Object, out message));
        }
        ...
        public void CanOnlySubmitCryptoOrders(SecurityType securityType, bool isValidSecurityType)
        {
            ...
            Assert.AreEqual(isValidSecurityType, _unit.CanSubmitOrder(TestsHelpers.GetSecurity(1.0m, securityType), order.Object, out message));
        }
