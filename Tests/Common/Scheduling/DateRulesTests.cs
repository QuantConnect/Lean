...
namespace QuantConnect.Tests.Common.Scheduling
{
    ...
    public class DateRulesTests
    {
        ...
        )
        {
            ...
            var dates = rule.GetDates(new DateTime(2000, 01, 01), new DateTime(2000, 6, 30))
                .ToList();
            ...
            var datesAndExpectedDays = dates.Zip(
                expectedDays,
                (date, expectedDay) => new { date, expectedDay }
            );
        ...
        public void StartOfYearWithSymbolWithOffset(
            Symbols.SymbolsKey symbolKey,
            int[] expectedDays,
            int offset
        )
        {
            ...
            var dates = rule.GetDates(new DateTime(2000, 01, 01), new DateTime(2004, 12, 31))
                .ToList();
        ...
        public void EndOfYearWithSymbolWithOffset(
            Symbols.SymbolsKey symbolKey,
            int[] expectedDays,
            int offset
        )
        ...
        public void StartOfWeekNoSymbolWithOffset(int offset, DayOfWeek expectedDayOfWeek)
        {
            ...
            int expected =
                expectedDayOfWeek == DayOfWeek.Saturday || expectedDayOfWeek == DayOfWeek.Sunday
                    ? 53
                    : 52;
        ...
        public void StartOfWeekWithSymbol(Symbols.SymbolsKey symbolKey, int[] expectedDays)
        {
            ...
            var dates = rule.GetDates(new DateTime(2000, 01, 01), new DateTime(2000, 1, 31))
                .ToList();
...
"
                ...
                Assert.AreEqual(
                    new DateTime(2023, 1, 16, 12, 0, 0),
                    funcDateRule
                        .GetDates(new DateTime(2023, 1, 1), new DateTime(2023, 2, 1))
                        .First()
                );
            }
        }
...
"
                ...
                Func<DateTime, DateTime, IEnumerable<DateTime>> csharpFunc = (start, end) =>
                {
                ...
                Assert.AreEqual(
                    ...
                    (
                        funcDateRule.GetDates(new DateTime(2023, 1, 1), new DateTime(2023, 2, 1))
                        as PyObject
                    )
...
"
                ...
                Assert.Throws<ArgumentException>(
                    () => new FuncDateRule("PythonFuncDateRule", pythonCustomDateRule)
                );
            }
        }
        ...
        private static DateRules GetDateRules()
        {
            ...
            var securityExchangeHours = mhdb.GetExchangeHours(
                Market.USA,
                null,
                SecurityType.Equity
            );
            ...
            securityExchangeHours = mhdb.GetExchangeHours(
                Market.Bitfinex,
                Symbols.BTCUSD,
                SecurityType.Crypto
            );
