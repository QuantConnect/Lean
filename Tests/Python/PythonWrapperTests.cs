        ...
        public class ValidateImplementationOf
        {
            ...
            )
            {
                using (Py.GIL())
                {
                    ...
                    Assert.That(
                        () => model.ValidateImplementationOf<IModel>(),
                        Throws
                            .Exception.InstanceOf<NotImplementedException>()
                            .With.Message.Contains(missingMemberName)
                    );
                }
            }
            ...
            [TestCase(
                nameof(FullyImplementedWithPropertyAsField),
                "FullyImplementedModelWithPropertyAsField"
            )]
            ...
            public void SettlementModelPythonWrapperWorks()
            {
                var results = AlgorithmRunner.RunLocalBacktest(
                    "CustomSettlementModelRegressionAlgorithm",
            ...
            {
                var results = AlgorithmRunner.RunLocalBacktest(
                    "CustomBenchmarkRegressionAlgorithm",
                    new Dictionary<string, string>()
                    {
                        { PerformanceMetrics.TotalOrders, "0" },
                        { "Average Win", "0%" },
            ...
            {
                return typeof(ValidateImplementationOf)
