    ...
    public class RegressionTests
    {
        ...
        private static TestCaseData[] GetRegressionTestParameters()
        {
            ...
            return new List<AlgorithmStatisticsTestParameters>
            {
                ...
                new AlgorithmStatisticsTestParameters("UniverseSelectionAlgorithm", universeSelectionRegressionStatistics, Language.CSharp),
                ...
                // Java
                new AlgorithmStatisticsTestParameters("BasicTemplateAlgorithm", basicTemplateStatistics, Language.Java),
