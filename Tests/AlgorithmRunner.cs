...
namespace QuantConnect.Tests
{
    ...
    public static class AlgorithmRunner
    {
        ...
        private static void RunSingleLanguageBacktest(string algorithm, Dictionary<string, string> expectedStatistics, string algorithmLanguage = "CSharp")
        {
        ...
        {
            foreach (var algorithmLanguage in new string [] { "CSharp", "Python", "FSharp", "VisualBasic", "Java"})
            {
