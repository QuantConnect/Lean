...
{
    [TestFixture]
    public class CovarianceIndicatorTests : CommonIndicatorTests<IBaseDataBar>
    {
        ...
        {
            var indicator = new Covariance("testCovarianceIndicator", Symbols.SPY, "QQQ RIWIV7K5Z9LX", 252);
            return indicator;
        }
