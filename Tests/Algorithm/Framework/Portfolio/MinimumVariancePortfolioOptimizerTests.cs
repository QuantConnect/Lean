...
namespace QuantConnect.Tests.Algorithm.Framework.Portfolio
{
    ...
    public class MinimumVariancePortfolioOptimizerTests : PortfolioOptimizerTestsBase
    {
        ...
        public void Setup()
        {
            var historicalReturns1 = new double[,]
            {
                { 0.76, -0.06, 1.22, 0.17 },
                { 0.02, 0.28, 1.25, -0.00 },
                { -0.50, -0.13, -0.50, -0.03 },
            ...
            var historicalReturns2 = new double[,]
            {
                { -0.15, 0.67, 0.45 },
                { -0.44, -0.10, 0.07 },
                { 0.04, -0.41, 0.01 },
            ...
            var historicalReturns3 = new double[,]
            {
                { -0.02, 0.65, 1.25 },
                { -0.29, -0.39, -0.50 },
                { 0.29, 0.58, 2.39 },
            ...
            var historicalReturns4 = new double[,]
            {
                { 0.76, 0.25, 0.21 },
                { 0.02, -0.15, 0.45 },
                { -0.50, -0.44, 0.07 },
            ...
            var covariance2 = new double[,]
            {
                { 0.05, -0.02, -0.01 },
                { -0.02, 0.21, 0.09 },
                { -0.01, 0.09, 0.04 }
            };
            var covariance3 = new double[,]
            {
                { 0.06, 0.09, 0.28 },
                { 0.09, 0.25, 0.58 },
                { 0.28, 0.58, 1.66 }
        ...
        public void OptimizeWeightingsSpecifyingTargetReturns(int testCaseNumber)
        {
            var testOptimizer = new MinimumVariancePortfolioOptimizer(
                targetReturn: _targetReturns[testCaseNumber]
            );
