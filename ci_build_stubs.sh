...
function push_to_github {
    ...
    git push stubs_deploy $PUSH_BRANCH --force-with-lease --quiet > /dev/null 2>&1
    ...
    curl -H "Authorization: bearer $GH_API_KEY" -X POST --data-raw "$graphql_query" https://api.github.com/graphql
