...
# The runtimeconfig.json is stored alongside start.py, but start.py is not
# necessarily in the current working directory. We therefore construct the
# absolute path to the start.py file, and find the runtimeconfig.json
# relative to that.
