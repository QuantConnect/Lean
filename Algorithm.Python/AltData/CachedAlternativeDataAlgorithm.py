...
class CachedAlternativeDataAlgorithm(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.usEnergy = self.AddData(USEnergyWeeklySupplyEstimate, USEnergy.GrossInputsIntoRefineries).Symbol
    ...
    def OnData(self, data):
        ...
        if data.ContainsKey(self.usEnergy):
            inputIntoRefineries = data.Get(USEnergyWeeklySupplyEstimate, self.usEnergy)
