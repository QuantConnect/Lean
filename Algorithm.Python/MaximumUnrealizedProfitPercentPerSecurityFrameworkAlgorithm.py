...
from BasicTemplateFrameworkAlgorithm import BasicTemplateFrameworkAlgorithm

### <summary>
### Framework algorithm uses <see cref="MaximumUnrealizedProfitPercentPerSecurity"/> risk management model.
### </summary>
class MaximumUnrealizedProfitPercentPerSecurityFrameworkAlgorithm(BasicTemplateFrameworkAlgorithm):
