...
class MaximumSectorExposureRiskManagementModelFrameworkRegressionAlgorithm(QCAlgorithm):
    '''Show example of how to use the MaximumSectorExposureRiskManagementModel Risk Management Model'''
    ...
    def Initialize(self):
        ...
        self.SetRiskManagement(MaximumSectorExposureRiskManagementModel(0.5))