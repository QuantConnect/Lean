...
class BasicTemplateCryptoFutureHourlyAlgorithm(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.fast = self.EMA(self.btcUsd.Symbol, 3, Resolution.Hour)
        self.slow = self.EMA(self.btcUsd.Symbol, 6, Resolution.Hour)
    ...
    def OnData(self,slice):
        ...
        if self.fast > self.low:
            ...
            if self.Time.Hours > 10 and self.Transactions.OrdersCount == 2:
