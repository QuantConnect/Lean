    ...
    def set_option_filter(self, security: Option) -> None:
        ...
        security.set_filter(
            ...
            .contracts(lambda contracts: [
                    ...
                    if contract.Greeks.Delta > 0.64 and contract.Greeks.Delta < 0.65
                    and contract.Greeks.Gamma > 0.0008 and contract.Greeks.Gamma < 0.0010
                    and contract.Greeks.Vega > 7.5 and contract.Greeks.Vega < 10.5
                    and contract.Greeks.Theta > -1.10 and contract.Greeks.Theta < -0.50
                    and contract.Greeks.Rho > 4 and contract.Greeks.Rho < 10
                    and contract.ImpliedVolatility > 0.10 and contract.ImpliedVolatility < 0.20
                    and contract.OpenInterest > 100 and contract.OpenInterest < 1000
                    ]))
