...
class Bitcoin(PythonData):
    ...
    def get_source(self, config, date, is_live_mode):
        ...
        subscription = SubscriptionDataSource("https://www.quantconnect.com/api/v2/proxy/quandl/api/v3/datatables/QDL/BITFINEX.csv?code=BTCUSD&api_key=WyAazVXnq7ATy_fefTqm", SubscriptionTransportMedium.REMOTE_FILE)
