...
### <summary>
### BlackLitterman-Portfolio Optimization algorithm
### Uses the HistoricalReturnsAlphaModel & RsiAlphaModel and the BlackLittermanPortfolioConstructionModel
### to create an algorithm that rebalances the portfolio according to modern portfolio theory
### </summary>
### <meta name="tag" content="using data" />
### <meta name="tag" content="using quantconnect" />
### <meta name="tag" content="trading and orders" />
class BlackLittermanOptimizationAlgorithm(QCAlgorithmFramework):
    '''Black-Litterman Portfolio Optimization algorithm.'''
    ...
    def Initialize(self):
        ...
        self.SetAlpha(CompositeAlphaModel(RsiAlphaModel(), HistoricalReturnsAlphaModel(resolution = Resolution.Daily)))
