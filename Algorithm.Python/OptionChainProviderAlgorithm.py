...
class OptionChainProviderAlgorithm(QCAlgorithm):
    ...
    ''' This algorithm demonstrates how to filter the option contracts for options trading using OptionChainProvider 
        The algorithm purchase a call option and a put option with the same strike and expiration date '''
