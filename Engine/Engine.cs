        ...
        public void Run(AlgorithmNodePacket job, AlgorithmManager manager, string assemblyPath)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    initializeComplete = _algorithmHandlers.Setup.Setup(algorithm, brokerage, job, _algorithmHandlers.Results, _algorithmHandlers.Transactions, _algorithmHandlers.RealTime, new SetupHandlerHelper(dataManager.UniverseSelection));
