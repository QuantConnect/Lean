...
namespace QuantConnect.Lean.Engine
{
    ...
    public class LeanEngineSystemHandlers : IDisposable
    {
        ...
        public LeanEngineSystemHandlers(
            IJobQueueHandler jobQueue,
            IApi api,
        ...
        public static LeanEngineSystemHandlers FromConfiguration(Composer composer)
        {
            return new LeanEngineSystemHandlers(
                composer.GetExportedValueByTypeName<IJobQueueHandler>(
                    Config.Get("job-queue-handler")
                ),
                composer.GetExportedValueByTypeName<IApi>(Config.Get("api-handler")),
                composer.GetExportedValueByTypeName<IMessagingHandler>(
                    Config.Get("messaging-handler")
                ),
                composer.GetExportedValueByTypeName<ILeanManager>(
                    Config.Get("lean-manager-type", "LocalLeanManager")
                )
            );
        }
