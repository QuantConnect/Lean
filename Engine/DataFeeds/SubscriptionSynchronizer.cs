            ...
            CancellationToken cancellationToken)
        {
            ...
            while (!cancellationToken.IsCancellationRequested)
            {
                ...
                do
                {
                    ...
                    _perfTrackingTool.Start(PerformanceTarget.DataSubscription);
                    ...
                    _perfTrackingTool.Stop(PerformanceTarget.DataSubscription);
                ...
                _perfTrackingTool.Start(PerformanceTarget.SliceCreation);
                var timeSlice = _timeSliceFactory.Create(frontierUtc, data, changes, universeDataForTimeSliceCreate);
                _perfTrackingTool.Stop(PerformanceTarget.SliceCreation);
