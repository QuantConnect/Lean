...
namespace QuantConnect.Lean.Engine.DataFeeds
{
    ...
    public class Subscription : IEnumerator<BaseData>
    {
        ...
        public Subscription(Security security, IEnumerator<BaseData> enumerator, DateTime utcStartTime, DateTime utcEndTime, bool isUserDefined, bool isUniverseSelectionSubscription)
        {
            Security = security;
