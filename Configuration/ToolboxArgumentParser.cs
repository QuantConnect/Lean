        ...
        private static readonly List<CommandLineOption> Options = new List<CommandLineOption>
            {
                ...
                new CommandLineOption("polygon-api-results-limit", CommandOptionType.SingleValue, "[REQUIRED for PolygonDownloader.  No Default.  Example: --polygon-api-results-limit=10000]"),
                new CommandLineOption("polygon-api-key", CommandOptionType.SingleValue, "[REQUIRED for PolygonDownloader.  No Default.  Example: --polygon-api-key=XXXXX]"),
                new CommandLineOption("polygon-download-threads", CommandOptionType.SingleValue, "[REQUIRED for PolygonDownloader.  No Default.  Example: --polygon-download-threads=64]"),
