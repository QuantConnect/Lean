        ...
        private static readonly List<CommandLineOption> Options = new List<CommandLineOption>
            {
                new CommandLineOption("app", CommandOptionType.SingleValue,
                                                     ...
                                                     + "/USTYCCV or USTreasuryYieldCurveConverter/POLDL or PolygonDownloader"
                                                     + "Example 1: --app=DDL\n"
                ...
                new CommandLineOption("exchange", CommandOptionType.SingleValue, "[REQUIRED for CryptoiqDownloader, PolygonDownloader] [Optional for KaikoDataConverter] The exchange to process, if not defined, all exchanges will be processed."),
                new CommandLineOption("api-key", CommandOptionType.SingleValue, "[REQUIRED for QuandlBitfinexDownloader, IEXDownloader, PsychSignalDataDownloader, PolygonDownloader]"),
                ...
                new CommandLineOption("destination-dir", CommandOptionType.SingleValue, "[REQUIRED for IVolatilityEquityConverter, "
                                                                                        ...
                                                                                        "[OPTIONAL for PolygonDownloader]"),
