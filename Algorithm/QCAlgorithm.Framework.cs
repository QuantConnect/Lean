...
namespace QuantConnect.Algorithm
{
    public partial class QCAlgorithm
    {
        ...
        public void FrameworkPostInitialize()
        {
            ...
            {
                // Note: if `_emightInsightWasCalled` is true,
                // there will be no auto generated orders anyway
                _emightAutogeneratedOrderBasedInsight = true;
            }
        }
