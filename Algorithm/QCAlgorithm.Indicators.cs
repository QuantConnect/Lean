...
namespace QuantConnect.Algorithm
{
    public partial class QCAlgorithm
    {
        ...
        /// <param name="slowPeriod">The period of the slow EMA used to calculate KVO</param>
        ...
        [DocumentationAttribute(Indicators)]
        public KlingerVolumeOscillator KVO(Symbol symbol, int fastPeriod, int slowPeriod, int signalPeriod, Resolution? resolution = null, Func<IBaseData, TradeBar> selector = null)
        {
