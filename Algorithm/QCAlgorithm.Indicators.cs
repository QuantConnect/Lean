...
namespace QuantConnect.Algorithm
{
    public partial class QCAlgorithm
    {
        ...
        {
            return PPHL(symbol, lengthHigh, lengthLow, lastStoredValues, resolution, selector, strict: true);
        }
        ...
        /// <returns>The PivotPointsHighLow indicator for the requested symbol.</returns>
        [DocumentationAttribute(Indicators)]
        public PivotPointsHighLow PPHL(Symbol symbol, int lengthHigh, int lengthLow, int lastStoredValues = 100, Resolution? resolution = null, Func<IBaseData, IBaseDataBar> selector = null, bool strict = true)
        {
