...
namespace QuantConnect.Algorithm
{
    public partial class QCAlgorithm
    {
        ...
        /// <summary>
        /// Creates and registers a new Least Squared Moving Average instance.
        /// </summary>
        ...
        public LeastSquaredMovingAverage LSMA(Symbol symbol, int period, Resolution? resolution = null, Func<BaseData, decimal> selector = null)
        {
            var name = CreateIndicatorName(symbol, string.Format("LSMA({0})", period), resolution);
            var lsma = new LeastSquaredMovingAverage(name, period);
