...
namespace QuantConnect.Algorithm
{
    public partial class QCAlgorithm
    {
        ...
        public int CalculateOrderQuantity(Symbol symbol, decimal target)
        {
            ...
            var currentHoldingsValue = price * quantity / security.Leverage;
            ...
            do
            {
                if (orderQuantity == 0)
                {
                    ...
                    orderQuantity = (int)(targetOrderValue * security.Leverage / unitPrice);
                }
                else
                {
                    // decrease the order quantity
                    orderQuantity -= (int)security.Leverage;
                }
