...
namespace QuantConnect.Algorithm
{
    public partial class QCAlgorithm
    {
        ...
        {
            return History(Securities.Keys, Time - span, Time, resolution, fillForward, extendedMarketHours).Memoize();
        }
        ...
        {
            return History(Securities.Keys, periods, resolution, fillForward, extendedMarketHours).Memoize();
        }
        ...
        public IEnumerable<DataDictionary<T>> History<T>(TimeSpan span, Resolution? resolution = null, bool? fillForward = null,
            ...
            where T : IBaseData
        {
            return History<T>(Securities.Keys, span, resolution, fillForward, extendedMarketHours).Memoize();
        }
        ...
        public IEnumerable<DataDictionary<T>> History<T>(IEnumerable<Symbol> symbols, TimeSpan span, Resolution? resolution = null,
            ...
            where T : IBaseData
        {
            return History<T>(symbols, Time - span, Time, resolution, fillForward, extendedMarketHours).Memoize();
        }
        ...
        public IEnumerable<T> History<T>(Symbol symbol, TimeSpan span, Resolution? resolution = null, bool? fillForward = null,
            ...
            where T : IBaseData
        {
            return History<T>(symbol, Time - span, Time, resolution, fillForward, extendedMarketHours).Memoize();
        }
            ...
            bool? extendedMarketHours = null)
        {
            ...
            return History(symbol, start, Time, resolution, fillForward, extendedMarketHours);
        }
        ...
        public IEnumerable<TradeBar> History(Symbol symbol, TimeSpan span, Resolution? resolution = null, bool? fillForward = null,
            bool? extendedMarketHours = null)
        {
            return History(symbol, Time - span, Time, resolution, fillForward, extendedMarketHours);
        }
            ...
            bool? extendedMarketHours = null)
        {
            ...
            return History(new[] { symbol }, start, end, resolutionToUse, fillForward, extendedMarketHours).Get(symbol).Memoize();
        }
        ...
        public IEnumerable<Slice> History(IEnumerable<Symbol> symbols, TimeSpan span, Resolution? resolution = null, bool? fillForward = null,
            bool? extendedMarketHours = null)
        {
            return History(symbols, Time - span, Time, resolution, fillForward, extendedMarketHours).Memoize();
        }
