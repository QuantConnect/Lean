...
{
    /// <summary>
    /// Test algorithm using <see cref="SimpleInsightPortfolioConstructionModel"/> and <see cref="ConstantAlphaModel"/>
    ...
    public class ConfidenceWeightedFrameworkAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public override void Initialize()
        {
            ...
            SetPortfolioConstruction(new SimpleInsightPortfolioConstructionModel());
