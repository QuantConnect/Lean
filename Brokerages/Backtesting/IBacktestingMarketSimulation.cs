...
namespace QuantConnect.Brokerages.Backtesting
{
    ...
    {
        /// <summary>
        /// Method is called by backtesting brokerage to give simulator information on current state of the backtesting
        /// </summary>
        /// <returns>true if simulator wants to trigger simulation. Method SimulateMarketConditions is called immediately</returns>
        /// <param name="algorithm">Algorithm instance</param>
        bool IsReadyToSimulate(IAlgorithm algorithm);
