...
namespace Oanda.RestV20.Model
{
    ...
    public partial class TransactionHeartbeat :  IEquatable<TransactionHeartbeat>, IValidatableObject
    {
        ...
        /// <param name="Time">The date/time when the TransactionHeartbeat was created..</param>
        public TransactionHeartbeat(string Type = default(string), string LastTransactionID = default(string), string Time = default(string))
        {
            this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TransactionHeartbeat);
        }

        /// <summary>
        /// Returns true if TransactionHeartbeat instances are equal
        /// </summary>
        /// <param name="other">Instance of TransactionHeartbeat to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionHeartbeat other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
