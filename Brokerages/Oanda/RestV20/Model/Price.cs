...
namespace Oanda.RestV20.Model
{
    ...
    public partial class Price :  IEquatable<Price>, IValidatableObject
    {
        ...
        /// <param name="QuoteHomeConversionFactors">The factors used to convert quantities of this price&#39;s Instrument&#39;s quote currency into a quantity of the Account&#39;s home currency..</param>
        /// <param name="UnitsAvailable">Representation of many units of an Instrument are available to be traded for both long and short Orders..</param>
        public Price(string Type = default(string), string Instrument = default(string), string Time = default(string), StatusEnum? Status = default(StatusEnum?), List<PriceBucket> Bids = default(List<PriceBucket>), List<PriceBucket> Asks = default(List<PriceBucket>), string CloseoutBid = default(string), string CloseoutAsk = default(string), QuoteHomeConversionFactors QuoteHomeConversionFactors = default(QuoteHomeConversionFactors), UnitsAvailable UnitsAvailable = default(UnitsAvailable))
        {
            this.Type = Type;
        ...
        /// </summary>
        /// <value>The factors used to convert quantities of this price&#39;s Instrument&#39;s quote currency into a quantity of the Account&#39;s home currency.</value>
        ...
        /// </summary>
        /// <value>Representation of many units of an Instrument are available to be traded for both long and short Orders.</value>
