...
namespace Oanda.RestV20.Model
{
    ...
    public partial class ClientConfigureTransaction :  IEquatable<ClientConfigureTransaction>, IValidatableObject
    {
        ...
        /// <param name="Type">The Type of the Transaction. Always set to \&quot;CLIENT_CONFIGURE\&quot; in a ClientConfigureTransaction..</param>
        ...
        public ClientConfigureTransaction(string Id = default(string), string Time = default(string), int? UserID = default(int?), string AccountID = default(string), string BatchID = default(string), string RequestID = default(string), TypeEnum? Type = default(TypeEnum?), string Alias = default(string), string MarginRate = default(string))
        {
            this.Id = Id;
            this.Time = Time;
            this.UserID = UserID;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ClientConfigureTransaction);
        }

        /// <summary>
        /// Returns true if ClientConfigureTransaction instances are equal
        /// </summary>
        /// <param name="other">Instance of ClientConfigureTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientConfigureTransaction other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
