...
namespace Oanda.RestV20.Model
{
    ...
    public partial class PositionSide :  IEquatable<PositionSide>, IValidatableObject
    {
        ...
        public PositionSide(string Units = default(string), string AveragePrice = default(string), List<TradeID> TradeIDs = default(List<TradeID>), string Pl = default(string), string UnrealizedPL = default(string), string ResettablePL = default(string))
        {
            this.Units = Units;
        ...
        public List<TradeID> TradeIDs { get; set; }
        /// <summary>
