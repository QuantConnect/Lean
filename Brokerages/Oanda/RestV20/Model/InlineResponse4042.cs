...
namespace Oanda.RestV20.Model
{
    ...
    public partial class InlineResponse4042 :  IEquatable<InlineResponse4042>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="OrderCancelRejectTransaction">OrderCancelRejectTransaction.</param>
        ...
        public InlineResponse4042(OrderCancelRejectTransaction OrderCancelRejectTransaction = default(OrderCancelRejectTransaction), List<TransactionID> RelatedTransactionIDs = default(List<TransactionID>), string LastTransactionID = default(string), string ErrorCode = default(string), string ErrorMessage = default(string))
        {
