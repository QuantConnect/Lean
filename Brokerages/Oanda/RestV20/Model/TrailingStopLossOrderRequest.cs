...
namespace Oanda.RestV20.Model
{
    ...
    public partial class TrailingStopLossOrderRequest :  IEquatable<TrailingStopLossOrderRequest>, IValidatableObject
    {
        ...
        public TrailingStopLossOrderRequest(TypeEnum? Type = default(TypeEnum?), string TradeID = default(string), string ClientTradeID = default(string), string Distance = default(string), TimeInForceEnum? TimeInForce = default(TimeInForceEnum?), string GtdTime = default(string), ClientExtensions ClientExtensions = default(ClientExtensions))
        {
            this.Type = Type;
