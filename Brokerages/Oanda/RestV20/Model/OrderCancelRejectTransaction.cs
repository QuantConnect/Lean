...
namespace Oanda.RestV20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderCancelRejectTransaction :  IEquatable<OrderCancelRejectTransaction>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The reason that the Order was to be cancelled.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <param name="Type">The Type of the Transaction. Always set to \&quot;ORDER_CANCEL_REJECT\&quot; for an OrderCancelRejectTransaction..</param>
        /// <param name="OrderID">The ID of the Order intended to be cancelled.</param>
        /// <param name="ClientOrderID">The client ID of the Order intended to be cancelled (only provided if the Order has a client Order ID)..</param>
        /// <param name="Reason">The reason that the Order was to be cancelled..</param>
        /// <param name="RejectReason">The reason that the Reject Transaction was created.</param>
        public OrderCancelRejectTransaction(string Id = default(string), string Time = default(string), int? UserID = default(int?), string AccountID = default(string), string BatchID = default(string), TypeEnum? Type = default(TypeEnum?), string OrderID = default(string), string ClientOrderID = default(string), ReasonEnum? Reason = default(ReasonEnum?), RejectReasonEnum? RejectReason = default(RejectReasonEnum?))
        {
            this.Id = Id;
            this.Time = Time;
            this.UserID = UserID;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OrderCancelRejectTransaction);
        }

        /// <summary>
        /// Returns true if OrderCancelRejectTransaction instances are equal
        /// </summary>
        /// <param name="other">Instance of OrderCancelRejectTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderCancelRejectTransaction other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
