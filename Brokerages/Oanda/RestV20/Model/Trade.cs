...
namespace Oanda.RestV20.Model
{
    ...
    public partial class Trade :  IEquatable<Trade>, IValidatableObject
    {
        ...
        /// <param name="ClientExtensions">The client extensions of the Trade..</param>
        /// <param name="TakeProfitOrder">Full representation of the Trade&#39;s Take Profit Order, only provided if such an Order exists..</param>
        /// <param name="StopLossOrder">Full representation of the Trade&#39;s Stop Loss Order, only provided if such an Order exists..</param>
        /// <param name="TrailingStopLossOrder">Full representation of the Trade&#39;s Trailing Stop Loss Order, only provided if such an Order exists..</param>
        public Trade(string Id = default(string), string Instrument = default(string), string Price = default(string), string OpenTime = default(string), StateEnum? State = default(StateEnum?), string InitialUnits = default(string), string CurrentUnits = default(string), string RealizedPL = default(string), string UnrealizedPL = default(string), List<TransactionID> ClosingTransactionIDs = default(List<TransactionID>), string Financing = default(string), string CloseTime = default(string), ClientExtensions ClientExtensions = default(ClientExtensions), TakeProfitOrder TakeProfitOrder = default(TakeProfitOrder), StopLossOrder StopLossOrder = default(StopLossOrder), TrailingStopLossOrder TrailingStopLossOrder = default(TrailingStopLossOrder))
        {
            this.Id = Id;
        ...
        /// </summary>
        /// <value>The client extensions of the Trade.</value>
        ...
        /// </summary>
        /// <value>Full representation of the Trade&#39;s Take Profit Order, only provided if such an Order exists.</value>
        ...
        /// </summary>
        /// <value>Full representation of the Trade&#39;s Stop Loss Order, only provided if such an Order exists.</value>
        ...
        /// </summary>
        /// <value>Full representation of the Trade&#39;s Trailing Stop Loss Order, only provided if such an Order exists.</value>
