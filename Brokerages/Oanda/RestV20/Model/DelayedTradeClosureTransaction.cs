...
namespace Oanda.RestV20.Model
{
    ...
    public partial class DelayedTradeClosureTransaction :  IEquatable<DelayedTradeClosureTransaction>, IValidatableObject
    {
        ...
        public DelayedTradeClosureTransaction(string Id = default(string), string Time = default(string), int? UserID = default(int?), string AccountID = default(string), string BatchID = default(string), TypeEnum? Type = default(TypeEnum?), ReasonEnum? Reason = default(ReasonEnum?), string TradeIDs = default(string))
        {
            this.Id = Id;
            this.Time = Time;
            this.UserID = UserID;
