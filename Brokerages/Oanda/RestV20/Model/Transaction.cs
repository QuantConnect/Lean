...
namespace Oanda.RestV20.Model
{
    ...
    public partial class Transaction :  IEquatable<Transaction>, IValidatableObject
    {
        ...
        public Transaction(string Id = default(string), string Time = default(string), int? UserID = default(int?), string AccountID = default(string), string BatchID = default(string))
        {
            this.Id = Id;
            this.Time = Time;
            this.UserID = UserID;
