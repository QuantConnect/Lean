...
namespace Oanda.RestV20.Model
{
    ...
    public partial class InlineResponse20017 :  IEquatable<InlineResponse20017>, IValidatableObject
    {
        ...
        public InlineResponse20017(string From = default(string), string To = default(string), int? PageSize = default(int?), List<TransactionFilter> Type = default(List<TransactionFilter>), int? Count = default(int?), List<string> Pages = default(List<string>), string LastTransactionID = default(string))
        {
            this.From = From;
            this.To = To;
        ...
        public List<TransactionFilter> Type { get; set; }
        /// <summary>
