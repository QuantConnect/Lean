...
namespace Oanda.RestV20.Model
{
    ...
    public partial class InlineResponse400 :  IEquatable<InlineResponse400>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="ConfigureRejectTransaction">The transaction that rejects the configuration of the Account..</param>
        ...
        public InlineResponse400(ClientConfigureRejectTransaction ConfigureRejectTransaction = default(ClientConfigureRejectTransaction), string LastTransactionID = default(string), string ErrorCode = default(string), string ErrorMessage = default(string))
        {
            this.ConfigureRejectTransaction = ConfigureRejectTransaction;
        ...
        /// </summary>
        /// <value>The transaction that rejects the configuration of the Account.</value>
        [DataMember(Name="configureRejectTransaction", EmitDefaultValue=false)]
        public ClientConfigureRejectTransaction ConfigureRejectTransaction { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ConfigureRejectTransaction: ").Append(ConfigureRejectTransaction).Append("\n");
        ...
        public bool Equals(InlineResponse400 other)
        {
            ...
            return 
                (
                    this.ConfigureRejectTransaction == other.ConfigureRejectTransaction ||
                    this.ConfigureRejectTransaction != null &&
                    this.ConfigureRejectTransaction.Equals(other.ConfigureRejectTransaction)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ConfigureRejectTransaction != null)
                    hash = hash * 59 + this.ConfigureRejectTransaction.GetHashCode();
