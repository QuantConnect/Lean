...
namespace Oanda.RestV20.Model
{
    ...
    public partial class MarginCallExtendTransaction :  IEquatable<MarginCallExtendTransaction>, IValidatableObject
    {
        ...
        public MarginCallExtendTransaction(string Id = default(string), string Time = default(string), int? UserID = default(int?), string AccountID = default(string), string BatchID = default(string), TypeEnum? Type = default(TypeEnum?), int? ExtensionNumber = default(int?))
        {
            this.Id = Id;
            this.Time = Time;
            this.UserID = UserID;
