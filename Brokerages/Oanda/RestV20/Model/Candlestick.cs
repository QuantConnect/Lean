...
namespace Oanda.RestV20.Model
{
    ...
    public partial class Candlestick :  IEquatable<Candlestick>, IValidatableObject
    {
        ...
        /// <param name="Bid">The candlestick data based on bids. Only provided if bid-based candles were requested..</param>
        /// <param name="Ask">The candlestick data based on asks. Only provided if ask-based candles were requested..</param>
        /// <param name="Mid">The candlestick data based on midpoints. Only provided if midpoint-based candles were requested..</param>
        ...
        /// </summary>
        /// <value>The candlestick data based on bids. Only provided if bid-based candles were requested.</value>
        ...
        /// </summary>
        /// <value>The candlestick data based on asks. Only provided if ask-based candles were requested.</value>
        ...
        /// </summary>
        /// <value>The candlestick data based on midpoints. Only provided if midpoint-based candles were requested.</value>
