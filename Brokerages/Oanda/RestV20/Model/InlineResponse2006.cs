...
namespace Oanda.RestV20.Model
{
    ...
    public partial class InlineResponse2006 :  IEquatable<InlineResponse2006>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Orders">The list of Order detail objects.</param>
        /// <param name="LastTransactionID">The ID of the most recent Transaction created for the Account.</param>
        public InlineResponse2006(List<Order> Orders = default(List<Order>), string LastTransactionID = default(string))
        {
            this.Orders = Orders;
        ...
        /// </summary>
        /// <value>The list of Order detail objects</value>
