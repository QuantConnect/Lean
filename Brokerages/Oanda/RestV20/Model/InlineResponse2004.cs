...
namespace Oanda.RestV20.Model
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        public InlineResponse2004(ClientConfigureTransaction ClientConfigureTransaction = default(ClientConfigureTransaction), string LastTransactionID = default(string))
        {
        ...
        public bool Equals(InlineResponse2004 other)
        {
            ...
            return 
                (
                    this.ClientConfigureTransaction == other.ClientConfigureTransaction ||
                    this.ClientConfigureTransaction != null &&
                    this.ClientConfigureTransaction.Equals(other.ClientConfigureTransaction)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ClientConfigureTransaction != null)
                    hash = hash * 59 + this.ClientConfigureTransaction.GetHashCode();
