...
namespace Oanda.RestV20.Model
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="ConfigureTransaction">The transaction that configures the Account..</param>
        /// <param name="LastTransactionID">The ID of the last Transaction created for the Account..</param>
        public InlineResponse2004(ClientConfigureTransaction ConfigureTransaction = default(ClientConfigureTransaction), string LastTransactionID = default(string))
        {
            this.ConfigureTransaction = ConfigureTransaction;
        ...
        /// </summary>
        /// <value>The transaction that configures the Account.</value>
        [DataMember(Name="configureTransaction", EmitDefaultValue=false)]
        public ClientConfigureTransaction ConfigureTransaction { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ConfigureTransaction: ").Append(ConfigureTransaction).Append("\n");
        ...
        public bool Equals(InlineResponse2004 other)
        {
            ...
            return 
                (
                    this.ConfigureTransaction == other.ConfigureTransaction ||
                    this.ConfigureTransaction != null &&
                    this.ConfigureTransaction.Equals(other.ConfigureTransaction)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ConfigureTransaction != null)
                    hash = hash * 59 + this.ConfigureTransaction.GetHashCode();
