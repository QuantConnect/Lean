...
namespace Oanda.RestV20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReopenTransaction :  IEquatable<ReopenTransaction>, IValidatableObject
    {
        /// <summary>
        /// The Type of the Transaction. Always set to \"REOPEN\" in a ReopenTransaction.
        /// </summary>
        /// <value>The Type of the Transaction. Always set to \"REOPEN\" in a ReopenTransaction.</value>
        ...
        /// <param name="Type">The Type of the Transaction. Always set to \&quot;REOPEN\&quot; in a ReopenTransaction..</param>
        public ReopenTransaction(string Id = default(string), string Time = default(string), int? UserID = default(int?), string AccountID = default(string), string BatchID = default(string), string RequestID = default(string), TypeEnum? Type = default(TypeEnum?))
        {
            this.Id = Id;
            this.Time = Time;
            this.UserID = UserID;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReopenTransaction {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ReopenTransaction);
        }

        /// <summary>
        /// Returns true if ReopenTransaction instances are equal
        /// </summary>
        /// <param name="other">Instance of ReopenTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReopenTransaction other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
