...
namespace Oanda.RestV20.Model
{
    ...
    public partial class InlineResponse2003 :  IEquatable<InlineResponse2003>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Instruments">The requested list of instruments..</param>
        public InlineResponse2003(List<Instrument> Instruments = default(List<Instrument>))
        {
        ...
        public bool Equals(InlineResponse2003 other)
        {
            ...
            return 
                (
                    ...
                    this.Instruments.SequenceEqual(other.Instruments)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Instruments != null)
                    hash = hash * 59 + this.Instruments.GetHashCode();
                return hash;
            }
        }
