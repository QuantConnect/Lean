...
namespace Oanda.RestV20.Model
{
    ...
    public partial class InlineResponse20010 :  IEquatable<InlineResponse20010>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="OrderClientExtensionsModifyTransaction">The Transaction that modified the Client Extensions for the Order.</param>
        /// <param name="LastTransactionID">The ID of the most recent Transaction created for the Account.</param>
        public InlineResponse20010(OrderClientExtensionsModifyTransaction OrderClientExtensionsModifyTransaction = default(OrderClientExtensionsModifyTransaction), string LastTransactionID = default(string))
        {
        ...
        /// </summary>
        /// <value>The Transaction that modified the Client Extensions for the Order</value>
