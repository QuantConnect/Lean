...
namespace Oanda.RestV20.Model
{
    ...
    public partial class TransferFundsTransaction :  IEquatable<TransferFundsTransaction>, IValidatableObject
    {
        ...
        public TransferFundsTransaction(string Id = default(string), string Time = default(string), int? UserID = default(int?), string AccountID = default(string), string BatchID = default(string), TypeEnum? Type = default(TypeEnum?), string Amount = default(string), FundingReasonEnum? FundingReason = default(FundingReasonEnum?), string AccountBalance = default(string))
        {
            this.Id = Id;
            this.Time = Time;
            this.UserID = UserID;
