...
namespace Oanda.RestV20.Model
{
    ...
    public partial class InlineResponse4004 :  IEquatable<InlineResponse4004>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="LongOrderRejectTransaction">The Transaction created that rejects the creation of a MarketOrder to close the long Position..</param>
        /// <param name="ShortOrderRejectTransaction">The Transaction created that rejects the creation of a MarketOrder to close the short Position..</param>
        ...
        /// </summary>
        /// <value>The Transaction created that rejects the creation of a MarketOrder to close the long Position.</value>
        ...
        /// </summary>
        /// <value>The Transaction created that rejects the creation of a MarketOrder to close the short Position.</value>
