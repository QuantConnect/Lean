...
namespace Oanda.RestV20.Model
{
    ...
    public partial class MarketOrderTransaction :  IEquatable<MarketOrderTransaction>, IValidatableObject
    {
        ...
        /// <param name="TradeClose">Details of the Trade requested to be closed, only provided when the Market Order is being used to explicitly close a Trade..</param>
        /// <param name="LongPositionCloseout">Details of the long Position requested to be closed out, only provided when a Market Order is being used to explicitly closeout a long Position..</param>
        /// <param name="ShortPositionCloseout">Details of the short Position requested to be closed out, only provided when a Market Order is being used to explicitly closeout a short Position..</param>
        /// <param name="MarginCloseout">Details of the Margin Closeout that this Market Order was created for.</param>
        /// <param name="DelayedTradeClose">Details of the delayed Trade close that this Market Order was created for.</param>
        ...
        /// </summary>
        /// <value>Details of the Trade requested to be closed, only provided when the Market Order is being used to explicitly close a Trade.</value>
        ...
        /// </summary>
        /// <value>Details of the long Position requested to be closed out, only provided when a Market Order is being used to explicitly closeout a long Position.</value>
        ...
        /// </summary>
        /// <value>Details of the short Position requested to be closed out, only provided when a Market Order is being used to explicitly closeout a short Position.</value>
        ...
        /// </summary>
        /// <value>Details of the Margin Closeout that this Market Order was created for</value>
        ...
        /// </summary>
        /// <value>Details of the delayed Trade close that this Market Order was created for</value>
        ...
        /// </summary>
        /// <value>The specification of the Take Profit Order that should be created for a Trade opened when the Order is filled (if such a Trade is created).</value>
        ...
        /// </summary>
        /// <value>The specification of the Stop Loss Order that should be created for a Trade opened when the Order is filled (if such a Trade is created).</value>
        ...
        /// </summary>
        /// <value>The specification of the Trailing Stop Loss Order that should be created for a Trade that is opened when the Order is filled (if such a Trade is created).</value>
        ...
        /// </summary>
        /// <value>Client Extensions to add to the Trade created when the Order is filled (if such a Trade is created).  Do not set, modify, delete tradeClientExtensions if your account is associated with MT4.</value>
