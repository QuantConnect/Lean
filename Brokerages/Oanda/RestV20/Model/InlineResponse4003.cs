...
namespace Oanda.RestV20.Model
{
    ...
    public partial class InlineResponse4003 :  IEquatable<InlineResponse4003>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="OrderClientExtensionsModifyRejectTransaction">The Transaction that rejected the modification of the Client Extensions for the Order.</param>
        ...
        public InlineResponse4003(OrderClientExtensionsModifyRejectTransaction OrderClientExtensionsModifyRejectTransaction = default(OrderClientExtensionsModifyRejectTransaction), string LastTransactionID = default(string), string ErrorCode = default(string), string ErrorMessage = default(string))
        {
        ...
        /// </summary>
        /// <value>The Transaction that rejected the modification of the Client Extensions for the Order</value>
        ...
        public bool Equals(InlineResponse4003 other)
        {
            ...
            return 
                (
                    this.OrderClientExtensionsModifyRejectTransaction == other.OrderClientExtensionsModifyRejectTransaction ||
                    this.OrderClientExtensionsModifyRejectTransaction != null &&
                    this.OrderClientExtensionsModifyRejectTransaction.Equals(other.OrderClientExtensionsModifyRejectTransaction)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OrderClientExtensionsModifyRejectTransaction != null)
                    hash = hash * 59 + this.OrderClientExtensionsModifyRejectTransaction.GetHashCode();
