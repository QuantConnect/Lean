...
namespace Oanda.RestV20.Model
{
    ...
    public partial class InlineResponse4001 :  IEquatable<InlineResponse4001>, IValidatableObject
    {
        ...
        public InlineResponse4001(Transaction OrderRejectTransaction = default(Transaction), List<string> RelatedTransactionIDs = default(List<string>), string LastTransactionID = default(string), string ErrorCode = default(string), string ErrorMessage = default(string))
        {
