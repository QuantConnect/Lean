...
namespace Oanda.RestV20.Model
{
    ...
    public partial class InlineResponse4001 :  IEquatable<InlineResponse4001>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="OrderRejectTransaction">The Transaction that rejected the creation of the Order as requested.</param>
        ...
        public InlineResponse4001(Transaction OrderRejectTransaction = default(Transaction), List<TransactionID> RelatedTransactionIDs = default(List<TransactionID>), string LastTransactionID = default(string), string ErrorCode = default(string), string ErrorMessage = default(string))
        {
        ...
        /// </summary>
        /// <value>The Transaction that rejected the creation of the Order as requested</value>
