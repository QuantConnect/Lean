...
namespace Oanda.RestV20.Model
{
    ...
    public partial class Account :  IEquatable<Account>, IValidatableObject
    {
        ...
        /// <param name="ResettabledPL">The total realized profit/loss for the Account since it was last reset by the client. Represented in the Account&#39;s home currency..</param>
        ...
        public Account(string Id = default(string), string Alias = default(string), string Currency = default(string), string Balance = default(string), int? CreatedByUserID = default(int?), string CreatedTime = default(string), string Pl = default(string), string ResettabledPL = default(string), string ResettabledPLTime = default(string), string MarginRate = default(string), string MarginCallEnterTime = default(string), int? MarginCallExtensionCount = default(int?), string LastMarginCallExtensionTime = default(string), int? OpenTradeCount = default(int?), int? OpenPositionCount = default(int?), int? PendingOrderCount = default(int?), bool? HedgingEnabled = default(bool?), string UnrealizedPL = default(string), string NAV = default(string), string MarginUsed = default(string), string MarginAvailable = default(string), string PositionValue = default(string), string MarginCloseoutUnrealizedPL = default(string), string MarginCloseoutNAV = default(string), string MarginCloseoutMarginUsed = default(string), string MarginCloseoutPercent = default(string), string WithdrawalLimit = default(string), string MarginCallMarginUsed = default(string), string MarginCallPercent = default(string), string LastTransactionID = default(string), List<TradeSummary> Trades = default(List<TradeSummary>), List<Position> Positions = default(List<Position>), List<Order> Orders = default(List<Order>))
        {
            ...
            this.Pl = Pl;
            this.ResettabledPL = ResettabledPL;
        ...
        [DataMember(Name="resettabledPL", EmitDefaultValue=false)]
        public string ResettabledPL { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ResettabledPL: ").Append(ResettabledPL).Append("\n");
        ...
        public bool Equals(Account other)
        {
            ...
            return 
                ...
                (
                    this.ResettabledPL == other.ResettabledPL ||
                    this.ResettabledPL != null &&
                    this.ResettabledPL.Equals(other.ResettabledPL)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ResettabledPL != null)
                    hash = hash * 59 + this.ResettabledPL.GetHashCode();
