...
namespace Oanda.RestV20.Model
{
    ...
    public partial class AccountChanges :  IEquatable<AccountChanges>, IValidatableObject
    {
        ...
        public AccountChanges(List<Order> OrdersCreated = default(List<Order>), List<Order> OrdersCancelled = default(List<Order>), List<Order> OrdersFilled = default(List<Order>), List<Order> OrdersTriggered = default(List<Order>), List<Trade> TradesOpened = default(List<Trade>), List<Trade> TradesReduced = default(List<Trade>), List<Trade> TradesClosed = default(List<Trade>), List<Position> Positions = default(List<Position>), List<Transaction> Transactions = default(List<Transaction>))
        {
