...
namespace Oanda.RestV20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StopLossOrderRequest :  IEquatable<StopLossOrderRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StopLossOrderRequest" /> class.
        /// </summary>
        /// <param name="Type">The type of the Order to Create. Must be set to \&quot;STOP_LOSS\&quot; when creating a Stop Loss Order..</param>
        ...
        public StopLossOrderRequest(TypeEnum? Type = default(TypeEnum?), string TradeID = default(string), string ClientTradeID = default(string), string Price = default(string), TimeInForceEnum? TimeInForce = default(TimeInForceEnum?), string GtdTime = default(string), ClientExtensions ClientExtensions = default(ClientExtensions))
        {
            this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as StopLossOrderRequest);
        }

        /// <summary>
        /// Returns true if StopLossOrderRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of StopLossOrderRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StopLossOrderRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
