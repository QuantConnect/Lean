...
namespace Oanda.RestV20.Model
{
    ...
    public partial class InlineResponse4006 :  IEquatable<InlineResponse4006>, IValidatableObject
    {
        ...
        public InlineResponse4006(TradeClientExtensionsModifyRejectTransaction TradeClientExtensionsModifyRejectTransaction = default(TradeClientExtensionsModifyRejectTransaction), string LastTransactionID = default(string), List<string> RelatedTransactionIDs = default(List<string>), string ErrorCode = default(string), string ErrorMessage = default(string))
        {
