...
namespace Oanda.RestV20.Model
{
    ...
    public partial class InlineResponse4006 :  IEquatable<InlineResponse4006>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="TradeClientExtensionsModifyRejectTransaction">The Transaction that rejects the modification of the Trade&#39;s Client Extensions..</param>
        ...
        public InlineResponse4006(TradeClientExtensionsModifyRejectTransaction TradeClientExtensionsModifyRejectTransaction = default(TradeClientExtensionsModifyRejectTransaction), string LastTransactionID = default(string), string ErrorCode = default(string), string ErrorMessage = default(string))
        {
        ...
        /// </summary>
        /// <value>The Transaction that rejects the modification of the Trade&#39;s Client Extensions.</value>
