...
namespace Oanda.RestV20.Model
{
    ...
    public partial class InlineResponse4002 :  IEquatable<InlineResponse4002>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="OrderRejectTransaction">The Transaction that rejected the creation of the replacing Order.</param>
        ...
        public InlineResponse4002(Transaction OrderRejectTransaction = default(Transaction), List<TransactionID> RelatedTransactionIDs = default(List<TransactionID>), string LastTransactionID = default(string), string ErrorCode = default(string), string ErrorMessage = default(string))
        {
        ...
        /// </summary>
        /// <value>The Transaction that rejected the creation of the replacing Order</value>
