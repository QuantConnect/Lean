...
namespace Oanda.RestV20.Model
{
    ...
    public partial class InlineResponse404 :  IEquatable<InlineResponse404>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="OrderCancelRejectTransaction">The Transaction that rejected the cancellation of the Order.</param>
        ...
        public InlineResponse404(OrderCancelRejectTransaction OrderCancelRejectTransaction = default(OrderCancelRejectTransaction), List<TransactionID> RelatedTransactionIDs = default(List<TransactionID>), string LastTransactionID = default(string), string ErrorCode = default(string), string ErrorMessage = default(string))
        {
        ...
        /// </summary>
        /// <value>The Transaction that rejected the cancellation of the Order</value>
        ...
        public bool Equals(InlineResponse404 other)
        {
            ...
            return 
                (
                    this.OrderCancelRejectTransaction == other.OrderCancelRejectTransaction ||
                    this.OrderCancelRejectTransaction != null &&
                    this.OrderCancelRejectTransaction.Equals(other.OrderCancelRejectTransaction)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OrderCancelRejectTransaction != null)
                    hash = hash * 59 + this.OrderCancelRejectTransaction.GetHashCode();
