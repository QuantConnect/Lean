...
namespace Oanda.RestV20.Model
{
    ...
    public partial class ClosePositionBody :  IEquatable<ClosePositionBody>, IValidatableObject
    {
        ...
        /// <param name="LongClientExtensions">The client extensions to add to the MarketOrder used to close the long position..</param>
        ...
        /// <param name="ShortClientExtensions">The client extensions to add to the MarketOrder used to close the short position..</param>
        ...
        /// </summary>
        /// <value>The client extensions to add to the MarketOrder used to close the long position.</value>
        ...
        /// </summary>
        /// <value>The client extensions to add to the MarketOrder used to close the short position.</value>
