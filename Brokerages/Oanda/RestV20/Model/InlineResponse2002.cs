...
namespace Oanda.RestV20.Model
{
    ...
    public partial class InlineResponse2002 :  IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Account">The summary of the requested Account..</param>
        /// <param name="LastTransactionID">The ID of the most recent Transaction created for the Account..</param>
        public InlineResponse2002(AccountSummary Account = default(AccountSummary), string LastTransactionID = default(string))
        {
        ...
        /// </summary>
        /// <value>The summary of the requested Account.</value>
