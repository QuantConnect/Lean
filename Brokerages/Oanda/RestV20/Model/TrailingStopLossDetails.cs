...
namespace Oanda.RestV20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrailingStopLossDetails :  IEquatable<TrailingStopLossDetails>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ClientExtensions">The Client Extensions to add to the Trailing Stop Loss Order when created..</param>
        ...
        /// </summary>
        /// <value>The Client Extensions to add to the Trailing Stop Loss Order when created.</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TrailingStopLossDetails);
        }

        /// <summary>
        /// Returns true if TrailingStopLossDetails instances are equal
        /// </summary>
        /// <param name="other">Instance of TrailingStopLossDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrailingStopLossDetails other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
