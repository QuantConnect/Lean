...
namespace Oanda.RestV20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderClientExtensionsModifyRejectTransaction :  IEquatable<OrderClientExtensionsModifyRejectTransaction>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="Type">The Type of the Transaction. Always set to \&quot;ORDER_CLIENT_EXTENSIONS_MODIFY_REJECT\&quot; for a OrderClientExtensionsModifyRejectTransaction..</param>
        ...
        /// <param name="OrderClientExtensionsModify">The new Client Extensions for the Order..</param>
        /// <param name="TradeClientExtensionsModify">The new Client Extensions for the Order&#39;s Trade on fill..</param>
        /// <param name="RejectReason">The reason that the Reject Transaction was created.</param>
        public OrderClientExtensionsModifyRejectTransaction(string Id = default(string), string Time = default(string), int? UserID = default(int?), string AccountID = default(string), string BatchID = default(string), TypeEnum? Type = default(TypeEnum?), string OrderID = default(string), string ClientOrderID = default(string), ClientExtensions OrderClientExtensionsModify = default(ClientExtensions), ClientExtensions TradeClientExtensionsModify = default(ClientExtensions), RejectReasonEnum? RejectReason = default(RejectReasonEnum?))
        {
            this.Id = Id;
            this.Time = Time;
            this.UserID = UserID;
            ...
            this.OrderClientExtensionsModify = OrderClientExtensionsModify;
        ...
        /// </summary>
        /// <value>The new Client Extensions for the Order.</value>
        [DataMember(Name="orderClientExtensionsModify", EmitDefaultValue=false)]
        public ClientExtensions OrderClientExtensionsModify { get; set; }
        /// <summary>
        /// The new Client Extensions for the Order&#39;s Trade on fill.
        /// </summary>
        /// <value>The new Client Extensions for the Order&#39;s Trade on fill.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OrderClientExtensionsModify: ").Append(OrderClientExtensionsModify).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OrderClientExtensionsModifyRejectTransaction);
        }

        /// <summary>
        /// Returns true if OrderClientExtensionsModifyRejectTransaction instances are equal
        /// </summary>
        /// <param name="other">Instance of OrderClientExtensionsModifyRejectTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderClientExtensionsModifyRejectTransaction other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.OrderClientExtensionsModify == other.OrderClientExtensionsModify ||
                    this.OrderClientExtensionsModify != null &&
                    this.OrderClientExtensionsModify.Equals(other.OrderClientExtensionsModify)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OrderClientExtensionsModify != null)
                    hash = hash * 59 + this.OrderClientExtensionsModify.GetHashCode();
