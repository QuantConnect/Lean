...
namespace Oanda.RestV20.Model
{
    ...
    public partial class TakeProfitOrder :  IEquatable<TakeProfitOrder>, IValidatableObject
    {
        ...
        /// <param name="ClientExtensions">The client extensions of the Order. Do not set, modify, or delete clientExtensions if your account is associated with MT4..</param>
        /// <param name="Type">The type of the Order. Always set to \&quot;TAKE_PROFIT\&quot; for Take Profit Orders..</param>
        ...
        /// </summary>
        /// <value>The client extensions of the Order. Do not set, modify, or delete clientExtensions if your account is associated with MT4.</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TakeProfitOrder);
        }

        /// <summary>
        /// Returns true if TakeProfitOrder instances are equal
        /// </summary>
        /// <param name="other">Instance of TakeProfitOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TakeProfitOrder other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
