...
namespace Oanda.RestV20.Model
{
    ...
    public partial class CloseTransaction :  IEquatable<CloseTransaction>, IValidatableObject
    {
        ...
        public CloseTransaction(string Id = default(string), string Time = default(string), int? UserID = default(int?), string AccountID = default(string), string BatchID = default(string), TypeEnum? Type = default(TypeEnum?))
        {
            this.Id = Id;
            this.Time = Time;
            this.UserID = UserID;
