...
namespace Oanda.RestV20.Model
{
    ...
    public partial class OrderFillTransaction :  IEquatable<OrderFillTransaction>, IValidatableObject
    {
        ...
        /// <param name="TradeOpened">The Trade that was opened when the Order was filled (only provided if filling the Order resulted in a new Trade)..</param>
        ...
        /// </summary>
        /// <value>The Trade that was opened when the Order was filled (only provided if filling the Order resulted in a new Trade).</value>
        ...
        /// </summary>
        /// <value>The Trade that was reduced when the Order was filled (only provided if filling the Order resulted in reducing an open Trade).</value>
