...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
        public interface IDailyChangeAPIApi : IApiAccessor
    {
        ...
        List<DailyChangeResponse> GetDailyChange (string version, string symbolId);
        ...
        ApiResponse<List<DailyChangeResponse>> GetDailyChangeWithHttpInfo (string version, string symbolId);
        /// <summary>
        /// get all daily changes
        /// </summary>
        /// <remarks>
        ...
        /// <param name="version">API version</param>
        /// <returns>List&lt;DailyChangeResponse&gt;</returns>
        List<DailyChangeResponse> GetDailyChanges (string version);
        ...
        /// <param name="version">API version</param>
        /// <returns>ApiResponse of List&lt;DailyChangeResponse&gt;</returns>
        ApiResponse<List<DailyChangeResponse>> GetDailyChangesWithHttpInfo (string version);
        ...
        System.Threading.Tasks.Task<List<DailyChangeResponse>> GetDailyChangeAsync (string version, string symbolId);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<DailyChangeResponse>>> GetDailyChangeAsyncWithHttpInfo (string version, string symbolId);
        /// <summary>
        /// get all daily changes
        /// </summary>
        /// <remarks>
        ...
        /// <param name="version">API version</param>
        /// <returns>Task of List&lt;DailyChangeResponse&gt;</returns>
        System.Threading.Tasks.Task<List<DailyChangeResponse>> GetDailyChangesAsync (string version);
        ...
        /// <param name="version">API version</param>
        /// <returns>Task of ApiResponse (List&lt;DailyChangeResponse&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<DailyChangeResponse>>> GetDailyChangesAsyncWithHttpInfo (string version);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class DailyChangeAPIApi : IDailyChangeAPIApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="DailyChangeAPIApi"/> class.
        /// </summary>
        /// <returns></returns>
        public DailyChangeAPIApi(String basePath)
        {
        ...
        /// <returns></returns>
        public DailyChangeAPIApi(IO.Swagger.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< List<DailyChangeResponse> > GetDailyChangeWithHttpInfo (string version, string symbolId)
        {
            ...
            var localVarPath = "/md/{version}/change/{symbolId}";
            ...
            {
                Exception exception = ExceptionFactory("GetDailyChange", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<List<DailyChangeResponse>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (List<DailyChangeResponse>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<DailyChangeResponse>)));
        }
        ...
        /// <param name="symbolId">symbol or comma-delimited symbols to request daily change</param>
        /// <returns>Task of List&lt;DailyChangeResponse&gt;</returns>
        public async System.Threading.Tasks.Task<List<DailyChangeResponse>> GetDailyChangeAsync (string version, string symbolId)
        {
             ApiResponse<List<DailyChangeResponse>> localVarResponse = await GetDailyChangeAsyncWithHttpInfo(version, symbolId);
             return localVarResponse.Data;
        ...
        /// <param name="symbolId">symbol or comma-delimited symbols to request daily change</param>
        /// <returns>Task of ApiResponse (List&lt;DailyChangeResponse&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<DailyChangeResponse>>> GetDailyChangeAsyncWithHttpInfo (string version, string symbolId)
        {
            // verify the required parameter 'version' is set
            if (version == null)
                throw new ApiException(400, "Missing required parameter 'version' when calling DailyChangeAPIApi->GetDailyChange");
        ...
        public ApiResponse< List<DailyChangeResponse> > GetDailyChangesWithHttpInfo (string version)
        {
            ...
            var localVarPath = "/md/{version}/change";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetDailyChanges", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="version">API version</param>
        /// <returns>Task of List&lt;DailyChangeResponse&gt;</returns>
        public async System.Threading.Tasks.Task<List<DailyChangeResponse>> GetDailyChangesAsync (string version)
        {
             ApiResponse<List<DailyChangeResponse>> localVarResponse = await GetDailyChangesAsyncWithHttpInfo(version);
             return localVarResponse.Data;
        ...
        /// <param name="version">API version</param>
        /// <returns>Task of ApiResponse (List&lt;DailyChangeResponse&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<DailyChangeResponse>>> GetDailyChangesAsyncWithHttpInfo (string version)
        {
            // verify the required parameter 'version' is set
            if (version == null)
                throw new ApiException(400, "Missing required parameter 'version' when calling DailyChangeAPIApi->GetDailyChanges");
