...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
        public interface IOrdersStreamAPIApi : IApiAccessor
    {
        ...
        InlineResponse200 OrderUpdatesHttp (string version);
        ...
        ApiResponse<InlineResponse200> OrderUpdatesHttpWithHttpInfo (string version);
        /// <summary>
        /// order updates ws stream
        /// </summary>
        /// <remarks>
        ...
        InlineResponse2002 OrderUpdatesWs (string version);
        ...
        ApiResponse<InlineResponse2002> OrderUpdatesWsWithHttpInfo (string version);
        ...
        System.Threading.Tasks.Task<InlineResponse200> OrderUpdatesHttpAsync (string version);
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse200>> OrderUpdatesHttpAsyncWithHttpInfo (string version);
        /// <summary>
        /// order updates ws stream
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<InlineResponse2002> OrderUpdatesWsAsync (string version);
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2002>> OrderUpdatesWsAsyncWithHttpInfo (string version);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class OrdersStreamAPIApi : IOrdersStreamAPIApi
    {
        ...
        /// <returns></returns>
        public OrdersStreamAPIApi(IO.Swagger.Client.Configuration configuration = null)
        {
        ...
        /// <param name="version">API version</param>
        /// <returns>InlineResponse200</returns>
        public InlineResponse200 OrderUpdatesHttp (string version)
        {
             ApiResponse<InlineResponse200> localVarResponse = OrderUpdatesHttpWithHttpInfo(version);
        ...
        /// <param name="version">API version</param>
        /// <returns>ApiResponse of InlineResponse200</returns>
        public ApiResponse< InlineResponse200 > OrderUpdatesHttpWithHttpInfo (string version)
        {
            // verify the required parameter 'version' is set
            if (version == null)
                throw new ApiException(400, "Missing required parameter 'version' when calling OrdersStreamAPIApi->OrderUpdatesHttp");

            var localVarPath = "/trade/{version}/stream/orders";
            ...
            {
                Exception exception = ExceptionFactory("OrderUpdatesHttp", localVarResponse);
        ...
        /// <param name="version">API version</param>
        /// <returns>Task of InlineResponse200</returns>
        public async System.Threading.Tasks.Task<InlineResponse200> OrderUpdatesHttpAsync (string version)
        {
             ApiResponse<InlineResponse200> localVarResponse = await OrderUpdatesHttpAsyncWithHttpInfo(version);
             return localVarResponse.Data;
        ...
        /// <param name="version">API version</param>
        /// <returns>Task of ApiResponse (InlineResponse200)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse200>> OrderUpdatesHttpAsyncWithHttpInfo (string version)
        {
            // verify the required parameter 'version' is set
            if (version == null)
                throw new ApiException(400, "Missing required parameter 'version' when calling OrdersStreamAPIApi->OrderUpdatesHttp");
        ...
        /// <param name="version">API version</param>
        /// <returns>InlineResponse2002</returns>
        public InlineResponse2002 OrderUpdatesWs (string version)
        {
             ApiResponse<InlineResponse2002> localVarResponse = OrderUpdatesWsWithHttpInfo(version);
             return localVarResponse.Data;
        }
        ...
        /// <param name="version">API version</param>
        /// <returns>ApiResponse of InlineResponse2002</returns>
        public ApiResponse< InlineResponse2002 > OrderUpdatesWsWithHttpInfo (string version)
        {
            // verify the required parameter 'version' is set
            if (version == null)
                throw new ApiException(400, "Missing required parameter 'version' when calling OrdersStreamAPIApi->OrderUpdatesWs");

            var localVarPath = "/trade/{version}/ws/orders";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("OrderUpdatesWs", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="version">API version</param>
        /// <returns>Task of InlineResponse2002</returns>
        public async System.Threading.Tasks.Task<InlineResponse2002> OrderUpdatesWsAsync (string version)
        {
             ApiResponse<InlineResponse2002> localVarResponse = await OrderUpdatesWsAsyncWithHttpInfo(version);
             return localVarResponse.Data;
        ...
        /// <param name="version">API version</param>
        /// <returns>Task of ApiResponse (InlineResponse2002)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse2002>> OrderUpdatesWsAsyncWithHttpInfo (string version)
        {
            // verify the required parameter 'version' is set
            if (version == null)
                throw new ApiException(400, "Missing required parameter 'version' when calling OrdersStreamAPIApi->OrderUpdatesWs");
