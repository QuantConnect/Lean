...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SeqValue : List<Value>,  IEquatable<SeqValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SeqValue" /> class.
        /// </summary>
        public SeqValue() : base()
        {
        }
        ...
        {
            return this.Equals(input as SeqValue);
        }

        /// <summary>
        /// Returns true if SeqValue instances are equal
        /// </summary>
        /// <param name="input">Instance of SeqValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SeqValue input)
        {
            if (input == null)
                return false;
