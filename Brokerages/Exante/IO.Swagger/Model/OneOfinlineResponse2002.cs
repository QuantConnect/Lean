...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OneOfinlineResponse2002 :  IEquatable<OneOfinlineResponse2002>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOfinlineResponse2002" /> class.
        /// </summary>
        public OneOfinlineResponse2002()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OneOfinlineResponse2002 {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as OneOfinlineResponse2002);
        }

        /// <summary>
        /// Returns true if OneOfinlineResponse2002 instances are equal
        /// </summary>
        /// <param name="input">Instance of OneOfinlineResponse2002 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneOfinlineResponse2002 input)
        {
            if (input == null)
                return false;
