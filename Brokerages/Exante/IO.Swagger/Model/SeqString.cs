...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SeqString : List<string>,  IEquatable<SeqString>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SeqString" /> class.
        /// </summary>
        public SeqString() : base()
        {
        }
        ...
        {
            return this.Equals(input as SeqString);
        }

        /// <summary>
        /// Returns true if SeqString instances are equal
        /// </summary>
        /// <param name="input">Instance of SeqString to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SeqString input)
        {
            if (input == null)
                return false;
