...
namespace IO.Swagger.Model
{
        ...
        public partial class IntervalResponse :  IEquatable<IntervalResponse>, IValidatableObject
    {
        ...
        public IntervalResponse(decimal? end = default(decimal?), decimal? start = default(decimal?))
        {
            ...
            if (end == null)
            {
                throw new InvalidDataException("end is a required property for IntervalResponse and cannot be null");
            }
            else
            {
                this.End = end;
            ...
            if (start == null)
            {
                throw new InvalidDataException("start is a required property for IntervalResponse and cannot be null");
            }
            else
            {
                this.Start = start;
