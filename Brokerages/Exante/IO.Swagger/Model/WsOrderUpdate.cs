...
namespace IO.Swagger.Model
{
        ...
        public partial class WsOrderUpdate :  IEquatable<WsOrderUpdate>, IValidatableObject
    {
        ...
        public WsOrderUpdate(EventEnum _event = default(EventEnum), long? sequenceNumber = default(long?), ApiOrder order = default(ApiOrder))
        {
            ...
            if (_event == null)
            {
                throw new InvalidDataException("_event is a required property for WsOrderUpdate and cannot be null");
            }
            else
            {
                this.Event = _event;
            ...
            {
                throw new InvalidDataException("sequenceNumber is a required property for WsOrderUpdate and cannot be null");
            }
            else
            {
            ...
            if (order == null)
            {
                throw new InvalidDataException("order is a required property for WsOrderUpdate and cannot be null");
            }
            else
            {
                this.Order = order;
