...
namespace IO.Swagger.Model
{
        ...
        public partial class QuoteSide :  IEquatable<QuoteSide>, IValidatableObject
    {
        ...
        public QuoteSide(string price = default(string), string size = default(string), string value = default(string))
        {
            ...
            if (price == null)
            {
                throw new InvalidDataException("price is a required property for QuoteSide and cannot be null");
            }
            else
            {
                this.Price = price;
            ...
            if (size == null)
            {
                throw new InvalidDataException("size is a required property for QuoteSide and cannot be null");
            }
            else
            {
                this.Size = size;
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for QuoteSide and cannot be null");
            }
            else
            {
                this.Value = value;
