...
namespace IO.Swagger.Model
{
        ...
        public partial class CurrencyPositionResponse :  IEquatable<CurrencyPositionResponse>, IValidatableObject
    {
        ...
        public CurrencyPositionResponse(string code = default(string), string convertedValue = default(string), string value = default(string))
        {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for CurrencyPositionResponse and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for CurrencyPositionResponse and cannot be null");
            }
            else
            {
                this.Value = value;
