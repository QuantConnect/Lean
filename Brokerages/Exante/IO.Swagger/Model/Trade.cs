...
namespace IO.Swagger.Model
{
        ...
        public partial class Trade :  IEquatable<Trade>, IValidatableObject
    {
        ...
        public Trade(string time = default(string), string price = default(string), string timestamp = default(string), EventEnum _event = default(EventEnum), string quantity = default(string), Guid? orderId = default(Guid?), string position = default(string))
        {
            ...
            if (time == null)
            {
                throw new InvalidDataException("time is a required property for Trade and cannot be null");
            }
            else
            {
                this.Time = time;
            ...
            if (price == null)
            {
                throw new InvalidDataException("price is a required property for Trade and cannot be null");
            }
            else
            {
                this.Price = price;
            ...
            if (_event == null)
            {
                throw new InvalidDataException("_event is a required property for Trade and cannot be null");
            }
            else
            {
                this.Event = _event;
            ...
            if (quantity == null)
            {
                throw new InvalidDataException("quantity is a required property for Trade and cannot be null");
            }
            else
            {
            ...
            if (position == null)
            {
                throw new InvalidDataException("position is a required property for Trade and cannot be null");
            }
            else
            {
