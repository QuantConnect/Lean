...
namespace IO.Swagger.Model
{
        ...
        public partial class OrderUpdate :  IEquatable<OrderUpdate>, IValidatableObject
    {
        ...
        public OrderUpdate(EventEnum _event = default(EventEnum), ApiOrder order = default(ApiOrder))
        {
            ...
            if (_event == null)
            {
                throw new InvalidDataException("_event is a required property for OrderUpdate and cannot be null");
            }
            else
            {
                this.Event = _event;
            ...
            if (order == null)
            {
                throw new InvalidDataException("order is a required property for OrderUpdate and cannot be null");
            }
            else
            {
                this.Order = order;
