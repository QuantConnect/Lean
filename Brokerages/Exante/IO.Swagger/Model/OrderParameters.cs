...
namespace IO.Swagger.Model
{
        ...
        public partial class OrderParameters :  IEquatable<OrderParameters>, IValidatableObject
    {
        ...
        public OrderParameters(string instrument = default(string), OrderTypeEnum orderType = default(OrderTypeEnum), string limitPrice = default(string), SideEnum side = default(SideEnum), string symbolId = default(string), string ifDoneParentId = default(string), string placeInterval = default(string), DurationEnum duration = default(DurationEnum), string stopPrice = default(string), string quantity = default(string), DateTime? gttExpiration = default(DateTime?), string ocoGroup = default(string), string priceDistance = default(string), string partQuantity = default(string))
        {
            ...
            if (instrument == null)
            {
                throw new InvalidDataException("instrument is a required property for OrderParameters and cannot be null");
            }
            else
            {
            ...
            if (orderType == null)
            {
                throw new InvalidDataException("orderType is a required property for OrderParameters and cannot be null");
            }
            else
            {
            ...
            if (side == null)
            {
                throw new InvalidDataException("side is a required property for OrderParameters and cannot be null");
            }
            else
            {
                this.Side = side;
            ...
            if (symbolId == null)
            {
                throw new InvalidDataException("symbolId is a required property for OrderParameters and cannot be null");
            }
            else
            {
            ...
            if (duration == null)
            {
                throw new InvalidDataException("duration is a required property for OrderParameters and cannot be null");
            }
            else
            {
            ...
            if (quantity == null)
            {
                throw new InvalidDataException("quantity is a required property for OrderParameters and cannot be null");
            }
            else
            {
