...
namespace QuantConnect.Brokerages.Bitfinex
{
    ...
    public class BitfinexSymbolMapper : ISymbolMapper
    {
        ...
        public static readonly HashSet<string> KnownSymbolStrings = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            "DSHBTC","BTCEUR","BTCJPY","XRPUSD","XRPBTC","IOTUSD","IOTBTC",
            "IOTETH","EOSUSD","EOSBTC","EOSETH","SANUSD","SANBTC","SANETH",
            "OMGUSD","OMGBTC","OMGETH","BCHUSD","BCHBTC","BCHETH","NEOUSD",
            "NEOBTC","NEOETH","ETPUSD","ETPBTC","ETPETH","QTMUSD","QTMBTC",
            "QTMETH","AVTUSD","AVTBTC","AVTETH","EDOUSD","EDOBTC","EDOETH",
            "BTGUSD","BTGBTC","DATUSD","DATBTC","DATETH","QSHUSD","QSHBTC",
            "QSHETH","YYWUSD","YYWBTC","YYWETH","GNTUSD","GNTBTC","GNTETH",
            "SNTUSD","SNTBTC","SNTETH","IOTEUR","BATUSD","BATBTC","BATETH",
            "MNAUSD","MNABTC","MNAETH","FUNUSD","FUNBTC","FUNETH","ZRXUSD",
            "ZRXBTC","ZRXETH","TNBUSD","TNBBTC","TNBETH","SPKUSD","SPKBTC",
            "SPKETH","TRXUSD","TRXBTC","TRXETH","RCNUSD","RCNBTC","RCNETH",
            "RLCUSD","RLCBTC","RLCETH","AIDUSD","AIDBTC","AIDETH","SNGUSD",
            "SNGBTC","SNGETH","REPUSD","REPBTC","REPETH","ELFUSD","ELFBTC",
            "ELFETH","BTCGBP","ETHEUR","ETHJPY","ETHGBP","NEOEUR","NEOJPY",
            "NEOGBP","EOSEUR","EOSJPY","EOSGBP","IOTJPY","IOTGBP","IOSUSD",
            "IOSBTC","IOSETH","AIOUSD","AIOBTC","AIOETH","REQUSD","REQBTC",
            "REQETH","RDNUSD","RDNBTC","RDNETH","LRCUSD","LRCBTC","LRCETH",
            "WAXUSD","WAXBTC","WAXETH","DAIUSD","DAIBTC","DAIETH","CFIUSD",
            "CFIBTC","CFIETH","AGIUSD","AGIBTC","AGIETH","BFTUSD","BFTBTC",
            "BFTETH","MTNUSD","MTNBTC","MTNETH","ODEUSD","ODEBTC","ODEETH",
            "ANTUSD","ANTBTC","ANTETH","DTHUSD","DTHBTC","DTHETH","MITUSD",
            "MITBTC","MITETH","STJUSD","STJBTC","STJETH","XLMUSD","XLMEUR",
            "XLMJPY","XLMGBP","XLMBTC","XLMETH","XVGUSD","XVGEUR","XVGJPY",
            "XVGGBP","XVGBTC","XVGETH","BCIUSD","BCIBTC","MKRUSD","MKRBTC",
            "MKRETH","VENUSD","VENBTC","VENETH","KNCUSD","KNCBTC","KNCETH",
            "POAUSD","POABTC","POAETH","LYMUSD","LYMBTC","LYMETH","UTKUSD",
            "UTKBTC","UTKETH","VEEUSD","VEEBTC","VEEETH","DADUSD","DADBTC",
            "DADETH","ORSUSD","ORSBTC","ORSETH","AUCUSD","AUCBTC","AUCETH",
            "POYUSD","POYBTC","POYETH","FSNUSD","FSNBTC","FSNETH","CBTUSD",
            "CBTBTC","CBTETH","ZCNUSD","ZCNBTC","ZCNETH","SENUSD","SENBTC",
            "SENETH","NCAUSD","NCABTC","NCAETH","CNDUSD","CNDBTC","CNDETH",
            "CTXUSD","CTXBTC","CTXETH","PAIUSD","PAIBTC","SEEUSD","SEEBTC",
            "SEEETH","ESSUSD","ESSBTC","ESSETH","ATMUSD","ATMBTC","ATMETH",
            "HOTUSD","HOTBTC","HOTETH","DTAUSD","DTABTC","DTAETH","IQXUSD",
            "IQXBTC","IQXEOS","WPRUSD","WPRBTC","WPRETH","ZILUSD","ZILBTC",
            "ZILETH","BNTUSD","BNTBTC","BNTETH"
        };
        ...
        public bool IsKnownBrokerageCurrency(string currency)
        {
