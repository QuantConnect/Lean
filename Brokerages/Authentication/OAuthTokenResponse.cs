...
namespace QuantConnect.Brokerages.Authentication
{
    ...
    /// Used by <see cref="LeanOAuthTokenHandler"/> for token retrieval and caching.
    /// Token expiry is tracked by the handler via its <c>tokenLifetime</c> constructor parameter,
    /// not stored in this response.
    /// </summary>
    public class OAuthTokenResponse : RestResponse
    {
        /// <summary>
